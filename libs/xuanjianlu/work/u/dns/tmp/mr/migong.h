int valid_leave(object me, string dir)
{
        ...
        if (dir == "north")
          me->add_temp("mark/lvls",-1);
            ...
            if (me->query_temp("mark/lvl") == -6&&me->query_temp("mark/lvls") == -7&&random(me->query("int"))>20)
         {
            ...
            if (me->query_temp("mark/lvls") == -6&&me->query_temp("mark/lvl") == 5)
         {
           ...
           if (me->query_temp("mark/lvls") > 20 || me->query_temp("mark/lvls") < -20)
            {  
 ...
 return notify_fail("你白费了半天劲, 又走回了原地。\n");
           ...
           if (me->query_temp("mark/lvl") > 20 || me->query_temp("mark/lvl") < -20)
            {  
           me->move(__DIR__"didao2");
           me->delete_temp("mark/lvls");
           me->delete_temp("mark/lvl");
