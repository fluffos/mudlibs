...
{
    if ( me->query("wuliang/master") == this_object()->query("id") )
    {
        return 1;
    }
...
{
    if ( you->query_temp( "wuliang/fight_master" ) )
    {
        you->delete_temp( "wuliang/fight_master" );
...
{
    if ( you->query_temp( "wuliang/fight_master" ) == query("id") )
    {
        you->set( "wuliang/defeat_master", query("id") );
        you->save();
