...
#define WIZ_PATH ({"/cmds/arch/", "/cmds/wiz/", "/cmds/imm/", "/cmds/eld/", "/cmds/usr/","/cmds/std/"})
#define APR_PATH ({"/cmds/imm/", "/cmds/eld/", "/cmds/usr/", "/cmds/std/", "/cmds/wiz/"})
#define IMM_PATH ({"/cmds/imm/", "/cmds/eld/", "/cmds/usr/", "/cmds/std/"})
#define ELD_PATH ({"/cmds/imm/", "/cmds/eld/", "/cmds/usr/", "/cmds/std/"})
#define PLR_PATH ({"/cmds/eld/", "/cmds/std/", "/cmds/usr/"})
