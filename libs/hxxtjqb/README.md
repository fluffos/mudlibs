...
游戏内标题为"西行战记"（MudOS v22pre11 MudLib Build 3310），一个西游记题材的传统 GB/BIG5 双编码 ES 血统 mudlib，严格取材《西游记》神话世界观——三十三天、蟠桃园、蓬莱、南海、天宫等取经沿途地标都是游戏里真实可达的场景，与本项目"三界神话"系家族（编号 99-101 等）地名风格相近，却是完全独立的代码库。注册时会先问玩家"是否为中小学生或更小年龄"，答"是"会被直接劝退，是这批收录档案里对未成年访问处理最直接的一例。月宫场景（`d/moon/`）里还放置了诗词类物件，为以战斗/探索为主的地图增添了一点文学化的细节。
