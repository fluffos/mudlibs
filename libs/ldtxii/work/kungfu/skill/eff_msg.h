...
//足太阳膀胱
string *foot_taiyang_name = ({ "至阴穴","通谷穴","束骨穴","京骨穴","昆仑穴","委中穴",});
//足少阴肾
string *foot_shaoyin_name = ({ "涌泉穴","然谷穴","太溪穴","复溜穴","阴谷穴",});
//手厥阴心包
string *hand_queyin_name = ({ "中冲穴","劳宫穴","大陵穴","间使穴","曲泽穴",});
//手少阳三焦
string *hand_shaoyang_name2 = ({ "关冲穴","液门穴","中渚穴","阳池穴","支沟穴","天井穴",});
//足少阳胆
string *foot_shaoyang_name = ({ "窍阴穴","侠溪穴","临泣穴","丘墟穴","阳辅穴","阳陵泉穴",});
//足厥阴肝
string *foot_queyin_name = ({ "大敦穴","行间穴","太冲穴","中封穴","曲泉穴",});
   #include "/kungfu/skill/eff_msg.h";
   int p;
    p = (int)target->query("qi")*100/(int)target->query("max_qi");
    msg += damage_msg(damage, "瘀伤");
