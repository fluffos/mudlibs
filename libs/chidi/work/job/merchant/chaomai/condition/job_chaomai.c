...
int update_condition(object me, int duration)
{
        ...
        if( pass_time>1800 ) {
                tell_object(me, HIG "胡子(edw)告诉你：我要你买的货物我已经搞到了，你还是下次再做吧。我损失的钱直接在你的银行里扣。\n" NOR );
