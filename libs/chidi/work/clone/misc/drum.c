...
int do_knock(string arg)
{
    ...
    if(j < 3 )
	{
		environment(me)->set("exits/southdown","d/huashan/houzhiwangyu.c");
    ...
    if(sizeof(fighters)<9)
	{
        if (query("loop"))
		{
			...
			environment()->set("exits",([
				...
				"3" : "d/huashan/biwu3.c",
				"4" : "d/huashan/biwu4.c",
				"southdown" : "d/huashan/houzhiwangyu.c",
			]));
