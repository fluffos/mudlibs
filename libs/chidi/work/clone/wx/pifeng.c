...
void create()
{
        set_name(RED"幽冥血翼"NOR, ({ "xueyi","yi" ,"pifeng"}) );
        set("long",@LONG
...
LONG );
	...
	if( clonep() )
		...
		set("wear_msg","$N拿出"HIR"幽冥血翼"NOR"展开，仔细的绑在臂、腰之间，双臂一振，似能飞翔。\n");
	}
	setup();
}
...
int do_fly(string arg)
{
	...
	if (!me->is_fighting())
		return notify_fail("幽冥血翼最好在战斗中使用，平常飞来飞去不怕太招摇了吗？\n");
	...
	mout = HIC"\n$N突然跃起，双臂一展，鼓起"RED"幽冥血翼"HIC"，已向"NOR + dir + HIC"滑了出去。\n\n"NOR;
	min = "半空中一个人影振着"RED"幽冥血翼"NOR"飞了过来，渐渐落在了地上。\n";
