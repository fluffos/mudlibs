...
//    set("attitude", "friendly")
    ...
    set("max_neili", 10000);
    set("jiali", 300);
        set("combat_exp", 103800000);
    set("score", 400000);
    set_skill("force", 900);
    set_skill("huagong-dafa", 920);
    set_skill("dodge", 900);
    set_skill("zhaixinggong", 920);
    set_skill("unarmed", 920);
    set_skill("xingxiu-duzhang", 1050);
    set_skill("parry", 950);
    set_skill("staff", 970);
    set_skill("tianshan-zhang", 965);
