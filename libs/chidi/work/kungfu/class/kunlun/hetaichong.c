...
对人总是彬彬有礼，很有一代宗师的风范。\n");        
        ...
        set("combat_exp",33300000);
 
           set_skill("force", 1390);
           set_skill("dodge", 1390);
           set_skill("parry", 1390);
           set_skill("xuantian-force", 1390);
           set_skill("sword", 1390);
           set_skill("literate",1390);
           set_skill("zhengliangyi-sword",1390);
           set_skill("yaoming-dodge", 1320);
           set_skill("sanyin-unarmed",1300);
