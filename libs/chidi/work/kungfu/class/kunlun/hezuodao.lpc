...
void create()
{
 ...
 "他就是昆仑派的开山祖师，江湖上人称“昆仑三圣”的何足道。\n");        
        ...
        set("combat_exp",27500000);
           ...
           set_skill("dodge", 1050);
           set_skill("parry", 1050);
           set_skill("xuantian-force", 1050);
           set_skill("sword", 1050);
           set_skill("literate",2800);
           set_skill("xunlei-sword", 1050);
           set_skill("unarmed", 1050);
           set_skill("sanyin-unarmed",1050);
           set_skill("throwing",1500);
           set_skill("yaoming-dodge", 1050);
           set_skill("mantianhuayu", 1550);
