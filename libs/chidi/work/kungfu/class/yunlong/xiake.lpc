...
//        set_name("少年侠士", ({ "xia shi","xia","shi" }));
        ...
        set("int", 20);
        set("dex", 60);
        set("combat_exp", 3080000 + random(4000000)); 
        ...
        if (ob->query_skill("force")>5)
{
        ...
        ob->set_skill("bibo-shengong",me->query_skill("force")* 2 / 4);
        ...
        ob->set_skill("taiji-jian", me->query_skill("force")* 2 / 4);
}
        if (ob->query_skill("force")>5)
{
if (random(10)>8)
{
        ...
        ob->set_skill("bibo-shengong",me->query_skill("force")* 3 / 4);
        ...
        ob->set_skill("taiji-jian", me->query_skill("force")* 3 / 4);
}
}
