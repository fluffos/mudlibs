...
int do_skills(string arg)
{
        ...
        "  基本内功 (force)                         - 深不可测 800/    \n"+
        "  基本手法 (hand)                          - 深不可测 800/    \n"+
        "  基本拳脚 (unarmed)                       - 深不可测 800/    \n"+
        "  基本鞭法 (whip)                          - 深不可测 800/    \n"+
        "  基本招架 (parry)                         - 深不可测 800/    \n"+
        "  基本剑法 (sword)                         - 深不可测 800/    \n"+
        "  云龙心法 (yunlong-xinfa)                 - 深不可测 800/    \n"+
        "  读书写字 (literate)                      - 深不可测 800/    \n");
        command("tell "+ob->query("id")+" 我所有的高深武功如下：\n"+
        "□猴拳 (houquan)                           - 深不可测 800/    \n"+
        "□五虎断门刀 (wuhu-duanmendao)             - 深不可测 800/    \n"+
        "□云龙神功 (yunlong-shengong)              - 深不可测 800/    \n"+
        "□云龙身法 (yunlong-shenfa)                - 深不可测 800/    \n"+
        "□云龙剑法 (yunlong-jian)                  - 深不可测 820/    \n"+
        "□云龙鞭 (yunlong-bian)                    - 深不可测 800/    \n"+
        "□云龙手 (yunlong-shou)                    - 深不可测 800/    \n"+
        "□云龙爪 (yunlong-zhua)                    - 深不可测 800/    \n");
        return 1;
}
...
*/
        ...
        if (me->query("kill_yunlong") == 1) {
             ...
             tell_object(me," 有一个反清义士被抓了，要送往京城，要在『" + quest["short"]             + "』路过，快去救人吧！\n");
