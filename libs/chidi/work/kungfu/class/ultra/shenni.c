...
void create()
{
  set_name("南海神尼", ({ "nanhai shenni", "shenni", "nanhai" }) );
        ...
        set("startroom", "/d/quanzhou/yucun1");
       // check_clone();
}
...
mixed ask_opinion()
{
        ...
        if ((int)me->query("combat_exp") < 100000000||((int)me->query_skill("force",1)< 1000))
...
{
        if (me->query("combat_exp") < 500000000)
        {
