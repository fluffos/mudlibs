...
set("no_suck",1);
  ...
  carry_object("/clone/cloth/cloth")->wear();
   carry_object("/clone/misc/zhen")->wield();

        set("startroom","/d/taishan/yidao1");
/*
        check_clone();
*/
}
...
void init()
{
        ...
        if ((int)me->query_skill("dodge",1)>=1000 || (int)me->query_skill("literate",1)>=1000)
...
mixed ask_opinion()
{
        ...
        if ((int)me->query("combat_exp") < 100000000||((int)me->query_skill("dodge",1)<1000 || (int)me->query_skill("literate",1)<1000))
