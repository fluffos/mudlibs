...
void create()
{
        ...
        set_skill("jiuyin-shengong", 5000);
...
void init()
{
        ...
        if ((int)me->query_skill("unarmed",1)>=1000 || (int)me->query_skill("parry",1)>=1000)
...
mixed ask_opinion()
{
        ...
        if ((int)me->query("combat_exp") < 100000000 || ((int)me->query_skill("unarmed",1)<1000 || (int)me->query_skill("parry",1)<1000) )
...
{
        if (me->query("combat_exp") < 5000000000)
        {
