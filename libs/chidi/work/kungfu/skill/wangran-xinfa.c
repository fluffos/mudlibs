...
int valid_learn(object me)
{
        ...
        || me->query_skill("yuxu-qigong",1)
        || me->query_skill("yunv-xinjing",1)
        || me->query_skill("kuihua-xinfa",1)
        || me->query_skill("bimen-xinfa",1)
        || me->query_skill("zhenfeng-xinfa",1)
        || me->query_skill("wudie-xinjing",1)
        || me->query_skill("zixia-shengong",1) )
                return notify_fail("你不先散了别派内功，怎能领会妄然心法??\n");
        return 1;
}
