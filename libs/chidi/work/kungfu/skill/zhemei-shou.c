...
inherit SKILL;
mapping *action = ({
([  "action" : "$N一招「"+BLK+"吹梅笛怨"+NOR+"」，双手横挥，抓向$n",
    "force" : 130,
    "lvl" : 0,
...
int valid_learn(object me)
{
    ...
    if (me->query_skill("unarmed", 1) <=me->query_skill("zhemei-shou", 1)
        && me->query_skill("unarmed", 1) <=me->query_skill("zhemei-shou", 1))
...
mapping query_action(object me, object weapon)
{
    ...
    if ( (me->query("family/family_name")=="逍遥派" && (string)me->query_skill_mapped("force")=="beiming-shengong") 
		|| (me->query("family/family_name")=="灵鹫宫" && (string)me->query_skill_mapped("force")=="bahuang-gong") )
	{
