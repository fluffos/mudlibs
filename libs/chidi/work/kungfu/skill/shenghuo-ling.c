...
的[33m‘中都’[2;37;0m[37m‘筑宾’[2;37;0m两穴，$n只觉下半身酸麻难动，大吃一惊",
    "dodge": 10,
    "damage": 30,
    "damage_type": "挫伤"
]),
...
([  "action": "[1;34m$N忽地放手，手中那柄$w尾端向上弹起，拍的一响，正好打中$n手腕。[2;37;0m",
    "dodge": 20,
    "damage": 90,
    "damage_type": "刺伤"
]),
...
为妙，刚向左踏开一步，眼前[1;37m白光[2;37;0m急闪，$N的$w已到右肩",
    "dodge": 20,
    "damage": 300,
    "damage_type": "挫伤"
]),
...
([      "action" : "$N将手中$w横挥，一式[1;32m「横扫千军」[2;37;0m，$w带出一股风声，疾驶向$n的咽喉",
        "skill_name" : "横扫千军",
        "force" : 150,
        "dodge" : 20,
        "parry" : 20,
...
([      "action" : "$N双手持$w举过头顶，猛然挥出[35m「天降神兵」[2;37;0m\n只见一股强劲的气浪随$w自空而降，袭向$n",
        "skill_name" : "天降神兵",
        "force" : 180,
        "dodge" : 30,
        "parry" : 30,
...
([      "action" : "$N手撙$w，运起真气，脚下走出怪异步法\n顿时好似有无数个$N将那无数的$w斩向$n的头颅，这着唤做[1;34m「天阵伏魔」[2;37;0m",
        "skill_name" : "天阵伏魔",
        "force" : 220,
        "dodge" : 50,
        "parry" : 30,
...
{
        if (random(me->query_skill("shenghuo-ling")) > 300 &&
            me->query_skill("sword") > 300 &&
            me->query("neili") > 10000)
         {
                me->add("neili", -1000);
                return ([
          "action" : "[1;32m只见$N挥力太猛，$w当空坠落，$N急忙俯身去接[2;37;0m\n[1;33m$n看到如此大好时机，岂肯放过，一步抢入准备施展手段[2;37;0m\n[1;36m$n怎知这正中了圣火令法的绝招「偃旗息鼓」，只见$N突然一个鹞子翻身，[2;37;0m\n[35m$n只感到胸口冰凉，看时已是$w插入了心脏处！[2;37;0m",
        "skill_name" : "偃旗息鼓",
        "force" : 400,
        "dodge" : 100,
        "parry" : 100,
...
void do_interlink(object me, object victim)
{
    ...
    if (random(skill)>400){
        ...
        message_vision("[5m[1;33m$N眼中精光一闪，手中兵器随手一挥，顿时\n这屈笨的一招妙到颠峰地化为数道[1;33m[1;31m剑光[2;37;0m[5m[1;33m直击向"+all_enemy+"。[2;37;0m\n\n",me);
        me->add("neili", -3000);
        me->start_busy(2);
        me->set_temp("shenghuo-ling",1);
        for (i=0;i<sizeof(enemy);i++){
            for (j=0;j<(skill/(90*sizeof(enemy)));j++)               
