...
int valid_learn(object me)
{
   ...
   return notify_fail("你的内功心法火候不够，无法学风啸斧。\n");
    if ((int)me->query("max_neili") < 150)
   return notify_fail("你的内力太弱，无法练风啸斧。\n");
    return 1;
}
...
{
    int i, level;
    level = (int)me->query_skill("fengxiao-axe", 1);
...
query("qi") < 30)
   ...
   return notify_fail("你的内力不够练风啸斧。\n");
    me->receive_damage("qi", 25);
return 1;
}
string perform_action_file(string action)
{
    return __DIR__"fengxiao-axe/" + action;
}
