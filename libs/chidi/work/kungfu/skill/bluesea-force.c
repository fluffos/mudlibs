...
string *usage_skills = ({ "unarmed", "sword", "blade", "dodge",
                          "parry", "force" });
...
int valid_learn(object me)
{
 ...
 if (!me->query("zhuanshi/times"))
              return notify_fail("你还没有投胎转世，不适合学习高深的南海玄功。\n");
 ...
 if ( me->query_skill("kuihua-mogong",1) )
        return notify_fail("你都学了葵花魔功，还学南海玄功做什麽？！\n");
        
  
if ( me->query_skill("never-defeated",1) )
        return notify_fail("你都学了不败神功，还学南海玄功做什麽？！\n");
      
 if ( me->query_skill("jiuyin-shengong",1) )
        return notify_fail("你都学了九阴神功，还学南海玄功做什麽？！\n");
