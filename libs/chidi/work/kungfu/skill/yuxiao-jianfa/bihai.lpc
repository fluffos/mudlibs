...
int perform(object me)
{
        ...
        if( me->query_skill("bibo-shengong",1) < 1000)
        ...
        msg = HIC
"$N脚下踏着八卦方位缓缓的奏出碧海生潮曲。"+weapon->name()
+"那萧声一时间如惊涛拍岸，一时间如细浪轻抚海滩。\n";
