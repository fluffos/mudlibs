...
HIB"你狂哮一声：发出至阴至及的一招杀手，顿时令$n忙于奔命"NOR,
        "force" : 340,
            "dodge" : 10,
        "damage": 25,
        "lvl" : 9,
...
NOR+HIC"如清泉飞泄，大江东去，连绵不绝，在$n的周身急刺不止"NOR,
        "force" : 380,
        "dodge" : 10,
        "damage" : 45,
        "lvl" : 27,
...
HIB"杀手剑之『殒石招唤』，顿时将$n逼退数步"NOR,
        "force" : 420,
        "dodge" : 15,
        "damage": 55,
        "lvl" : 36,
...
NOR+HIC"$N掌剑望着$n有如天兵下凡，手中$w"NOR+HIC"化做无数分身直刺$n"NOR,
        "force" : 480,
        "dodge" : 5,
        "damage" : 55,
        "lvl" : 52,
...
NOR+HIC"$n一阵惊讹，只见眼前白光闪过，剑气已然逼目而来"NOR,
        "force" : 500,
        "dodge" : 5,
        "damage": 65,
        "lvl" : 60,
