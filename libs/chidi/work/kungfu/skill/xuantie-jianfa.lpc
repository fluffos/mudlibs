...
([      "action" : "$N一招无中生有剑体下垂，无半点防御姿式，突然间手足齐动，上步近身，一道剑光划向$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([      "action" : "$N一招拖泥带水剑光云袖飘动，宛若流水，飞沙走石剑光直刺$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([      "action" : "$N一招"HIY" 力不从心 "NOR"含胸收腹，头缓缓低下，脚步沉重的迈向$n,剑光由下至上斜劈$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([      "action" : "$N一招"HIR" 行尸走肉 "NOR"发出一剑。这一剑发出时恍恍惚惚，隐隐约约，若有若无的刺向$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([      "action" : "$N一招"YEL" 玄冰落月 "NOR"凝目远眺，突然剑光如一弯新月班落向$n的$l"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([      "action" : "$N一招"BLU" 暗云藏星 "NOR"脚下虚浮，有如几天不吃不睡后的脚步朗舱的袭到$n的身旁，剑光一道刺向$n的$l"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
 ...
 //  第六等级的伤气
      if( me->query_skill("xuantie-jianfa",1)>5000
  && me->query("jh_dj/dj")>=25  ) {
              victim->receive_damage("qi", (damage_bonus -100 ) * 2 , me);
return HIW  "$N手中重剑发出一阵阵"MAG"奇重剑气"NOR HIW"夹着阵阵"HIC"海啸之声"NOR HIW"压的$n"HIW"喘不过气来！\n" NOR;
...
return WHT  "$N以手中一柄重剑发出一阵"HIB"海啸"WHT"般的"HIW"剑气"WHT"震碎了$n"WHT"的心脉！\n" NOR;
  }      
      if( damage_bonus < 110 ) return 0;
...
return CYN "$N的玄铁剑法已初入化镜，随意一招竟似千百匹骏马奔腾般直袭$n！\n" NOR;
  }  
...
return RED "$N的玄铁剑法已有小成，随意一招竟似骏马奔腾般直袭$n！\n" NOR;
}    
}
