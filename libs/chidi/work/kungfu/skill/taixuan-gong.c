...
mixed hit_ob(object me, object victim, int damage_bonus)
{
       ...
       if( random(me->query("neili"))*2 > random(victim->query("neili"))) {
               victim->receive_wound("qi", (damage_bonus - 100) , me);
                return HIW "太玄功潜藏的威力发挥了出来，$n"HIW"感到心头一甜，吐出一口"HIR"鲜血"HIW"！\n" NOR;
        }
}
...
if ((int)me->query_skill("taixuan-gong",1) > 501)
        return notify_fail("太玄功我就教到这儿，以后就要靠你自己练了。\n");
