...
int valid_learn(object me)
{
	...
	if (me->query("gender") == "无性" &&
       ...
       if (!me->query("zhuanshi/times"))
              return notify_fail("你还没有投胎转世，不适合学习高深的不败神功。\n");
...
*/
 ...
 if ( me->query_skill("kuihua-mogong",1) )
        return notify_fail("你都学了葵花魔功，还学不败神功做什麽？！\n");
        
  
if ( me->query_skill("bluesea-force",1) )
        return notify_fail("你都学了南海玄功，还学不败神功做什麽？！\n");
      
 if ( me->query_skill("jiuyin-shengong",1) )
        return notify_fail("你都学了九阴神功，还学不败神功做什麽？！\n");
