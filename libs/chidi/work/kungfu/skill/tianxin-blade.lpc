...
mapping *action = ({
([      "action" : "$N脚步轻浮，手中单刀斜挥，一式「"HIM"花开花落"NOR"」虚虚实实向$n的$l攻出二十三刀",
        "force" : 660,
        "dodge" : 480,
        "parry" : 340,
        "damage" : tydamage,
...
([      "action" : "$N直冲向$n，接着身子一缩，竟然到了$n的身后，接着一记「"HIG"背车一刀"NOR"」向$n的$l砍去",
        "force" : 660,
        "dodge" : 480,
        "parry" : 340,
        "damage" : tydamage,
...
([      "action" : "$N长身前扑，手中$w使一招「"HIB"风狂雨暴"NOR"」，只见一片刀光向$n的$l罩下",
        "force" : 660,
        "dodge" : 480,
        "parry" : 340,
        "damage" : tydamage,
...
([      "action" : "$N脚踩太虚，刀走偏锋，一手「"HIY"轻风微拂"NOR"」从下往上直取$n的$l"NOR,
        "force" : 660,
        "dodge" : 480,
        "parry" : 340,
        "damage" : tydamage,
...
([      "action" : "$N急越上半空，使出「"HIB"星云直坠"NOR"」绝招，一连数十刀从天而降攻向$n的$l，将$n攻个措手不及"NOR,
        "force" : 660,
        "dodge" : 480,
        "parry" : 340,
        "damage" : tydamage,
...
([      "action" : "$N脚踩太白虚浮，身形如影，手中刀光忽隐忽现，$n一时不觉，$N手中刀光竟然已至$n的$l"NOR,
        "force" : 660,
        "dodge" : 480,
        "parry" : 340,
        "damage" : tydamage,
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
 ...
 //  第六等级的伤气
      if( me->query_skill("tianxin-blade",1)>6000
...
return WHT "$N体内的易经神功的刚劲与刀招中发出的天行刀意融合为一，化做一股混元真力震碎了$n的心脉！\n" NOR;
 ...
 //  第五等级的伤气
      if( me->query_skill("tianxin-blade",1)>5000
...
return CYN "$N的天行刀已到第三等级，随意一招带出无数劲气扑向$n！\n" NOR;
  }  
 // 第二等级的伤气
