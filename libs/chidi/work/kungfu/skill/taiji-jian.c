...
([  "action" : "$N使出「"+HIR+"狮子摇头"+NOR+"」，$w由右向左划出一个大８字，将$n的$l圈在其中",
    "force" : 180,
    "lvl" : 141,
    "damage_type" : "刺伤"
]),
...
([  "action" : "$N一招「"+RED+"迎风掸尘"+NOR+"」，$w看似随意地一挥，$n的$l却陡觉一股劲气袭来",
    "force" : 240,
    "lvl" : 260,
    "damage_type" : "刺伤"
]),
...
mapping *action2 = ({
([  "action" : RED"$N一招「"+WHT+"流星赶月"+NOR RED+"」，$w疾刺$n的$l"NOR,
        "force" : 520,
        "dodge" : 130,
        "parry" : 110,
        "damage" : 235,
...
([  "action" : RED"$N突然盘蹲下身来，一招「"+HIB+"海底捞月"+NOR RED+"」，$w自下而上地向$n的$l挥去"NOR,
        "force" : 560,
        "dodge" : 200,
        "parry" : 220,
        "damage" : 245,
...
([  "action" : HIC"$N一招「"+HIM+"挑帘式"+NOR HIC+"」，$w自下而上徐徐划出一个大弧，平平地向$n的$l挥去"NOR,
        "force" : 420,
        "dodge" : 330,
        "parry" : 210,
        "damage" : 260,
 ...
 ([  "action" : YEL"$N一招「"+WHT+"黄蜂入洞"+NOR YEL+"」，$w自上而下划出一个大弧，平平地向$n的$l挥去"NOR,
        "force" : 470,
        "dodge" : 270,
        "parry" : 380,
        "damage" : 300,
...
([  "action" : HIB"$N一招「"+WHT+"大鹏展翅"+NOR HIB+"」，身形跃起，右手$w刺向$n的$l"NOR,
        "force" : 520,
        "dodge" : 330,
        "parry" : 310,
        "damage" : 280,
 ...
 ([  "action" : HIB"$N一招「"+BLK+"车轮剑"+NOR HIB+"」，$w化作一片银盘，平平地向$n的$l卷去"NOR,
        "force" : 600,
        "dodge" : 430,
        "parry" : 410,
        "damage" : 345,
 ...
 ([  "action" : RED"$N左脚轻点地面，身形往前一扑，一招「"+HIB+"天马行空"+NOR RED+"」，$w向$n的$l挥去"NOR,
        "force" : 650,
        "dodge" : 450,
        "parry" : 450,
        "damage" : 355,
...
([  "action" : YEL"$N一招「"+WHT+"风扫梅花"+NOR YEL+"」，身体跃在半空，手中$w扫向$n的$l"NOR,
        "force" : 690,
        "dodge" : 490,
        "parry" : 490,
        "damage" : 375,
 ...
 ([  "action" : MAG"$N一招「"+HIC+"却步抽剑"+NOR MAG+"」，左脚跃步落地，$w回抽，反手勾向$n的$l"NOR,
        "force" : 700,
        "dodge" : 600,
        "parry" : 600,
        "damage" : 400,
...
([  "action" : MAG"$N右腿半屈般蹲，一招「"+HIY+"如封似闭"+NOR MAG+"」，剑尖虚指，转身撩向$n的$l"NOR,
        "force" : 750,
        "dodge" : 680,
        "parry" : 670,
        "damage" : 370,
...
([  "action" : MAG"$N回身拧腰，右手虚抱，一招「"+HIG+"拨云瞻日"+NOR MAG+"」，$w中宫直进，刺向$n的$l"NOR,
        "force" : 800,
        "dodge" : 800,
        "parry" : 800,
        "damage" : 400,
...
mapping query_action(object me, object weapon)
{
        ...
        level   = (int) me->query_skill("taiji-jian",1);
          me = this_player();
        if (me->query_skill("taiji-jian",1)<501)  
    return action[random(sizeof(action))];
 
        if (me->query_skill("taiji-jian",1)>500
        && me->query("jh_dj/dj")>=2)
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
    ...
    if( me->query("neili") < 50000   ) return 0;
      ...
      //第六等级伤害
    if( me->query_skill("taiji-jian",1)>5000
       && me->query("jh_dj/dj")>=25
 ) {
                victim->receive_damage("qi", (damage_bonus - 100) *2 , me);
return HIW "太极剑法的精髓在$n"HIW"体内爆发第六层伤害！顿时让$n"HIW"觉得天崩地裂！\n" NOR;
  }
      //第五等级伤害
    if( me->query_skill("taiji-jian",1)>4000
       && me->query("jh_dj/dj")>=20
 ) {
                victim->receive_damage("qi", (damage_bonus - 100)  , me);
return HIW "太极剑法的精髓在$n"HIW"体内爆发第五层伤害！顿时让$n"HIW"觉得天旋地转！\n" NOR;
  }
    
       //第四等级伤害
    if( me->query_skill("taiji-jian",1)>3000
       && me->query("jh_dj/dj")>=15
 ) {
                victim->receive_damage("qi", (damage_bonus - 100)  / 2, me);
return HIW "太极剑法的精髓在$n"HIW"体内爆发第四层伤害！顿时让$n"HIW"觉得痛苦不堪！\n" NOR;
  }
    //第三等级伤害
...
return HIW "太极剑法的精髓在$n"HIW"体内爆发第三层伤害！顿时让$n"HIW"觉得痛苦不堪！\n" NOR;
  }
    //第二等级伤害
...
return HIW "太极剑法的精髓在$n"HIW"体内爆发第二层伤害！顿时让$n"HIW"觉得苦不堪言！\n" NOR;
  }
}
