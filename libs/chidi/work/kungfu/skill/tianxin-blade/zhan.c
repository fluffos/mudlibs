...
int perform(object me, object target)
{
 ...
 if ( (string)me->query("family/family_name") != "大理段家") 
      ...
      if ((int)me->query_skill("lingyunbu", 1) < 1200 )
        return notify_fail("你的凌云步法没学到家，不够身法配合「玄幻一斩」。\n"NOR);      if ((int)me->query_skill("yijing-force", 1) < 1000 )
...
damage = (int)me->query_skill("tianxin-blade", 1)*5+(int)me->query_skill("force",1)*2;
...
damage2 = (int)me->query_skill("tianxin-blade", 1)*5+(int)me->query_skill("force",1)*2;
