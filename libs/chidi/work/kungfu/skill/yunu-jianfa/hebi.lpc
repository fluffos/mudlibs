...
int perform(object me, object target)
{
       ...
       if ( me->query("gender")!="女性") return notify_fail("你使用的技能不对。\n");
        ...
        if( (int)me->query_skill("yunu-jianfa", 1) < 600 )
                return notify_fail("你的玉女剑法不够娴熟，不会使用合壁。\n");
        if( (int)me->query_skill("yunu-xinjing", 1) < 800 )
        ...
        if( (int)target->query_skill("quanzhen-jianfa", 1) < 600 )
                return notify_fail("对方的全真剑法不够娴熟，不会使用合壁。\n");
         if( (int)target->query_skill("yunu-xinjing", 1) < 800 )
