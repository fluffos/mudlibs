...
if (random(me->query_skill("qiankundanuoyi",1)) > 120
&& me->is_busy()
//&& me->query_skill_mapped("force") == "jiuyang-shengong"
&& random(2)==0)
{
