...
mapping *action = ({
        ([      "action":
"$N左手托住$w，向上疾斩使出一招"HIR"[龍翔闪]"NOR"$w犹如一道弯月，向$n的$l砍来",
        "force" : 100,
        "dodge" : 10,
        "damage" : 100,
        "skill_name" : "龍翔闪",
        ...
        ([      "action":
"$N全力跳向高空，双手握住$w全力向下劈下使出一招"HIB"「龍锤闪」"NOR"$w带着一股劲风劈向$n，$n来不及反应以被狠狠的劈中了肩部",
        "force" : 150,
        "dodge" : -5,
        "damage" : 200,
        "skill_name" : "龍锤闪",
        ...
        ([      "action":
"$N使出一招"HIW"[土龍闪]"NOR"用左手$w架住$n的兵器，右手握住刀鞘顺势劈向$n的$l",
        "force" : 200,
        "dodge" : 30,
        "damage" : 230,
        "skill_name" : "土龍闪",
        ...
        ([      "action":
"$N使出一式的"HIB"「双龍闪」"NOR"以拔刀术收刀式闪电般收回$w紧接着劲力微吐，$w疾如流星离鞘刺向$n",
        "force" : 200,
        "dodge" : 40,
        "damage" : 250,
        "skill_name" : "双龍闪",
        ...
        ([      "action":
"$N将手中的$w向前虚劈一刀，左手拿着刀鞘全力砸向地下激起一阵飞石砸向$n。
$n愕然之际以被砸了个面目全飞。这招正是飞天御剑流奇招"HIW"「龍巢闪」"NOR"",
        ...
        ([      "action":
"$N跳向空中在半空中屈卷身体向$n使出了一招"HIM"「龍卷闪]"NOR"$N手中的$w和人卷成一团犹如一道刀轮劈向$n的$l",
        "force" : 300,
        "dodge" : 60,
        "damage" : 400,
        "skill_name" : "龍卷闪",
        ...
        ([      "action":
"$N使出飞天御剑流最后一式"HIC"「飞翔龍闪」"NOR"手中$w带着一股杀气犹如蛟龍一般刺向$n",
        "force" : 400,
        "dodge" : 70,
        "damage" : 600,
        "skill_name" : "飞翔龍闪",
