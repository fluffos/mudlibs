...
int exert(object me, object target)
{
    ...
    if (( random(sp) > random(dp) ) )
    {
        ...
        target->receive_wound("jing", 10 + random((int)me->query_skill("longxiang", 1)/100),me );
        me->start_busy(2);
    ...
    {   
        ...
        me->receive_wound("jing", 10 + random((int)me->query_skill("longxiang", 1)),me );
        me->start_busy(4);
    }
    return 1;
}
