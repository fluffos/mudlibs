...
([      "action":"$N身体一晃，突然飞起一脚踢向$n的下阴，蓦的又收回，反手$w此向$n的$l",
        "force" : 360,
        "attack": 180,
        "dodge" : 120,
        "parry" : 57,
...
int valid_learn(object me)
{
        ...
        if (me->query("dex") < 22 && me->query_dex() < 61)
                return notify_fail("你觉得自己的身法不行，不可能掌握这么飘缈"
                                   "玄奇的葵花魔功。\n");
 if (!me->query("zhuanshi/times"))
              return notify_fail("你还没有投胎转世，不适合学习高深的葵花魔功。\n");
 ...
 if ( me->query_skill("never-defeated",1) )
        return notify_fail("你都学了不败神功，还学葵花魔功做什麽？！\n");        
  
if ( me->query_skill("bluesea-force",1) )
        return notify_fail("你都学了南海玄功，还学葵花魔功做什麽？！\n");
      
 if ( me->query_skill("jiuyin-shengong",1) )
        return notify_fail("你都学了九阴神功，还学葵花魔功做什麽？！\n");
