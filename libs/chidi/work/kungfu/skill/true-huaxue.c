...
mapping query_action(object me, object weapon)
{
    ...
    level   = (int) me->query_skill("true-huaxue",1);
 ...
 a_action["damage"] = 300+random(300);
    if ((int)me->query_temp("true-huaxue")>0)
