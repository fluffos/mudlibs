...
mapping *action = ({
([  "action":       "$N端坐不动，一招「"+RED+"裂石式"+NOR+"」，手中$w抖得笔直，对准$n的$l要害连刺数鞭",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":       "$N身形一转，一招「"+RED+"断川式"+NOR+"」，手中$w如矫龙般腾空一卷，猛地向$n的$l打下",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":       "$N力贯鞭梢，一招「"+HIW+"破云式"+NOR+"」，手中$w舞出满天鞭影，排山倒海般扫向$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":       "$N力贯鞭梢，一招「"+HIW+"分海式"+NOR+"」，手中$w舞出满天鞭影，排山倒海般扫向$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":       "$N力贯鞭梢，一招「"+BLU+"裂空式"+NOR+"」，手中$w舞出满天鞭影，排山倒海般扫向$n的$l",
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":HIW       "$N力贯鞭梢，一招「"+BLU+"佛光普照"+HIW+"」，手中$w"HIW"舞出满天鞭影，排山倒海般扫向$n的$l"NOR, 
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":HIR       "$N力贯鞭梢，一招「"+YEL+"金刚伏魔"+HIR+"」，手中$w"HIR"舞出满天鞭影，排山倒海般扫向$n的$l"NOR, 
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action":HIC       "$N力贯鞭梢，一招「"+HIR+"佛法无边"+HIC+"」，手中$w"HIC"舞出满天鞭影，排山倒海般扫向$n的$l"NOR , 
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
  ...
  if( me->query("neili") < 50000   ) return 0;
      if( random(10) < 2   ) return 0;
        ...
        // 第六等级的伤气
  if( me->query_skill("riyue-bian",1)>6000
...
return HIW           "$N的日月鞭法已经达到了"BLINK  HIR"偷天换日"NOR HIW"的境界，自动摧毁了"BLINK HIR"$n"NOR HIW"的真元！\n" NOR;
  ...
  // 第五等级的伤气
       if( me->query_skill("riyue-bian",1)>5000
  && me->query("jh_dj/dj")>=20  ) 
 {
                victim->receive_damage("qi", (damage_bonus ) , me); 
return HIW "$N的日月鞭法已经达到了"BLINK  HIR"第五层"NOR HIW"境界，自动摧毁了"BLINK HIR"$n"NOR HIW"的真元！\n" NOR;
  }
   if( damage_bonus < 100 ) return 0;

  // 第四等级的伤气
      if( me->query_skill("riyue-bian",1)>4000
  && me->query("jh_dj/dj")>=15  ) 
      {
                victim->receive_damage("qi", (damage_bonus - 100)/2 , me); 
return HIW "$N的日月鞭法已经达到了"BLINK  HIR"第四层"NOR HIW"境界，自动摧毁了"BLINK HIR"$n"NOR HIW"的真元！\n" NOR;
  }      
  // 第三等级的伤气
       if( me->query_skill("riyue-bian",1)>3000
  && me->query("jh_dj/dj")>=10  ) 
  {
                victim->receive_damage("qi", (damage_bonus - 100)/3 , me); 
return HIW "$N的日月鞭法已经达到了"BLINK  HIR"第三层"NOR HIW"境界，自动摧毁了"BLINK HIR"$n"NOR HIW"的真元！\n" NOR;
  } 
  
 // 第二等级的伤气
        if ( me->query_skill("riyue-bian",1)>1000
         && me->query_skill("riyue-bian",1)<2001
  ) {
             victim->receive_damage("qi", (damage_bonus) / 4  , me); 
return HIW "$N的日月鞭法已经达到了"BLINK  HIR"第二层"NOR HIW"境界，自动摧毁了"BLINK HIR"$n"NOR HIW"的真元！\n" NOR;
}
}
