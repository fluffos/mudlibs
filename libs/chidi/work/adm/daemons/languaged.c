...
nosave int G2B_cols, B2G_cols;
nosave mapping B2G_Cache=([]),
		G2B_Cache=([]);


protected int Fetch(int key, int flag)
{
...
protected int *g2b(int c1, int c2)
{
	int i;
...
protected int *b2g(int c1, int c2)
{
	int i;
