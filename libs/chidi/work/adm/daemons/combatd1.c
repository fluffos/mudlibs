			...
			if(me_exp<2000000000&&vic_exp+10000000 > me_exp)
                           {
                             int expup,potup;
                                  ...
                                  expup=me->query_int()+random(me->query_int()/2);
                                  else
                                  expup=(me->query_int()+random(me->query_int()))/(me->query("zhuanshi/times")+random(me->query("jh_dj/dj"))*2/3);                                  
	 		     if(me_exp<100000000)
				{ my["combat_exp"] += expup;
