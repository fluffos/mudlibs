...

{
   ...
   object who;
   who=this_player();
   if(  !who->query("opinion/ultra1") ) 
   {int zsexp;
    zsexp=who->query("zhuanshi/times")*100000000;
    if(zsexp>1000000000)
       zsexp=1000000000;
    if( (int)who->query("combat_exp") < zsexp) 
...
message_vision("$N对$n阴阴地笑了几声，说：天堂有路你不走，地狱无门你闯进来。\n",this_object(),who);
   ...
   who->move("/u/luoyun/zhuanshi/emptyroom");
...
{   
   ...
   who->unconcious();
   this_object()->move("/u/luoyun/zhuanshi/youmingdian");
...
{   int i;
        ...
        if( !(empty = find_object("/u/luoyun/zhuanshi/emptyroom")) )
                empty = load_object("/u/luoyun/zhuanshi/emptyroom");
   write("四周刮起一阵阴风。。。\n");
        if( empty = find_object("/u/luoyun/zhuanshi/emptyroom") ) {
...
{
   command("chat 恭喜"+who->query("name")+"要闯过幽冥地府十八层地狱,开始他投胎转世为人的路程！\n");
   tell_object(who,"你可以去投胎转世去了。\n");
   who->set("HellZhenPass",1);
   who->move("/u/luoyun/zhuanshi/difu");
   this_object()->move("/u/luoyun/zhuanshi/youmingdian");
   this_object()->delete_temp("SomeonePassing");
   call_out("remove_all", 3);
   return 1;
...
int round_1(object who)
{
   object ghost;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/1");
   tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_2(object who)
{
        object ghost;
        seteuid(getuid());
       ghost=new("/u/luoyun/zhuanshi/HellZhen/2");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_3(object who)
{
        object ghost;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/3");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_4(object who)
{
        object ghost;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/4");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_5(object who)
{
        object ghost;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/5");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_6(object who)
{
        object ghost;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/6");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_7(object who)
{
        object ghost;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/7");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_8(object who)
{
        object ghost;
        seteuid(getuid());
       ghost=new("/u/luoyun/zhuanshi/HellZhen/8");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_9(object who)
{
        object ghost;
        seteuid(getuid());
       ghost=new("/u/luoyun/zhuanshi/HellZhen/9");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_10(object who)
{
        object ghost;
        seteuid(getuid());
       ghost=new("/u/luoyun/zhuanshi/HellZhen/10");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_11(object who)
{
        object ghost,ghostb;
        seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/15");
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/11");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_12(object who)
{
        object ghost,ghostb;
        seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/11");
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/12");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_13(object who)
{
        object ghost,ghostb;
        seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/16");
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/13");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
...
int round_14(object who)
{
        object ghost,ghostb;
   seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/18");
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/14");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
        tell_room(environment(who),RED"                **************************************\n"NOR);
...
int round_15(object who)
{
        object ghost,ghostb;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/15");
        seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/13");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
        tell_room(environment(who),GRN"                **************************************\n"NOR);
...
int round_16(object who)
{
        ...
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/15");
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/16");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
        tell_room(environment(who),YEL"                **************************************\n"NOR);
...
int round_17(object who)
{
   ...
   seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/16");
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/17");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
        tell_room(environment(who),BLU"                **************************************\n"NOR);
...
int round_18(object who)
{
        object ghost,ghostb;
        seteuid(getuid());
        ghost=new("/u/luoyun/zhuanshi/HellZhen/18");
   seteuid(getuid());
        ghostb=new("/u/luoyun/zhuanshi/HellZhen/17");
        tell_room(environment(who),"\n突然间一道黑牌闪过：\n\n");
        tell_room(environment(who),CYN"                **************************************\n"NOR);
