...
int main(object me, string arg)
{
        ...
        if( me->query("banghui/rank_lv") < 5 )
          return notify_fail("你在帮中的地位不够高，不能发出邀请！\n"); 
