...
void create()
{
    set_name("大导师", ({ "npc_boss" }));
    set("long", 
        "他就是江湖里第一个转世的玩家。\n");
    set("gender", "男性");
    set("title",HIR"逍遥派第三代弟子"NOR);
    set("nickname",HIY"江湖"NOR+HIC"第一个转世玩家"NOR);
    set("age", 150);
...
{
        message_vision("大导师喂$N服下一颗药丸,然后盘膝坐下，双掌贴着$N的背心。\n", ob);    
        ob->set_temp("heal",1);
...
{   
    ...
    message_vision("大约过了一盅茶的时份，大导师慢慢地站了起来。\n",ob);
