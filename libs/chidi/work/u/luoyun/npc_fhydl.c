...
void create()
{
    set_name("小夜", ({ "npc_fhydl" }));
    set("long", 
        "他就是江湖里第二个转世的玩家。\n");
    set("gender", "男性");
    set("title",HIR"逍遥派第三代弟子"NOR);
    set("nickname",HIY"江湖"NOR+HIC"第二个转世玩家"NOR);
    set("age", 150);
  ...
  set_skill("jiuzhuan-12tian",10000);
    ...
    set_skill("beiming-shengong", 1000);
    set_skill("huagong-dafa", 1000);
    map_skill("unarmed", "kuihua-baodian");
    map_skill("dodge", "kuihua-baodian");
...
{
        message_vision("小夜喂$N服下一颗药丸,然后盘膝坐下，双掌贴着$N的背心。\n", ob);    
        ob->set_temp("heal",1);
...
{   
    ...
    message_vision("大约过了一盅茶的时份，小夜慢慢地站了起来。\n",ob);
