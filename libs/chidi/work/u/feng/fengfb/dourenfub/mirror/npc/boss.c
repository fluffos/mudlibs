...
void die()
{
	...
	for(i=0;i<size;i++)
	{
		...
		if(exp)
		{
			...
			tell_object(team[i],HIY"【江湖】恭喜你挑战镜像成功！请拾取物品，镜像将在1分钟后关闭。\n"NOR);
