...
set("no_fly", 1);
	...
	set("item_desc", ([
              "paizi" : "你可以分别去不同的出口选择你的的内在品质,它会影响你学某些武功,\n"
"除了某些特殊情况下对性格有要求以外，不同的性格还具有以下特点：\n"
"光明磊落：具有很强的抗打击能力（不容易受伤）,在战斗中能减弱对手对你的伤害。\n"
"狡黠多变：在和对手fight的时候能得到比其他的内在品质更多的经验值。\n"
"心狠手辣：可以在命中对手时具有更强的杀伤力.同样的武功杀伤力比其他的内在品质大些.\n"
"阴险奸诈：攻击时命中率比其他的内在品质的更高。\n",
	]));
	set("objects", ([
