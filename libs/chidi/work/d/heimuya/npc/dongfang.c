...
//        object ob=this_player();
   ...
   killer->set("lonely/duguqiubai1",1);
  ...
  string ask_gaoshou()
{
    ...
    return RANK_D->query_respect(me)+"又来一个送死的？"
    +"那就让老娘送你一程吧！\n";
}
...
int send_me(object me)
{
    if(objectp(me))
    {
    message_vision(HIB"只见$N运起葵花心法，身形渐渐消失在空气中......！\n"
    " $n突然感觉自己身子飘了起来，$n被$N提在空中驭气飞行中......！\n"
      +"不一会儿，$N将$n从空中扔到了一个不知名的山谷。"
    +"$n被摔得七荤八素！\n"NOR,this_object(),me);
    me->move("d/heimuya/wuminggu");
    }
    return 1;
}
