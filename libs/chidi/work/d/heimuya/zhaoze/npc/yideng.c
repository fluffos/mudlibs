...
void create()
{
    ...
    set("combat_exp", 337500000);
     
    set_skill("force", 50000);             // 基本内功
    set_skill("kumu-shengong", 50000);
    set_skill("shaolin-shenfa", 50000);
    set_skill("sun-finger", 50000);
    set_skill("unarmed", 50000);           // 基本拳脚
    set_skill("dodge", 50000);             // 基本躲闪
    set_skill("parry", 50000);             // 基本招架
    set_skill("sword", 50000);             // 基本剑法
...
{       
        ...
        if ((int)ob->query_skill("kumu-shengong",1) < 500 ) {
        ...
        } else  command("say 老衲已是出家之人，不再收徒的了！");
}
