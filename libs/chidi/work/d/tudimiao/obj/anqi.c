// /d/tudimiao/obj/anqi.c 暗器
// xlgg@hero.cd 1999.6.9
...
string *shot_str = ({
        ...
        "$N将钉盒上的机钮一掀，只听得‘嗤嗤’破空声不断，数十细若发丝的梨花钉一闪而过，直射$n\n",
...
int do_shot(string arg)
{
        ...
        if (damage > 0 ) {
                ...
                message_vision(HIW+escape_str[random(sizeof(escape_str))]+NOR,obj);
        }
