...
void create()
{
        ...
        set("str", ob->query("str")+random(5));
        set("jiali",myskill/2);    
        set("dex", ob->query("dex")+random(5));
        set("per", ob->query("per"));
        set("killer",ob->query("id"));
        set("combat_exp", ob->query("combat_exp")+random(10000));
        set_skill("dodge", myskill+random(30));
        set_skill("blade", myskill+random(10));
        set_skill("force", myskill+random(10));
        set_skill("xiaowuxiang", myskill+random(10));
        set_skill("xue-dao", myskill+random(10));
        set_skill("xiaoyaoyou", myskill+random(10));
        set_skill("parry", myskill+random(10));  
        set_skill("unarmed", myskill+random(10));  
        set_skill("jiuyin-baiguzhao", myskill+random(10)); 
