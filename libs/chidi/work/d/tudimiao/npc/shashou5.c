...
void create()
{
        ...
        set("qi", ob->query("qi")+random(450));
        set("max_qi", ob->query("max_qi")+random(450));
        ...
        set_skill("sword", myskill+random(30)); 
        set_skill("jinshe-jianfa", myskill+random(30));   
