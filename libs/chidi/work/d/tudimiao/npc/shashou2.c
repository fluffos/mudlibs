...
void create()
{
        ...
        set("jiali",myskill/2);    
        set("str", ob->query("str")+random(10));
        set("dex", ob->query("dex")+random(10));
        set("per", ob->query("per"));
        set("killer",ob->query("id"));
        set("combat_exp", ob->query("combat_exp")+random(50000));
        set_skill("dodge", myskill+random(40));
        set_skill("sword", myskill+random(10));
        set_skill("force", myskill+random(10));
        set_skill("xiaowuxiang", myskill+random(10));
        set_skill("jinshe-jianfa", myskill+random(10));
