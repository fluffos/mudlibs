...
void create()
{
     ...
     "你想拜见老爷子吗？但他闭关面壁,你得找成师叔要到玉牌,才能见到他。",
        ...
        set_skill("xueshan-sword", 450);
        set_skill("bingxue-xinfa", 500);
        set_skill("snow-zhang", 450);
        set_skill("snowstep", 450);
...
void attempt_apprentice(object ob)
{
    ...
    if ((int)ob->query_skill("bingxue-xinfa",1) < 160 ) {
        command("say 你的本门内功心法太低了,还是努努力先提高一下吧!");
                return;
    } 
    if ((int)ob->query_skill("xueshan-sword",1) < 180 ) { 
