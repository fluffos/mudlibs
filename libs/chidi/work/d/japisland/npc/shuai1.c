...
set("cor",10000);
  set("lunhui_zhuanshi",random(20));
       set("max_kee", 9000000+3000*laa);
       set("max_sen", 9000000+3000*laa);
...
set_temp("apply/sub_max_tu",1000+random(1200));
     ...
     add_temp("apply/sub_max_phy",17200+100*laa);
     add_temp("apply/sub_phy",16360+50*laa);
