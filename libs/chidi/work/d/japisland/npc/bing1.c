...
的营地，是进攻日出城的基地。\n");
        ...
        //set("bellicosity", 1);
        set("wokou",1);
set("env/combatd",random(10));
        set("str", 10000);
   set("combat_exp", 100000000+5000000*laa);
 set("daoxing", 100000000+5000000*laa);

       // set("class","ninja");
     set("max_kee",500000+10000*laa);
        set("max_sen",500000+10000*laa);
      //  set("max_gin",20000);
...
set("level",100+random(100));
   set_skill("force",1600);
        set_skill("lengquan-force",1300+10*random(laa));
        set_skill("unarmed", 1350+10*random(laa));
        set_skill("blade", 1250+10*random(laa));
        set_skill("parry", 1250+10*random(laa));
set_skill("spells", 1250+10*random(laa));
set_skill("buddhism", 2250+10*random(laa));
set_skill("baguazhou", 1250+10*random(laa));
        set_skill("dodge", 1250+10*random(laa));
        set_skill("kugu-blade",1260+10*random(laa));
  set_skill("ittouryu",1260+10*random(laa));
 set_skill("huntian-qigong",1260+10*random(laa));
 set_skill("cloudforce",1260+10*random(laa));
 set_skill("shenji-blade",1260+10*random(laa));
 ...
 set_skill("wuhu-blade",1260+10*random(laa));
        ...
        set_skill("yueying-wubu",1250+10*random(laa));
...
set_skill("lotusforce",2200+10*random(laa));
...
set_temp("apply/armor", 16720+300*laa); 
                add_temp("apply/damage", 455+10*laa);
add_temp("apply/armor_vs_force", 1525+random(2500)+40*laa);  	
                    set_temp("combat/bless",14*laa);
                 set_temp("combat/lucky",14*laa);
                  set_temp("apply/sub_max_armor",1760+30*laa); 
                 set_temp("apply/sub_max_defense",1790+30*laa); 
...
set_temp("apply/sub_max_tu",1000+random(1200));
     ...
     add_temp("apply/sub_max_phy",4500+30*laa);
     add_temp("apply/sub_phy",4360+10*laa);
...
if(random(300)<=1+this_object()->query_temp("mmmmmmmmmm"))
{
m=random(15);
if(m==0)
