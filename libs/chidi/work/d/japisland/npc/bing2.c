...
set("env/combatd",random(11));
        set("str", 10000);
        set("combat_exp", 800000000+1000000*laa);
 set("daoxing", 800000000+1000000*laa);

       // set("class","ninja");
     set("max_kee",630000+3000*laa);
        set("max_sen",630000+3000*laa);
      //  set("max_gin",20000);
...
set_temp("apply/armor", 26720+300*laa); 
                add_temp("apply/damage", 455+20*laa);
add_temp("apply/armor_vs_force", 3725+random(2500)+30*laa);  	
                    set_temp("combat/bless",14*laa);
                 set_temp("combat/lucky",14*laa);
                  set_temp("apply/sub_max_armor",7600+50*laa); 
                 set_temp("apply/sub_max_defense",7900+50*laa); 
...
set_temp("apply/sub_max_tu",1000+random(1200));
     ...
     add_temp("apply/sub_max_phy",7200+40*laa);
     add_temp("apply/sub_phy",6360+20*laa);
...
set("env/combatd",1);
 ...
 carry_object(__DIR__"obj/blade2");
 carry_object(__DIR__"obj/blade2");
 carry_object(__DIR__"obj/blade2");
 carry_object(__DIR__"obj/blade2");
 carry_object(__DIR__"obj/blade2");
...
if(random(260)<=1+this_object()->query_temp("mmmmmmmmmm"))
{
m=random(16);
if(m==0)
