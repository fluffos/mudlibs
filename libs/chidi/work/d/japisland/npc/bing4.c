...
{       
                                ...
                                string *name= ({"玉面修罗", "长发修罗"});
        set_name(name[random(2)], ({ "jap badguy", "badguy"}) );
        set("title", HIR"倭寇"NOR); 
        set("long","
...
set("cps",10000);
set("cor",10000);
        set("combat_exp", 700000000+1000000*laa);
 set("daoxing", 700000000+1000000*laa);

       // set("class","ninja");
     set("max_kee",900000+6000*laa);
        set("max_sen",900000+6000*laa);
      //  set("max_gin",20000);
...
set_temp("apply/armor", 46720+100*laa); 
                add_temp("apply/damage", 655+20*laa);
add_temp("apply/armor_vs_force", 5725+random(5500)+100*laa);  	
                    set_temp("combat/bless",14*laa);
                 set_temp("combat/lucky",14*laa);
                  set_temp("apply/sub_max_armor",5600+100*laa); 
                 set_temp("apply/sub_max_defense",4900+100*laa); 
...
set_temp("apply/sub_max_tu",1000+random(1200));
     ...
     add_temp("apply/sub_max_phy",12200+100*laa);
     add_temp("apply/sub_phy",10360+40*laa);
...
set("env/combatd",1);
 ...
 carry_object(__DIR__"obj/blade4");
 carry_object(__DIR__"obj/blade4");
 carry_object(__DIR__"obj/blade4");
 carry_object(__DIR__"obj/blade4");
 carry_object(__DIR__"obj/blade4");
   ...
   //     if (objectp(killer))
        {
          //   if(killer->query("possessed")) killer =killer->query("possessed");
                killer->add_temp("jap_badguy/bing4", 1);
        }
...
if(random(180)<=1+this_object()->query_temp("mmmmmmmmmm"))
{
m=random(16);
if(m==0)
