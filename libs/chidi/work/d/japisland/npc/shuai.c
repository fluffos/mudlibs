...
set("cor",10000);
  set("lunhui_zhuanshi",20+random(10));
       set("max_kee", 8000000+3000*laa);
       set("max_sen", 8000000+3000*laa);
...
set_temp("apply/armor", 56720+300*laa); 
                add_temp("apply/damage", 31155+20*laa);
add_temp("apply/armor_vs_force", 18725+random(8500)+100*laa);  	
...
set_temp("apply/sub_max_tu",1000+random(1200));
     ...
     add_temp("apply/sub_max_phy",19200+100*laa);
     add_temp("apply/sub_phy",18360+50*laa);
