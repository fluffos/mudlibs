...
void create()
{
        ...
        set_skill("wuji-shengong", 1450);
        set_skill("dodge",1450);
        set_skill("bugui-bufa", 1420);
        set_skill("strike", 1420);
        set_skill("fanyun-zhang", 1420);
        set_skill("parry",1450);
        set_skill("unarmed",1420);
        set_skill("blade",1460);
        set_skill("qishen-dao",1450);
        set_skill("sword",1420);
