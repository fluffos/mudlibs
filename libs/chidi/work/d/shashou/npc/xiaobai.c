...
void create()
{
        ...
        set_skill("force", 860);
        set_skill("unarmed", 860);
       set_skill("wuji-shengong", 860);
        set_skill("dodge",860);
        set_skill("bugui-bufa",860);
        set_skill("parry",880);
        set_skill("sword", 880);
        set_skill("qingyi-jian", 1200);
        set_skill("literate", 880);
        set_skill("strike",860);
        set_skill("fanyun-zhang",880);
...
string ask_me()
{
        ...
        add("book_count", -1);
        ob = new("/d/shashou/npc/obj/qingyi-book");
        ob->move(this_player());
