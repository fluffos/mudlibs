...
void create()
{
    ...
    set_skill("force", 15000);             // 基本内功
    set_skill("finger", 17000);            // 基本指法
    set_skill("dodge", 15000);             // 基本躲闪
    set_skill("parry", 15000);             // 基本招架
    set_skill("six-finger", 20000);   // 六脉神剑
    set_skill("taixuan-gong", 20000);      // 太玄神功
    set_skill("lingxu-bu", 20000);         // 凌虚步
