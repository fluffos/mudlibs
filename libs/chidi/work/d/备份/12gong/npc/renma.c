...
void create()
{
        ...
        set_skill("westsword",6500);
        set_skill("boxing",6500);
        set_skill("balei",6500);
        set_skill("spells",6500);
        set_skill("renma", 6500);
        map_skill("sword","westsword");
        map_skill("unarmed","boxing");
        map_skill("spells","renma");
        set_skill("piaomiao-shenfa",6500);
...
void die()
{
        ...
        ob->start_busy(3);
        killer=new("/d/12gong/npc/mojie"); 
        killer->move("/d/12gong/mojie"); 
