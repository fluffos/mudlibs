...
void create()
{
        ...
        set_skill("westsword",10000);
        set_skill("boxing",10000);
        set_skill("balei",10000);
        set_skill("spells",10000);
        set_skill("renma", 10000);
        map_skill("sword","westsword");
        map_skill("unarmed","boxing");
        map_skill("spells","renma");
        set_skill("piaomiao-shenfa",10000);
        set_skill("taixuan-gong",10000);
