...
void create()
{
        ...
        set_skill("dodge", 14000);
        set("cant_be_smashed",1);
        set("attitude", "peaceful");
        set_skill("force", 14000);
        set_skill("parry", 14000);
        set_skill("unarmed", 14000);
        set_skill("sword", 14000);
        set_skill("westsword",14000);
        set_skill("boxing",14000);
        set_skill("balei",14000);
        set_skill("spells",14000);
        set_skill("shuangyu", 14000);
        map_skill("sword","westsword");
        map_skill("unarmed","boxing");
        map_skill("spells","shuangyu");
        set_skill("piaomiao-shenfa",14000);
        set_skill("taixuan-gong",14000);
        map_skill("force","taixuan-gong");
        map_skill("dodge","piaomiao-shenfa");
        set("max_jingli", 120000000);
        set("jingli", 120000000);
        set("max_neili", 120000000);
        set("neili", 120000000);
        set("max_qi", 120000000);
        set("max_jing", 120000000);
        set("jiali",20000);
