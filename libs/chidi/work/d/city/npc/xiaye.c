...
inherit BHNPC;
string query_save_file() { return DATA_DIR + "npc/下野德康"; }
...
int do_convert(string arg)
{
	...
	if (!bv1)
	{
        ...
        bv2 = to_ob ? to_ob->query("base_value") : call_other("/clone/money/" + to, 
"query", "base_value" );
...
//	}
	...
	if((int)me->query_encumbrance() + 
             (amount/8)*12* what->query("base_weight")
