        ...
        if (random(kar)>15) {
                message_vision("$N打到一只"HIW"百灵鸟。\n"NOR, me);
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("combat_exp",1300+bb);
                        tell_object(me,"你得到了1300点经验\n");
                }
       me->receive_damage("qi", 10);
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("potential",900+bb);
                        tell_object(me,"你得到了900点潜能\n");
                }
        ...
        if (random(kar)>10) 
                message_vision("$N打到一只"HIY"金丝雀。\n"NOR, me);
                    if (me->query("combat_exp")>=15000000)
                        ...
                        bb=(int)me->query("combat_exp");
                        me->set("combat_exp",1000+bb);
                        tell_object(me,"你得到了1000点经验\n");
                }
       me->receive_damage("qi", 10);
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
               ...
               message_vision("$N打到一只"HIG"鹦鹉。\n"NOR, me);
                bb=(int)me->query("combat_exp");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        tell_object(me,"你得到了990点经验\n");
                        me->set("combat_exp",990+bb);
                }
            me->receive_damage("qi", 10);  
                ...
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("potential",bb+700);
                       tell_object(me,"你得到了700点潜能\n");
               }
               ...
               message_vision("$N打到一只"YEL"麻雀。\n"NOR, me);
                bb=(int)me->query("combat_exp");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        tell_object(me,"你得到了800点经验\n");
                        me->set("combat_exp",800+bb);
                }
            me->receive_damage("qi", 10);  
                ...
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("potential",bb+500);
                       tell_object(me,"你得到了500点潜能\n");
               }
