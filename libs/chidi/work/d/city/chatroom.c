...
LONG
        ...
        set("no_clean_up", 0);
        set("exits", ([
"north": "/quest/game/start",
        "down": __DIR__"guangchang",
        "up"  : __DIR__"chatroom2",
        "enter"  : __DIR__"game_room",
        "east" : "/d/pk/entry" ,
        ]));
        set("no_fight",1);
        set("no_magic",1);
...
add_action("discmds",({"sleep","respitate","eat","exert","array","duanlian","ansuan","touxi","persuade","teach","exert","exercise","study","learn","kill","steal","conjure","fight","hit","perform","prcatice","scribe","surrender","yanjiu","respire","get"}));    
}
int discmds()
{
