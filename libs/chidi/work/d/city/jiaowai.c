        ...
        if (random(kar)>15) {
                message_vision("$N打到一只"HIW"百灵鸟。\n"NOR, me);
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("combat_exp",3300+bb);
                        tell_object(me,"你得到了3300点经验\n");
                }
       me->receive_damage("qi", 10);
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("potential",1900+bb);
                        tell_object(me,"你得到了1900点潜能\n");
                }
        ...
        if (random(kar)>10) 
                message_vision("$N打到一只"HIY"金丝雀。\n"NOR, me);
                    if (me->query("combat_exp")>=15000000)
                        ...
                        bb=(int)me->query("combat_exp");
                        me->set("combat_exp",2000+bb);
                        tell_object(me,"你得到了2000点经验\n");
                }
       me->receive_damage("qi", 10);
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
               ...
               message_vision("$N打到一只"HIG"鹦鹉。\n"NOR, me);
                bb=(int)me->query("combat_exp");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        tell_object(me,"你得到了1990点经验\n");
                        me->set("combat_exp",1990+bb);
                }
            me->receive_damage("qi", 10);  
                ...
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("potential",bb+1700);
                       tell_object(me,"你得到了1700点潜能\n");
               }
               ...
               message_vision("$N打到一只"YEL"麻雀。\n"NOR, me);
                bb=(int)me->query("combat_exp");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        tell_object(me,"你得到了1800点经验\n");
                        me->set("combat_exp",1800+bb);
                }
            me->receive_damage("qi", 10);  
                ...
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=15000000)
                        ...
                        me->set("potential",bb+1500);
                       tell_object(me,"你得到了1500点潜能\n");
               }
