...
void create()
{
    ...
    if( clonep() )
        ...
        set("long","一张小巧玲珑的茶几，上面放满了补偿大家的礼物，大家快拿礼物(pick gift)啊！");
        set("value", 0);
        set("material", "stone");
    }
}
...
int do_pick(string arg)
{
       ...
       tell_object(me,CYN "黑客的身影突然出现在一阵烟雾之中。\n\n");
       tell_object(me,HIR "黑客一巴掌敲在你手上：嘿,哥们儿，每人只有一份礼物！\n\n");
       tell_object(me,CYN "只见一阵烟雾过後，黑客的身影已经不见了。\n" NOR);
       return 1;
       }
