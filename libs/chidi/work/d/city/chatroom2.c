...
void init()
{
 ...
 add_action("do_climb", "climb");
   if (!wizardp(this_user()))  
    add_action("discmds",({"sleep","respitate","exert","eat","array","duanlian","ansuan","touxi","persuade","teach","exert","exercise","study","learn","kill","steal","conjure","fight","hit","perform","prcatice","scribe","surrender"}));
