...
void create()
{
  ...
  set_name(names[i]+nm2[random(sizeof(nm2))]+nm3[random(sizeof(nm3))], ({"jiaozhong"}));
        set("nickname", HIG"魔教教众"NOR);
        set("gender", "男性");
        set("age", 22);
        set("long", 
                "他是一个魔教教众。\n");
...
{
            ob->set_skill("jiuyang-shengong", me->query_skill("force"));
            ob->set_skill("qiankun-danuoyi", me->query_skill("force"));
            ob->set_skill("qishang-quan", me->query_skill("force"));
            ob->set_skill("shenghuo-shengong", me->query_skill("force"));
        ...
        ob->set_skill("taiji-quan", me->query_skill("force")* 2 / 4); 
            ...
            ob->set_skill("shenghuo-ling", me->query_skill("force"));
}
        if (ob->query_skill("force")>5)
{
if (random(10)>8)
