...
文殊、普贤菩萨。一群青衣小和尚们正在佛像前的地上诵经。一
些香客在地上跪着磕头，似乎在企求佛祖的庇佑。缕缕香烟与梵
唱交错在一起，仰视佛祖拈花浅笑的面容，令人顿时生起几分脱
俗之感。身边经常有一队队僧人鱼贯而入，看他们手持戒刀，似
乎是巡寺的僧人。
LONG
    );
    set("exits", ([
...
void init()
{
    this_player()->set_temp("ketou_times", random(50)+1);
...
int do_ketou()
{
    ...
    && present("silk", me) )
    {
        ...
        me->improve_skill("force", me->query_int());
        if ( random(5) == 0 )
