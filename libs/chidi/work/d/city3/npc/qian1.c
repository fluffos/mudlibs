...
void create()
{
        set_name("Ç®ÃÔÃÔ", ({"qian mimi", "qian", "mimi"}));
	set("title", "Ç®×¯ÀÏ°å");
        set("nickname", "Ò»Ã«²»°Î");
	set("gender", "ÄĞĞÔ");
	set("age", 34);
	...
	set("chat_chance", 2);
	set("chat_msg", ({
        "Ç®ÃÔÃÔ½¾°ÁµÄËµµÀ£º±¾ÒøºÅÒÑ¾­ÓĞÉÏ°ÙÄêµÄÀúÊ·£¬ÔÚ´¨ÖĞ¿ÉÒÔËµÊÇµÚÒ»¼Ò¡£\n",
        "Ç®ÃÔÃÔĞ¦×ÅËµµÀ£ºÔÚ±¾µê´æÇ®ÎŞÀûÏ¢£¬È¡Ç®ÊÕÊ®·ÖÖ®¶şµÄÊÖĞø·Ñ£¬¿Í¹ÙÄú¿´×Å°ì°É¡£\n"
        "Ç®ÃÔÃÔÎ¢Î¢Ò»Ğ¦£¬ËµµÀ£º±¾µê»¹°ìÀí²»Í¬Ãæ¶î»õ±ÒµÄ¶Ò»»ÒµÎñ£¬µ«Ã¿´ÎÒªÊÕÊ®·ÖÖ®Ò»µÄÊÖĞø·Ñ¡£\n"
	}));
...
//	}
	if (!total || total < 0) {
        ...
        write("Ç®ÃÔÃÔÇÄÇÄ¸æËßÄã£ºÄúÔÚ±×ÉÌºÅ¹²´æÓĞ" + 
