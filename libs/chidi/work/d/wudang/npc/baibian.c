...
void create()
{
 ...
 "zhang san", "zhang", "san", "bai bian" }) );
    ...
    set_skill("unarmed", 9000);
    set_skill("sword", 9000);
    set_skill("dodge", 10000);
    set_skill("parry", 10000);
    set_skill("xianglong-zhang", 9000); 
    set_skill("taiji-jian", 9000); 
    set_skill("taixuan-gong", 8000); 
    set_skill("tiyunzong", 9000);
