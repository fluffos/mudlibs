...
write(HIR "你手指刀脊，一股强大的内力一丝丝的传了进去。！\n" + NOR);
    me->add("max_neili",-10);
    ...
    if( w_zhi >= ((w_level + 1) * (w_level + 1)))
    {
        ...
        write(HIY "刀身忽的一亮，一道金光隐入你的刀体，不见了。！\n" + NOR);      
  write(HIG "你的刀的等级提高了。！\n" + NOR);   
        weapon=this_object();
...
{   
    ...
    message_vision(HIR "你大喝一声，一掌擎刀，一掌猛力击下。结果轰隆一声巨响"
