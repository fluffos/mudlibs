...
set("env/wimpy", 30);
           ...
           set_skill("sword", 11000);           set_skill("strike", 11000);
           set_skill("dodge", 11000);
           set_skill("parry", 11000);
           set_skill("zixia-shengong", 11000);
           set_skill("dugu-jiujian", 11000);
           set_skill("poyu-quan", 11000);
           set_skill("hunyuan-zhang", 11000);
           set_skill("qiankundanuoyi", 11000);
