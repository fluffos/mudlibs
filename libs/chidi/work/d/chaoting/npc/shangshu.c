...
void create()
{
	...
	set("title", HIY "朝廷一品官 吏部尚书" NOR );
        ...
        set_skill("bahuang-qiangfa", 70);
        set_skill("force", 80);
        set_skill("bawang-force",80);
        set_skill("parry", 50);
        set_skill("dodge", 60);
...
if(ob->query("family/family_name") == "朝廷")
	    ...
	    if(exp>=250000&&exp<500000)
			...
			ob->set("title",HIY"朝廷六品官 偏将军"NOR);
			ob->set("rank",6);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=500000&&exp<1000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIY"朝廷五品官 威东将军"NOR);
			ob->set("rank",5);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=1000000&&exp<1250000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIW"朝廷五品官 破虏将军"NOR);
			ob->set("rank",5);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=1250000&&exp<1500000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIW"朝廷五品官 荡寇将军"NOR);
			ob->set("rank",5);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=1500000&&exp<1750000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIW"朝廷四品官 奋威将军"NOR);
			ob->set("rank",4);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=1750000&&exp<2000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIG"朝廷四品官 建威将军"NOR);
			ob->set("rank",4);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=2000000&&exp<2250000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIG"朝廷四品官 征虏将军"NOR);
			ob->set("rank",4);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=2250000&&exp<2500000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIG"朝廷三品官 左将军"NOR);
			ob->set("rank",3);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=2500000&&exp<2750000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIB"朝廷三品官 平东将军"NOR);
			ob->set("rank",3);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=2750000&&exp<3000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIB"朝廷三品官 安东将军"NOR);
			ob->set("rank",3);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=3000000&&exp<3500000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIC"朝廷二品官 镇东将军"NOR);
			ob->set("rank",2);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=3500000&&exp<4000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIC"朝廷二品官 征东将军"NOR);
			ob->set("rank",2);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=4000000&&exp<5000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIC"朝廷二品官 卫东将军"NOR);
			ob->set("rank",2);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
	    if(exp>=5000000&&exp<6000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIM"朝廷一品官 车骑将军"NOR);
			ob->set("rank",1);
            message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users()); 
			return 1;
			} 
	    if(exp>=6000000&&exp<8000000)
			{
			command("say 好！好！好，我立即奏明皇上，为你加官进爵！！！");
			ob->set("title",HIM"朝廷一品官 骠骑将军"NOR);
			ob->set("rank",1);
			message("vision",CYN"庾子建:皇上御旨,昭封"+ob->name()+"为"+ob->query("title")+"\n"NOR,users());	
			return 1;
			} 
...
{
        object gold;
         if((string)who->query("family/family_name") == "朝廷"
          && ob->query("军事详图")=="YES"
