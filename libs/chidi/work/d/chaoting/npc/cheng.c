...
void create()
{
 set_name("程药发", ({ "cheng yaofa", "cheng yaofa","cheng" }) );
      ...
      "他就是程药发，扬州现任知府。\n");
       ...
       set_skill("bahuang-qiangfa",300);
       set_skill("bawang-force",300);
