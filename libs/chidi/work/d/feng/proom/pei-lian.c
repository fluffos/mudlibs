...
void create()
{ 
    set_name(HIG"陪练"NOR,  ({ "pei lian", "pei" }));
        set("nickname", HIM"私人陪练"NOR);
        set("long", 
                HIY"她就是你的私人陪练，除了不能陪你makelove，其它任何事都可以找她。\n"NOR);
        set("gender", "女性");
        set("age", 18);
