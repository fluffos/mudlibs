        ...
        if (random(kar)>15) {
                message_vision("$N打到一只"HIW"百灵鸟。\n"NOR, me);
                    if (me->query("combat_exp")>=2000000)
                        ...
                        me->set("combat_exp",250+bb);
                        tell_object(me,"你得到了250点经验\n");
                }
       me->receive_damage("qi", 10);
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=2000000)
                        ...
                        me->set("potential",220+bb);
                        tell_object(me,"你得到了220点潜能\n");
                }
        ...
        if (random(kar)>10) 
                message_vision("$N打到一只"HIY"金丝雀。\n"NOR, me);
                    if (me->query("combat_exp")>=2000000)
                        ...
                        bb=(int)me->query("combat_exp");
                        me->set("combat_exp",180+bb);
                        tell_object(me,"你得到了180点经验\n");
                }
       me->receive_damage("qi", 10);
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=2000000)
                        ...
                        me->set("potential",bb+180);
                        tell_object(me,"你得到了180点潜能\n");
                }
            ...
            me->receive_damage("qi", 10);  
                ...
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=2000000)
                        ...
                        me->set("potential",bb+150);
                       tell_object(me,"你得到了150点潜能\n");
               }
               ...
               message_vision("$N打到一只"YEL"麻雀。\n"NOR, me);
                bb=(int)me->query("combat_exp");
                    if (me->query("combat_exp")>=2000000)
                        ...
                        tell_object(me,"你得到了120点经验\n");
                        me->set("combat_exp",120+bb);
                }
            me->receive_damage("qi", 10);  
                ...
                bb=(int)me->query("potential");
                    if (me->query("combat_exp")>=2000000)
                        ...
                        me->set("potential",bb+120);
                       tell_object(me,"你得到了120点潜能\n");
               }
