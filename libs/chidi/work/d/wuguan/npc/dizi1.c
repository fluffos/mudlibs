...
int do_task(string arg)
{
       ...
       if( arg=="ok" && ob->query_temp("mark/完了")){
            ...
            pot=(int)(ob->query_skill("force",1)/5)+310+random(20);
            exp=(int)(ob->query_skill("force",1)/5)+330+random(30);
...
void greeting(object ob)
{
       ...
       if ( ob->query("combat_exp") < 3000000 
        ...
        && !ob->query_temp("job_name")) {
           ...
           command("say 这位"+ RANK_D->query_respect(ob)+ "，我们这缺人手，你可以找我领工作"HIY HBCYN" ask lu about 工作 "CYN"来做。"NOR);
       }
}
