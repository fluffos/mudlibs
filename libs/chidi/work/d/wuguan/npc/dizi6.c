...
void greeting(object ob)
{
       ...
       if( ob->query_temp("job_name")){
            ...
            command("say 这位"+RANK_D->query_respect(ob)+ "，到我这领工具 "HIY HBCYN"ask wu about 工具"CYN" 吧。"NOR);
       }
}                               
