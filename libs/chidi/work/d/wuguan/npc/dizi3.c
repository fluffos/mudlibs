...
string* tools = ({
       "/d/city/npc/obj/yayifu",
       "/d/city/npc/obj/beixin",
       "/d/city/obj/tiejia",
       "/d/city/npc/obj/junfu",
}); 
...
{        
        ...
        if (  present("armor", this_player()) || present("junfu",this_player()) || present("yayi cloth",this_player()) || present ("beixin",this_player()))
                return RANK_D->query_respect(this_player()) + 
                "你不是已经来要过防具了，怎么又来要了？可真贪心哦！";
