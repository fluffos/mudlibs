...
// By jh@ty 炼丹的额外奖励!
    ...
    if ( liandan > 500 && jh > 15) {
    if ( jh>15 && jh<20 && all2 < 211 &&all2 > 100 
    && random(10000)>9995) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan11");
   ...
   if ( liandan > 300 && jh > 10 && random(100)>70) {

    if ( jh < 15 && jh>10 && all2 < 200 && all2 > 100 
    && random(100)>90) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan19");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIC"你练出了可以增加全部武功的技能丹!!!\n"NOR);
    }

    if ( jh < 15 && jh>3 && all2 < 200 && all2 > 30 
    && random(100)>60) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan12");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIB"你练出了可以使人返老还童的仙丹!!!\n"NOR);
    }

    if ( jh < 15 && jh>10 && all2 < 150 && all2 > 40 
    && random(100)>95) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan6");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
   ...
   if ( jh < 15 && jh>10 && all2 < 150 && all2 > 40 
    ...
    if ( jh < 8 && jh>3 && all2 < 100 && all2 > 30 && random(10)>4
    && zhuyao >= 1 && zhuyao < 5) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan2");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIG"你练出了可使自己使自己脱离busy的疾风丹\n"NOR);
    }
    
    if ( jh < 6 && jh > 3 && all2 < 100 && all2 > 20 
    && random(10)>4&& zhuyao >= 21 && zhuyao < 25) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan3");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIW"你练出了少林圣药菩提子!\n"NOR);
    }
    
    if ( jh < 10 && jh > 4 && all2 < 100 && all2 > 20 
    && random(10)>4&& zhuyao >= 11 && zhuyao < 15) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan4");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    ...
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan5");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIW"你练出了补精圣药,肾宝!!!\n"NOR);
    }

    if ( jh < 10 && jh > 2 && all2 < 100 && all2 > 10 
    && random(10)>3 && zhuyao >= 1 && zhuyao < 5) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan13");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    ...
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan14");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIG"你练出了可增加攻击力的战神丸!!!\n"NOR);
    }

    if ( jh < 15 && jh > 2 && all2 < 100 && all2 > 30 
    && random(10)>8 && zhuyao >= 21 && zhuyao < 25) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan15");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIG"你练出了可增加技能的龙丹!!!\n"NOR);
    }

    if ( jh < 7&& jh > 2 && all2 < 100 && all2 > 20 &&random(10)>4
    && zhuyao >= 21 && zhuyao < 25) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan1");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIR"你练出了可使自己状态恢复满的血气丹!\n"NOR);
    }

    if ( jh < 10 && jh > 3 && all2 < 100 && all2 > 10 
    && random(10)>2 && zhuyao >= 1 && zhuyao < 5) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan16");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIB"你练出了可增加正气的正气丸!!!\n"NOR);
    }

    if ( jh < 15 && jh > 3 && all2 < 150 && all2 > 30 
    && random(10)>3 && zhuyao >= 21 && zhuyao < 25) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan17");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIR"你练出了可增加基本内功的太级丹!!!\n"NOR);
    }

    if ( jh < 15 && jh > 1 && all2 < 150 && all2 > 10 
    && random(10)>3 && zhuyao >= 1 && zhuyao < 5) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan18");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    ...
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan21");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
    return notify_fail(HIR"你练出了可增加基本拳脚的神力丸!!!\n"NOR);
    }

    if ( jh < 10 && jh > 4 && all2 < 150 && all2 > 50 
    && random(10)>3 && zhuyao >= 21 && zhuyao < 25) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao");
    me->delete_temp("jh_dan");
    dan = new("/d/yao/xdan/dan22");
    dan->set("zhuren",""+me->query("id")+"");
    dan->move(me);
