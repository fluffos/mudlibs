...
{
        object ob,room;
      room = load_object("/d/hainan/duchuan2");
...
int do_ask(string arg)
{
      ...
      if((arg!="yu weng about out")&&(arg!="yu weng about 出海")) return 0;
        ...
        load_object("/d/hainan/haitan")->set("exits/enter","/d/hainan/duchuan2");
        this_object()->move("/d/hainan/duchuan2");
        load_object("/d/hainan/duchuan2")->set("exits/out", "/d/hainan/haibian");
