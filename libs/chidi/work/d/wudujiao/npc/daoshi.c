...
void create()
{
        ...
        set_skill("qianzhu-wandushou", 185);
...
void greeting(object ob)
{
        ...
        switch( random(3) ) {
                case 0:
                        say( "游方道人嘿嘿一阵奸笑道：这位" + RANK_D->query_respect(ob)
                                + "，也是来住店的吗？\n");
                        break;
                case 1:
                        say( "游方道人点了点手道：这位" + RANK_D->query_respect(ob)
                                + "请过这里坐，这是要去那啊？\n");
                        break;
                case 2:
                        say( "游方道人面现惊讶之色道：这位" + RANK_D->query_respect(ob)
...
int ask_me()
{
        ...
        message("vision", "远处一辆马车急驶而来，车门一开"+me->query("name")+"从里面钻了出来。\n", ob);
         tell_object(me, "只听车把势说道：这位"+ RANK_D->query_respect(me)
          + "已经到了，请下车吧。\n"NOR );
