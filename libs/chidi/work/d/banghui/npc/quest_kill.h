mapping area=([
 "扬州城" : ({"/d/city/","beidajie1","beidajie2","beimen","bingyin",
            "bingyindamen","caizhu","guangchang","houyuan","kedian2",
            "lichunyuan","meigui","yidao","yidao1","yidao2","hanshui1",
            "ml1","ml2","ml3","ml4","ml5","ml6","ml7","mudan",
            "nandajie1","nandajie2","nanmen","neizhai","pomiao",
            "shuyuan","xidajie1","xidajie2","ximen",
            "xiting","xixiang","yamen","ymzhengting",
 ...
 "白驼山" : ({"/d/baituo/","bridge","cao1","cao2","caomeide","caoping",
            ...
            "neishi","nongshe","shanlu","shanlu1","shijie",
                     "shulin","shulin1","storeroom",
...
int place_room(object me,object ob)
{
  ...
  do {
     ...
     } while ( !objectp( room = load_object(site_file) ) );
