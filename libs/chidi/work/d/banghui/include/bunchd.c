...
#define BUNCH_D         "/d/banghui/include/bunchd"
...
public mixed check_areas()
{
        ...
        foreach (string area in all_area)
        {
                ...
                {
                        message("channel:rumor", HIM"【帮会】由于帮派瓦解，" +
...
#endif
                {
                        message("channel:rumor", HIW "【帮会】由于帮派资产长期严重亏损，帮会「" + 
