...
int working(object me)
{
        ...
        me->add("jing",-30);
        me->add("qi",-30);
        if((string)environment(me)->query("short")!="矿洞")
        {
       ...
       if ( (me->query_skill("wakuang-shu",1) > 300&& random(1000)>997)
        ...
        if (random(10)>5)
        switch (random(4)) {
                case 0: ob = "/d/jh/weapon/gaogao/gao11"; break;
                case 1: ob = "/d/jh/weapon/gaogao/gao12"; break;
                case 2: ob = "/d/jh/weapon/gaogao/gao13"; break;
                case 3: ob = "/d/jh/weapon/gaogao/gao14"; break;
        }
            
        else 
        switch (random(4)) {
                case 0: ob = "/d/jh/weapon/gaogao/gao21"; break;
                case 1: ob = "/d/jh/weapon/gaogao/gao22"; break;
                case 2: ob = "/d/jh/weapon/gaogao/gao23"; break;
                case 3: ob = "/d/jh/weapon/gaogao/gao24"; break;
        }
        }else
     if ( (me->query_skill("wakuang-shu",1) > 150&& random(100)>98)
       || (me->query_skill("wakuang-shu",1) > 400 && random(100)>96) ){
        switch (random(5)) {
                case 0: ob = "/d/jh/weapon/gang/gang1"; break;
                case 1: ob = "/d/jh/weapon/gang/gang2"; break;
                case 2: ob = "/d/jh/weapon/gang/gang3"; break;
                case 3: ob = "/d/jh/weapon/gang/gang4"; break;
                case 4: ob = "/d/jh/weapon/gang/gang5"; break;
        }
        } 
 else
        ...
        if ( random(10)>8 )
        switch (random(5)) {
                case 0: ob = "/d/jh/weapon/tie/tie1"; break;
                case 1: ob = "/d/jh/weapon/tie/tie2"; break;
                case 2: ob = "/d/jh/weapon/tie/tie3"; break;
                case 3: ob = "/d/jh/weapon/tie/tie4"; break;
                case 4: ob = "/d/jh/weapon/tie/tie5"; break;
        }
        else 
        switch (random(5)) {
                case 0: ob = "/d/jh/weapon/tong/tong1"; break;
                case 1: ob = "/d/jh/weapon/tong/tong2"; break;
                case 2: ob = "/d/jh/weapon/tong/tong3"; break;
                case 3: ob = "/d/jh/weapon/tong/tong4"; break;
                case 4: ob = "/d/jh/weapon/tong/tong5"; break;
        }
        }
        else
