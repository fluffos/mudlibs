...
int do_ride(string arg)
{
       ...
       if (fam && fam["family_name"]=="血河派" && ((int)me->query("combat_exp")<500000))
              return notify_fail("你的经验太少了，会把车弄丢的！\n");
        ...
        set("ride",1);
	 ob->move("/d/longmen/xuehepai/tanbian");
        me->move("/d/longmen/xuehepai/tanbian");
        me->set_temp("xueheche",1);
        return 1;
}
