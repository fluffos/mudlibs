...
void create()
{
        ...
        set_skill("shuangzi", 2005250);
        map_skill("sword","westsword");
        map_skill("unarmed","boxing");
        map_skill("spells","shuangzi");
        map_skill("force","taixuan-gong");
        map_skill("dodge","piaomiao-shenfa");
        set("max_jingli", 3500000);
        set("jingli", 2100000000);
        set("max_neili", 3500000);
        set("neili", 2100000000);
        set("max_qi", 700000000);
        set("max_jing", 700000000);
        set("jiali",2000000);
...
void die()
{
        ...
        ob->start_busy(3);
        killer=new("/d/12gong/npc/juxie"); 
        killer->move("/d/12gong/juxie"); 
