...
set("chat_chance_combat",40);
        ...
        set_skill("canhe-zhi", 1000);
        set_skill("murong-jianfa",1000);       
       set_skill("shenyuan-gong", 1001);
        set_skill("yanling-shenfa", 1000);
        set_skill("douzhuan-xingyi", 1030);
        set_skill("parry", 1010);
        set_skill("sword", 1000);
        set_skill("literate", 500);
        set_skill("murong-daofa", 1000);
