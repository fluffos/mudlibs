// command.h
#define BOS_PATH ({"/cmds/bos/","/cmds/adm/", "/cmds/arch/","/cmds/ang/", "/cmds/wiz/", "/cmds/app/","/cmds/gen/","/cmds/imm/", "/cmds/usr/","/cmds/std/", "/cmds/skill/"})
...
#define APR_PATH ({"/cmds/app/","/cmds/gen/","/cmds/imm/", "/cmds/usr/","/cmds/std/", "/cmds/skill/"})
...
#define EXAMINE_CMD     "/cmds/bos/checkall"
