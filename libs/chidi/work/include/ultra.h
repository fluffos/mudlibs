...
void check_ultra(object me)
{
        ...
        if (me->query("opinion/unarmed") != "大宗师" ||
            me->query("opinion/weapon") != "大宗师"  ||
            me->query("opinion/force") != "大宗师"  ||
            me->query("opinion/dodge") != "大宗师" )
                return;

        me->set("opinion/ultra1", 1);
me->delete("opinion/ultra");
