...
int set_std_skills (int level,object ob)
{
   ...
   ob->set_skill("dodge",level/2);
   ob->set_skill("parry",level/2);
...
{  
   ...
   ob->set("gender","男性");
   ob->set_skill("blade",level/4);
   ob->set_skill("wuhu-duanmendao",level/4);
...
{
     carry_object("/quest/blade")->wield();
    carry_object("/quest/armor")->wear();
}
...
int set_hell_guai(int level,object ob)
{
   ...
   ob->set("gender","男性");
   ob->set_skill("blade",level/2);
   ob->set_skill("wuhu-duanmendao",level/2);
   ob->map_skill("blade","wuhu-duanmendao");
 //ob->set("chat_msg_combat", ({
 //     (: perform_action, "blade.duan" :),
 //   }) );
