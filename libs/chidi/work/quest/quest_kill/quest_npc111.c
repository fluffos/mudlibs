...
void die()
{
        int reward_exp,reward_pot,reward_gold,level=0;
        string fam;
        object killer,me;
        string *dir,file;
        object equip;
