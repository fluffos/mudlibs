...
void create()
{
    	set_name("倒退卡", ({ "back card", "card", "back" }) );
...
if( wizardp(ob) ) return notify_fail("这张片对巫师无效！\n");
      ...
      //  if(query_ip_name(ob) == query_ip_name(me) && !wizardp(me) ) 
       //         return notify_fail("请多看一看游戏规则！下不为例！\n");
        ...
        CHANNEL_D->do_channel(this_object(), "game", "在" 
