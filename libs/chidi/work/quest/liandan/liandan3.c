...
string *dan4 = ({"/clone/misc/dahuan-dan","/clone/misc/zhujingchan","/clone/misc/wuchangdan",
"/clone/misc/jiuhua"});
string *dan5 = ({"/d/shenlong/obj/baihua","/d/city/npc/obj/shouwu","/d/quanzhen/npc/obj/gao"});
string *dan6 = ({"/d/xiakedao/obj/zhou","/quest/feizei/lingzhi"});
...
{
        object ob; 
        if ((int)me->query_skill("liandan", 1) < 70 )
        {
        ...
        if ((int)me->query_skill("liandan", 1) > 199 )
        {
           ...
           me->add("combat_exp",50+random(30));
           me->add("potential",25+random(10));
           ob=new(dan6[random(2)]);
           ob->move(me);       
           me->improve_skill("liandan", (int)me->query_skill("liandan", 1));  
           return 1;
        }
        else  
        if ((int)me->query_skill("liandan", 1) > 149 )
        {
           ...
           me->add("combat_exp",50+random(30));
           me->add("potential",25+random(10));
           ob=new(dan5[random(3)]);
           ob->move(me);       
           me->improve_skill("liandan", (int)me->query_skill("liandan", 1));  
           return 1;
        }
        else 
        if ((int)me->query_skill("liandan", 1) > 69 )
        {
