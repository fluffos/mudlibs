...
"一个身高大但满脸又是伤疤加横肉的西夏兵。\n");
  ...
  set("max_mana",300+random(390));
	...
	set("bellicosity", 10000);
        ...
        set_skill("kuang-jian", 10+random(100));
...
void die()
{
        ...
        message("vision", me->name() + "由于成功的保卫了祖国,增加了450000经验和25000潜能。\n", me);
        me->add("combat_exp",450000);
