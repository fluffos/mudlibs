...
void create()
{
    ...
    set_skill("blade", 200+random(100));
    set_skill("parry", 200+random(100));
    set_skill("dodge", 200+random(100));
    set_skill("force", 200+random(100));
    set_skill("renshu", 200+random(100));
    set_skill("kongshoudao",200+random(100));
    set_skill("wind-blade", 200+random(100)); 
...
void die()
{
        ...
        + "由于成功的保卫了祖国,增加了200000经验和60000潜能。\n", me);
