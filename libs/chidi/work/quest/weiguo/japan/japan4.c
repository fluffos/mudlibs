...
void create()
{
    ...
    set("max_jing",4000+random(1000));
    set("max_jingli",2000+random(1000));
    set("max_neili",10000+random(2000));
    set("eff_qi",query("max_qi"));
    set("eff_jing",query("max_jing"));
    set("jingli",query("max_jingli"));
    set("qi",query("max_qi"));
    set("jing",query("max_jing"));
    set("neili",10000+random(2000));
    set("per", 12);
    ...
    set_skill("blade", 400+random(100));
    set_skill("parry", 400+random(100));
    set_skill("dodge", 400+random(100));
    set_skill("force", 400+random(100));
    set_skill("renshu", 400+random(100));
    set_skill("kongshoudao",400+random(100));
    set_skill("wind-blade", 400+random(100)); 
...
void die()
{
        ...
        message("vision", me->name() + "由于成功的保卫了祖国,增加了500000经验和100000潜能。\n", me);
