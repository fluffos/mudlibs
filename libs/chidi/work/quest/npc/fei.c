...
void create()
{
        ...
        setup();
         carry_object("/quest/npc/obj/jinchuang");
         carry_object("/quest/npc/obj/jinchuang");
         carry_object("/quest/npc/obj/jinchuang");
         carry_object("/quest/npc/obj/jinchuang");
         carry_object("/quest/npc/obj/jinchuang");
...
void copy_status(object me)
{
        ...
        set("max_qi",13000+random(1000));
        set("eff_qi",13000+random(1000));
        set("qi",13000+random(1000));

        set("max_jingli",2000+random(1000));
        set("eff_jingli",2000+random(1000));
        set("jingli",2000+random(1000));

        set("max_jing",12000+random(1000));
        set("eff_jing",12000+random(1000));
        set("jing",12000+random(1000));

        set("max_neili",3000+random(1000));
        set("neili",6000+random(1000));
        set("force_factor",300);


        set("combat_exp",5000000+random(10000000));
//        set("daoxing",100000+random(300000));
        ...
        set("bellicosity",300);
        carry_object("/quest/npc/obj/boots")->wear();
...
//        tell_object(ob,"\n你得到了"+COMBAT_D->chinese_daoxing(reward)+"经验和"
        tell_object(ob,"\n你得到了"+reward+"经验和"
                + reward/2 + "点潜能！\n" );
//        MONITOR_D->report_system_object_msg(ob,"得到了"+COMBAT_D->chinese_daoxing(reward)+"经验和"
        MONITOR_D->report_system_object_msg(ob,"得到了"+reward+"经验和"
