...
int do_teach(string arg)
{
        ...
        jing_cost = 100/ (int)me->query_int();
        if((int)me->query("jing") < jing_cost)
        return notify_fail("你显然太累了没有办法教！\n");
        me->receive_damage("jing",jing_cost);
        me->add("potential",-1);
        amount = (int)me->query_int() * (int)me->query_int();
...
int do_shape(string arg)
{
        ...
        printf("精：%s%3d/ %3d %s(%3d%%)"NOR"  气：%s%3d/ %3d %s(%3d%%)"NOR"  神：%s%3d/ %3d %s(%3d%%)\n"+NOR,
                status_color(my["jing"], my["max_jing"]), my["jing"],my["max_jing"],
                status_color(my["max_jing"], my["max_jing"]),     my["max_jing"] * 100 / my["max_jing"],
                status_color(my["qi"], my["max_qi"]), my["qi"], my["max_qi"],
                status_color(my["max_qi"], my["max_qi"]),     my["max_qi"] * 100 / my["max_qi"],
               
        );              
//        printf("主人： %s\t\t经验： %d\t\t神： %d\n",
//        my["owner"], my["combat_exp"],my["shen"]
//        );
/*        
