...
//      for (int i=0;i<10;i++) carry_object("/d/obj/drug/jinchuang");
        carry_object("/u/xiha/npc/obj/jinchuang");
        carry_object("/u/xiha/npc/obj/jinchuang");
}
...
//                        carry_object(base_name(inv[i]))->wear();
        ...
        if(eff_dx>150000000) 
        nk_factor = 9;
        else if(eff_dx>80000000)
        nk_factor = 8;
        else if(eff_dx>60000000)
        nk_factor = 7;
        else if(eff_dx>30000000)
        nk_factor = 6;
        else if(eff_dx>10000000)
        nk_factor = 5;
        else if(eff_dx>50000000)
        nk_factor = 4;
        else if(eff_dx>20000000)
        nk_factor = 3;
        else if(eff_dx>10000000)
        nk_factor = 2;
        else nk_factor = 1;
