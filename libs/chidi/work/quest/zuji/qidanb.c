...
void create()
{
        ...
        set_name("契丹军官",({ "menggu junguan","junguan" }) );
        set("gender", "男性" );
        set("long","这是一名契丹将领，正带着军马执行着战斗任务。\n");
...
{ 
  ...
  if ( jungong > 10 ) set("title",HIR"契丹万夫长"NOR);
  else if ( jungong > 8 ) set("title",HIG"契丹军那颜"NOR);
  else if ( jungong > 5 ) set("title",HIY"契丹千夫长"NOR);
  else set("title",HIC"契丹百夫长"NOR);
