...
/* copy hp */
        ...
        me->set("combat_exp",hp_status["combat_exp"]/5);
        me->set("max_qi",    hp_status["max_qi"]/5);
        me->set("eff_qi",    hp_status["max_qi"]/5);
        me->set("qi",        hp_status["max_qi"]/5);
        me->set("max_jing",  hp_status["max_jing"]/5);
        me->set("eff_jing",  hp_status["eff_jing"]/5);
        me->set("jing",      hp_status["eff_jing"]/5);
        me->set("jingli", hp_status["max_jingli"]/5);
