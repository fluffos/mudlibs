...
{                            
  ...
  set_skill("wudu-shengong", 1000);
  set_skill("tiyunzong", 1000);
  set_skill("arrow",1000);
...
void change_ob(object me)
{
  ...
  if( query("max_qi") < 12000 ) set("max_qi",1200);
  set("eff_qi",query("max_qi")); 
  set("qi",query("max_qi"));
  set("max_jing",me->query("max_jing")/2);
  if( query("max_jing") < 6000 ) set("max_jing",6000);   
