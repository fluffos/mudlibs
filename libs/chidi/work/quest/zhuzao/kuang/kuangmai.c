...
string *kuang2=({__DIR__"tong-kuang",__DIR__"tie-kuang",__DIR__"ying-kuang"});
string *kuang3=({__DIR__"tong-kuang",__DIR__"tie-kuang",__DIR__"ying-kuang",__DIR__"jing-kuang"});
string *kuang4=({__DIR__"tong-kuang",__DIR__"tie-kuang",__DIR__"ying-kuang",__DIR__"jing-kuang",__DIR__"xuantie-kuang"});
string *kuang5=({__DIR__"tong-kuang",__DIR__"tie-kuang",__DIR__"ying-kuang",__DIR__"jing-kuang",__DIR__"xuantie-kuang",__DIR__"hantie-kuang1"});
string *kuang6=({__DIR__"tong-kuang",__DIR__"tie-kuang",__DIR__"ying-kuang",__DIR__"jing-kuang",__DIR__"xuantie-kuang",__DIR__"hantie-kuang1",__DIR__"hantie-kuang2"});
