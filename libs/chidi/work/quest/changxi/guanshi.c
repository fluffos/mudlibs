...
{      
    ...
    if( me->query("combat_exp")< 40000000)//经验下限4千万
    {
                tell_object(me,"你已经太软弱了，这种工作不合适你做了。\n");
                return 1;
    }
    else
    if( me->query("combat_exp")>=80000000)//经验上限8千万
    {
...
{      
    ...
    exp=5000+random(3000);
    pot=exp/4;
    me->add("combat_exp",exp);
    me->add("potential",pot);
    me->delete_temp("obj");
    tell_object(me,HIW"你获得了"+CHINESE_D->chinese_number(exp) +"点的『实战经验』"+CHINESE_D->chinese_number(pot)+"点的『潜能』！\n"NOR); 
