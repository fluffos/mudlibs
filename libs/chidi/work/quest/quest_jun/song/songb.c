...
void create()
{
        ...
        set("int", 33);
        set("str", 200+random(100));
        set("con", 200+random(100));
        set("dex", 200+random(100));
        set("age", 20+random(30));
        set("per", 15+random(15)); 
        set("age", 20+random(30));
        set("per", 15+random(15));                                         
        set("no_get",1);
        set("jh_dj/dj",random(4)+1);
        ratio=80+random(40);
        rate=get_exp_rate();
        exp=(random(rate)+1)*(random(rate)+1)*50000000;    
        if(exp < 300000000) exp =300000000;
        if(exp > 900000000) exp =900000000;
        skill=get_level(exp);
        if(skill<4000)    skill=4000;   
        set("combat_exp",exp/100*ratio);
        nl=skill*100+exp/1000;
