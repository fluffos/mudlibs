...
void create()
{
        ...
        set("int", 30);
        set("str", 100+random(100));
        set("con", 100+random(100));
        ...
        exp=(random(rate)+1)*(random(rate)+1)*10000000;
        if(exp < 100000000) exp =100000000;
        if(exp > 500000000) exp =500000000;
        skill=get_level(exp);
...
{ 
  ...
  call_out("move_me",10,this_object());
  call_out("check_me",10,this_object());    
  return;
}
