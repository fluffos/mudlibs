...
void create()
{
	...
	set_name("腰带"NOR, ({"linzi waist", "hecheng", "waist"}) );
	set("hcloth/name", "腰带"NOR);
	set("hcloth/id", "linzi waist");
	set("long", "这是由林子(linzi)合成的腰带" + NOR + "。\n");
	...
	set("armor_prop/constitution", 712);
	set("armor_prop/dexerity", 738);
	set("armor_prop/intelligence", 800);
	set("armor_prop/strength", 841);
