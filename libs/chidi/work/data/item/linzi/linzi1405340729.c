...
void create()
{
	...
	set_name("披风"NOR, ({"linzi pifeng", "hecheng", "pifeng"}) );
	set("hcloth/name", "披风"NOR);
	set("hcloth/id", "linzi pifeng");
	set("long", "这是由林子(linzi)合成的披风" + NOR + "。\n");
	...
	set("armor_prop/constitution", 657);
	set("armor_prop/dexerity", 751);
	set("armor_prop/intelligence", 763);
	set("armor_prop/strength", 725);
