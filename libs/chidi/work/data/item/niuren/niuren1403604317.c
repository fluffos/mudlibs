...
void create()
{
	...
	set_name("天尊头盔"NOR, ({"niuren head", "hecheng", "head"}) );
	set("hcloth/name", "天尊头盔"NOR);
	set("hcloth/id", "niuren head");
	set("long", "这是由必须的必(niuren)合成的天尊头盔" + NOR + "。\n");
	set("armor_type", "head");
	set_weight(5000);
	set("unit", "双");
	set("no_get", 1);
	...
	set("armor_prop/intelligence", 678);
