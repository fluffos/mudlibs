...
int main(object me, string arg)
{
        ...
        sp = (int)me->query_skill("begging") * 15 + (int)me->query_kar() * 5
                - (int)me->query("begger") * 2+me->query("combat_exp");
        if( sp < 1 ) sp = 1;
        dp = (int)victim->query("jing")+victim->query("combat_exp")-victim->query("shen")*10;
