...
int jing,i,m_jing,eq,mq;
int main(object me, string arg)
{
        string dest, mout, min, dir, face, thing_msg;
        object env, obj,obj1, thing,*member;
        ...
        if (me->query_encumbrance() < 0)
                return notify_fail("你都快被压死了，还想动弹?\n");
...
// end of part
        ...
        if( me->move(obj) ) {//这里对组队做了改动,队长移动队员自动跟随.
