...
int main(object me)
{
  ...
  if(me->query_temp("wajuedi") == environment(me)->name())
  ...
  {
    case 0:
    caoyao = new("/d/liandan/zyao/yao0");
    break;
    case 1:
    caoyao = new("/d/liandan/zyao/yao1");
    break;
    case 2:
    caoyao = new("/d/liandan/zyao/yao2");
    break;
    case 3:
    caoyao = new("/d/liandan/zyao/yao3");
    break;
    case 4:
	caoyao = new("/d/liandan/zyao/yao4");
    break;
    case 5: 
    caoyao = new("/d/liandan/zyao/yao5");
    break;
    case 6:
    caoyao = new("/d/liandan/zyao/yao6");
    break;
    case 7:
    caoyao = new("/d/liandan/zyao/yao7");
    break;
    case 8:
    caoyao = new("/d/liandan/zyao/yao8");
    break;
    case 9:
    caoyao = new("/d/liandan/zyao/yao9");
    break;
   }
   me->start_busy(10);
   }
  ...
  switch(random(2))
{
  ...
  break;
   ...
   environment(me)->set("wajue",time()+120);
