...
int main(object me, string arg)
{
        ...
        bh=(string)me->query("banghui/name");
        ...
        if( !objectp(player))   {
                ...
                if( player->query("no_use"))    {
                        ...
                        player->delete("banghui/name");
                        if(!undefinedp(player->query("score")))
                                player->delete("score");
                        if(!undefinedp(player->query("banghui/rank")))
                                player->delete("banghui/rank");
                        if(!undefinedp(player->query("banghui/rank_lv")))
                                player->delete("banghui/rank_lv");
                        player->save();
                        destruct(player);
                }
        }
        ...
        message("channel:rumor",YEL"【谣言四起】某人："+name+"("+arg+")被"+
                "帮会「"+bh+"」开除！\n"NOR,users());
