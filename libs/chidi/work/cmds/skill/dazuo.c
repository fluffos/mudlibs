// exercise.c
//modify by jzw 2006/1/31 for 断线打坐
#include <skill.h>
inherit F_CLEAN_UP;
...
int exercising(object me)
{
  ...
  //  if (!interactive(me)) return 0;  //by jzw
	if (exercise_cost < 1)
		return 0;
