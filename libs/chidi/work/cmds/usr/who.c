// who.c
// 2002/1/18 by 李彦(liyan) email:liyan_st@sina.com
...
int opt_dead,opt_banghui,opt_game;
...
str = HIY"\n「"+ CHINESE_MUD_NAME+"」"HIW"目前";
if(opt_banghui)
  if(me->query("banghui/name"))
    str += me->query("banghui/name")+"的玩家有：";
  else
...
if(opt_game && !list[i]->query_temp("wqa's room/flag")) continue;
