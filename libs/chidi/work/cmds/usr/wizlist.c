...
int main(object me, string arg)
{
    ...
    int ceo_n, bos_n, adm_n, arc_n, ang_n, wiz_n, app_n, gen_n, imm_n, j, k, time, day, hour, min, year, month;
        object login;
       mission = explode(read_file("/adm/etc/renwu"), "\n");
        ...
        str +=YEL"≡≡≡≡≡≡≡≡≡≡≡≡≡≡["BBLU+HIG"江湖"NOR+YEL"]≡≡≡≡≡≡≡≡≡≡≡≡≡≡\n"NOR;
        str +=BRED+HIY"巫师等级级别       巫师ID    状态 巫师任务级别    间隔时间        \n"NOR;
       str +=YEL"≡≡≡≡≡≡≡≡≡≡≡≡≡≡["BBLU+HIG"江湖"NOR+YEL"]≡≡≡≡≡≡≡≡≡≡≡≡≡≡\n"NOR;
        for(i=0; i<sizeof(list); i++)
		{
                if (hood != wizhood(list[i]))
				{
                        ...
                        switch (hood)
						{
                                case "(boss)"           :msg =HIR"☆"HIW"游戏策划"HIR"☆"NOR;k=bos_n;break;
                                case "(admin)"          :msg =HIR"☆"HIM"程序管理"HIR"☆"NOR;k=adm_n;break;
                                case "(arch)"           :msg =HIR"☆"HIY"程序开发"HIR"☆"NOR;k=arc_n;break;
                                case "(wizard)"         :msg =HIR"☆"HIC"开发辅助"HIR"☆"NOR;k=wiz_n;break;
                                case "(apprentice)"     :msg =HIR"☆"HIB"人事管理"HIR"☆"NOR;k=app_n;break;
                                case "(immortal)"       :msg =HIR"☆"YEL"荣誉玩家"HIR"☆"NOR;k=imm_n;break;
                        }
                        j=1;
                }
				else
				...
				{
                        att=HIR"离线"NOR;
						st = stat(sprintf("%slogin%s%s%s", DATA_DIR,"/"+list[i][0..0]+"/",list[i],__SAVE_EXTENSION__),-1);
