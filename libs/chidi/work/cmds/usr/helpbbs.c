...
int register()
{
   ...
   if(!me->query("register")) {
         write(CLR"\n");
         write(HIW"【使用者设定】        "HIY"【"+CHINESE_MUD_NAME+"注册单】\n"NOR);
         write("\n");
         write(YEL"目前选择：\n\n"NOR);
         write(HIW"    您的代号     : "NOR);
...
void view_main()
{
     ...
     write(BBLU HIY"分类选单"NOR"                   " HIR"〖 "+HIG+BRED+CHINESE_MUD_NAME+NOR+HIR" 〗""                  "BBLU HIY"选单["+select+"]\n"NOR);     
     write("目前选择：[ "+name+" ]\n");
...
private void confirm_c_choice(string arg)
{
 ...
 switch(arg) {
    case "1":
             start_help(read_file("/doc/help/map/huashan-map"));
             return ;
    case "2":
             start_help(read_file("/doc/help/map/taishan-map"));
             return ;
    case "3":
             start_help(read_file("/doc/help/map/city-map"));
             return ;
    case "4":
             start_help(read_file("/doc/help/map/jiaxing-map"));
             return ;
    case "5":
             start_help(read_file("/doc/help/map/city2-map"));
             return ;
    case "6":
             start_help(read_file("/doc/help/map/xingxiu-map"));
             return ;
    case "7":
             start_help(read_file("/doc/help/map/changan-map"));
             return ;
    case "8":
             start_help(read_file("/doc/help/map/xiangyang-map"));
             return ;
    case "9":
             start_help(read_file("/doc/help/map/shaolin-map"));
             return ;
    case "10":
...
private void confirm_o_choice(string arg)
{
 ...
 switch(arg){
    case "1":
             start_help(read_file("/doc/help/board/applywiz"));
             return ;
    case "2":
             start_help(read_file("/doc/help/board/gab"));
             return ;
    case "3":
             start_help(read_file("/doc/help/board/pet"));
             return ;
    case "4":
             start_help(read_file("/doc/help/board/checkip"));
             return ;
    case "5":
             start_help(read_file("/doc/help/board/quest"));
             return ;
    case "6":
             start_help(read_file("/doc/help/board/transport"));
             return ;
    case "7":
             start_help(read_file("/doc/help/board/passwd"));
             return ;
    case "8":
             start_help(read_file("/doc/help/board/sboard"));
             return ;
    case "9":
             start_help(read_file("/doc/help/board/pig_cmds"));
             return ;
    case "10":
             start_help(read_file("/doc/help/board/crash"));
             return ;
    case "11":
             start_help(read_file("/doc/help/board/force"));
             return ;
    case "b":
             m_display();
             write(YEL "\r请输入您得选择:"NOR);
