       ...
       //titlemission = explode(read_file("/u/lonely/wtm"), "\n");
        ...
        for(i=0; i<sizeof(list); i++) {
                if (hood != wizhood(list[i])) {
                        hood = wizhood(list[i]);
                        switch (hood) { 
                                case "(boss)"          :msg =HIR"〖幕后黑手〗"NOR;k=bos_n;break;
                                case "(admin)"          :msg =HIM"〖天庭波士〗"NOR;k=adm_n;break;
                                case "(arch)"           :msg =HIM"〖天界总管〗"NOR;k=arc_n;break;
                                case "(angel)"          :msg =HIM"〖八部天神〗"NOR;k=ang_n;break;
                                case "(wizard)"         :msg =HIM"〖天庭星宿〗"NOR;k=wiz_n;break;
                                case "(apprentice)"     :msg =HIM"〖天门守神〗"NOR;k=app_n;break;
                                case "(genie)"          :msg =HIM"〖天庭侍卫〗"NOR;k=gen_n;break;
                                case "(immortal)"       :msg =HIM"〖金童玉女〗"NOR;k=imm_n;break;
                        }
                        j=1;
                } else {
                        msg="";
