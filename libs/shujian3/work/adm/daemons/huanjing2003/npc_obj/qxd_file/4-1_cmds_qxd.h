...
// 开始进行详细的分类统计。
    ...
    if( n = sizeof( list ) )
    {
        msg += sprintf( cl+"攻击剑器类(共 %d 件)："NOR"\n""%s\n",
                n, get_msg( list, 1 ) );
        hjinv -= list;
    }
    ...
    if( n = sizeof( list ) )
    {
        msg += sprintf( cl+"魔法水晶类(共 %d 件)："NOR"\n""%s\n",
                n, get_msg( list, 1 ) );
        hjinv -= list;
    }
    ...
    if( n = sizeof( list ) )
    {
        msg += sprintf( cl+"辅助道具类(共 %d 件)："NOR"\n""%s\n",
                n, get_msg( list, 1 ) );
        hjinv -= list;
    }
    ...
    if( n = sizeof( list ) )
    {
        msg += sprintf( cl+"果品或宝石类(共 %d 件)："NOR"\n""%s\n",
                n, get_msg( list, 1 ) );
        hjinv -= list;
    }
    ...
    if( n = sizeof( list ) )
    {
        msg += sprintf( cl+"各族宝物类(共 %d 件)："NOR"\n""%s\n",
                n, get_msg( list, 0 ) );
        hjinv -= list;
    }
