...
void get_out_here( object me )
{
    ...
    message_vision( HIR"$N"HIR"不知怎么的闯进了幻境密林里，一阵奇异的震荡把$N"HIR"抛了出去。"NOR"\n",me);
