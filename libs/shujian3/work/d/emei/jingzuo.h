...
int do_jingzuo(string arg)
{
       ...
       break; 
        ...
        message_vision(HIW"$N现出略有所悟的神情，先侧头想了一会，然后，在地上坐了下来，盘起了腿。"NOR"\n", me);
...
圆顶的石室内，也还维持着盘腿而坐的姿势。  
"NOR"\n");
message_vision(HIY"$N已经和大自然容为一体，过了片刻，精神抖擞的站了起来。"NOR"\n", this_player());
...
int do_halt()
{
        object me = this_player();
        if(environment(me) && me->query_temp("jingzuo")) { 
       message_vision(HIY"$N已经略显疲倦，拍了拍身上的灰尘，站了起来。"NOR"\n", me);
