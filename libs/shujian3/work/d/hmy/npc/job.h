...
int do_letout()
{
        ...
        if (userp(obj))
                tell_object(obj,GRN"任盈盈悄悄在你耳边说道：是驽马让我放你出去的，快点走吧，别再被抓住了！"NOR"\n");
        message_vision(HIY"突然，一阵狂风刮起，$N骤然出现在这里，样子呆呆傻傻，可能是被吓坏了。"NOR"\n",obj);
        return 1;
}
