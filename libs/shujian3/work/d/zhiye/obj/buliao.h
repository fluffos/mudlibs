...
{       
        ...
        switch (i) {
                case 1:
                        ...
                        set("long",HIW"这是一块普通棉，人们最常用的廉价衣料的原料。"NOR"\n");
                        set("material","mianhua");
                        set("value",500);
                        break;
                case 2:
                        set_name(YEL"亚麻"NOR, ({"ya ma","yama","ma"}));
                        set("long",YEL"这是一块亚麻，由亚麻的茎皮纤维纺织而成的布料质地疏松手感粗糙。"NOR"\n");
                        set("material","yama");
                        set("value",800);
                        break;
                case 3:
                        set_name(YEL"大麻"NOR, ({"da ma","dama","ma"}));
                        set("long",YEL"这是一块大麻,选用大麻的细纤维精织而成的夏布，可做衣料。"NOR"\n");
                        set("material","dama");
                        set("value",1200);
                        break;
                case 4:
                        set_name(HIY"苎麻"NOR, ({"zhu ma","zhuma","ma"}));
                        set("long",HIY"这是一块上等的苎麻,选用上等的苎麻精织而成的布料，其纤维洁白有光泽，耐热且抗拉力。"NOR"\n");
                        set("material","zhuma");
                        set("value",1800);
                        break;
                case 5:
                        set_name(HIW"蚕丝"NOR, ({"cansi","si" }));
                        set("long",HIW"这是寻常家蚕吐的丝，看上去纤细柔滑。"NOR"\n");
                        set("material","cansi");
                        set("value",2500);
                        break;
                case 6:
                        set_name(HIY"木棉花"NOR, ({"mumianhua","hua"}));
                        set("long",HIY"少有的木棉花。"NOR"\n");
                        set("material","mumianhua");
                        set("value",3900);
                        break;
                case 7:
                        set_name(GRN"玉蚕丝"NOR, ({"yucansi","si"}));
                        set("long",GRN"这是产自百毒谷的玉蚕丝。看上去比一般的丝略粗，具有极高的弹性及柔韧性，通体透白，是蚕丝中的精品。"NOR"\n");
                        set("material","yucansi");
                        set("value",7000);
                        break;
                case 8:
                        set_name(HIW"冰蚕丝"NOR, ({"bingcansi","si"}));
                        set("long",HIW"传说中昆仑山巅某种冰蚕吐的丝，粘性极强、伸缩自如。若不得解法，一旦沾上再难脱身，犹如被恶鬼缠身。"NOR"\n");
                        set("material","bingcansi");
                        set("value",10000);
                        break;
                case 9:
                        set_name(WHT"天蚕丝"NOR, ({"tiancansi","si"}));
                        set("long",WHT"这是天山蚕王所吐的丝，坚韧无比，寻常刀剑不能将其斩断。"NOR"\n");
                        set("material","tiancansi");
                        set("value",20000);
                        break;
                case 10:
                	set_name(HIY"龙茧蚕丝"NOR,({"longjiansi","si"}));
                	set("long",HIY"一种形如盘龙的毒蚕所产之丝。"NOR"\n");
                	set("material","longcansi");
                	set("value",40000);
                	break;
                case 11:
                        set_name(MAG"波斯彩丝"NOR, ({"bosi caisi","caisi","si"}));
                        set("long",MAG"这是一块匹从西域波斯运来的波斯彩丝。"NOR"\n");
...
void change_state2(string type)
{
        ...
        set("long",MAG"这是一"+query("unit")+"用从西域波斯运来的波斯彩绸制成的"+name()+MAG"。"NOR"\n");
}
...
void change_name()
{
        switch (query_level()) {
                case 1:
                        ...
                        set("long",HIW"这是一块由普通棉纱织成的布，人们最常用的廉价衣料。"NOR"\n");
                        break;
                case 2:
                        set_name(YEL"亚麻布"NOR, ({"yama bu","yama","bu"}));
                        set("long",YEL"这是一块用亚麻的茎皮纤维纺织而成的布料，质地疏松手感粗糙。"NOR"\n");
                        break;
                case 3:
                        set_name(YEL"大麻布"NOR, ({"dama bu","dama","bu"}));
                        set("long",YEL"这是一块选用大麻的细纤维精织而成的夏布，可做衣料。"NOR"\n");
                        break;
                case 4:
                        set_name(HIY"苎麻布"NOR, ({"zhuma bu","zhuma","bu"}));
                        set("long",HIY"这是一块选用上等的苎麻精织而成的布料，其纤维洁白有光泽，耐热且抗拉力。"NOR"\n");
                        break;
                case 5:
                        set_name(HIW"丝绸"NOR, ({"si chou","cansi","chou" }));
                        set("long",HIW"高价的丝绸。"NOR"\n");
                        break;
                case 6:
                        set_name(HIY"木棉布"NOR, ({"mumian bu","mumianhua","bu"}));
                        set("long",HIY"少有的木棉布。"NOR"\n");
                        break;
                case 7:
                        set_name(GRN"玉蚕丝绸"NOR, ({"yucan sichou","yucansi","sichou"}));
                        set("long",GRN"这是产自百毒谷的玉蚕丝绸。看上去比一般的丝略粗，具有极高的弹性及柔韧性，通体透白，是蚕丝中的精品。"NOR"\n");
                        break;
                case 8:
                        set_name(HIW"冰蚕丝绸"NOR, ({"bingcan sichou","bingcansi","sichou"}));
                        set("long",HIW"极其罕见的冰蚕丝绸。"NOR"\n");
                        break;
                case 9:
                ...
                case 10:
                	...
                	set("long",HIY"一种形如盘龙的毒蚕所产之丝所制丝绸。"NOR"\n");
                	break;                
                case 11:
                        set_name(MAG"波斯彩绸"NOR, ({"bosi caichou","caichou","bosicansi","chou"}));
                        set("long",MAG"这是一匹从西域波斯运来的波斯彩绸。"NOR"\n");
                        break;
        }
}
