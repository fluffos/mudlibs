...
void change_state()
{
        ...
        switch (query_level()) {
                case 1:
                        ...
                        set("long",GRN"斑斑铜锈绿中透着古意，这是一块青铜。"NOR"\n");
                        break;
                case 2:
                        set_name(YEL"生铁"NOR, ({"shengtie"}));
                        set("long",YEL"乌亮两色集与一身，这是矿工常用的生铁。"NOR"\n");
                        break;
                case 3:
                        set_name(YEL"软铁"NOR, ({"ruantie"}));
                        set("long",YEL"这种产自南方的软铁，质地不如生铁坚硬，但却韧性更足。"NOR"\n");
                        break;
                case 4:
                        set_name(HIG"绿石"NOR, ({"lushi"}));
                        set("long",HIG"绿石原产云南，石中带骨，声如洪种，是打造上乘武器的原料。"NOR"\n");
                        break;
                case 5:
                        set_name(RED"流花石"NOR, ({"liuhuashi"}));
                        set("long",RED"其色斑斓，其质刚劲，其型瑞合，是为流花石也。"NOR"\n");
                        break;
                case 6:
                        set_name(HIW"软银"NOR, ({"ruanyin","ruanying"}));
                        set("long",HIW"这种金属外柔而内刚，卸劲于无形，因为色白，江湖人称软银。"NOR"\n");
                        break;
                case 7:
                        set_name(HIY"金铁"NOR, ({"jintie"}));
                        set("long",HIY"有三分金，五分铁，两分黑石，传说中的金铁极其罕见。"NOR"\n");
                        break;
                case 8:
                        set_name(RED"万年神铁"NOR, ({"shentie"}));
                        set("long",RED"铁入地母，沉睡百年以上而有魂，人们称赞之为“万年神铁”。"NOR"\n");
                        break;
                case 9:
                        set_name(WHT"玄铁"NOR, ({"xuantie"}));
                        set("long",WHT"此铁原产瑶池仙境，随恶煞气洒落人间，内含玄机无数，凡人莫能知其究竟。"NOR"\n");
                        break;
                case 10:
                	set_name(HIC"万年寒冰铁"NOR, ({"hantie"}));
                        set("long",HIC"不知出处，铁质冰寒，消魂噬骨，有万年造化之力的一块寒冰铁。"NOR"\n");
                        break;
        }
