...
nosave mapping *wudang_message = ({
	...
	([
		...
		"prompt":HIY"掌门张真人已传下号令，马上召开武当重要会议，请您尽快赶到武当山三清殿。"NOR"\n",
		"send_to" :"各位武当弟子请了！",
...
nosave mapping *xingxiu_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"星宿老仙已传下号令，马上召开星宿派百仙大会，请您尽快赶到星宿海日月洞。"NOR"\n",
		"send_to" :"各位星宿弟子听了！",
...
nosave mapping *huashan_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"岳掌门已传下号令，令华山弟子人速华山正气堂召开门派评定大会。"NOR"\n",
		"send_to" :"各位华山弟子请了！",
...
nosave mapping *taohua_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"桃花岛主黄药师已经传下号令，令东邪门人速回太湖归云庄，在大厅侯命。"NOR"\n",
		"send_to" : "凡我东邪门人听了",
...
nosave mapping *gaibang_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"洪帮主已传下号令，马上召开改帮大会，请您尽快赶到扬州总舵。"NOR"\n",
		"send_to" : "各位丐帮英雄请了！",
...
nosave mapping *emei_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"掌门灭绝师太已经传下法旨，令峨嵋弟子速回峨嵋山华藏庵大雄宝殿召开掌教大会。"NOR"\n",
		"send_to" : "峨嵋弟子听了！",
...
nosave mapping *baituo_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"欧阳主人已经传下命令，令白驼弟子速回西域白驼山庄召开评议大会。"NOR"\n",
		"send_to" : "白驼山弟子听了！",
...
nosave mapping *quanzhen_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"掌门丘真人已经传下法旨，令全真弟子速回终南山重阳宫长春殿召开掌教大会。"NOR"\n",
		"send_to" : "全真教徒听了！",
...
nosave mapping *xueshan_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"大轮寺的钟声已经响起，催促各喇嘛们回到大轮寺广场召开宏法大会。"NOR"\n",
		"send_to" : "各位雪山派喇嘛听旨！",
...
nosave mapping *dali_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"段王爷已经传下旨意，令大理段家之人速回王府大殿，召开王府大会。"NOR"\n",
		"send_to" : "各位大理段家的英雄请了！",
...
nosave mapping *shaolin_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"方丈大师已经传下法旨，招少林弟子速回少林寺，在大雄宝殿召开少林大会。"NOR"\n",
		"send_to" : "阿弥陀佛！！",
