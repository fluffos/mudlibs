...
nosave mapping	SPECIAL_B = ([
	...
	"wield_neili":	       1500,
	"wield_str":	       50,
	"wield_msg":	       HIG"\n$N将手在风中一挥，无数的火星从四方飞来，渐渐聚在一起～～～一柄$n"HIG"已经出现在$P手中！"NOR"\n",
	"unwield_msg":	       HIG"\n$N将$n"HIG"随手一扔，只见$n"HIG"突然变得火红，化做无数的火星四散飘走了！"NOR"\n",
	"dur":                 5000,
	]);
nosave mapping	SUPER_B	= ([
	...
	"wield_neili":	       1200,
	"wield_str":	       39,
	"wield_msg":	       HIW"\n$N将手一挥，一柄$n"HIW"从身后飞出，电光一闪，已经握在了$P手中。"NOR"\n",
	"unwield_msg":	       HIW"\n$N将手中的$n"HIW"一弹，电光闪耀中，已不见了$n"HIW"的踪迹。"NOR"\n",
	"dur":                 4500,
	]);
...
nosave mapping	Super_Class = ([
	HIM"轩辕" : ([	"id":	"xuanyuan",
			"long2": HIM"昔日黄帝持此物立于指南车上，驱迷雾，扫阴霾，率应龙旱魃，御百兽而战蚩尤！"NOR"\n",
		]),
	HIR"神通" : ([	"id":	"shentong",
			"long2":	HIR"天兵神通，走势要平善，气要随行，两眼顾尖，气沉两足稳，
身法需自然，身行如飞燕，身落如停风，收如花絮，刺如钢钉！"NOR"\n",
		]),
	HIG"无极" : ([	"id":	"wuji",
			"long2": HIG"此物已达出神入化，登峰造极，神乎其神之境界！俗说万物归宗，便是这“无极”！"NOR"\n",
		]),
	HIW"八卦" : ([	"id":	"bagua",
			"long2": HIW"八卦有“休”“生”“伤”“杜”“死”“景”“惊”“开”之别，创自诸葛武候，集天下万变于一身！"NOR"\n",
		]),
	HIB"乔依乌斯" :	([	"id":	"joeywus",
			"long2": HIB"在西方查理曼统治的时代，最简朴的剑也能值三头母牛的价钱。而查理大帝自己的那把传奇式的神兵“乔依乌斯”据说是半人半神的“韦兰铁匠”所造，乃当世界神兵！"NOR"\n",
		]),
	HIW"太白" : ([	"id":	"taibai",
			"long2": HIW"赵客缦胡缨  吴钩霜雪明    银鞍照白马  飒沓如流星
十步杀一人  千里不留行    事了拂衣去  深藏身与名
闲过信陵饮  脱剑膝前横    将炙口朱亥  持觞劝侯嬴
三杯吐然诺  五狱倒为轻    眼花耳热後  意气素霓生
救赵挥金槌  邯郸先震惊    千秋二壮士  喧赫大梁城
纵死侠骨香  不惭世上英    谁能书阁下  白首太玄经"NOR"\n",
		]),
	HIY"乾坤" : ([	"id":	"qiankun",
			"long2": HIY"此物左右两边分别以黑白两种奇铁溶铸而成，一黑一白，切合乾坤，包含阴阳之气，好一柄宝物！"NOR"\n",
		]),
	HIY"太极" : ([	"id":	"taiji",
			"long2": HIY"太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。
人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而理为一贯！"NOR"\n",
		]),
	HIC"天地" : ([	"id":	"tiandi",
			"long2": HIC"天地之初，女娲补天所留下的天地间至尊之物之一经千秋万载所制，功能开天劈地！"NOR"\n",
		]),
	HIM"风云" : ([	"id":	"fengyun",
			"long2": HIM"所谓风云际会，天地变色！仗此行千里，老魔小丑，岂堪一击！"NOR"\n",
		]),
	HIG"浩气" : ([	"id":	"haoqi",
			"long2": HIG"天地浩气之神兵，扫魔除妖，为国为民，侠之大者！"NOR"\n",
		]),
	HIR"炼狱" : ([	"id":	"lianyu",
			"long2": HIR"三十三天下有地，地下有城，城名鬼城，大小妖魔，人神畜生都在此轮回往返，谓之“炼狱”！"NOR"\n",
		]),
	HIC"三清" : ([	"id":	"sanqing",
			"long2": HIC"大道无名，聚气成形，功参造化，一是三清！这便是“老子一罡化三清。”"NOR"\n",
		]),
	HIC"昆仑" : ([	"id":	"kunlun",
...
nosave mapping	Armor_Special_Class =	([
	"cap":	([
		YEL"青龙头盔"NOR : ([
			"id":		"qinglong toukui",
			"long2":	YEL"飞龙在天之宝器。"NOR"\n",
			"armor_prop":	([ "armor":30 , "dexerity":2 ]),
			]),
		HIW"白虎头盔"NOR : ([
			"id":		"qinglong toukui",
			"long2":	HIW"坚固无比之上古宝器。"NOR"\n",
			"armor_prop":	([ "armor":50 ]),
			]),
		RED"莫邪头盔"NOR : ([
			"id":		"moye toukui",
			"long2":	RED"莫邪开天辟地，百毒不侵，为古代辟邪之物！"NOR"\n",
	...
	"boot": ([
		HIW"飞云靴"NOR : ([
			"id":		"feiyun xue",
			"long2":	HIW"飞龙在天，纵横天下之宝靴！"NOR"\n",
			"armor_prop":	([ "armor":25 , "dexerity":3 ]),
			]),
		HIY"天龙靴"NOR : ([
			"id":		"tianlong xue",
			"long2":	HIY"坚固无比之上古宝器。"NOR"\n",
			"armor_prop":	([ "armor":40 ]),
			]),
		HIR"工布靴"NOR : ([
			"id":		"gongbu xue",
	...
	"belt": ([
		HIW"飞天腰带"NOR : ([
			"id":		"feitian yaodai",
			"long2":	HIW"飞翔于九天之外之宝器！"NOR"\n",
			"armor_prop":	([ "armor":25 , "dexerity":2 ]),
			]),
		HIB"辟邪腰带"NOR : ([
			"id":		"pixie yaodai",
			"long2":	HIB"辟邪除魔之震妖宝器！"NOR"\n",
			"armor_prop":	([ "armor":25 , "constitution":2 ]),
			]),
		RED"湛卢腰带"NOR : ([
			"id":		"zhanlu yaodai",
			"long2":	RED"湛卢坚固无比，乃千古神器！"NOR"\n",
			"armor_prop":	([ "armor":40 ]),
			]),
		RED"胜邪腰带"NOR : ([
			"id":		"shengxie xue",
	...
	"coat": ([
		...
		RED"太阿彩衣"NOR : ([
			"id":		"taie caiyi",
			"long2":	RED"太阿帝王之器，持之能号令天下，莫有不从！"NOR"\n",
			"armor_prop":	([ "armor":90 , "qi":1000 , "jing":500 ]),
			]),
		RED"湛卢彩衣"NOR : ([
			"id":		"zhanlu caiyi",
			"long2":	RED"湛卢坚固无比，乃千古神兵！"NOR"\n",
...
纵死侠骨香  不惭世上英    谁能书阁下  白首太玄经"NOR"\n",
	...
	HIY"乾坤" : ([	"id":	"qiankun",
			"long2": HIY"此物左右两边分别以黑白两种物质融会而成，一黑一白，切合乾坤，包含阴阳之气，好一见宝物！"NOR"\n",
		]),
	HIY"太极" : ([	"id":	"taiji",
			"long2": HIY"太极者，无极而生，阴阳之母也。动之则分，静之则合。无过不及，随曲就伸。
人刚我柔谓之走，我顺人背谓之粘。动急则急应，动缓则缓随。虽变化万端，而理为一贯！"NOR"\n",
