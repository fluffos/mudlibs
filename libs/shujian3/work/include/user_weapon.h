...
RED"太阿" : ([	"id": ({ "taie jian", "taie", "sword", "jian" }),
		"long2"	: RED"太阿宝剑，帝王之兵，持之能号令天下，莫有不从！"NOR"\n",
...
RED"巨阙" : ([	"id": ({ "juque jian", "juque", "sword", "jian" }),
		"long2"	: RED"巨阙宝剑，坚硬无比，能开天辟地，荡妖除魔！"NOR"\n",
		"weapon_prop/damage":  270,
		"sharpness":	       7,
		"rigidity":	       20,
		]),
RED"纯钩" : ([	"id": ({ "chunjun jian", "chunjun", "sword", "jian" }),
		"long2"	: RED"纯钩宝剑，将帅之兵，持之能挥军百万，克敌制胜！"NOR"\n",
		"weapon_prop/damage":  150,
...
RED"湛卢" : ([	"id": ({ "zhanlu jian", "zhanlu", "sword", "jian"	}),
		"long2"	: RED"湛卢宝剑，威力、锋利、坚硬都冠绝当世，乃千古神兵！"NOR"\n",
		"weapon_prop/damage":  290,
		"sharpness":	       12,
		"rigidity":	       12,
		]),
RED"工布" : ([	"id": ({ "gongbu jian", "gongbu", "sword", "jian" }),
		"long2"	: RED"工布宝剑，天生怪异，功能参商！"NOR"\n",
		"weapon_prop/damage":  150,
...
的神兵“乔依乌斯”据说是半人半神的“韦兰铁匠”所造，乃当世界神兵！"NOR"\n",
		]),
	HIW"太白" : ([	"id":	"taibai",	
			"long2": HIW"
