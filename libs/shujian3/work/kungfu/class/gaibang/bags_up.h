...
"道德经", "沙袋", HIM"粉红绸衫"NOR,
"围棋",
"玉箫","金刚经","七伤拳谱","太极十三势","虎皮","肘後备急方","灰狼皮","硫磺"
HIW"银钥匙"NOR,"鱼篓","绣花针","铁罗汉","刀法概要","图画","玉真散","回阳五龙膏","寓意草"
YEL"千年首乌"NOR,"竹哨","星宿毒经","摩诃僧诋律"
*/
...
int ask_bag()
{
	...
	if ((me->query("job_time/丐帮") + me->query("job_time/报效国家") + me->query("job_time/抓蛇")) <  100 * bag ) {
