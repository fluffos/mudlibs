...
void create()
{
        ...
        set("per", 30);
        set("str", 30);
        set("long","一只在岛上修炼多年业已成精的狐狸。\n");
        set("combat_exp", 50000000);
        set("daoxing", 50000000);
        set_skill("literate", 300);        
        set_skill("force", 400+random(150));
        set_skill("moonforce", 400+random(150));
        set_skill("moonshentong", 400+random(150));
        set_skill("spells", 400+random(150));
        set_skill("snowsword", 400+random(150));
        set_skill("xuanhu-blade",400+random(150));
        ...
        set_skill("baihua-zhang", 400+random(150));        
        set_skill("moondance", 400+random(150)); 
