...
void create()
{
        set_name("狐狸精", ({"huli jing", "head"}));        
        set("title", HIW"狐狸头领"NOR);
        set("gender", "女性" );
        set("taskguai",1);
        set("age", 45);
        set("per", 30);
        set("str", 30);
        set("long","一只在岛上修炼多年业已成精的狐狸，它是狐狸中的头领。\n");
        set("attitude", "aggressive");
        set("combat_exp", 80000000);
        set("daoxing", 80000000);
        set_skill("literate", 400);        
        set_skill("force", 600+random(150));
        set_skill("moonforce", 600+random(150));
        set_skill("moonshentong", 600+random(150));
        set_skill("spells", 600+random(150));
        set_skill("snowsword", 600+random(150));
        set_skill("xuanhu-blade",600+random(150));
        ...
        set_skill("baihua-zhang", 600+random(150));        
        set_skill("moondance", 600+random(150));               
