...
void create()
{
        set_name("头狼", ({"tou lang", "head"}));        
        set("title", HIW"野狼头领"NOR);
        set("gender", "男性" );
        set("taskguai",1);
        set("age", 45);
        set("per", 30);
        set("str", 30);
        set("long","一只在岛上修炼多年业已成精的豺狼，它是狼群的头领。\n");
        set("attitude", "aggressive");
        set("combat_exp", 80000000);
        set("daoxing", 80000000);
        set_skill("literate", 300);        
        set_skill("force", 600+random(150));
        set_skill("zhenyuan-force", 600+random(150));
        set_skill("taiyi", 600+random(150));
        set_skill("spells", 600+random(150));
        set_skill("sanqing-jian", 600+random(150));
        set_skill("xiaofeng-sword",600+random(150));
        ...
        set_skill("wuxing-quan", 600+random(150));        
        set_skill("baguazhen", 600+random(150));               
