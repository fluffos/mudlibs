...
string *list=({
        "baowang","foxhead","huwang","pighead","wolfhead",
});
...
LONG);
        ...
        set("exits", ([ /* sizeof() == 4 */  
                "north":__DIR__"fangzhudao17",
                "west":__DIR__"fangzhudao18",
                "east" : __DIR__"fangzhudao19",
                "southeast":__DIR__"fangzhudao11",
        ]));
        set("objects", ([  
                __DIR__"npc/head/pighead" : 1,
        ]));
        ...
        if (this_object()->query_temp("npc_times")>10){
                ...
                if(this_object()->qurey("npc_num")> 0){
                        for(i=0;i<this_object()->query("npc_num");i++) { 
                                guai = new("/d/quest/fangzhudao/npc/head/"+list[random(sizeof(list))]);
