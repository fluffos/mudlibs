void skill_set1(object ob, int level)
{
	...
	case "星宿派拍马手" :
		...
		weapon=new("/d/xingxiu/obj/gangzhang.lpc");
		weapon->move(ob);
		weapon->wield();
		break;
	case "华山派弃徒" :
		...
		case 0 :
			...
			weapon=new("/d/city/obj/gangdao.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		case 1 :
			...
			weapon=new("/d/city/obj/gangjian.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		}
	...
	case "雪山派小喇嘛" :
		...
		case 0 :
			...
			weapon=new("/d/xueshan/obj/miandao.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		case 1 :
		...
		case 2 :
			...
			weapon=new("/d/xueshan/obj/fachu.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		}
	...
	case "丐帮恶贼" :
		...
		weapon=new("/d/city/obj/zhubang.lpc");
		weapon->move(ob);
		weapon->wield();
		break;
	case "五毒教打手" :
		...
		weapon=new("/clone/weapon/hook.lpc");
		weapon->move(ob);
		weapon->wield();
		break;
	}
...
void skill_set2(object ob, int level)
{
	...
	case "西域少林恶僧" :
		...
		case 2 :
			...
			weapon=new("/clone/weapon/qimeigun.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		}
...
void skill_set3(object ob, int level)
{
	...
	case "西域少林高僧" :
		...
		case 1 :
			...
			weapon=new("/clone/weapon/changbian.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		case 2 :
	...
	case "雪山派喇嘛" :
		...
		case 1 :
			...
			ob->map_skill("sword","mingwang-jian");
			ob->map_skill("parry","mingwang-jian");
			weapon=new("/clone/weapon/gangjian.lpc");
			weapon->move(ob);
			weapon->wield();
			break;
		}
