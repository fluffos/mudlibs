//update by troy 2002.1.1 add 古墓
//job_family_master.h
//产生任务发布人名单
...
nosave mapping family_skills_award=([
					  ...
					  "古墓派"	:({"yunu-xinjing","yunu-jianfa","feiyan-gong"}),
					  ]);
...
nosave mapping *gumu_message = ({
	...
	([
		"job_tell_mode":"oppose_pker",
		"pk_npc" : "$N说道:“近日在$ROOM附近有人杀我古墓弟子，你速去将其除去。”\n"
		]),
	([
		"job_tell_mode":"award",
		"opposepk_award" : "$N说道:“辛苦你了，$P，你为本门立下了一功。”\n"
		...
		"kick_out_player": "$N将$n赶了出去。\n",
		"family":"$N说道：“想我古墓武功自称一派，江湖中那个不惧？哈哈哈......”\n",
		"assess_start":"$N说道：“好，现在开始。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为我古墓派闯下不小威名，我将传授古墓武功精髓于你！”\n",
		"assess_punish":"$N说道：“$P，你数次违我命令，该当严惩！”\n",
