 ...
 * 本文件已经被JACKYBOY针对中文LPMUD做过适应性修改。
 * 有任何疑问，请访问http://mud.yn.cninfo.net/jackyboy
 */

/* seclect options by bigfoot */
 ...
 * arguments were ("/read_buffer.lpc")
...
#define DEFAULT_PRAGMAS PRAGMA_STRICT_TYPES + PRAGMA_WARNINGS + PRAGMA_ERROR_CONTEXT + PRAGMA_SAVE_BINARY + PRAGMA_OPTIMIZE 
 ...
 */
#define FLUSH_OUTPUT_IMMEDIATELY
 ...
 */
#define LARGEST_PRINTABLE_STRING 32768
...
#define CFG_EVALUATOR_STACK_SIZE        10000
#define CFG_COMPILER_STACK_SIZE         4000
