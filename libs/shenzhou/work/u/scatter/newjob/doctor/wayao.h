...
int do_search(string arg)
{
                  ...
                  if( !present("chanzi", me) )
                                         return notify_fail("你没有工具，无法拨开灌木山草寻找草药！\n");

                  if( (int)me->query("jingli") < 1 )
...
int do_dig(string arg)
{
                  ...
                  if(me->query_temp("newjob/wayao",1))
                  {
                          exp = 50+random(50);
