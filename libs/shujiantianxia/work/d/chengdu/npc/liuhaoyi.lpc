...
int ask_question()
{
	...
	if (me->query_temp("qipu_guess_win"))
		...
		write("刘好弈道：“题目是这样的：我有一套" + CHINESE_D->chinese_number(BOOKNUM) + "册《梅花谱》，而书房里有" + CHINESE_D->chinese_number(SHELFNUM) + "个书架，\n");
		write("现在我把这" + CHINESE_D->chinese_number(BOOKNUM) + "册书分别放到不同的书架上去，你只需猜出来每册书放在那个书架上即可。\n");
	}
