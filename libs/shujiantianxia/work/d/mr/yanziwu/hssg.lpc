...
void create()
{
         ...
         set("long",
"这就是举世闻名的姑苏慕容的还施水阁，这里据说有很多武林人事向往以\n"
"久的武功。只见墙上有一个书架子(shujia)，上面摆满了各种武籍。\n"
);
	set("exits",([
		"south" : __DIR__"jiabi",
	]));
...
int do_kan(string arg)
{
	...
	if ( !living(this_player()) || arg != "miji" )
		return notify_fail("你要在这里干什么？发呆？\n");
	...
	if ( (int)me->query_skill("literate", 1) < 160)
	...
	if ((int)me->query_skill("douzhuan-xingyi", 1) < 160)
	...
	me->improve_skill("douzhuan-xingyi", me->query_skill("literate")/4);
	return 1;
}
