...
void create()
{
	...
	set ("long",@long
后花园和庄中其它地方一样种满了山茶花, 参杂在假山巨石, 绿竹小溪中,
此所谓：“千呼万唤始出来，犹报琵琶半遮面”更增姿媚。抬头望去，只见藏
书阁的窗户半开着，一根古藤蜒伸在墙上。一股清泉从假山上涌出，尝一口沁
人心脾。
long);
...
int do_say(string arg)
{
	...
	tell_room(environment(me), me->name()+"从暗门走了出来。\n", me);
	return 1;
}
...
int do_pa(string arg)
{
	...
	if ( arg =="teng"){ 
		...
		message("vision", me->name() + "从沿着树藤爬了上来。\n", environment(me), ({me}) );
	}
	return 1;
}
