...
LONG                           
	...
	set("exits", ([               
		...
		"south" : __DIR__"conglin"+(random(4)+9),
		"north" : __DIR__"conglin9",
		"northeast" : __DIR__"conglin"+(random(12)+1),
		"northwest" : __DIR__"conglin"+(random(4)+5),
		"southeast" : __DIR__"conglin7",
		"southwest" : __DIR__"conglin"+(random(4)+9),
	]));
	set("outdoors", "武当");
