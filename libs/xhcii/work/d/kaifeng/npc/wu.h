...
#define DIRNAME "/d/kaifeng/"

#define MYFILE "/d/kaifeng/npc/wu??.lpc"
...
int accept_fight(object ob)
{
  ...
  object pang = present("qin chai",environment(me));

  if (! pang)
  {
    command ("say 包大人不在，如何比武也？\n");
    return notify_fail("还是请包大人来吧。\n");
  }
  ...
  {
    return notify_fail("看来包大人不允许你比武。\n");
  }
...
int check_result(object me, object ob)
{
  ...
  if (((int)me->query("kee")*100/(1+my_max_qi)) <= 50 )
  {
