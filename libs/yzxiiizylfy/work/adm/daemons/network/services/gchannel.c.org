...
inherit F_CLEAN_UP;
#define G_CHANNEL ({ "es","gwiz","gbwiz","wiz","lic","jh" })
#define BIG5_SITE  CONFIG_DIR+"big5_site"
nosave string *Big5;
nosave string channel_id="网路频道精灵";
//nosave string *ban_nodes = ({ "SDXL.CD","LJXY-WHU"});
nosave string *ban_nodes = ({"WLZBII","SDYXZ","HOUYUN","SUPER-MUD","J.H.Y.J","LDTX","WLLZ","XHC","DTXY","HC","YSYX","YS.BJ","YS.AH","SNOWSWORD.BJ","CENTURY","云起云落","JXQY","ajkd","XLQY","XHC_II","LSJH","HYL2000.SH","HYL2000-SH","HYL2000-ZZ","JHCQ.ET","XKJH","HYL2000.ZZ","XJQX","LDJ" });
...
if (member_array(upper_case(info["NAME"]),ban_nodes)!=-1){
