...
//added by Lxh@TXJH 2000.2.8
#define TOP_RICH     "/u/lxh/top/rich.txt"
#define TOP_PKER     "/u/lxh/top/pker.txt"
#define TOP_EXP      "/u/lxh/top/exp.txt"
#define RICH_B "铁血江湖十大富人排行榜"
#define PKER_B "铁血江湖十大杀人狂排行榜"
#define EXP_B  "铁血江湖十大高手排行榜"
#define TOP_D                "/u/lxh/topd"
// Daemons
...
#define THCASH_OB		"/obj/money/thousand-cash" //Add by Huang
#define GOLD_OB			"/obj/money/gold" //Add by Huang
...
#define HOCKSHOP_STORAGE        "/std/room/hockshop_storage" //add by Huang
...
// F_SSERVER: missing from this archive's globals.h (present in nearly
// every sibling ES II lib as "/feature/sserver.lpc", but this archive's
// copy actually lives at /std/sserver.lpc) -- 16 skill files
// `inherit F_SSERVER` and fail to compile without it.
#define F_SSERVER		"/std/sserver.lpc"
// Profiling switches
//
