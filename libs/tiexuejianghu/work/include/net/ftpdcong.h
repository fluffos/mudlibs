...
/* If this is defined, it should point to a fills
e that should be
...
#define FTP_BUGS_EMAIL "webmaster@public1.jy.js.cn"
...
#define FTP_USERS ({ "oldsix","xxy","panguan","china","mool","daniel","lxh"})
