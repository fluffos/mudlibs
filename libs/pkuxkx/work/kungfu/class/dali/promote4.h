...
void unconcious()
{
	...
	if (objectp(who = me->get_damage_origin_object()))	who->add("dali/trust", -1);
...
string ask_me_1()
{
	...
	obj = new("/d/dalicheng/obj/allow-letter2");
...
{
	object room=find_object("/d/dalicheng/wuhua2.lpc");
...
int accept_fight()
{
	...
	if ( mapp(skill_status = me->query_skills()) )
	{
		...
		obj->set_skill("kurong-shengong", s_level);
		...
		obj->map_skill("force","kurong-shengong");
...
void reset(object me)
{
	...
	me->set_skill("kurong-shengong", 90);
	...
	me->map_skill("force","kurong-shengong");
...
int do_taojiao(string arg)
{
	...
	if (arg!="kurong-shengong" && arg!="duanjia-jian" && arg!="duanshi-shenfa" && arg!="buddhism" && arg!="jinyu-quan") return notify_fail("高升泰根本不会这门功夫，无法指导你。\n");
