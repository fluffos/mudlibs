...
"神色，显然对当年的剑宗气宗之争一直难以忘怀。\n");
	...
	set_skill("zixia-shengong", 950);
	set_skill("poyu-quan", 970);
	set_skill("fanliangyi-dao", 980);
    set_skill("huashan-sword", 900);
	set_skill("hunyuan-zhang", 970);
    set_skill("lonely-sword", 900);
    set_skill("feiyan-huixiang",960);
	set_skill("literate", 920);
