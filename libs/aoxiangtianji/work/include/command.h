...
#define APR_PATH ({"/cmds/app/", "/cmds/imm/", "/cmds/usr/","/cmds/std/", "/cmds/skill/"})
#define IMM_PATH ({"/cmds/imm/", "/cmds/usr/","/cmds/std/", "/cmds/skill/"})
#define ELD_PATH ({"/cmds/eld/", "/cmds/usr/", "/cmds/std/","/cmds/skill/"})
...
#define TIME_TICK1      ((time()-1082000000)*60)
#define TIME_TICK       ((time()-1082000000)*60)
