...
int do_study(string arg)
{
	...
	switch (file_name(where))
	{
		...
		case "/d/xiakedao/shiroom20": item = 13; break;
		case "/d/xiakedao/shiroom21": item = 16; break;
		case "/d/xiakedao/shiroom22": item = 18; break;
		case "/d/xiakedao/shiroom23": item = 1; break;
		case "/d/xiakedao/shiroom24": item = 17; break;
		default: break;
	}
