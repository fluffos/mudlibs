...
#define ADM_PATH ({"/cmds/adm/", "/cmds/arch/", "/cmds/wiz/", "/cmds/imm/", "/cmds/usr/","/cmds/std/", "/cmds/skill/", "/cmds/pgr/", "/cmds/egr/"})
#define ARC_PATH ({"/cmds/arch/", "/cmds/wiz/", "/cmds/imm/", "/cmds/usr/","/cmds/std/", "/cmds/skill/", "/cmds/egr/", "/cmds/pgr/"})
#define WIZ_PATH ({"/cmds/imm/", "/cmds/usr/", "/cmds/std/", "/cmds/skill/", "/cmds/wiz/", "/cmds/egr/"})
#define PGR_PATH ({"/cmds/imm/", "/cmds/usr/", "/cmds/std/", "/cmds/skill/", "/cmds/pgr/","/cmds/egr/"})
#define EGR_PATH ({"/cmds/imm/", "/cmds/usr/", "/cmds/std/", "/cmds/skill/", "/cmds/egr/"})
