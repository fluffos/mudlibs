...
nosave mapping _set_commands(mapping commands);
nosave mapping _query_commands();


// internal
nosave int _execute(mixed fun, string str, mixed *parsed);
nosave int _process_command(string str, string *noparsestr, mixed fun,
