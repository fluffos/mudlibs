...
nosave int     _query_attack_busy();
nosave int     _query_free_hands();
nosave mixed   _query_hands();
nosave mixed  *_query_hands_used_by();
nosave mapping _query_resistance_strengths();
nosave int     _query_total_ac();
nosave int     _query_total_wc();
nosave int     _query_used_hands();
nosave int     _set_attack_busy(mixed val);
nosave int     _set_disable_attack(int val);
nosave mixed   _set_hands(mixed h);
nosave mixed   _set_resistance(mixed arg);
nosave int     _set_used_hands(int new_num);
nosave mixed   _set_vulnerability(mixed arg);
nosave int     _set_wimpy(int i);
