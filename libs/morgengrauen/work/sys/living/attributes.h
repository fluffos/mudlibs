...
nosave mapping _set_attributes(mapping arr);
nosave mapping _query_attributes();
nosave mapping _set_attributes_offsets(mapping arr);
nosave mapping _query_attributes_offsets();
nosave mixed   _set_attributes_modifier(mixed arr);
nosave mapping _query_attributes_modifier();
nosave mixed _query_timed_attr_mod();
