...
nosave mapping _set_exits(mapping map_ldfied) ;
nosave mapping _query_exits();
nosave int _set_special_exits(mapping map_ldfied);
nosave mapping _query_special_exits();
nosave string _MakePath(string str);
