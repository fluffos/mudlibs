...
nosave  void http_error(int fd, mapping err);
nosave  void add_activity(int fd, string str);
void close_connection(int fd);
nosave  void get_file(int fd, string file);
nosave  string format_date(int x);
