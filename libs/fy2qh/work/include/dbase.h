...
mixed set_pawn(string prop, mixed data);
mixed set_vpawn(string prop, mixed data);
mixed set_fpawn(string prop, mixed data);
mixed set_temp_vector(string prop, mixed owner, mixed func);
varargs mixed query_temp(string prop, int raw);
varargs mixed query_pawn(string prop, int raw);
varargs mixed query_vpawn(string prop, int raw);
varargs mixed query_fpawn(string prop, int raw);
mixed add_temp(string prop, mixed data);
int delete_temp(string prop);
int delete_pawn(string prop);
int delete_vpawn(string prop);
int delete_fpawn(string prop);
