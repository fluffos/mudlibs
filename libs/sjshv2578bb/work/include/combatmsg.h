...
string eff_status_msg(int ratio) {
  ...
  if (ratio > 60) return HIY "受伤不轻，看起来状况并不太好。" NOR if (ratio > 40) return HIR "气息粗重，动作开始散乱，看来所受的伤着实不轻。" NOR if (ratio > 30) return HIR "已经伤痕累累，正在勉力支撑着不倒下去。" NOR if (ratio > 20) return HIR "受了相当重的伤，只怕会有生命危险。" NOR if (ratio > 10) return RED "伤重之下已经难以支撑，眼看就要倒在地上。" NOR if (ratio > 5) return RED "受伤过重，已经奄奄一息，命在旦夕了。" NOR return RED "受伤过重，已经有如风中残烛，随时都可能断气。" NOR string status_msg(int ratio
