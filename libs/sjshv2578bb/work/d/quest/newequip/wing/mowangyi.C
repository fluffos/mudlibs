...
void create()
{
        set_name(HIB"魔王翼"NOR, ({"mowang yi", "wing"}));
        set_weight(3000);
        if( clonep() )
                ...
                if(random(10)==1){
                	set("armor_prop/attack",random(60));     
                	set("armor_prop/defense",random(30));     
                }    	
                else if(random(10)==8){
                	set("armor_prop/attack",random(30));
                	set("armor_prop/defense",random(60));
                }              	
                else{
                	set("armor_prop/attack",random(30));
                	set("armor_prop/defense",random(30));    
