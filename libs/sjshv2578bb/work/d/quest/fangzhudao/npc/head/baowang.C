...
void create()
{
        set_name("金钱豹", ({"jinqian bao", "head"}));        
        set("title", HIW"豹群头领"NOR);
        set("gender", "男性" );
        set("taskguai",1);
        set("age", 45);
        set("per", 30);
        set("str", 30);
        set("long","一只在岛上修炼多年业已成精的金钱豹，它是豹群中的头领。\n");
        set("attitude", "aggressive");
        set("combat_exp", 80000000);
        set("daoxing", 80000000);
        set_skill("literate", 300);        
        set_skill("force", 600+random(150));
        set_skill("zixia-shengong", 600+random(150));
        set_skill("taoism", 600+random(150));
        set_skill("spells", 600+random(150));
        set_skill("shushan-jianfa", 600+random(150));
        set_skill("yujianshu",600+random(150));
        set_skill("dodge", 600+random(150));
        set_skill("parry", 600+random(150));     
        set_skill("sword", 600+random(150)); 
        set_skill("unarmed", 600+random(150));
        set_skill("hunyuan-zhang", 600+random(150));        
        set_skill("sevensteps", 600+random(150));               
