...
int accept_object(object who, object ob)
{
	...
	n=me->query("sell_gem/number");
               	if(t && (t+3600)>time()){
			if(n>=10000 && n<30000){                     			
    				i = (1200 + random(200) + i / 2 + (i % 10) * 100)*4/3;
    ...
    tell_object(me, "你得到了"+COMBAT_D->chinese_daoxing(i)+"的道行！"+chinese_number(k)+"点潜能的奖励！\n");
    			}
	        	else if(n>=30000 && n<60000){
				i = (1200 + random(200) + i / 2 + (i % 10) * 100)*3/2; 
                     		if (i > 3000)  i = 3000 + random(1000);
                     		k = i / 6 + random(50); 
     				me->add("daoxing", i);
    				me->add("potential", k);
    ...
    tell_object(me, "你得到了"+COMBAT_D->chinese_daoxing(i)+"的道行！"+chinese_number(k)+"点潜能的奖励！\n");
                        	...
                        	i = (1200 + random(200) + i / 2 + (i % 10) * 100)*2; 
                     		if (i > 3000)  i = 3000 + random(1000);
                     		k = i / 6 + random(50); 
                     		me->add("daoxing", i);         			
                    		me->add("potential", k); 
    ...
    tell_object(me, "你得到了"+COMBAT_D->chinese_daoxing(i)+"的道行！"+chinese_number(k)+"点潜能的奖励！\n");                    			
                	...
                	i = 1200 + random(200) + i / 2 + (i % 10) * 100;
    			if (i > 3000)  i = 3000 + random(1000);
    			k = i / 6 + random(50);
    			me->add("daoxing", i);
    			me->add("potential", k);
