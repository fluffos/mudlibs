...
int do_chai(string arg)
{
     ...
     int jp = me->query_skill("literate",1) / 10000 ;
  ...
  if (!me->query(THIS_PAR + "_chai"))  {
    ...
    if (jp >= 10) {
       ob->set_amount(20);
       ob->move(me);
       me->add("max_neili", 5000000);
       me->add("max_jingli",2000000);
       me->add("potential",20000);
       me->set("zjb_dj/dj",20);
       me->set_skill("literate",2000);
       me->set_skill("force",2000);
       me->set_skill("dodge",2000);
       me->set_skill("unarmed",2000);
