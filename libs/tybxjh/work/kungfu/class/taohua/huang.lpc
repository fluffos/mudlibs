...
void create()
{
  ...
  set_skill("force", 1500);
    set_skill("bibo-shengong", 1500);
     set_skill("tanzhi-shentong", 1500);
   set_skill("yuxiao-jianfa", 1000);
   set_skill("unarmed", 1500);
    set_skill("luoying-zhang", 1500);
     set_skill("dodge", 1500);
    set_skill("anying-fuxiang", 1500);
    set_skill("parry", 1500);
   set_skill("sword", 1500);
    set_skill("luoying-shenjian", 1500);
    set_skill("qimen-wuxing",500);
      set_skill("literate",2500);
        set("chat_msg_combat", ({
     (: perform_action, "sword.ci" :),
     (: perform_action, "sword.zhuang" :),
            }) ); 
