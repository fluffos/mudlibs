...
void create()
{
    ...
    create_family("白驼山派",4,"叛徒");
        ...
        carry_object("/quest/quest_pk/obj/sword")->wield();
}
void die()
{
        object ob, me, corpse;
   ...
   message_vision(WHT"$N的大叫一声！喷出几口黑血，死了。\n"NOR,ob,me);
