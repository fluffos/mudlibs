...
#define BLK ESC+"[0;2;30m"          /* Black    */
#define RED ESC+"[0;2;31m"          /* Red      */
#define GRN ESC+"[0;2;32m"          /* Green    */
#define YEL ESC+"[0;2;33m"          /* Yellow   */
#define BLU ESC+"[0;2;34m"          /* Blue     */
#define MAG ESC+"[0;2;35m"          /* Magenta  */
#define CYN ESC+"[0;2;36m"          /* Cyan     */
#define WHT ESC+"[0;2;37m"          /* White    */
...
#define HBRED ESC+"[41m"       /* Red      */
#define HBGRN ESC+"[42m"       /* Green    */
#define HBYEL ESC+"[43m"       /* Yellow   */
#define HBBLU ESC+"[44m"       /* Blue     */
#define HBMAG ESC+"[45m"       /* Magenta  */
#define HBCYN ESC+"[46m"       /* Cyan     */
#define HBWHT ESC+"[47m"       /* White    */
...
#define NOR ESC+"[0;2;37;40m"      /* Puts everything back to normal */
