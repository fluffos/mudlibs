...
int do_get(string arg)
{
  ...
  if(present(arg1, me) || present(arg1, environment()))
    ...
    switch (arg1){
          case "book": ob=new("/u/quanzhen/obj/force_book"); break;             
          case "quan pu": ob=new("/u/quanzhen/obj/unarmed_book"); break;   
          case "jian pu": ob=new("/u/quanzhen/obj/sword_book"); break;         
          case "dodge book": ob=new("/u/quanzhen/obj/dodge_book"); break;         
          default :
