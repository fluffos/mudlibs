...
int main(object me)
{
  ...
  {
    case 0:
    caoyao = new("/d/zjb/obj/yao0");
    break;
    case 1:
    caoyao = new("/d/zjb/obj/yao1");
    break;
    case 2:
    caoyao = new("/d/zjb/obj/yao2");
    break;
    case 3:
    caoyao = new("/d/zjb/obj/yao3");
    break;
    case 4:
  caoyao = new("/d/zjb/obj/yao4");
    break;
    case 5: 
    caoyao = new("/d/zjb/obj/yao5");
    break;
    case 6:
    caoyao = new("/d/zjb/obj/yao6");
    break;
    case 7:
    caoyao = new("/d/zjb/obj/yao7");
    break;
    case 8:
    caoyao = new("/d/zjb/obj/yao8");
    break;
    case 9:
    caoyao = new("/d/zjb/obj/yao9");
    break;
   }
   me->start_busy(10);
   }
...
{
  case 0:
   caoyao = new("/d/zjb/yao/yao");
  break;
  case 1:
   caoyao = new("/d/zjb/yao/yao2");
  break;
}
   me->start_busy(7);
}
