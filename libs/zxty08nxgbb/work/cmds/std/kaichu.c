...
int main(object me, string arg)
{
        ...
        if( lp->query("bangzhu_id")!=me->query("id") &&
            me->query("tybang/zjb")<=player->query("tybang/zjb")){  
                destruct(lp);
