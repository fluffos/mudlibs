//new wizlist
//Modified by Bug@XHCII (09/28/2000)
// Updated by Zjb@TY 
...
int main(object me)
{
    ...
    write(HIG"〖"HIW + MUD_NAME + HIG"〗"NOR + "目前的开发组成员有：\n");
