...
int main(object me, string arg)
{
        ...
        if (times < 1 || times > 40)
                return notify_fail("练习次数最少一次，最多也不能超过四十次。\n");
   ...
   me->improve_skill(skillname, (skill_basic/7+1)*times);
                write( HIY "你把你的" + to_chinese(skillname) + "练了"+chinese_number(times)+"次,感觉进步了不少！\n" NOR);
