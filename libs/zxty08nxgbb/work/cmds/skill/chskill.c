...
#include <ansi.h>
inherit F_CLEAN_UP;
string *basic_skill = ({ "sword","blade","dagger","hook","stick","staff","club" ,"throwing",     
        "force","parry","dodge","magic","whip","axe","finger","hand","cuff","claw","strike",      
        "leg","unarmed","hammer",   });
int main(object me, string arg)
{
        ...
        if (!skl) return notify_fail("你目前并没有学会任何技能。\n");
         if (!skl[arg] && !wizardp(me))  return notify_fail("你不会这种技能。\n");
