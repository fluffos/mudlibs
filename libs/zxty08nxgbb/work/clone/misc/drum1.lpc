    ...
    if(sizeof(fighters)<8){
        if (query("loop")){
            ...
            if (stringp(query("drum_knocked"))){
              ...
              no1->set_skill("dodge",no1->query_skill("dodge",1)+10);
              no1->add("combat_exp",10000000);
              no1->add("potential",500000);
 message_vision(HIW"恭喜"+no1->name()+"获得本月新手组第一的宝座，同时也得到了因得的奖励!\n",no1);
              ...
              no2->set_skill("dodge",no2->query_skill("dodge",1)+5);
              no2->add("combat_exp",7000000);
              no2->add("potential",300000);
 message_vision(HIY"恭喜"+no2->name()+"获得本月新手组第二的宝座，同时也得到了因得的奖励!\n",no2);
              ...
              no3->add("combat_exp",5000000);
              no3->add("potential",200000);
message_vision(HIG"恭喜"+no3->name()+"获得本月新手组第三的宝座，同时也得到了因得的奖励!\n",no3);
