...
void greeting(object me)
{
        if (objectp(me) && environment(me) == environment())
                message_vision(CYN "$N" CYN "对$n" CYN "说道：这位" + RANK_D->query_respect(me)+"，可是想要打造武器吗？\n" NOR, this_object(), me);
}
