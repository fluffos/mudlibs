...
int do_dig()
{
    ...
    if( me->is_busy() || me->is_fighting() ) 
		...
		if ( random(1999)==1 && me->query("kar") > 100 && !ob->query("yuntie") )//获得陨铁
		...
		if ( random(999)==1 && me->query("kar") > 30 )//获得玄铁
		{
				...
				if ( random(888)>885 && me->query("kar") > 30 )//获得玄铁
		{
