...
"ml1","ml2","ml3","ml4","ml5","ml6","ml7","mudan",
            "nandajie1","nandajie2","nanmen","neizhai","pomiao",
            "qianzhuang","shuyuan","xidajie1","xidajie2","ximen",
            "xiting","xixiang","yamen","yaopu","yaopuls","ymzhengting",
...
*/
 "北京城" : ({"/d/city2/","alley1","alley2","alley3","anding","aobai1",
            ...
            "chaguan","chaoyan1","chaoyan2","chaoyang","datiepu",
            ...
            "mianguan","nandaj1","nandaj2","road1","road10",
            "road2","road3","road4","road5","road6","road7","road8",
            "road9","tuzai","wangfu1","wangfu2","wangfu3",
 ...
 "白驼山" : ({"/d/baituo/","bridge","cao1","cao2","caomeide","caoping",
            ...
            "neishi","nongshe",
            "shanlu","shanlu1","shijie","shulin","shulin1",
...
int place_room(object me,object ob)
{
  ...
  me->set_temp("gstart_rooms", site_file);
  ob->move(site_file);
