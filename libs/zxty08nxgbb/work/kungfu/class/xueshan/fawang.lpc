...
LONG
        ...
        set_skill("longxiang", 1500);
        set_skill("dodge", 1500);
        set_skill("shenkong-xing", 1500);
        set_skill("unarmed", 1500);
        set_skill("yujiamu-quan", 1500);
        set_skill("parry", 1500);
        set_skill("sword", 1500);
        set_skill("mingwang-jian", 1500);
        set_skill("mizong-xinfa", 1500);
        set_skill("literate", 2200);
        set_skill("hammer", 1500);
        set_skill("riyue-lun", 1500 );
