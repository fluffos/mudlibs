...
void create()
{
        ...
        set_skill("huntian-qigong", 1500);        // 混天气功
        set_skill("unarmed", 1000);               // 基本拳脚
        set_skill("xianglong-zhang", 1500);       // 降龙十八掌
        set_skill("dodge", 2000);                 // 基本躲闪
        set_skill("xiaoyaoyou", 1500);            // 逍遥游
...
"  叫化绝活 (begging)                       - 出类拔萃  250/   \n"+
"  道听途说 (checking)                      - 出类拔萃  250/   \n"+
"  基本轻功 (dodge)                         - 一代宗师  600/   \n"+
"  基本内功 (force)                         - 一代宗师  600/   \n"+
"□混天气功 (huntian-qigong)                - 一代宗师  650/   \n"+
"  基本招架 (parry)                         - 登峰造极  600/   \n"+
"  基本拳脚 (unarmed)                       - 一代宗师  600/   \n"+
"□降龙十八掌 (xianglong-zhang)             - 登峰造极  650/   \n"+
"□逍遥游 (xiaoyaoyou)                      - 一代宗师  650/   \n");
        return 1;
}
