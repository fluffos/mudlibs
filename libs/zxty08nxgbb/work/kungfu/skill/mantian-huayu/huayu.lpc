...
int perform(object me, object target)
{
        ...
        lvl = (int)me->query_skill("mantian-huayu", 1);
        ...
        msg = CYN "$N双手在背囊里一抓，抓出" + CHINESE_D->chinese_number(lvl / 20) + weapon->query("base_unit") + weapon->query("name") + "来，运用指力漫天地弹了出去，$n只觉眼前似乎在下一场暗器雨！\n";

        damage = lvl * 2 + (int)me->query_skill("tanzhi-shentong", 1);
