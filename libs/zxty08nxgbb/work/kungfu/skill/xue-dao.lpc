...
([      "action" : "$N就地一滚，使一招「"+RED+"刺血满地"+NOR+"」，手中$w卷向$n的大腿  ",
...
([      "action" : "$N使出一招「"+RED+"呕心沥血"+NOR+"」，将$w舞得如白雾一般压向$n  ",
        "skill_name" : RED "呕心沥血" NOR,
        "force" : 220,
        "dodge" : 5,
        "parry" : -5,
        "lvl" : 24,
...
([      "action" : "$N使出「"+RED+"血迹斑斑"+NOR+"」，飞身斜刺，忽然反手一刀横斩$n的腰部  ",
        "skill_name" : RED "血迹斑斑" NOR,
        "force" : 280,
        "dodge" : 10,
        "parry" : -5,
        "lvl" : 40,
...
([      "action" : "$N刀锋虚点，使出一招「"+RED+"血流满面"+NOR+"」，转身举$w横劈$n的面门  ",
        "skill_name" : RED "血流漫面" NOR,
        "force" : 320,
        "dodge" : 10,
        "parry" : -20,
        "lvl" : 56,
