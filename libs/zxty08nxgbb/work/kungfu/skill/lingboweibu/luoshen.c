...
int perform(object me, object target)
{
       ...
       if( (int) me->query_skill("beiming-shengong",1)<500 )
             return notify_fail("你的北溟神功不够娴熟，不能施展洛神。\n");
//     how can others pfm luoshen?
//       if (me->query_skill_mapped("force") != "beiming-shengong")
//                return notify_fail("你所使用的内功不对。\n");
       if (me->query_skill_mapped("dodge") != "lingboweibu")
       ...
       if( me->query_skill("lingboweibu") > 1000)
       {
           i= 10*((int)me->query("dex"));
           if( skill>2000) i= 15*((int)me->query("dex"));
       }else
       {
           i= (int)me->query("dex");
       }
