...
([  "action" : "$N身形往上一纵，使出一式「"+HIW+"天绅倒悬"+NOR+"」，双掌并拢，笔直地向$n的$l插去",
    "force" : 340,
    "lvl" : 40,
    "skill_name" : HIW "天绅倒悬" NOR,
        "damage_type" : "瘀伤"
]),
([  "action" : "$N身形一变，使一式「"+HIW+"无边落木"+NOR+"」，双掌带着萧刹的劲气，猛地击往$n的$l",
    "force" : 380,
    "lvl" : 50,
    "skill_name" : HIW "无边落木" NOR,
        "damage_type" : "瘀伤"
]),
([  "action" : "$N使一式「"+BLU+"高山流水"+NOR+"」，左掌凝重，右掌轻盈，同时向$n的$l击去",
    "force" : 420,
    "lvl" : 60,
    "skill_name" : BLU "高山流水" NOR,
        "damage_type" : "瘀伤"
]),
([  "action" : "$N突地一招「"+RED+"金玉满堂"+NOR+"」，双掌挟着一阵风雷之势，猛地劈往$n的$l",
    "force" : 460,
    "lvl" : 70,
    "skill_name" : RED "金玉满堂" NOR,
        "damage_type" : "瘀伤"
]),
...
([  "action" : "$N一式「"+RED+"烟雨飘渺"+NOR+"」，身形凝立不动，双掌一高一低，看似简单，却令$n无法躲闪",
    "force" : 540,
    "lvl" : 90,
    "skill_name" : RED "烟雨飘渺" NOR,
        "damage_type" : "瘀伤"
])
});
...
int valid_learn(object me)
{
    ...
    if (me->query_skill("unarmed", 1) <=me->query_skill("hunyuan-zhang", 1)
    && me->query_skill("unarmed", 1) <=me->query_skill("hunyuan-zhang", 1))
