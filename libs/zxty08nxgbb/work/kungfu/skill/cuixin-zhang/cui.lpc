...
int perform(object me, object target)
{
 ...
 if ( (string)me->query("family/family_name") != "玄天派") 
    ...
    msg = HIC "
$N双手一分，施展出摧心掌之秘技"HIM+"「摧心碎魂」"+HIC"，向$n轻飘飘的拍出一掌！\n"NOR;

if( random(me->query_skill("cuixin-zhang",1)+me->query_skill("unarmed",1)) > target->query_skill("unarmed",1)) { 
      me->start_busy(1);
   target->start_busy(random(2));

damage = (int)me->query_skill("cuixin-zhang", 1)*5+(int)me->query_skill("force",1)*2;
