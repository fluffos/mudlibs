...
int perform(object me, object target)
{
    string msg, *limbs;
        ...
        int arg=(int)(me->query_skill("xinyue-gong", 1) / 100);
        ...
        if( (int)me->query_skill("xinyue-gong", 1) < 120 )
        ...
        if (me->query_skill_prepared("unarmed") != "xinyue-gong"
        || me->query_skill_mapped("unarmed") != "xinyue-gong")
