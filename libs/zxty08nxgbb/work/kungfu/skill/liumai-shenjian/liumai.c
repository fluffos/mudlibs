...
if( random(me->query_skill("liumai-shenjian",1)+me->query_skill("unarmed",1)) > target->query_skill("unarmed",1)) { 
      me->start_busy(1);
   target->start_busy(random(2));

damage = (int)me->query_skill("liumai-shenjian", 1)*5+(int)me->query_skill("force",1)*2;
