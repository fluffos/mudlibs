...
{
    int sp, dp;
    int my_max, tg_max,skills,max_suck;
    ...
    if( objectp(me->query_temp("weapon")) )
        ...
        skills=(int)me->query_skill("huagong-dafa",1); 
     if(  (skills < 100 || me->query("max_jingli") > skills*500)&& !me->query_temp("wujiwan")) 
...
// 修改了吸精力的bug,防止出现任务copy 精力npc，玩家无限吸精力
// by zjb 2002.3.30
if (target->query("max_jingli")>70000 && !userp(target))
return notify_fail("对不起星空已经修改了吸精力的bug了!\n");
    message_vision(
