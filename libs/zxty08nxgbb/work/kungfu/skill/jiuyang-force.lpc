...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
        ...
        if( intp(foo) && (damage_bonus + foo > 0) ) {
            if( (random(2*(me->query_skill("jiuyang-force"))) > (damage_bonus + foo))&&(me->query("max_neili")>2000)&&(me->query_skill("jiuyang-force")>120)&&(me->query("max_neili")>victim->query("max_neili")) )
                 {                        
