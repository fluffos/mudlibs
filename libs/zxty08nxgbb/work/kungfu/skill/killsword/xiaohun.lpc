...
int perform(object me, object target)
{
    ...
    string msg;
        if( !me->is_fighting() )
            return notify_fail("「销魂夺魄」只能在战斗中使用。\n");
        ...
        if((int)me->query_skill("killsword",1) < 300)
      ...
      msg += MAG"时而幻出千万剑气，向对方当头罩下，只见漫天剑气，\n"NOR;
      msg += MAG"阴风阵阵，随着你的无穷内力的注入，变的越来越强！\n"NOR;
