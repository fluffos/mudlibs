...
([  "action" : "$N满场游走，东刺一剑，西刺一剑，令$n莫明其妙，分不出$N剑法的虚实！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action" : "$N抱剑旋身，转到$n身后，杂乱无章地向$n刺出一剑，不知使的是什么剑法！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action" : "$N剑挟刀势，大开大阖地乱砍一通，但招招皆击在$n攻势的破绽，迫得$n不得不守！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action" : "$N随手一剑指向$n，落点正是$n的破绽所在，端的是神妙无伦，不可思议！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([
    "action" : "$N将$w随手一摆，但见$n自己向$w撞将上来，神剑之威，实人所难测！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action" : "$N突然运剑如狂，一手关外的「"+NOR YEL+"乱披风剑法"+NOR+"」，猛然向$n周身乱刺乱削！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
([  "action" : "$N剑势忽缓而不疏，剑意有余而不尽，化恒山剑法为一剑，向$n慢慢推去！"NOR,
        "force" : 560,
        "dodge" : 280,
        "parry" : 240,
        "damage" : tydamage,
...
return WHT  "$N的九剑以到最高等级，一剑攻出，剑气横飞,时若游龙穿空，时若惊鸿渡云扑向$n！！！！！\n" NOR;
  }      

 //  第五等级的伤气
      if( me->query_skill("dugu-jiujian",1)>3000
  && me->query("zjb_dj/dj")>=15 ) {
              victim->receive_damage("qi", damage_bonus  , me);
return YEL "$N的九剑以到第五等级，一剑随意挥出,如生了眼睛一般扑向$n！！！！！\n" NOR;
  }      
...
return MAG "$N的独孤九剑以到第四等级，随意一剑带出九十阵剑气扑向$n！！！！！\n" NOR;
  }      
