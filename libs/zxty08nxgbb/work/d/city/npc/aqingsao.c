inherit F_DEALER;
inherit BHNPC;
string query_save_file() { return DATA_DIR + "npc/aqingsao"; }
...
void create()
{
        ...
        set("area_name","扬州茶馆");
        set("area_id","yzchaguan");
        set("area_file","/d/city/chaguan");
        set("kaifa",38);
        set("jizhi",46);
        set("ziyuan","茶叶");
        set("nickname", "扬州一支花");
...
"/d/obj/tangyuan", 
        ...
        setup();
        carry_object("/clone/misc/hiw_cloth")->wear();
}
void init()
{
        object ob,owner;
