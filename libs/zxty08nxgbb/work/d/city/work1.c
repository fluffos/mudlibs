...
int do_work(string arg)
{
        ...
        if (me->query_temp("working")&&me->query_temp("work_zjb")>time()) return notify_fail("加油呀！谁叫你穷呀！\n");
      ...
      message("vision",HIY"〖谷物加工厂〗"NOR+":"+YEL" 由于"HIW+me->name()+NOR YEL"工作勤劳，获得了老板的嘉奖!\n"NOR,users());
        ...
        ob = new("/clone/money/silver");
          ob->set_amount(10+random(20));
            me->add("combat_exp",1000+random(200));
            me->add("potential",300+random(100));
        ob->move(me);
