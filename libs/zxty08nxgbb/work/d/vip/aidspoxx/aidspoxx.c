...
#endif
#define MENGZHU NPCDATA + "aidspoxx"
inherit NPC;
inherit F_MASTER;
inherit F_UNIQUE;
inherit F_SAVE;
...
void create()
{
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/aidspoxx/room");
   set("no_get",1);
        setup();
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/aidspoxx/aidspoxx");
    newob->move("/d/vip/aidspoxx/room");
    destruct(me);
    return 1;
}
