...
#endif
#define MENGZHU NPCDATA + "skyicewing"
inherit NPC;
inherit F_MASTER;
inherit F_UNIQUE;
inherit F_SAVE;
...
void create()
{
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/skyicewing/room");
   set("no_get",1);
        setup();
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/skyicewing/skyicewing");
    newob->move("/d/vip/skyicewing/room");
    destruct(me);
    return 1;
}
