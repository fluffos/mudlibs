...
#endif
#define MENGZHU NPCDATA + "bjluotuo"
inherit NPC;
inherit F_MASTER;
inherit F_UNIQUE;
inherit F_SAVE;
...
void create()
{
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/bjluotuo/room");
   set("no_get",1);
        setup();
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/bjluotuo/bjluotuo");
    newob->move("/d/vip/bjluotuo/room");
    destruct(me);
    return 1;
}
