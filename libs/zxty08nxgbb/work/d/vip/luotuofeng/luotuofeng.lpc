...
#endif
#define MENGZHU NPCDATA + "luotuofeng"
inherit NPC;
inherit F_MASTER;
inherit F_UNIQUE;
inherit F_SAVE;
...
void create()
{
    ...
    set_name("蓝风", ({ "tianya mengzhu", "mengzhu", "zhu" }) );
    set("title", "一字并肩王" );
    set("gender", "男性" );
    set("age", 40);
    set("mud_age", 4000000);
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/luotuofeng/room");
   set("no_get",1);
        setup();
...
//       shizhe->rm_file();
    ...
    me->set("short", YEL+"第" + chinese_number(me->query("generation")) + "代一字并肩王" + NOR+" " + me->query("name") + "(Tianya mengzhu)");
    me->delete("title");
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/luotuofeng/luotuofeng");
    newob->move("/d/vip/luotuofeng/room");
    destruct(me);
    return 1;
}
