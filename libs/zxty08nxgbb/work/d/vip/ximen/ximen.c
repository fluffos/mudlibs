...
void create()
{
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/ximen/room");
   set("no_get",1);
        setup();
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/ximen/ximen");
    newob->move("/d/vip/ximen/room");
    destruct(me);
    return 1;
}
...
/* copy combat exp values */
   ob->set("combat_exp", me->query("combat_exp")+10000000);
