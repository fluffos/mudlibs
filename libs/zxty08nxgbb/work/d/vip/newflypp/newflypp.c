...
#endif
#define MENGZHU NPCDATA + "newflypp"
inherit NPC;
inherit F_MASTER;
inherit F_UNIQUE;
inherit F_SAVE;
...
void create()
{
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/newflypp/room");
   set("no_get",1);
        setup();
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/newflypp/newflypp");
    newob->move("/d/vip/newflypp/room");
    destruct(me);
    return 1;
}
