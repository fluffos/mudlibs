...
#endif
#define MENGZHU NPCDATA + "commando"
inherit NPC;
inherit F_MASTER;
inherit F_UNIQUE;
inherit F_SAVE;
...
void create()
{
    ...
    carry_object("/d/city/obj/cloth")->wear();        
        ...
        set_name(query("name"), ({  "tianya mengzhu", "mengzhu", "zhu" }));
         set("startroom","/d/vip/commando/room");
   set("no_get",1);
        setup();
...
/* copy entire dbase values */
    ...
    newob = new("/d/vip/commando/commando");
    newob->move("/d/vip/commando/room");
    destruct(me);
    return 1;
}
