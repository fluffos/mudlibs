...
int do_copy(object me,int flag)
{
        ...
        i = (me->query_skill("dodge",1)+me->query_skill("force",1))/3+me->query("zjb_dj/dj") *10;
        if(i>5000) i=5000;
/*
...
*/
        ...
        ob->set("str",(me->query("zjb_dj/dj")*2));
        ob->set("con",(me->query("zjb_dj/dj")*2));
        ob->set("dex",(me->query("zjb_dj/dj")*2));

        ob->set("jiali", ob->query_skill("force",1)/6);
        ob->reincarnate(); 
//                ob->set("qi",  me->query("zjb_dj/dj")*50000); 
        ob->set("neili",  me->query("zjb_dj/dj")*50000); 
        ob->set("max_neili",  me->query("zjb_dj/dj")*50000); 
...
//                ob->set("max_qi",  me->query("zjb_dj/dj")*80000); 
...
void die()
{
        ...
        if( objectp(corpse = CHAR_D->make_corpse(this_object(), killer)) )
          corpse->set_name(this_object()->name()+"µÄÊ¬Ìå", ({ killer->query("id")+" jianxi corpse" }) );
