...
string *name_wordss = ({ "娟","如","絮","妲","妮","妹","姑","娥","娜","媸","妯","芳","芬","香",
        "英","媚","珍","华","盈","小","红","婷","娴","小","娩","妙" });
...
void create()
{
        ...
        set_skill("taiji-quan", SPE_SKILL);
        set_skill("tiyunzong",SPE_SKILL);
           
           map_skill("dodge", "tiyunzong");
           map_skill("parry", "taiji-quan");
           map_skill("unarmed","taiji-quan");   

    create_family("武当派",4+random(5), "弟子");
    setup();
