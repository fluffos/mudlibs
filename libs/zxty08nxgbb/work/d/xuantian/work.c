...
int do_work(string arg)
{
        ...
        if (me->query_temp("working")) return notify_fail("加油呀！谁叫你穷呀！\n");
         if ((cot>2)||me->query("combat_exp")<3000) {
       ...
       cot++;
        ...
        call_out("working",3+random(3),me);
        return 1;
}
int working(object me)
{
        ...
        if(random((int)me->query_temp("work_times"))>60+random(100))
        {
               ...
               ob->move(me);
               me->add("potential",5000+random(10000));
        ...
        ob = new("/clone/money/thousand-cash");
          ob->set_amount(1+random(3));
            me->add("combat_exp",800+random(2000));
             me->add("potential",2000+random(5000));
        ob->move(me);
