// Room: /u/marry/obj/cxwxm/longfeng.c
// marry 8,14
inherit ROOM;
#include <ansi.h>
...
int do_yanjiu(string arg)
{
    ...
    if ((me->query("family/family_name") == "痴心妄想门")&&(int)me->query_skill("chixin-bianfa", 1) < 800)
    {
 message_vision(HIY"$N仔细的研究了墙上的图案，终于心领神会。\n"NOR,me);
                me->receive_damage("jing", 8 + random(5));
me->improve_skill("chixin-bianfa", me->query("int")*3);
