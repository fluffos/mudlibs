...
set("no_suck",1);
        ...
        set_skill("force", 1810);
        set_skill("dodge", 1820);
        set_skill("unarmed",1740);
        set_skill("parry", 1825);
        set_skill("axe", 1860);
        set_skill("literate", 1900);
        set_skill("wangxiang-fufa", 1850);
        set_skill("shuiyue", 1830);
        set_skill("wangran-xinfa", 1840);
        set_skill("cxwx-quan", 1760);
