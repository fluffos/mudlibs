...
object *usr; 
    ...
    usr=all_inventory(this_object()); 
     for(i=0; i<sizeof(usr); i++) { 
         ...
         if (usr[i]->query("name")==this_player()->query("name"))  continue; 

                if (str==query_ip_number(usr[i]))
     ob->move("/d/wizard/fightroom");
    tell_object(this_player(),"每IP只允许一人挖矿！\n");
...
int working(object me)
{
       ...
       if ( (me->query_skill("wakuang-shu",1) > 300&& random(1000)>997)
        ...
        if (random(10)>5)
        switch (random(4)) {
                case 0: ob = "/d/zjb/weapon/gao11"; break;
                case 1: ob = "/d/zjb/weapon/gao12"; break;
                case 2: ob = "/d/zjb/weapon/gao13"; break;
                case 3: ob = "/d/zjb/weapon/gao14"; break;
        }
            
        else 
        switch (random(4)) {
                case 0: ob = "/d/zjb/weapon/gao21"; break;
                case 1: ob = "/d/zjb/weapon/gao22"; break;
                case 2: ob = "/d/zjb/weapon/gao23"; break;
                case 3: ob = "/d/zjb/weapon/gao24"; break;
        }
        }else
     if ( (me->query_skill("wakuang-shu",1) > 150&& random(100)>98)
       || (me->query_skill("wakuang-shu",1) > 400 && random(100)>96) ){
        switch (random(5)) {
                case 0: ob = "/d/zjb/weapon/gang1"; break;
                case 1: ob = "/d/zjb/weapon/gang2"; break;
                case 2: ob = "/d/zjb/weapon/gang3"; break;
                case 3: ob = "/d/zjb/weapon/gang4"; break;
                case 4: ob = "/d/zjb/weapon/gang5"; break;
        }
        } else
     ...
     if ( (me->query_skill("wakuang-shu",1) > 550&& random(100)>98 && me->query("canwazhongji"))
       || (me->query_skill("wakuang-shu",1) > 400 && random(100)>96) && me->query("canwazhongji")){
        ...
        if ( random(10)>8 )
        switch (random(5)) {
                case 0: ob = "/d/zjb/weapon/tie1"; break;
                case 1: ob = "/d/zjb/weapon/tie2"; break;
                case 2: ob = "/d/zjb/weapon/tie3"; break;
                case 3: ob = "/d/zjb/weapon/tie4"; break;
                case 4: ob = "/d/zjb/weapon/tie5"; break;
        }
        else 
        switch (random(5)) {
                case 0: ob = "/d/zjb/weapon/tong1"; break;
                case 1: ob = "/d/zjb/weapon/tong2"; break;
                case 2: ob = "/d/zjb/weapon/tong3"; break;
                case 3: ob = "/d/zjb/weapon/tong4"; break;
                case 4: ob = "/d/zjb/weapon/tong5"; break;
        }
        }
        else
