...
int do_xi(string arg)
{
  ...
  if(me->is_busy()) return notify_fail("你上一个动作还没有完成。\n");
      ...
      if me->("neili") > ("maxneili)*2)
          return notify_fail("你内力已经到达极限了，再吸收下去会走火入魔。\n");
...
message_vision(HIR"$N猛的一颤,感觉一股奇怪的内劲源源不断的从"HIW"圣舍利"HIR"里传
到了自己的体内,$N感觉自己的内力值有了明显的增加!\n"NOR,me);
...
message_vision(HIG"$N定了定神,双手按到"HIW"圣舍利"HIG"上,感到一股内劲从
"HIW"圣舍利"HIG"中传到了自己的体中\n"NOR,me);
...
message_vision(HIG"\n"+me->name()+"在吸取圣舍利内力的时候,突然脑中出现了!
一些奇怪的画面,"+me->name()+"感到自己的"HIM"战神录"HIC"一些不明白的地方突然想通了!\n"NOR, this_player());
...
message_vision(HIB"\n"+me->name()+"在吸取圣舍利内力的时候,突然脑中出现了!
一些奇怪的画面,"+me->name()+"感到自己对"HIW"道心种魔大法"HIB"一些不明白的地方突然想通了!\n"NOR, this_player());
