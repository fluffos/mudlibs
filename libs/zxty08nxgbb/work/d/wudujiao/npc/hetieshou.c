...
LONG
        ...
        set_skill("wudu-shengong", 1600);
        set_skill("dodge", 1900);
        set_skill("wudu-yanluobu", 1650);
        set_skill("unarmed", 1700);
        set_skill("qianzhu-wandushou", 1650);
        set_skill("parry", 1900);
        set_skill("sword", 1800);
        set_skill("wudu-goufa", 1600);
        set_skill("duji", 1800);
        set_skill("literate", 1500);
         set_skill("whip", 1500);
          set_skill("wudu-bian", 1500);
