...
int move(mixed dest)
{
       ...
       message("channel:rumor",HIY"【宝典书籍】"+ "某人：葵花宝典II被"+
...
int do_du(string arg)
{
    ...
    if ( me->query_skill("pixie-jian", 1) > 74) neili_lost = 10;
        ...
        if( me->query_skill("pixie-jian", 1) > 449){
          if (me->query_skill("kuihua-xinfa", 1)<100 && me->query("neili")>500){
    ...
    if ( !me->query_temp("study_book") ){
        tell_object(me, "你居然敢作弊，还想学葵花心法！哼!\n");
        return 0;
    }
