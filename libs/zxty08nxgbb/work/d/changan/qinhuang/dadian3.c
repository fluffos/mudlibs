...
void create()
{
    set("short", "大殿");
    set("long",@LONG
沿着"水银"河，走到了大殿的尽头，这里更是金碧辉煌，迎面
是一个龙头宝座，用纯金铸造而成，宝座上囊嵌无数的宝石，上方
有个硕大的龙头，也是由金玉所成，巍是壮观。东面有扇巨大的石
门，但却是关着的。
LONG
);
        set("exits", ([
...
int do_qiao(string arg)
{
        ...
        if (weapon->query("skill_type")!="dagger")      return notify_fail("你举起手中"+weapon->query("name")+"挥舞了几下，才发现这样东西不好使也。\n");
