...
void check_trigger()
{
    ...
    &&  !query("exits/down") ) {
        ...
        if( !room = find_object(__DIR__"beilin3") )
            ...
            message("vision", "头顶上的石板忽然发出轧轧的声音，露出一个光亮亮的洞口。\n一块块踏脚石从墙壁中凸了出来，形成一个向上的阶梯。\n",room );
        delete("poem_said");
        delete("up_trigger");
        delete("down_trigger");
...
string look_tower()
{
    ...
    "    ※※※※※※※※※※※※※※※※※※※※※※\n"
    "\n你喃喃地念了几遍，无法领悟其中的奥妙。\n"
    "\n\n你目光一扫，发现石碑底下的泥土似乎有点不一样。真想扳(pull)起来看看。\n";
}
string look_stone()
{
    return
    ...
    "    ※※※※※※※※※※※※※※※※※※※※※※\n"
    "\n你喃喃地念了几遍，无法领悟其中的奥妙。\n"
    "\n\n你目光一扫，发现石碑底下的泥土似乎有点不一样。真想扳(push)起来看看。\n";
}
