...
void trapping(object ob, object room)
{
	...
	room->set("exits/south", __DIR__"qingsonglin"+(random(8)+6));
	room->set("exits/north", __DIR__"qingsonglin"+(random(8)+6));
	room->set("exits/east", __DIR__"qingsonglin"+(random(8)+6));
	room->set("exits/west", __DIR__"qingsonglin"+(random(8)+6));
}
