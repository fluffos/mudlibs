...
void create()
{
    ...
    set("con", 330);
      ...
      set("max_jing", 100000);
        ...
        set_skill("tiangang-zhengqi", 2750);
        set_skill("dodge", 2300);
        set_skill("qixing-huanwei", 2300);
        set_skill("unarmed", 2650);
        set_skill("kongming-quan", 2600);
        set_skill("parry", 2800);
        set_skill("sword", 2100);
        set_skill("quanzhen-jianfa", 2100);
        set_skill("xiantian-gong", 2700);
        set_skill("qixing-array", 700);
        set_skill("taoism", 2700);
