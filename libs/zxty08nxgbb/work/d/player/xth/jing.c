...
void create()
{
        set("short", "卧雪轩");
        set("long",
"这是笑魔天的寝室，屋内摆设挺简单的，显得窗明几净的。门
的一进门就面对着一张漂亮的梳妆台，这就是笑魔天的女朋友平时打扮
的地方了。右边是一张双人大床，不用说也可以知道那是笑魔天休息的
地方了。床上铺着一张牡丹花底的床单，看起来好舒服好舒服的。靠右方
的角上摆了一个大衣柜，里面当然放着衣服。房子左边有一块蒲团，那是
   他练功的地方。\n" 
);
        set("exits", ([ 
  "down" : __DIR__"zly1",
