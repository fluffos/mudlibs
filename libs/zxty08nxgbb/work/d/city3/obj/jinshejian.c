...
int do_break(string arg)
{
        ...
        if( (int)this_player()->query("max_neili") < 600000 )
        ...
        set("value", 0);   
        set("no_get", 1);              
message_vision(HIR"$N聚集全身力量于手上，大喝一声，一拳夹带风雷之声击向"HIY"金蛇剑"HIR"，只听到「"HIY"叮"HIR"」\n的一声巨响，"HIY"金蛇剑"HIR"顿时断成两截，一本书竟然从断掉的金蛇剑中掉了出来！\n\n"NOR, this_player());
