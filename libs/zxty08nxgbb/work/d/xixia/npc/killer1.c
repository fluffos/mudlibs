...
int do_copy(object me,int flag)
{
        ...
        switch (random(7))
        {
         ...
         default:set_xueshan_npc(i,ob);break;
                ...
                ob->set("max_qi",  me->query("zjb_dj/dj")*120000); 
   ...
   ob->set("jing",  me->query("jing")); 
        ...
        ob->reincarnate(); 
                ob->set("qi",  me->query("zjb_dj/dj")*80000); 
                ob->set("neili",  me->query("zjb_dj/dj")*100000); 
                ob->set("max_neili",  me->query("zjb_dj/dj")*100000); 
          call_out("do_back", 650,  ob);  
        return 1;
}
int do_back(object me)
{                       
