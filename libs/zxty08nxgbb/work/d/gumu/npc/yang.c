...
void create()
{
        ...
        set("zjb_dj/dj",5);        set_skill("sword",1500);
        set_skill("dodge",1500);
          set_skill("unarmed",1500);
        set_skill("force", 1500);
        set_skill("yunu-shenfa", 1500);
        set_skill("xuantie-jianfa", 1500);
        set_skill("anranxiaohun-zhang", 1000);     
        set_skill("quanzhen-jianfa",1480);
        set_skill("tianluo-diwang", 1480);
        set_skill("parry", 1400);
        set_skill("yunu-xinjing",1500);
        set_skill("literate", 1450); 
