...
void create()
{
        ...
        set_skill("sword", 1480);
        set_skill("throwing", 1480);
        set_skill("whip", 1500);
        set_skill("meinu-quanfa", 1480);
        set_skill("unarmed", 1480);
        set_skill("yunu-shenfa", 1480);
        set_skill("yinsuo-jinling", 1400); 
        set_skill("literate", 1480);         
        set_skill("yunu-jianfa", 1480);
        set_skill("yunu-xinjing", 1400);
