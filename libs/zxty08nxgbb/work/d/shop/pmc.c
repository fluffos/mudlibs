...
void create()
{
        set("short",BYEL+HIW"商会后厅"NOR);        
    set("long", @LONG
扬州总商会后厅是专门用于拍卖店铺的房间，来这里的人，
都是有能耐有来头的。现在英雄会馆里正围着黑压压的一大群
人，都是来自各地的知名商贾。凤天南座于中堂，犀利的目光
似乎要把你刺透一般。西墙挂着的牌子(paizi)上面写着此次
拍卖大会的规则，一定要好好看看。
LONG);
        set("no_fight", 1);
        set("no_sleep", 1);
