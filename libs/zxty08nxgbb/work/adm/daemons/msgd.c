...

{
        ...
        i=sizeof(msg);
        if (i<=0){
                  CHANNEL_D->do_channel(this_object(),"es",
                      HIW"天涯---(碧血江湖),"HIY"更换服务器,现在的连线地址是:211.97.200.87,PORT:2001.4000.5555.7777.8888!"HIC"奖励100万经验和50万潜能上，300 literate,300force!"HIR"服务器是全新的unix操作系统\n");
                  call_out("on_time",2);
                return;
                }
        j=random(i);
