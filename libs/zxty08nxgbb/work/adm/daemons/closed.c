...
#define ANI_CMD              "/cmds/skill/animaout"
#define BILIAN_CMD              "/cmds/skill/bilian"
...
void continue_doing(object user_ob)
{
        ...
        case "animaout":
          res = ANI_CMD->continue_outing(user_ob);
                break;

        case "scheme":
             res = SCHEME_CMD->execute_schedule(user_ob);
                break;

        case "bilian":
             res = BILIAN_CMD->jixu_lian(user_ob);
                break;
