...
void choose_npc()
{
        ...
        {
          message("system",HIG"【天涯】独孤求败「唉」的一声叹了口气。\n"NOR,users());
        message("system",HIG"【天涯】独孤求败(dugu qiubai)：长安月下,一壶清酒,一树梨花!\n"NOR,users());
        remove_call_out("choose_npc");
