...
+"及"+CHINESE_D->chinese_number(reward_score)+"点综合评价奖励和"+chinese_number(gold)+"两黄金！\n"NOR,);
   ...
   MIS_REW->give_reward_yunbiao(me);
