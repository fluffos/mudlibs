...
//        set_guai_qi_jing(turn,who);
         guaiob->set("max_neili",who->query("max_neili"));
         guaiob->set("neili",who->query("max_neili"));
        guaiob->set("max_jingli",guaim(turn,who));
         guaiob->set("jingli",who->query("max_jingli"));
//        guaiob->set("combat_exp",who->query("zjb_dj/dj")*5000000);
        ...
        guaiob->set("max_qi",who->query("zjb_dj/dj")*80000);
        guaiob->set("qi",who->query("zjb_dj/dj")*80000);
        guaiob->set("eff_qi",who->query("zjb_dj/dj")*80000);
...
//set_guai_qi_jing(turn,guaiob)
   guaiob->set("max_neili",guaif(turn,who));
         guaiob->set("max_neili",who->query("max_neili"));
         guaiob->set("neili",who->query("max_neili"));
        guaiob->set("max_jingli",who->query("max_jingli));
        guaiob->set("jingli",who->query("max_jingli));
...
{       
        ...
        money = me->query("money");
         ...
         me->add("money",-2500000);
         me->add("potential",-800);
         me->delete_temp("kill");
   
return HIY"我看错你了，我只能找别人了,扣你800点POT和250两金子.\n"NOR;
}
