...
#endif
#define SHIZHE NPCDATA + query("banghui")
inherit NPC;
inherit F_UNIQUE;
inherit F_SAVE;
...
int accept_fight(object ob)
{
    ...
    fae = load_object(__DIR__"shang-shan");
    fae->restore();
    name2 = fae->query("winner");
    if( this_player()->query("id")==name2 ){
    ...
    fae = load_object(__DIR__"xin-xiu");
    fae->restore();
    name2 = fae->query("winner");
    if( this_player()->query("id")==name2 ){
