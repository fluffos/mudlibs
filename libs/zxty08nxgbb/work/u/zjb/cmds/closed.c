...
*/
if (me->query_skill("unarmed",1)>1500)
return notify_fail("老大，你武功这么高了，还想闭关？\n");
if (me->query_skill("parry",1)>1500)
return notify_fail("老大，你武功这么高了，还想闭关？\n");
if (me->query_skill("sword",1)>1500)
return notify_fail("老大，你武功这么高了，还想闭关？\n");
if (me->query_skill("blade",1)>1500)
return notify_fail("老大，你武功这么高了，还想闭关？\n");
if (me->query_skill("club",1)>1500)
return notify_fail("老大，你武功这么高了，还想闭关？\n");
...
//       if ((random(100) < 3) && me->can_improve_neili())
       if (random(100) < 21)
        {
            tell_object(me, HIR "你对内功有所领悟，内力增加了三千点！\n" NOR);
...
//     if ((random(100) < 3) && me->can_improve_jingli())
      if (random(100) < 21) 
        {
          tell_object(me, HIM "你对神通有所领悟，感到精力增加了1500点！\n" NOR);
...
tell_object(me, HIM "你对神通有所领悟，感到基本内功增加了两级！\n" NOR);
 if (me->query_skill("force",1)>4998)
{
   me->set_skill("force", (int)me->query_skill("force",1) - 2);
tell_object(me, HIM "你的内功已经到达5000级了，不能再加了，星空又帮你降了回来！\n" NOR);
}
}
...
//           me->improve_skill(ks[r], 500000 + random(1000));
           me->improve_skill(ks[r], 210000000 + random(210000));
        }
*/
  if (random(100) < 21) 
{
...
一个安全并且可以休息的地方才能闭关，闭关前需要有十万点潜能，闭
