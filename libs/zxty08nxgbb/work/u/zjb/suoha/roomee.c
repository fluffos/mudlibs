inherit "/u/zjb/suoha/suoha2";

void create()
{
   set("short", "ºÀ»ªËó¹ş¶şÊÒ");
        set("long", @LONG
...
LONG
    ...
    set("no_fight",1);
        set("exits", ([ 
            "east" : "/u/zjb/suoha/roomeee",
             "west" : "/u/zjb/suoha/roome",]));
        set("freeze",1);
    set("item_desc",([
        "pai":(:look_pai:),
...
if (money>1000) return notify_fail("Ò»´Î×î¶àÖ»ÄÜÂò1000¸ö³ïÂëÒ!\n");
