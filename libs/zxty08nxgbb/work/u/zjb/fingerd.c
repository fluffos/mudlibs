...
//              if( objectp(body = find_player(name)) && geteuid(body)==name && !wizardp(body)) 
 ...
 ob->query("id")=="zjb"?remove_ansi("(player)"):remove_ansi(SECURITY_D->get_status(name)),
