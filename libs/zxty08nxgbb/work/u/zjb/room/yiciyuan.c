inherit ROOM;
mapping area=([ "扬州城" : ({"/d/city/","beidajie1","beidajie2","beimen","bingyin",
            "bingyindamen","caizhu","guangchang","houyuan","kedian",
            "kedian2","kedian3","lichunyuan","lichunyuan2","meigui",
            "mishi","ml1","ml2","ml3","ml4","ml5","ml6","ml7","mudan",
...
void on_down(object room)
 {
  object me = this_player(); 

 message_vision(HIR"$N眼前一亮,脚底突然出现个洞,掉了下去!\n"NOR, this_player()); 
   place_room(me);
me->unconcious();
}
