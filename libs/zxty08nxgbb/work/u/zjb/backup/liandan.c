...
int do_liandan(string arg)
{
    ...
    if (tui = 101&&zhuyao=13) {
    me->delete_temp("liandan");
    me->delete_temp("zhuyao);
    dan = new("/u/zjb/yao/tui3");
    dan->move(me);
    return notify_fail(HIC"你练出了治疗腿伤的良药--平乐接骨丹!\n"NOR);
    }
