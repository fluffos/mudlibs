...
string query_rank(object ob)
{
        ...
        if( (int) ob->query("fight_rank") == 1 )
	{
        ...
        case "女性":
                ...
                default:
// By zjb加上等级
                     if( userp(ob) && ob->query("zjb_dj/dj") > 100)
                                return  "【"BLINK HIY"金榜英雌"NOR"】";    
                         else if( userp(ob) && ob->query("zjb_dj/dj") > 70)
                                 return  "【"BLINK HIR"红榜英雌"NOR"】";    
                        else if( userp(ob) && ob->query("zjb_dj/dj") > 50)
                                return  "【"BLINK HIB"黑榜英雌"NOR"】";   
 ...
 switch(wizhood(ob)) {
                ...
                default:
                     ...
                     if( userp(ob) && ob->query("zjb_dj/dj") > 100)
                                 return  "【"BLINK HIY"金榜英雄"NOR"】";    
                         else if( userp(ob) && ob->query("zjb_dj/dj") > 70)
                                 return  "【"BLINK HIR"红榜英雄"NOR"】";    
                        else if( userp(ob) && ob->query("zjb_dj/dj") > 50)
                                return  "【"BLINK HIB"黑榜英雄"NOR"】";   
