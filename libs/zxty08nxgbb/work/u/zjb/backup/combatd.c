...
{
   int status, level, power, dj, djexp;

     dj = ob->query("zjb_dj/dj");
if ( dj > 1 ) {
if ( dj == 2 ) djexp=(int)ob->query("combat_exp")/500+20000; 
if ( dj == 3 ) djexp=(int)ob->query("combat_exp")/500+60000; 
if ( dj == 4 ) djexp=(int)ob->query("combat_exp")/500+120000; 
if ( dj == 5 ) djexp=(int)ob->query("combat_exp")/500+200000; 
if ( dj == 6 ) djexp=(int)ob->query("combat_exp")/500+300000; 
if ( dj == 7 ) djexp=(int)ob->query("combat_exp")/500+420000; 
if ( dj == 8 ) djexp=(int)ob->query("combat_exp")/500+560000;
if ( dj == 9 ) djexp=(int)ob->query("combat_exp")/500+720000;
if ( dj ==10 ) djexp=(int)ob->query("combat_exp")/500+900000;
if ( dj > 10 && ob->query("combat_exp")>500) 
djexp=((int)ob->query("combat_exp")/500)+(900000+((dj-10)*200000));
}
else {
...
djexp=(int)ob->query("combat_exp");
    ...
    if( !level || level<1){
if ( dj > 1) {
if ( dj == 2 ) power=(int)ob->query("combat_exp")/500+20000; 
if ( dj == 3 ) power=(int)ob->query("combat_exp")/500+60000; 
if ( dj == 4 ) power=(int)ob->query("combat_exp")/500+120000; 
if ( dj == 5 ) power=(int)ob->query("combat_exp")/500+200000; 
if ( dj == 6 ) power=(int)ob->query("combat_exp")/500+300000; 
if ( dj == 7 ) power=(int)ob->query("combat_exp")/500+420000; 
if ( dj == 8 ) power=(int)ob->query("combat_exp")/500+560000;
if ( dj == 9 ) power=(int)ob->query("combat_exp")/500+720000;
if ( dj ==10 ) power=(int)ob->query("combat_exp")/500+900000;
if ( dj > 10 && ob->query("combat_exp")>500) 
power=((int)ob->query("combat_exp")/500)+(900000+((dj-10)*200000));
}
else {
if ( ob->query("combat_exp")>500 )
    power=(int)ob->query("combat_exp")/500;
else
power=(int)ob->query("combat_exp");
    ...
    if (usage == SKILL_USAGE_ATTACK){
      ...
      power*=(ob->query("str") + ob->query_temp("str")+ob->query_skill(skill,1)/20)/5;
    }else
...
//
int vic_exp, me_exp,em,max_tili,tili;
varargs int do_attack(object me, object victim, object weapon, int attack_type)
{
    ...
    mixed foo;
    int ap, dp, pp ;
   int dj, dj2, meexp, vicexp;
  int damage, damage_bonus, defense_factor, damage2, defense_factor2;
    int cost;
    int wounded = 0;
...
/*    if(me->query("age")>60)
        {    	max_tili = me->query("max_jingli");
        tili = me->query("jingli");
       }
     if(max_tili==0)
        max_tili = 1;
    if (userp(me)) {
...
*/
      dj = victim->query("zjb_dj/dj");
      dj2 = me->query("zjb_dj/dj");
...
vic_exp=(int)victim->query("combat_exp");
    ...
    {      // Does the victim dodge this hit?
        result += dodge_msg;
    if( !userp(victim)&&ap+cost > pp && random(your["jing"]*100/your["max_jing"] + victim->query_int()/2) > 30&&me_exp > vic_exp
|| userp(victim)&&ap+cost > pp && random(your["jing"]*100/your["max_jing"] + victim->query_int()/2) > 30&&me_exp > vic_exp&&victim->query("zjb_dj/dj")>=me->query("zjb)dj/dj"))
        {
                  if(vic_exp>150000000)
                   {
                            your["combat_exp"] += victim->query_int()/60;
                         victim->improve_skill("dodge", random(victim->query_int())/20);
                    }
                    else if(vic_exp>100000000)
                   {
  ...
  {
                            your["combat_exp"] += victim->query_int()/50;
   ...
   {
            result += parry_msg;
   if(!userp(victim)&& ap+cost > dp && random(your["jing"]*100/your["max_jing"] + victim->query_int()) > 60&&me_exp > vic_exp
||userp(victim)&& ap+cost > dp && random(your["jing"]*100/your["max_jing"] + victim->query_int()) > 60&&me_exp > vic_exp&&victim->query("zjb_dj/dj")>=me->query("zjb)dj/dj"))
            {   
                if(vic_exp>150000000)
                   {
                          your["combat_exp"] += victim->query_int()/30;
...
if ( dj2 > 1&& me->query("combat_exp")>500) {
if ( dj2 == 2 ) meexp=(int)me->query("combat_exp")/500+20000; 
if ( dj2 == 3 ) meexp=(int)me->query("combat_exp")/500+60000; 
if ( dj2 == 4 ) meexp=(int)me->query("combat_exp")/500+120000; 
if ( dj2 == 5 ) meexp=(int)me->query("combat_exp")/500+200000; 
if ( dj2 == 6 ) meexp=(int)me->query("combat_exp")/500+300000; 
if ( dj2 == 7 ) meexp=(int)me->query("combat_exp")/500+420000; 
if ( dj2 == 8 ) meexp=(int)me->query("combat_exp")/500+560000;
if ( dj2 == 9 ) meexp=(int)me->query("combat_exp")/500+720000;
if ( dj2 ==10 ) meexp=(int)me->query("combat_exp")/500+900000;
if ( dj2 > 10 && me->query("combat_exp")>500) 
{
meexp=((int)me->query("combat_exp")/500)+(900000+((dj-10)*200000));
}
}
else {
if ( me->query("combat_exp")>500 )
{     meexp=(int)me->query("combat_exp")/500;
}else
...
if ( dj > 1&& your["combat_exp"]>500) {
if ( dj == 2 ) vicexp=(your["combat_exp"]/500)+20000; 
if ( dj == 3 ) vicexp=(your["combat_exp"]/500)+60000; 
if ( dj == 4 ) vicexp=(your["combat_exp"]/500)+120000; 
if ( dj == 5 ) vicexp=(your["combat_exp"]/500)+200000; 
if ( dj == 6 ) vicexp=(your["combat_exp"]/500)+300000; 
if ( dj == 7 ) vicexp=(your["combat_exp"]/500)+420000; 
if ( dj == 8 ) vicexp=(your["combat_exp"]/500)+560000;
if ( dj == 9 ) vicexp=(your["combat_exp"]/500)+720000;
if ( dj ==10 ) vicexp=(your["combat_exp"]/500)+900000;
if ( dj > 10 && your["combat_exp"]>500) 
{
vicexp=(your["combat_exp"]/500)+(900000+((dj*200000)-2000000));
}
}
else {
if ( your["combat_exp"]>500 )
{     vicexp=your["combat_exp"]/500;
}else
vicexp=your["combat_exp"];
}




  defense_factor = vicexp;
if (defense_factor < 0) defense_factor=2100000000;
...
/*
if ( random(defense_factor) > meexp ) {
damage -= damage/3;
defense_factor /= 2;
}
*/
        ...
        damage = (damage*limb_damage[limb]/150);
...
if(!userp(victim)&&vic_exp+500000 > me_exp && random(my["jing"]*100/my["max_jing"] + me->query_int()) > 50
||userp(victim)&&victim->query("zjb_dj/dj")>=me->query("zjb)dj/dj")&&vic_exp+500000 > me_exp && random(my["jing"]*100/my["max_jing"] + me->query_int()) > 50) 
            {
          if(me_exp>300000000)
                  my["combat_exp"] += me->query_int()/45;
            	else if(me_exp>100000000)
                    my["combat_exp"] += me->query_int()/30;
              	
                else 
                	my["combat_exp"] += me->query_int()/15;
                        me->improve_skill(attack_skill, random(me->query_int()));
...
void killer_reward(object killer, object victim)
{
 ...
 if (victim->query("age",1)<18 && userp(victim) && userp(killer)||killer->query("age",1)<18 && userp(killer)&& userp(victim)) return 0;
      if (!killer)     return;
