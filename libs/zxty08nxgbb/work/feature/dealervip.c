...
int do_check(string arg)
{
    ...
    if (!(ob = obj->query("vipxiang")))
        return notify_fail(this_object()->query("name")+sprintf("说道：%s你的储存柜中没有任何物品。\n",obj==me?"你":obj->short(1)));
