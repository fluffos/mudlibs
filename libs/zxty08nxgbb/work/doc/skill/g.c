...
int do_clone(string arg)
{
   ...
   string filegold,filesilver,filecoin;
     int times;
    filegold="/clone/money/thousand-gold.c";
    filesilver="/clone/money/gold.c";
