...
int ask_fofa() {
  ...
  switch (random(4)) {
    case 0: {
      ...
      call_out("do_nod1", 5, me); return 1;
    }
    break;
    ...
    case 1: {
      ...
      call_out("do_nod2", 5, me); return 1;
    }
    break;
    ...
    case 2: {
      ...
      call_out("do_nod3", 5, me); return 1;
    }
    break;
    ...
    case 3: {
      ...
      call_out("do_nod4", 5, me); return 1;
    }
    break;
  }
}
...
int do_nod1() {
  ...
  if ((int)me->query_skill(
    "dacheng-fofa",
    1
  ) < 101 || (int)me->query_skill("dacheng-fofa", 1) > 121) {
    write("你仔细想了半天，也想不出来。\n");
    me->receive_damage("jing", 80 - (int)me->query("int") * 2);
    return 1;
  }
  if ((int)me->query_skill(
    ...
    if (random(10) > 3) {
	 ...
	 你说：朝打三千，暮打八百。\n" NOR, me);
      ...
      me->receive_damage("jing", 80 - (int)me->query("int") * 2);
      me->add("potential", -1);
      me->delete_temp("ask_force_1", 1); return 1;
    } else {
      write("你仔细想了半天，也想不出来。\n");
      me->receive_damage("jing", 25);
      me->delete_temp("ask_force_1"); return 1;
    }
  }
}
...
你答道：古人说“一滴投于巨壑”，殊不知大海也投于一滴！\n" NOR, me);
      ...
      me->receive_damage("jing", 80 - (int)me->query("int") * 2);
      me->add("potential", -1);
      me->delete_temp("ask_force_2", 1); return 1;
    } else {
      write("你仔细想了半天，也想不出来。\n");
      me->receive_damage("jing", 25);
      me->delete_temp("ask_force_2"); return 1;
    }
  }
}
...
int do_nod3() {
  ...
  if ((int)me->query_skill(
    ...
    if (random(10) >= 3) {
      write(HIR "你想起在一部书里读到过这个典故。
你说：遥指扶桑日那边。\n" NOR, me);
      me->improve_skill("dacheng-fofa", (int)me->query("int") * 4);
      me->receive_damage("jing", 80 - (int)me->query("int") * 2);
      me->add("potential", -1);
      me->delete_temp("ask_force_3", 1); return 1;
    } else {
      write("你仔细想了半天，也想不出来。\n");
      me->receive_damage("jing", 25);
      me->delete_temp("ask_force_3"); return 1;
    }
  }
}
...
int do_nod4() {
  ...
  if ((int)me->query_skill(
    ...
    if (random(10) > 3) {
      write(HIW "你想起在一部经书里读到过这个典故。
你答道：夜听水流庵后竹，昼起看云面前山。\n" NOR, me);
      me->improve_skill("dacheng-fofa", (int)me->query("int") * 4);
      me->receive_damage("jing", 80 - (int)me->query("int") * 2);
      me->add("potential", -1);
      me->delete_temp("ask_force_4", 1); return 1;
    } else {
      write("你仔细想了半天，也想不出来。\n");
      me->receive_damage("jing", 25);
      me->delete_temp("ask_force_4"); return 1;
    }
  }
}
