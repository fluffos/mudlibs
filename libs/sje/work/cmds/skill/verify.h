...
mapping perform_names = ([
  ...
  "hunyuan-zhang/wuji": HBRED "混元无极" NOR,
  "poyu-quan/leidong": HBMAG "雷动九天" NOR,
  ...
  "huashan-jianfa/feijian": HBBLU "飞　　剑" NOR,
  "huashan-jianfa/sanqingfeng": HBBLU "太岳三青峰" NOR,
  "huashan-jianfa/yangwu": HBBLU "养吾剑法" NOR,
  "huashan-jianfa/xiyi": HBBLU "希夷剑法" NOR,
  "huashan-jianfa/shunv": HBBLU "淑女剑法" NOR,
  "huashan-jianfa/junzi": HBBLU "君子剑法" NOR,
  "huashan-jianfa/feilong": HBBLU "天外飞龙" NOR,
  "huashan-jianfa/wushuang": HBBLU "无双无对,宁氏一剑" NOR,
  "huashan-jianfa/kuaijian": HBBLU "狂风快剑" NOR,
  "huashan-jianfa/lianhuan": HBBLU "夺命连环三仙剑" NOR,
  "huashan-jianfa/shijiushi": HBBLU "玉女十九式" NOR,
  "dugu-jiujian/kuangfeng": GRN "狂风卷地" NOR,
  "dugu-jiujian/zongjue": GRN "总 诀 式" NOR,
  "dugu-jiujian/poqi": GRN "破 气 式" NOR,
  "dugu-jiujian/pobian": GRN "破 鞭 式" NOR,
  "dugu-jiujian/podao": GRN "破 刀 式" NOR,
  "dugu-jiujian/pojian": GRN "破 剑 式" NOR,
  "dugu-jiujian/pojianshi": GRN "破 箭 式" NOR,
  "dugu-jiujian/poqiang": GRN "破 枪 式" NOR,
  "dugu-jiujian/posuo": GRN "破 索 式" NOR,
  "dugu-jiujian/pozhang": GRN "破 掌 式" NOR,
  ...
  "pixie-jian/cimu": HBBLU "飞针刺目" NOR,
  "pixie-jian/feiying": HBBLU "葵花飞影术" NOR,
  "pixie-jian/jue": HBBLU "绝 命 针" NOR,
