...
// 从在线玩家中找出 exp > 1000000 ,+shen > 500000 的，然后随机抽出一个去监狱
        ...
        message("channel:chat",HIC"【闲聊】魔教杀手狂笑之后，说道：你们这些正派武林人士，整日自吹自擂，说什么自己门派天下第一，简直一派胡言！！\n"NOR,users());
        message("channel:chat",HIC"【闲聊】魔教杀手续又说道：堂堂"HIY + myfam + HIC"的"HIY + hostage_n + "(" + hostage_i +")"HIC"已经被我们抓去当人质了，除非你们自愿奉我们日月神教为武林盟主，我们就放人。否则，嘿嘿。。。。！！！\n"NOR,users());
        return 1;
}
...
int do_fail(object me)
{
        ...
        message("channel:chat",HIC"【闲聊】魔教杀手朗声道：我们圣教以圣教主为首，挑少林，克武当，昆仑、峨嵋不攻自下，再要灭了丐帮，也不过举手之劳。圣教主千秋万载，一统江湖！\n"NOR,users());
