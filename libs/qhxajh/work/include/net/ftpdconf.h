 ...
 */
#define LOGIN_MSG       "/system/etc/ftpd_welcome"
...
#define FTP_BUGS_EMAIL "falcon@XO"
 ...
 */
#define FTP_USERS ({ "peacock", "qyz", "nerd", "yuhj", \
                     "lin", "ram", "trill", "hamlet", \
                     "leonhart", "thekid", "lala", "know", \
                     "lnwm", "jameson", "jojo", "marry" })
