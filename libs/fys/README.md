...
档案本身标注为"风云三"，但游戏内登入横幅实际写的是"铁血江湖"——一个
独立于本项目改动的原始命名不一致。地图以中原江湖的华山、武当、明教
等经典门派重镇为核心，另外还设有两处跨海历练场景：一片"神户"（日
本）区域和一处台湾区域。新角色从中央城最大的酒楼"英豪酒楼"起步；退
出游戏设有真实的 30 秒登入后冷却（提示"档案正在存取中，三十秒后方
能下线!"），是本合集里少数把防刷退机制直接写进游戏设计的一个。
