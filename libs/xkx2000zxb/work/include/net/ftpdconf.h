...
#define FTP_BUGS_EMAIL "robocoder@tmi-2 or wizards@xkx"
 ...
 */
//#define FTP_USERS ({ "xiang", "ding", "cleansword", "mongol", "qfy", "xbc", "zhouzi", "xuy", "ryu", "ywz", "oyxb" })
#define FTP_USERS ({ "qfy", "xbc", "chu", "ssy", "ryu", "cleansword", "xuy", "sdong", "haowen", "apache", "arthurgu", "xqin", "maco", "wzfeng","acep","snowbird","oyxb","fear","zhangchi","xiaojian","wsky","yunq","sure","mantian",})
 ...
 */
//#define FTP_USERS ({ "xiang", "ding", "cleansword", "mongol", "qfy", "xbc", "zhouzi", "xuy", "ryu", "ywz", "oyxb" })
#define FTP_USERS ({ "xiang", "zhouzi", "oyxb", "xbc", "kane" })
//#define FTP_USERS ({ "zhouzi", "oyxb", "xbc" })
