...
{
  if (!this_object()->query_temp("my_killer"))
...
void powerup()
{
        ...
        random(2)?
        me->command_function("chat 海皇波士顿，赐予我力量吧！\n"):
...
{
	if (me->query_temp("last_opponent")!=me->query_temp("my_killer"))
	{
		message_vision(me->name()+"大喝到：你们以多取胜，我不奉陪了.\n",me);
