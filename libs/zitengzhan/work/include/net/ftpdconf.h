// this file should be named: ftpdconf.h
...
#define FTP_BUGS_EMAIL "pozi0297@163.com"
 ...
 */
#define FTP_USERS ({ "snowtu", "xdao", "jznt", "zlga", "pozi", "cloud" })
