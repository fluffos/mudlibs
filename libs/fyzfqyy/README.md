...
一个以古龙小说为背景的"风云"MUD。这份档案的实际游戏地图相当单薄：
全库只有约 48 个带房间描述的文件，且大多数分散在各个巫师的个人目录
下，而不是一套完整的官方城镇/门派地图；唯一较为完整的官方场景是
`quest/kaifeng/` 的开封"衙门"，包拯、展昭都驻扎在此。注册流程把管理
密码与登录密码彻底分离，比常见的单密码注册更谨慎。
