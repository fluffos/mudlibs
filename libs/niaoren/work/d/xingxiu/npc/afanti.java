...
void create()
{
        ...
        set("inquiry", ([
            ...
            "納蘇爾" : "是我出生的地方。",
            "謎語" : "你幫我找到小毛驢，我就給你出謎語。",
            "巴依" : "他把我關在這里，有吃有喝，我就不走了。巴依是個壞蛋，愿胡大懲罰他。",
            "毛驢" : "我的小毛驢在我到沙漠里騙巴依種金子時走丟了。",
            "驢" : "我的小毛驢在我到沙漠里騙巴依種金子時走丟了。",
            "小毛驢" : "我的小毛驢在我到沙漠里騙巴依種金子時走丟了。",
            "卷帘格" : "卷帘格指謎底各字順序顛倒過來和謎面相扣。",
            "胡大" : "就是真主。又名安拉或阿拉。",
...
//               destruct(ob);
		       ...
		       write("巴黎習語。(打一本泥潭技能名，卷帘格)\n");
                   ...
                   case 12:
                    ...
                    // this riddle made by 居士　（美國）
                       ...
                       break;
                   case 13:
                       write("麥克杰克遜。(打二本泥潭NPC名)----回答時二名一起回答，中間不加任何標點。\n");
		       ...
		       break;
                  ...
                  message("vision", "阿凡提對著"+who->name()+"嘀咕了几句話。\n",
                          environment(who), ({who}) );
                  remove_call_out("destroying");
                  call_out("destroying", 1, this_object(), ob);
                  return 1;
...
int do_answer(string arg)
{
        ...
        switch (arg) {
          ...
          case "龍云": soln=16; break;
	  case "少林": soln=17; break;
	  case "李莫愁" : soln=18; break;
	  case "逍遙洞逍遙游" : soln=19; break;
          case "買賣提" : soln=20; break;
          default :
              say("阿凡提大笑起來，說道：你說什么\呀，牛頭不對馬嘴。\n"
                  + me->name() + "的臉被臊得通紅。\n");
              return 1;
        }
