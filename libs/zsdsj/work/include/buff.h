...
#define BUFF_ARMOR_SLASH		"buff/armor/slash"		// 揮砍類防禦
#define BUFF_ARMOR_GORE			"buff/armor/gore"		// 穿刺類防禦
#define BUFF_ARMOR_EXPLODE		"buff/armor/explode"		// 爆炸類防禦
#define BUFF_ARMOR_INJURY		"buff/armor/injury"		// 內傷類防禦
#define BUFF_ARMOR_FIRE			"buff/armor/fire"		// 烈火抵抗
#define BUFF_ARMOR_ICE			"buff/armor/ice"		// 寒冰抵抗
#define BUFF_ARMOR_POISON		"buff/armor/poison"		// 劇毒抵抗
#define BUFF_ARMOR_HEART		"buff/armor/heart"		// 心靈抵抗
