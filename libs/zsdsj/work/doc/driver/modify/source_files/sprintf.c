...
nosave sprintf_state_t	*sprintf_state = NULL;

nosave void numadd PROT((outbuffer_t *, int num));
nosave void add_space PROT((outbuffer_t *, int indent));
nosave void add_justified PROT((char *str, int slen, pad_info_t *pad, int fs, format_info finfo, short int trailing));
nosave int add_column PROT((cst ** column, int trailing));
nosave int add_table PROT((cst ** table));

#define ERROR(x) sprintf_error(x, 0)

nosave void pop_sprintf_state PROT((void)) {
...
nosave void push_sprintf_state PROT((void)) {
    sprintf_state_t *state;
 ...
 * freed later.
 */
nosave void sprintf_error P2(int, which, char *, premade) {
    char lbuf[2048];
    char *err;
...
nosave void numadd P2(outbuffer_t *, outbuf, int, num)
{
...
nosave void add_space P2(outbuffer_t *, outbuf, int, indent)
{
    int l;
...
nosave void add_pad P2(pad_info_t *, pad, int, len) {
    char *p;
    int padlen;
 ...
 */
nosave void add_justified P6(char *, str, int, slen, pad_info_t *, pad,
 ...
 */
nosave int add_column P2(cst **, column, int, trailing)
{
 ...
 */
nosave int add_table P1(cst **, table)
{
    int done, i;
 ...
 */
nosave pad_info_t *make_pad P1(pad_info_t *, p) {
    pad_info_t *x;
    if (p->len == 0) return 0;
