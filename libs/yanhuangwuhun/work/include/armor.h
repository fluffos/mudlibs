...
// found missing via the lpcc sweep (only /inherit/armor/charm.lpc uses
// this, every sibling TYPE_* slot already existed -- AGENTS.md §8g style
// missing-macro gap, named to match this file's own existing convention.
