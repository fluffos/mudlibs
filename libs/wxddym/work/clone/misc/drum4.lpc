...
int do_knock(string arg)
{
        ...
        msg = BOLD "\n\n\t" + me->query("name") + "敲响了华山绝顶元老组比武场上的大鼓，鼓声咚咚，令人热血沸腾。\n\n" NOR;
...
{
     	if (! arg) return "";
    	if ((strsrch(arg, "本月元老组第一") >= 0)
      	||  (strsrch(arg, "本月元老组第二") >= 0)
      	||  (strsrch(arg, "本月元老组第三") >= 0))
        {
        	arg = replace_string(arg, HIY "本月元老组第一" NOR, "");
        	arg = replace_string(arg, HIY "本月元老组第二" NOR, "");
        	arg = replace_string(arg, HIY "本月元老组第三" NOR, "");
        }
    	return arg;
}
