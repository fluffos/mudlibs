...
mapping *action = ({
([      "action" : "$N手中$w横推，使出一招破海,由上至下向$n刺去",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
([      "action" : "$N一招山崩,剑锋自下而上划了个半弧，$w一提一收，平刃挥向$n的颈部",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
([      "action" : "$N蓦的使一招吞天，顿时剑光中无数朵剑花从四面八方涌向$n全身",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
int get_finish(object me)
{
        ...
        CHANNEL_D->do_channel(this_object(), "rumor", "听说" + me->name() + "演练出"HIY"天道剑"HIM"。\n");
        return 1;
}
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
	...
	if (i > 100)
	{
		...
		} else
		{
			...
			return HIW "但见$N" HIW "微微一笑，缓缓移动天剑，$n" HIW "已然中招！"NOR"\n";
		}
	}
}
