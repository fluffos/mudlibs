...
int waiting(object me)
{
        ...
        else if( !present("fanyao",environment(me)) || !fighter->query_temp("fanyao-asked") )
        {
                if( random(10) == 0 )
...
int fighting(object me, object fighter, int count)
{
        ...
        {
                if( fighter->query_temp("beat_count") >= 14 )
