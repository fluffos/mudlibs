...
Source: [`michaelprograms/nightmare-residuum`](https://github.com/michaelprograms/nightmare-residuum) (`submodule-patch`, pin `dee36ca2`, mudlib root `work/lib`). Catalog FluffOS-compat in `patches/`.
