...
mapping *quest = ({
  ...
  (["name":                "江湖宵小",
   ...
   (["name":                "山贼", 
    "where" :              "/d/job/npc/shanzei",]),
    }), 
    ({
     (["name":                "山贼", 
    "where" :              "/d/job/npc/shanzei",]),
     (["name":                "盖一鸣",
     "where" :              "/d/job/npc/gaiyiming",]),
     (["name":                "常长风",
     "where" :              "/d/job/npc/chang",]),
      (["name":                "花剑影",
     "where" :                "/d/job/npc/hua",]),
      (["name":                "黄须道人",
     "where" :                "/d/job/npc/huangxu",]),
     (["name":                "恶僧",
     "where" :                "/d/job/npc/eseng",]),
      (["name":                "曹化淳",
     "where" :                "/d/job/npc/cao",]),
      (["name":                "朱安国",
     "where" :                "/d/job/npc/zhu",]),
      ...
      ({
         (["name":                "江洋大盗 王三",
     "where" :                "/d/job/npc/dadao",]),
       (["name":                "草寇",
     "where" :                "/d/job/npc/caokou",]),
      (["name":                "恶霸",
     "where" :                "/d/job/npc/eba",]),
      (["name":                "宋扬",
     "where" :                 "/d/job/npc/songyang",]),
      (["name":               "全二风",
     "where" :                 "/d/job/npc/quan",]),
      (["name":               "孟正鹏",
     "where" :                 "/d/job/npc/meng",]),
      (["name":               "鲜于通",
     "where" :                 "/d/job/npc/xian",]),
      (["name":               "麦鲸",
     "where" :                 "/d/job/npc/maijing",]),
      (["name":               "过三拳",
     "where" :                 "/d/job/npc/guo",]),
       }), 
      ({
      (["name":               "赵一伤",
     "where" :                 "/d/job/npc/zhaoyishang",]),   
      (["name":               "钱二败",
     "where" :                 "/d/job/npc/qian",]),    
      (["name":               "孙三毁",
     "where" :                 "/d/job/npc/sun",]),  
      (["name":               "李四摧",
     "where" :                 "/d/job/npc/li",]), 
      (["name":               "周五输",
     "where" :                 "/d/job/npc/zhou",]), 
      (["name":               "吴六破",
     "where" :                 "/d/job/npc/wu",]), 
      (["name":               "郑七灭",
     "where" :                 "/d/job/npc/zheng",]), 
      (["name":               "元广波",
     "where" :                 "/d/job/npc/yuan",]), 
      (["name":               "徐长老",
     "where" :                 "/d/job/npc/xu",]), 
      (["name":               "单正",
     "where" :                 "/d/job/npc/shan",]), 
      (["name":               "霍元风",
     "where" :                 "/d/job/npc/huo",]),
      }), 
      ({
