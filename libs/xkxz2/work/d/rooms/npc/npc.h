...
int singing()
{
 ...
 switch(random(8)) {
       ...
       case 1 : command("chang bosi_xiaoqu"); break;
       case 2 : command("chang wenshi_jian"); break;
       case 3 : command("chang dielian_hua"); break;
       case 4 : command("chang wanghai_chao"); break;
       case 5 : command("chang chunjiang_huayueye"); break;
       case 6 : command("chang yinma_changcheng"); break;
       case 7 : command("chang jiangjin_jiu"); break;
     }
   return 1;
 }
...
{     
      ...
      if (!present("jinzhong shan",ob))
                carry_object("/d/rooms/obj/jinshan")->wield();
      if(me->query("id")!="snowman")
      me->set_temp("kill_snowman", 1);            
...
int do_mo(string target)
{
     ...
     ob = this_object();
      ...
      if(target == "xue" || 
         ...
         target == "daiyu" || 
         target == "baochai") {
        if((string)me->query("id")=="jjgod")
            {
                switch(random(4)) 
                {           
                case 0 : command("kiss jjgod");break;
                case 1 : command("blush"); break;
                case 2 : command("xixi jjgod"); break;
                case 3 : command("blush jjgod"); break;  
                }               
                return 0;
                }
