...
#define F_TRIGGER "/feature/trigger.lpc" 
...
#define BACKUP_DIR         "/data_back_up/"
...
#define NEWTASK_D          "/adm/daemons/newquestd"
...
#define QUEST_D(x)  ("/quest/halfgod/qlist" + x)
...
#define F_DANGPU            "/feature/dangpu.lpc"
