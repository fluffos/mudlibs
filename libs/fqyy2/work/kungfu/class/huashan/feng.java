...
"神色，显然对当年的剑宗气宗之争一直难以忘怀。\n");
	...
	set_skill("zixia-shengong", 1400);
	set_skill("poyu-quan", 1400);
	set_skill("fanliangyi-dao", 1400);
    set_skill("huashan-sword", 1400);
	set_skill("hunyuan-zhang", 1400);
    set_skill("lonely-sword", 1400);
    set_skill("feiyan-huixiang", 1400);
...
void attempt_apprentice(object ob)
{
    ...
    if ( ob->query("int") < 10)
    {
        command("say 也不知道你是真聪明还是假聪明，可是总诀三千字你背不下来。");
        command("sigh");
        return;
    }
	if ( student_num == 3)
