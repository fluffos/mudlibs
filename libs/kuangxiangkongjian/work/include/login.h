...
#define PKLIST				"/adm/etc/pklist"

#define COP_HEAD			"/open/common/npc/cop"
#define PK_LICENSE			"/open/common/obj/pk_license"
#define STARTROOM			"/open/common/room/inn"
#define DEATHROOM			"/open/death/gate"
#define DEATH_ROOM_NO_PEN		"/open/death/wangsi"
...
// 暂时设定为 50 ，若有需要再行斟酌     (fund) (9/20/1996)
