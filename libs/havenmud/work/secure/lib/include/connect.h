...
nosave void InputLinkName(string);
...
nosave void InputTown(string str);
nosave void cmdHelpTown(string str);
nosave void cmdListTown();
nosave void cmdPickTown(string args);
...
nosave void eventGeneratePassword(string email);
#endif /* l_connect_h */
