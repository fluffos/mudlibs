...
string * shot_msg = ({
        ...
        "这是个很热闹的所在，一个$N笑嘻嘻地对着$n迎了上来，似乎要交给$n什么东西。\n",
        "街角上一个$N本来在那里懒洋洋地晒着太阳，突然象离弦的箭一样跳了起来。\n",
        "一个$N站在街心正在吆喝着什么，忽然转眼看见了$n，转身冲了过来！\n",
        "一个很平常的$N站在那里，脸上木然地没什么表情。\n",
        "街面上站着一个$N，嘴里嘟囔着什么话，结果看见$n就大叫了一声扑了过来。\n",
});
...
string * weapon_msg = ({
        ...
        "/d/tudimiao/obj/anqi",
        "/d/tudimiao/obj/anqi",
        "/d/tudimiao/obj/chuidutong",
        "/d/tudimiao/obj/sheerkou",
});
