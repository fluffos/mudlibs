...
/*
	if( interactive(ob = this_player()) && !is_fighting() && (string)this_player()->query("id") == "xuanyuan" ) {
...
{           object ob;
            ...
            if ( ob->query_temp("mrjob_status") == 3 )
               { ob->delete_temp("mrjob_status");
                 ob->add("mrjob_comp", 1);
