...
int perform(object me, object target)
{
	...
	original = me->query_skill("force")/4;
	bili = me->query_str();
	dodge = me->query_dex();
	...
	me->add_temp("apply/attack", original);
...
//	me->start_busy(1+random(2));
	...
	me->start_call_out( (: call_other, __FILE__, "remove_effect", me, skill,bili,original,dodge :), 40);

	return 1;
}

void remove_effect(object me, int skill, int bili, int amount,int dodge)
{
	me->add_temp("apply/speed", - skill*2);
	me->add_temp("apply/strength", - bili/2);
	me->add_temp("apply/dexerity",-dodge/2);
