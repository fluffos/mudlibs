...
int perform(object me, object target)
{
	...
	sp = me->query_skill("sword") + me->query_skill("dodge") + me->query_dex()*5;
	dp = target->query_skill("parry") + target->query_skill("dodge") + me->query_dex()*5;
	...
	if( random(sp) > random(dp) ) 
	{
		...
		me->add("neili", -damage/8 - random(damage/6));
