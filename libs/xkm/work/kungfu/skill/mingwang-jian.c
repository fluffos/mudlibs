...
mapping *action_other = ({

		([      "action" : "紧接着$N使出一式「"CYN"狂风"NOR"」，手中的$w已经迅捷无比的刺向$n的$l",
		        "skill_name" : "狂风",
		        "force" : 400,
		        "dodge" : 35,
		        "lvl" : 90,
		...
		([      "action" : "$N剑锋忽转，一式「"HIG"骤雨"NOR"」，登时剑影弥漫，一片碧绿围向$n",
		        "skill_name" : "骤雨",
		        "force" : 420,
		        "dodge" : 40,
		        "lvl" : 95,
		...
		([      "action" : "$N使出一招「"HIR"天火"NOR"」，全身劲气贯于$w中，一片火红袭向$n的$l",
		        "skill_name" : "天火",
		        "force" : 440,
		        "dodge" : 45,
		        "lvl" : 100,
		...
		([      "action" : "$N使出「"HIB"祭雷"NOR"」，双脚点地，全身转出一团蓝光滚向$n",
		        "skill_name" : "祭雷",
		        "force" : 460,
	        	"dodge" : 50,
		        "lvl" : 100,
		...
		([      "action" : "$N运气于剑，阵阵青蓝，一招「"HIC"掣电"NOR"」，手中$w向$n的$l连攻数剑",
	        	"skill_name" : "掣电",
		        "force" : 480,
		        "dodge" : 55,
	        	"lvl" : 110,
		...
		([      "action" : "$N舞动$w发出逼人剑气刺去，一招「"HIY"万象归宗"NOR"」，挟著闪闪剑光刺向$n的$l",
		        "skill_name" : "万象归宗",
	        	"force" : 500,
		        "dodge" : 60,
		        "lvl" : 115,
...
mapping query_action(object me, object weapon)
{
	...
	{
        	for(i = sizeof(action_other); i > 0; i--)
			if(level > action[i-1]["lvl"])
				return action_other[NewRandom(i, 20, level/5)];
	}
	else {
