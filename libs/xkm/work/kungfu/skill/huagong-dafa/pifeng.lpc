...
*/
        ...
        me->add_temp("apply/speed", me->query_temp("apply/speed",1)+skill);
        me->add_temp("apply/parry", skill);
        me->add_temp("apply/dodge", skill);
        me->add_temp("apply/defence", skill);
...
//bright change
        ...
        me->delete_temp("apply/speed", me->query_temp("apply/speed",1)+skill);
        me->delete_temp("apply/parry", skill);
        me->delete_temp("apply/dodge", skill);
        me->delete_temp("apply/defence", skill);
        me->delete_temp("apply/attack",  skill);
