...
int perform(object me, object target)
{
	...
	target->set_temp("taohua_huaixin",1);
        ...
        if ( me->query("combat_exp",1)/1000 + me->query_skill("kick") + me->query_skill("xuanfeng-saoye") + me->query_int()*10 > target->query("combat_exp",1)/1000 + target->query_skill("dodge") + target->query_skill("parry") + target->query_int()*10)
        {
