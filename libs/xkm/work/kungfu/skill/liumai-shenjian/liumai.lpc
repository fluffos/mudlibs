...
int check_6mai(object me, object target)
{
        ...
        int lv, i, neili, ap, dp, damage, p, j;
        mapping act, *action;
        object wep;
...
([      "action" : liumai_msg[random(sizeof(liumai_msg))],
        ...
        ap = me->query_skill("force") + me->query_skill("liumai-shenjian", 1) + me->query_int();
