...
//	kongming-quan相较的还是内功修为，与物理攻击是否联系待定
	if (victim->query_temp("kongming")
		&& victim->query("max_neili") > 5000
		...
		&& !me->query_temp("weapon") ) 
	{
		if (damage + damage_bonus > 0)
			...
			result = HIR"$N猛觉$n拳力若有若无，自己掌力使实了固然不对，使虚了也是极其危险，不禁暗暗吃惊，一个收势不及，一交跌了下去。\n"NOR;
//			result = "斗然间$N觉得$n的拳力忽虚，一个收势不及，一交跌了下去。\n";
