...
int main( object me, string arg )
{
	...
	me->edit( (: call_other, __FILE__, "do_change" , me, file_name( env ) + ".c" :) );
	write("修改房间描述成功。\n");
	return 1;
}
