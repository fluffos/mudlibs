...
string ask_me()
{
        ...
        if (who->query("dali/rank")>=3)
        {
                ...
                if (who->query("dali/arrestmade")>=10000 && who->query("dali/dut

y")==5 && who->query("dali/rank")==3 && who->query("dali/jobdone")>=6000 && !who->query("dali/findduan") && !who->query_temp("dali/uprank"))
                {
