...
*/
        ...
        if ( me->query_skill("literate", 1) > 100) neili_lost = 10;
        else
        if ( me->query_skill("literate", 1) > 200) neili_lost = 20;
        else neili_lost = 5;
        ...
        me->improve_skill("literate", (int)me->query_skill("literate", 1)/4+1);
        write("你研读《易经文学》，颇有心得。\n");
        return 1;
}
