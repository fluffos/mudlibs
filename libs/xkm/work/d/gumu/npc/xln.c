...
void create()
{
        ...
        set("inquiry", ([
          ...
          "李莫愁" : "她是我师姐，不过我已经派人去清理门户了。",            "钥匙" : 
"嗯....这我可记不清楚，好象是放在古墓里面了吧。",
            "银索" : (: ask_suo :),
          "玉蜂针" : (: ask_zhen :),
        ])); 
         set("zhen_count", 2);
...
string ask_zhen()
{
                 ...
                 || fam["family_name"] != "古墓派")
                  ...
                  if (query("zhen_count") < 1)
                                         return 
"我已经将玉蜂针已给了派去清理门户的人，你好好练功，以后有机会再去吧。";
                  add("zhen_count", -1);
