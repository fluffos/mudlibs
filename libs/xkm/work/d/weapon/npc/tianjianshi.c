...
int do_answer(string arg)
{
	...
	switch ( me->query_temp("or") ) {
	  case 1:
		w_or = new("/d/weapon/tan/item/shenmu",1);
		w_or->move(me);
		message_vision(HIC "欧冶子给了$N一块千年神木。\n" NOR, me);
		break;
	  case 2:
		w_or = new("/d/weapon/tan/item/jinmu",1);
		w_or->move(me);
		message_vision(HIC "欧冶子给了$N一块海底金母。\n" NOR, me);
		break;
	  case 3:
		w_or = new("/d/weapon/tan/item/hanzhu",1);
		w_or->move(me);
...
object creat_weapon()
{
	...
	switch(mask)	{
		case "剑":
			weapon = new("/d/weapon/weapon/m_sword",1);
			return weapon;
		case "刀":
			weapon = new("/d/weapon/weapon/m_blade",1);
			return weapon;
		case "棍":
			weapon = new("/d/weapon/weapon/m_club",1);
			return weapon;
		case "杖":
			weapon = new("/d/weapon/weapon/m_staff",1);
			return weapon;
		case "锤":
			weapon = new("/d/weapon/weapon/m_hammer",1);
			return weapon;
		case "鞭":
			weapon = new("/d/weapon/weapon/m_whip",1);
			return weapon;
	}
}
