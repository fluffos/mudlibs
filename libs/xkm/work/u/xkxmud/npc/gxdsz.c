...
int do_change(string arg)
{
	...
	{
		if( me->query("menggxd") < 10000 )
			return temp2();
		else
		{
			me->add("menggxd",-10000);
			me->add("gxdcon",1);
			me->add("con",1);
