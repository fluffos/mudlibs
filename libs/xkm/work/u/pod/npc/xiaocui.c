...
void create()
{
	...
	set("age", 12+random(6));
	set("long",
     "这是个年龄不大的小姑娘，但宽松的道袍也遮不住她过早发育的身体。\n"
    ...
    set("shen_type", 1);
        ...
        set("inquiry", ([
         "仙桃" : "这「仙桃」珍贵得很，连香主儿也不是能随便吃着的，\n"
                + "不过如果你能把你身上的所有黄金给我，我倒可以从香主儿那里弄些「小仙桃」来。\n",
...
int accept_object(object who, object ob)
{
	...
	if (  (string)ob->query("name") == "茶叶"
                ...
                || (string)ob->query("name") == "黄金"  )
	{
          if ( (string)ob->query("name") == "黄金" ) 
          {
