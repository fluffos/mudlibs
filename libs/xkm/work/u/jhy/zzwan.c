...
void create()
{
        set_name(HIB "再造丸" NOR, ({"poli dan", "puoli", "dan"}));
        set("long", HIW"     一颗淡蓝色的小药丸，闪烁着晶莹的光泽，这就是传说中能够让
人脱胎换骨，洗心革面，重新做人的再造丸了。如想了解更多关于破
...
//   me = this_player();
    ...
    {
    		write(HIR "再造丸每人最多只能服用一次，你以前服用过，不可以再次服用了！\n");
    		return 1;
    }
    else
    {  
...
int do_one()
{
    ...
    return 1;
           ...
           int do_bl()
           {
               ...
               me->set("fupldan", "yes");
               message_vision(HIY "先天盈弱的$N服下再造丸，只觉得浑身是劲，顿时显得强壮了许多！\n" NOR, me);
...
//             me->unconcious();
           ...
           int do_gg()
           {
               ...
               me->set("con", fgg);
               me->set("fupldan", "yes");
               message_vision(HIY "$N服下了一枚再造丸，身体似乎悄悄的发生了些变化。\n $N只感觉浑身胫脉之处如虫蚁咬嚼般难受，惭惭浑身疼痛，意识模糊....\n" NOR, me);
               me->unconcious();
               destruct(this_object());
               return 1;
           }
           ...
           int do_sf()
           {
               ...
               me->set("dex", fsf);
               me->set("fupldan", "yes");
               message_vision(HIY "$N服下了一枚再造丸，骨节啪啪作响，顿觉身轻如燕，\n$N有一很想飞起来的感觉！\n" NOR, me);
//             me->unconcious();
               destruct(this_object());
               return 1;
           }
           ...
           int do_wx()
           {
               ...
               me->set("int", fwx);
               me->set("fupldan", "yes");
               message_vision(HIY "$N服下了一枚再造丸，有点意识恍惚.... \n$N猛的打了一下激凌，脑中突然一片空明，人看上去显得灵慧了许多。\n" NOR, me);
//             me->unconcious();
               destruct(this_object());
...
int do_six()
{
    object me;
    me = this_player();
    message_vision(HIY "因为考虑到再造丸每人只能服用一次，$N最终取消了现在服用再造丸的念头，打算留到最关键的时候再服。\n" NOR, me);
    return 1;
}
