    ...
    //    set("chat_msg", ({
      //          (: random_move :),
       ...
       // carry_object( __DIR__ "lingzhi");
         carry_object(  "/quest/feizei/lingzhi");
        add_money("gold",1);
