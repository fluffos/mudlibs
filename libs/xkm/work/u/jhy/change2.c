...
"一是由于wiz的失误，导致你的先天属性和小于108，二是由于您的一些 \n"
...
"正常加的天赋，请您在调整后通知wiz帮你补上。\n"
	...
	set ("item_desc", ([
		"gaoshi" : 
"\n用xiugai 膂力 悟性 根骨 身法 来修改您的先天属性，注意，四项和必须等于原来的天赋和小于108。\n\n"
...
int do_xiugai(string arg)
{
	...
	int sum,sum2, num1, num2, num3, num4;
	...
	if ( sum >= 108 ) return notify_fail("各项天赋值的总和须为一百零八点！\n");

	if (sum==sum2) return notify_fail("各项天赋值的总和须和原来的一样！\n");
