...
int valid_enable(string usage) 
{
  ...
  if ( skill >= 200)
    return usage == "strike" || usage == "parry" || usage == "sword" 
        ...
        || usage == "whip"   || usage == "force";

  if ( skill >= 150)
    return usage == "strike" || usage == "parry" || usage == "sword" 
        || usage == "blade"  || usage == "hook"  || usage == "force";
