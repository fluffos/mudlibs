...
#define FTP_BUGS_EMAIL "robocoder@tmi-2 or wizards@xkm"
...
//#define FTP_USERS ({ "xuanyuan","seashore","nettrain","lich"})
#define FTP_USERS ({ "puma","jhy","tod","program","snow","xkxmud","londe","bright"})
