...
private void random_gift(mapping my)
{
	...
	tmpstr = tmpint = tmpcon = tmpdex = tmpend = 15;
	...
	my["end"] = 105 - my["dex"] - my["str"] - my["int"] - my["con"];
...
write(HIY"             　　　　　　　请大家用ip 211.163.18.49 5555登陆梦mud！\n"NOR);
write(HIR"             　　　　　　　请大家用域名xkmbbs.my163.com登陆梦mud！\n"NOR);
write(HIC"             　　　　　　　请大家光临我们的主页xkm.my163.com！\n"NOR);
write(NOR"\n");
...
private void init_new_player(object user)
{
	...
	user->set("channels", ({ "chat", "rumor", "xkx" }) );
