...
int do_travel(string arg)
{
	...
	}else if( arg == "gumu" || arg == "古墓" ) {
		destin = "/d/zhongnan/gumu";
		destch = "古墓";
		destmg = "古墓可是全真教的大本营，一般人是不让靠近的，听说里面有机关。您慢慢逛吧。";
	}else if( arg == "lingxiao" || arg == "凌霄" ) {
		destin = "/d/lingxiao/shanya";
		destch = "凌霄";
		destmg = "凌霄城是新开的门派，有什么问题请向巫师反应呀，听说里面有东西不少。您试试吧。";
	}else if( arg == "mingjiao" || arg == "明教" ) {
		destin = "/d/mingjiao/shanmen";
		destch = "明教";
		destmg = "明教新开的门派，可能还有bug呀，有什么问题请向巫师反应呀，听说里面有东西不少，您试试吧。";
