...
nosave mapping family_skills_award=([
					  ...
					  "古墓派"	:({"yunu-jue","yunu-xinjing","tianluo-diwang","meinu-quan"}),
					  "灵鹫宫"	:({"music","bahuang-gong","zhemei-shou","liuyang-zhang"}),
					  "姑苏慕容"	:({"literate","douzhuan-xingyi","canhe-zhi","xingyi-zhang"}),
					  "凌霄城"	:({"snow-zhang","xueshan-jian","bingxue-xinfa","literate"}),
					  //"明教"	:({"literate","douzhuan-xingyi","canhe-zhi","xingyi-zhang"}),
					  ]);
...
nosave mapping family_master=([
					  ...
					  "古墓派"	:"龙姑娘/掌门/xiao longnu/终南山古墓/小龙女",
					  "灵鹫宫"	:"天山童姥/尊主/tong lao/缥缈峰灵鹫宫/天山童姥",
					  "姑苏慕容"	:"慕容公子/公子/murong fu/燕子坞姑苏慕容氏/慕容复",
					  "凌霄城"	:"白万剑/少城主/Bai wanjian/凌霄城/白万剑",
					  //"明教"	:"慕容公子/公子/murong fu/燕子坞姑苏慕容氏/慕容复",
					  ]);
nosave mapping family_master_place=([
					  ...
					  "古墓派"	:"/d/zhongnan/dating",
					  "灵鹫宫"	:"/d/lingjiu/biguan",
					  "姑苏慕容"	:"/d/murong/qing9",
					  "凌霄城"	:"/d/lingxiao/qihan",
					  //"明教"	:"/d/murong/qing9",
					  ]);
...
nosave mapping family_master_basefile=([
					  ...
					  "古墓派"	:"/kungfu/class/gumu/longnu",
					  "灵鹫宫"	:"/kungfu/class/lingjiu/tonglao",
					  "姑苏慕容"	:"/kungfu/class/murong/fu",
					  "凌霄城"	:"/d/lingxiao/npc/bai-wanjian.lpc",
					  //"明教"	:"/kungfu/class/murong/fu",
					  ]);
...
nosave mapping *gaibang_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"洪帮主已传下号令，马上召开丐帮大会，请您尽快赶到扬州总舵。\n"NOR,
		"send_to" : "各位丐帮英雄请了！",
...
nosave mapping *gumu_message = ({
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"掌门小龙女已传下命令，令古墓弟子速回终南山古墓召开重要会议。\n"NOR,
		"send_to" :"各位古墓弟子请了！",
		"send_to1":"为察看各位古墓弟子近期来在江湖上的作为，定于三日后在终南山古墓召开门派大会。",
		"kick_out": "$N说道：“现在我古墓派正在进行掌门会议，请非本门弟子离开此处。”\n",
		"kick_out_player": "$N将$n请了出去。\n",
		"family":"$N说道：“我古墓开派自祖师林朝英以来，随归隐于古墓，但弟子行走江湖也是多行仁义之事，除暴安良，驱逐哒子。”\n",
		"assess_start":"$N说道：“现在开始古墓派大会。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为我古墓派所做贡献最大，特传授你玉女心经精要，望你能将我古墓派发扬光大。”\n",
		"assess_punish":"$N说道：“$P，你数次违我号令，该受门规处置！”\n",
		"assess_award_common":"$N说道：“希望我古墓派能振兴武林，凡古墓弟子须时时牢记用情专一四字。”\n",
...
nosave mapping *lingjiu_message = ({
	([
		"job_tell_mode":"传令",
		"time_noover" : "$N对$n点了点头,说道：“$P，你来的正好。”\n",
		"time_over" : "$N对$n皱了皱眉，说道：“$P，你怎么此时才到？姥姥本有重要任务让你去做，却被你延误时机。\n"
						"下次要再如此，必当重罚。”\n"
		]),
	([
		"job_tell_mode":"oppose_pker",
		"pk_npc" : "$N说道:“近日在$ROOM附近经常有三十六洞七十二岛的余孽出现，你速去将其除去，为得我耳根清净。”\n"
		]),
	([
		"job_tell_mode":"protect",
		"npc" : "$N说道:“近来江湖动乱，常有无辜百姓被邪派妖人所杀，搞得江湖人心惶惶。\n"
	...
	([
		"job_tell_mode":"award",
		"opposepk_award" : "$N说道:“恩，不错，$P，你为本门立下了一功，姥姥将来不会亏待你的。”\n"
		]),
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"尊主天山童姥已传下命令，令灵鹫宫弟子速回天山缥缈峰召开重要会议。\n"NOR,
		"send_to" :"各位灵鹫宫弟子请了！",
		"send_to1":"为察看各位灵鹫宫弟子近期来在江湖上的作为，定于三日后在天山缥缈峰上召开门派大会。",
		"kick_out": "$N说道：“现在我灵鹫宫正在进行重要会议，请非本门弟子离开此处。”\n",
		"kick_out_player": "$N将$n赶了出去。\n",
		"family":"$N说道：“我创建灵鹫宫以来，虎据这天山缥缈峰之上，虽很少与中原武林人士来往，但是也知道些江湖上的蹊跷。\n",
		"assess_start":"$N说道：“现在开始灵鹫宫大会。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为我灵鹫宫所做贡献最大，本座传授你本门武学精要，望你能将密宗发扬光大。”\n",
		"assess_punish":"$N说道：“$P，你数次违我号令，该受门规处置！”\n",
		"assess_award_common":"$N说道：“希望我灵鹫宫能振兴武林，凡古灵鹫宫弟子须时时牢记。”\n",
		"assess_end":"$N说道：“这次灵鹫宫大会到此结束。”\n"
		]),
		});
nosave mapping *murong_message = ({
	([
		"job_tell_mode":"传话",
		"time_noover" : "$N对$n点了点头,说道：“$P，你来的正好。”\n",
		"time_over" : "$N对$n皱了皱眉，说道：“$P，你怎么此时才到？我本有重要任务让你去做，却被你延误时机。\n"
	...
	([
		"job_tell_mode":"oppose_pker",
		"pk_npc" : "$N说道:“近日在$ROOM附近有人阻我大燕复国，你速去将其除去。”\n"
		]),
	([
		"job_tell_mode":"protect",
		"npc" : "$N说道:“近来江湖动乱，常有无辜百姓被邪派妖人所杀，搞得江湖人心惶惶。\n"
	...
	([
		"job_tell_mode":"award",
		"opposepk_award" : "$N说道:“辛苦你了，$P，我大燕复国有望。”\n"
		]),
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"慕容公子已经传下口信，令全慕容家臣速回燕子坞参合庄内厅召开重要会议。\n"NOR,
		"send_to" : "我众位慕容氏家臣听了！",
		"send_to1":	"三日后于燕子坞参合庄内厅召开重要会议，凡我慕容氏家臣，务必准时参加。",
		"kick_out": "$N说道：“现在慕容氏正在召开重要会议，闲杂人等请速离去。”\n",
		"kick_out_player": "$N将$n请了出去。\n",
		"family":"$N说道：“我姑苏慕容氏自慕容龙成创出以彼之道、还施彼身的绝技后，一直以复兴大燕国为己任。”\n",
		"assess_start":"$N说道：“慕容氏会议正式开始。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为我姑苏慕容所做贡献不小，现我指点你一些慕容氏武学精义，望今以后能更好的为我大燕复国尽力！”\n",
		"assess_punish":"$N说道：“$P，你数次坏我慕容氏大事，该当严惩！”\n",
		"assess_award_common":"$N说道：“还望各位能牢记复兴大燕国的任务，我大燕复国遥遥可望了。”\n",
		"assess_end":"$N说道：“本次评定大会到此结束。”\n"
		]),
	});
	
nosave mapping *lingxiao_message = ({
	([
		"job_tell_mode":"传令",
		"time_noover" : "$N对$n点了点头,说道：“$P，你来的正好。”\n",
		"time_over" : "$N对$n皱了皱眉，说道：“$P，你怎么此时才到？我本有重要任务让你去做，却被你延误时机。\n"
	...
	([
		"job_tell_mode":"oppose_pker",
		"pk_npc" : "$N说道:“近日在$ROOM附近经常有江湖败类出现，你速去将其除去，为我城在江湖扬扬名。”\n"
		]),
	([
		"job_tell_mode":"protect",
		"npc" : "$N说道:“近来江湖动乱，常有无辜百姓被邪派妖人所杀，搞得江湖人心惶惶。\n"
	...
	([
		"job_tell_mode":"award",
		"opposepk_award" : "$N说道:“恩，不错，$P，你为本城立下了一功，本城主将来不会亏待你的。”\n"
		]),
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"少城主已传下命令，令凌霄城弟子速回天山凌霄城召开重要会议。\n"NOR,
		"send_to" :"各位凌霄城弟子请了！",
		"send_to1":"为察看各位凌霄城弟子近期来在江湖上的作为，定于三日后在凌霄城召开门派大会。",
		"kick_out": "$N说道：“现在我凌霄城正在进行重要会议，请非本门弟子离开此处。”\n",
		"kick_out_player": "$N将$n赶了出去。\n",
		"family":"$N说道：“我创建凌霄城以来，虎据这大雪山之上，虽很少与中原武林人士来往，但是也知道些江湖上的蹊跷。\n",
		"assess_start":"$N说道：“现在开始凌霄城大会。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为我凌霄城所做贡献最大，本座传授你本门武学精要，望你能将密宗发扬光大。”\n",
		"assess_punish":"$N说道：“$P，你数次违我号令，该受门规处置！”\n",
		"assess_award_common":"$N说道：“希望我凌霄城能振兴武林，凡古凌霄城弟子须时时牢记。”\n",
		"assess_end":"$N说道：“这次凌霄城大会到此结束。”\n"
		]),
		});
/*
nosave mapping *murong_message = ({
