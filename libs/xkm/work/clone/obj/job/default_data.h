...
int assess_gm=ASSESS_NUM*5/10;
int assess_lj=ASSESS_NUM*6/10;
int assess_mr=ASSESS_NUM*5/10;
int assess_lx=ASSESS_NUM*5/10;
//int assess_mj=ASSESS_NUM*5/10;
...
int luck_gm=1+random(3);
int luck_lj=1+random(3);
int luck_mr=2+random(3);
int luck_lx=1+random(3);
//int luck_mj=2+random(3);
/***********************************************************************************/
//各个门派产生任务的比率初始设定
int luck_wdrate=30;
int luck_xxrate=20;
...
　　现有地方：嵩山少林、湖北武当山、终南山、山东泰山、黄河边、洞庭湖、北岳恒山、中岳嵩山、黑木崖。
