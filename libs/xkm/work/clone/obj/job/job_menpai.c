...
string con_name(string name,int mode)
{
	...
	if(mode==1)
	{
		...
		case "古墓派": con_name = "gumu"; break;
		case "灵鹫宫": con_name = "lingjiu"; break;
		case "姑苏慕容": con_name = "murong"; break;
		case "凌霄城": con_name = "lingxiao"; break;
		//case "明教": con_name = "mingjiao"; break;
		default:
				return ("门派转换错误\n");
	...
	if(mode==2)
		...
		case "gumu": con_name = "古墓派"; break;
		case "lingjiu": con_name = "灵鹫宫"; break;
		case "murong": con_name = "姑苏慕容"; break;
		case "lingxiao": con_name = "凌霄城"; break;
//		case "mingjiao": con_name = "明教"; break;
			default:
				return ("英文-〉中文门派转换错误\n");
