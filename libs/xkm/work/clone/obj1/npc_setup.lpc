...
string set_skills(string menpai, int exp, int skill_rate)
{
	...
	break;
    case "murong":
        set_skill("murong-daofa", level);
        set_skill("murong-shenfa", level);
        set_skill("douzhuan-xingyi", level);
		set_skill("xingyi-zhang", level);
	...
	break;
    case "gumu":
        set_skill("wudu-xinfa", level);
        set_skill("jueqing-bian", level);
        set_skill("tianluo-diwang", level);
        set_skill("meinu-quan", level);
		set_skill("gumu-shenfa", level);
	...
	break;
    case "lingjiu":
        set_skill("bahuang-gong", level);
        set_skill("tianyu-qijian", level);
        set_skill("ruyi-dao", level);
	set_skill("liuyang-zhang", level);
	set_skill("zhemei-shou", level);
