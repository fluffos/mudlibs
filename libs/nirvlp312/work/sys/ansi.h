 ...
 *      Edited by Rumplemintz, added new defines and included new
 *                             cntl_sequences.h file
 */
#ifndef _sys_ansi_h
#define _sys_ansi_h
...
#define ANSI_NORMAL              CS_NORMAL
#define ANSI_BOLD                CS_BOLD
#define ANSI_UNDERSCORE          CS_UNDERSCORE

#define ANSI_BLACK               CS_BLACK
#define ANSI_RED                 CS_RED
#define ANSI_GREEN               CS_GREEN
#define ANSI_YELLOW              CS_YELLOW
#define ANSI_BLUE                CS_BLUE
#define ANSI_MAGENTA             CS_MAGENTA
#define ANSI_CYAN                CS_CYAN
#define ANSI_WHITE               CS_WHITE

#define ANSI_BOLD_BLACK          CS_BOLD_BLACK
#define ANSI_BOLD_RED            CS_BOLD_RED
#define ANSI_BOLD_GREEN          CS_BOLD_GREEN
#define ANSI_BOLD_YELLOW         CS_BOLD_YELLOW
#define ANSI_BOLD_BLUE           CS_BOLD_BLUE
#define ANSI_BOLD_MAGENTA        CS_BOLD_MAGENTA
#define ANSI_BOLD_CYAN           CS_BOLD_CYAN
#define ANSI_BOLD_WHITE          CS_BOLD_WHITE

#define ANSI_BG_BLACK            CS_BG_BLACK
#define ANSI_BG_RED              CS_BG_RED
#define ANSI_BG_GREEN            CS_BG_GREEN
#define ANSI_BG_YELLOW           CS_BG_YELLOW
#define ANSI_BG_BLUE             CS_BG_BLUE
#define ANSI_BG_MAGENTA          CS_BG_MAGENTA
#define ANSI_BG_CYAN             CS_BG_CYAN
#define ANSI_BG_WHITE            CS_BG_WHITE
