# fengyun3xiuding — 风云Ⅲ (星星修订版) / "Fengyun III, Xingxing's revised edition"
...
branding already seen on archives #33/#34, `shujiantianxia`/
`shujianpiaoling2`). `readme.txt` (converted): "这是星星修订的风云3，非常
...
lpcc sweep also running on `fengyun3dianzang` — no OOM risk at this file
count).
...
processing archive #98 (`风云III典藏版.rar` → `fengyun3dianzang`, a
