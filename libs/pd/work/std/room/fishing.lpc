...
//  Made the fishing code a separate file, so it can be included in other rooms
//  Nulvect 2010-12-02

#define FISH ([ "mackeral":3, "sea bass":4, "blue fish":5, "flounder":12, "marlin":20, "swordfish":30 ])
...
void give_player_a_fish(string who, string fish_name, int strength) {
	...
	this_catch->set_long("A fish caught by a fisher of Primal Darkness!\n");
