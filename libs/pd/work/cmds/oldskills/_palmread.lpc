...
int abil() {
  ...
  // 6 clairvoyance per level, this is gained at level 7
  if (tp &&
      tp->query_subclass() == "gypsy" &&
      tp->query_skill("clairvoyance") >= 37)
    return 1;
