...
if (this_player()->query_level() <= 35)
	...
	j += (int)this_player()->query_stats("strength")* 4/5;
	j += (int)this_player()->query_stats("dexterity") * 4/5;
    ...
    {
	j +=  (int)this_player()->query_skill("murder")*3/5;
	j += (int)this_player()->query_skill("agility")*2/5;
	j += (int)this_player()->query_stats("strength");
	j += (int)this_player()->query_stats("dexterity");
	j -= ((int)victim->query_stats("constitution"))/4;
	j -= ((int)victim->query_skill("defense"))/3;	
