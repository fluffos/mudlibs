...
int cmd_stun(string str)
{
    ...
    if (this_player()->query_current_attacker())
        return notify_fail("You cannot find an opening in the stomach area.\n");
   ...
   if (mstr >= 200) para = 5;
    ...
    write("%^ORANGE%^You send a punch to "+ob->query_cap_name()+"'s stomach knocking the wind out of "+gen+".");
    say("%^ORANGE%^"+this_player()->query_cap_name() + " sends a punch to "+ob->query_cap_name()+"'s stomach knocking the wind out of "+gen+".");
