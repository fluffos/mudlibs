...
int help()
{
    write("Command: speak\nSyntax: speak [in <language>] <text>\n"
      ...
      "       text.  The others will see parts of it based on their speaking\n"
