...
//    cat("/wizards/descartes/guild/news/news");
    return 1;
}

int info(string str) {
    if(!str || str != "truth") return 0;
    this_player()->more("/wizards/descartes/guild/news/info");
    return 1;
}
...
mixed *query_auto_load() {
    return ({ "/wizards/descartes/guild/object/seeker_scroll",
...
int add_member(object who) {
    ...
    who->setenv("start", "/wizards/descartes/guild/room/phil_lounge");
    ob = new("/wizards/descartes/guild/object/seeker_scroll");
    ob->move(who);
    return 1;
}
...
int seekhome(string str) {
    ...
    this_player()->move_player("/wizards/descartes/guild/room/phil_lounge");
...
void end_news() {
    rm("/wizards/descartes/guild/news/news");
    write_file("/wizards/descartes/guild/news/news", read_file("/tmp/phil_news"));
    rm("/tmp_phil_news");
