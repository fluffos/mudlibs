...
//  bcost = bdmg/11;
  bcost = BALANCE3_D->get_cost(bdmg, rank, "sp");
  ...
  tgt->do_damage(limb, bdmg, DAMAGE_PHYSICAL | DAMAGE_SLASH, 0, tp);
...
//  kcost = kdmg/12;
  kcost = BALANCE3_D->get_cost(kdmg, rank, "sp");
  ...
  tgt->do_damage(limb, kdmg, DAMAGE_PHYSICAL | DAMAGE_SLASH, 0, tp);
