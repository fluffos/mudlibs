...
mapping forage = ([
  ...
  "food" : ([
    "forest" : ({"nut","fruit","mushroom","root","large fruit","melon","large egg"}),
    "mountain" : ({"nut","berry","egg","root","large root","melon","large egg"}),
    "swamp" : ({"garlic","berry","mushroom","moss","large root","bulb","large egg"}),
    "plains" : ({"garlic","berry","egg","root","large root","onion","large egg"}),
    "jungle" : ({"berry", "fruit", "egg", "root", "large fruit", "large beetle", "salamander"}),
