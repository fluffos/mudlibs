...
attack = BALANCE_D->get_damage( tp, ob, 3, ({ "magic attack" }),
                                   ({ "wisdom", "intelligence" }), ({ "wisdom", "intelligence" }) );
attack = attack + attack/3;
    ...
    write("%^BOLD%^You focus your efforts into turning " + ob->query_cap_name() + "'s mana into deadly fire in " + ob->query_possessive() + " veins.\n");
        ...
        tp->set_disable();
        tp->add_skill_points("magic attack", (attack/20));
        tp->add_alignment(-25);
        ...
        void help() 
{
        ...
        "opponents' bodies and turn it into pain is of great use against mages."
        "\n");
}
int spell() {
object tp;
