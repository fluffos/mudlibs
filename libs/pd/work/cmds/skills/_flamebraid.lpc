...
int cmd_flamebraid(string str) {
  ...
  for (int i=0; i<hits; i++) {
    ...
    message("magic", COL+"A b%^YELLOW%^ra%^RED%^id of flame twines all around you!"+RES, tgt);
    message("magic", COL+"A b%^YELLOW%^ra%^RED%^id of flame twines all around "+
