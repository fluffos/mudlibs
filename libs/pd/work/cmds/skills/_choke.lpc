...
//    cost = (dmg+count*50)/9.5;
    cost = BALANCE3_D->get_cost(dmg+count*50, 3, "sp") * (110+count*10) / 100;
  ...
  tgt->do_damage("head", dmg/3, DAMAGE_UNARMED | DAMAGE_PHYSICAL, DAMAGE_BYPASS_ARMOUR | DAMAGE_NO_SEVER, tp);
  tgt->do_damage("none", dmg*2/3, DAMAGE_UNARMED | DAMAGE_PHYSICAL, DAMAGE_BYPASS_ARMOUR, tp);
