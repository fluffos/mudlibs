...
int cmd_feint(string str) {
  ...
  bonus = tp->query_skill("blade")*75/100;
  bonus += tp->query_stats("dexterity")*3/2;
  ...
  bonus -= tgt->query_stats("intelligence")*3/2;
  bonus -= tgt->query_skill("agility")/3;
