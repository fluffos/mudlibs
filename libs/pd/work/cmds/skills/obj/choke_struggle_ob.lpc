...
int do_struggle(string str) {
  ...
  // this is weird logic, sorry.. if it's "struggle" or an exit name, then struggle,
  // else check if it's a spell or abil
  if (verb != "struggle" && member_array(verb, env->query_exits()) == -1) {
