...
set_items((["room" : "This room is old, broken and tragic, very well resembling the crabs which come here to die.", "walls" : "There are bits of broken shell sticking out of the walls, an accident waiting to happen.", "ceiling" : "Large bits of shell jut out from above, causing you to duck your head every now and then.", "floor" : "Shell is littering the floor, it crunches beneath you as you walk upon it.", "shell" : "It is broken bits of crab exoskeleton, from the crabs who have died here. There is no explanation as to why its in broken pieces though..."]));
