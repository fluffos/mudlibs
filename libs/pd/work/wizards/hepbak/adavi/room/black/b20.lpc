...
room::create();
   ...
   set_short("Adavi Swamp");
    set_day_long(
      ...
      "steep point, making it impossible to climb over it to "           "continue the journey south.  Along the east wall, some vines "
      "cling onto it.  The path to the north leads back "
      "through the swamp."
    );
    set_night_long(
      "The trees thin out a bit as a large boulder comes into "
      "view.  The boulder rises out of the earth and comes to a "
      "steep point, making it impossible to climb over it to "           "continue the journey south.  Along the east wall, some vines "
      "cling onto it.  The path to the south leads north "
      "through the swamp."
    );
    set_items(([
        "trees" : ".",
...
int climb2()
{
    write("You scurry up the vines with ease.");
        this_player()->move_player(BLACK "b12", "climbs up the vines."); 
    return 1;
}
