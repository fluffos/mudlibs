...
void create() {
  ...
  set_long(
   ...
   "to a cave is in the eastern mountain wall. Several plants and "
  ...
  set_items(([
    ...
    " An opening to a cave lies within the east mountain "
    "wall.",
    ...
    "cave" : "A cave lies within the eastern mountain wall.",
    "opening" : "The opening to a cave lies within the face of the "
    "eastern mountain wall. It appears to be darker within the "
    "cave than out here.",
