...
({"hole", "south wall"}) : "There is a hole in the southern wall that appears to"
    ...
    set_exits( ([ 
       "south" :  "/wizards/smoke/mountain/rooms/hole1",
       "southwest" :  "/wizards/smoke/mountain/rooms/hole3",
       "northwest" :  "/wizards/smoke/mountain/rooms/hole11",
       "southeast" :  "/wizards/smoke/mountain/rooms/hole21",
       "northeast" :  "/wizards/smoke/mountain/rooms/hole13"
    ]) );
}
void reset() {
    if(!present("ogre"))
