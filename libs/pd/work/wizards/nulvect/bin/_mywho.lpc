...
#define GUILDS ({ "vorticon","forsaken","lastsaints","unholy","darksoul","illuminati","dw","blacksails" })
...
<tr><td colspan=10 align="right"><center><hr size=1 width="100%"></center></td></tr>
END;
