...
void help() {
  message("help",
    ...
    "money at someone. You will lose coins of the "
    "chosen currency, of course. The more the coin is worth, "
...
int cmd_flick(string str) {
  ...
  switch (cur) {
    case "platinum": mult = 65; break;
    case "gold": mult = 57; break;
    case "electrum": mult = 48; break;
    case "silver": mult = 35; break;
    case "copper": mult = 27; break;
    default: mult = 40;
  }
  ...
  for (int i = 0; i < howmany; i++) {
    ...
    if (hit < dodge+random(10)-random(5)) {
      miss++;
      continue;
    }
    ...
    tgt->do_damage(tgt->return_limb(), dmg+random(5));
