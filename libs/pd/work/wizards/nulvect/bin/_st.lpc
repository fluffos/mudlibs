...
void skills_display() {
    ...
    int i, blah;
    attack = ({ "attack", "melee", "defense", "double wielding", "rage", "charging", "riding" });
    weapon = ({ "knife", "blade", "blunt", "ranged", "projectile", "axe", "flail" });
    decep = ({ "locks", "stealth", "murder", "stealing", "bargaining","agility", "euphony",
               "perception", "valor", "discipline", "ferocity", "entertainment", "flying" });
    mag = ({ "faith", "healing", "conjuring", "magic attack", "magic defense", "summoning",
             "psionics", "wizardry", "illusion", "nature", "belief", "necromancy", "pyromancy",
             "clairvoyance"});
