...
// rewritten by Nulvect 20080316, original author unknown
...
void help() {
  message("help",
    ...
    "something from a container (such as bags or pouches) "
    "in someone's inventory. Smarter thieves usually grab "
    "the more valuable things first.",
    this_player());
}
