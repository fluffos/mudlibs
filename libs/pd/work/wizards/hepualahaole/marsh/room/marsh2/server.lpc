...
void create() {
  ...
  set_day_sentances( ({
   ...
   "Something swimming in the water leaves a wake of ripples behind it off in
the distance.",
...
"
 low riding fog drifts by, before it dissipated into thin air.",
...
MOB"falligator", MOB"mwaterbug", MOB"fcockroach", MOB"mudbug"
  }) );
