...
set_weight(70);
set_type("armour");
set_limbs(({"torso", "first arm", "second arm", "third arm", "fourth arm", "right foreleg", "left foreleg", "right rear leg", "left rear leg", "head", "first hand", "second hand", "third hand", "fourth hand"}));
}
int query_auto_load() {
