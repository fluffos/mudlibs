...
void create() {
 ::create();
   set_name("bracer");
   set_short("%^YELLOW%^Gold%^RED%^ S%^RESET%^YELLOW%^erpent%^RESET%^ "
             "Bracer");
   set_long("A finely crafted golden bracer in the form of a winding "
            "serpent.  A small ruby is set in the eye.");
