...
void create() {
  ...
  set("long","The cake has 20 candles all lit up, creating a cheery glow.  A light frosting covers the soft cake.  It looks like you could <cut a piece> of cake if you wanted.  There is something written in the frosting.");
  set_prevent_get("You'd ruin the party if you took the whole cake!");
  set("read", "Happy 20th Birthday, Azire!");
  set_weight(100000);
  set_value(0);
}
