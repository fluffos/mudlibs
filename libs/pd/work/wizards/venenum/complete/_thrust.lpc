...
int cmd_thrust(string str)
{
	...
	if (ob==this_player())
	{
	    write("Now that is very silly, isn't it? *sigh*, you mooks, making me put more functions into my abilities just to stop you hurting yourself... *grumblemutter*");
	    return 1;
	}
    }
    ...
    if(!sizeof(wield)) {
	return notify_fail("You need a spear to thrust with.\n");
    }
