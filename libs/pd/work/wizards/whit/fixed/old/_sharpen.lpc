...
int cmd_sharpen(string str) {
   ...
   if (!ob->sharpen(random(4)))
     return notify_fail("It cannot be sharpened any more than it already is.\n");
...
A soldier, knight, and warrior ability, sharpen improves the quality
of a bladed weapon.
");
}
...
int abil() {
   ...
   o = this_player();
   if (o)
     if (o->query_subclass() == "ranger" || o->query_subclass() == "warrior" || o->query_subclass() == "scout")
      if (o->query_level() >= 6)
          return 1;
}
