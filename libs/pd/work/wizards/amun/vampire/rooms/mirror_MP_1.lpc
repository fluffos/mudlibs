...
void create() {
    ...
    set_exits( ([ "west" : VR"mirror_LS_1", "east" : VR"mirror_MP_2", "northeast" : VR"mirror_MP_5", "north" : VR"mirror_MP_4" ]) );
    set_invis_exits( ({"southwest", "southeast", "east", "northeast", "north", "northwest", "west"}) );
    skip_obvious();
}
string make_a_long() {
