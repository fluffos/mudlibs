...
void create() {
    ...
    set_exits( ([ "west" : VR"mirror_BP_4", "southwest" : VR"mirror_BP_1", "south" : VR"mirror_BP_2", "southeast" : VR"mirror_BP_3", "east" : VR"mirror_BP_6", "north" : VR"mirror_MP_2" ]) );
    set_invis_exits( ({"west", "southwest", "south", "southeast", "north", "east"}) );
    skip_obvious();
}
string make_a_long() {
