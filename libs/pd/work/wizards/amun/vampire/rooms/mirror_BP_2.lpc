...
void create() {
    ...
    set_exits( ([ "east" : VR"mirror_BP_3", "north" : VR"mirror_BP_5", "northeast" : VR"mirror_BP_6", "northwest" : VR"mirror_BP_4", "west" : VR"mirror_BP_1" ]) );
    set_invis_exits( ({"east", "north", "northeast", "northwest", "west"}) );
    skip_obvious();
}
string make_a_long() {
