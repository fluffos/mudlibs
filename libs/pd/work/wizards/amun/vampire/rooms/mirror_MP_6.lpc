...
void create() {
    ...
    set_exits( ([ "west" : VR"mirror_MP_5", "southwest" : VR"huanted_MP_2", "south" : VR"mirror_MP_3", "east" : VR"mirror_RS_2", "northwest" : VR"mirror_MP_8" ]) );
    set_invis_exits( ({"west", "southwest", "south", "east", "northwest"}) );
    skip_obvious();
}
string make_a_long() {
