...
void create() {
    ...
    set_exits( ([ "west" : VR"mirror_LS_3", "south" : VR"mirror_MP_1", "southeast" : VR"mirror_MP_2", "east" : VR"mirror_MP_5", "northeast" : VR"mirror_MP_8" ]) );
    set_invis_exits( ({"west", "south", "southeast", "east", "northeast"}) );
    skip_obvious();
}
string make_a_long() {
