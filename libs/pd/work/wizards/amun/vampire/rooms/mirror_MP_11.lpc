...
void create() {
    ...
    set_exits( ([ "west" : VR"mirror_MP_10", "southwest" : VR"mirror_MP_7", "south" : VR"mirror_MP_8", "southeast" : VR"mirror_MP_9", "east" : VR"mirror_MP_12", "north" : VR"mirror_MP_13" ]) );
    set_invis_exits( ({"west", "southwest", "south", "southeast", "east", "north"}) );
    skip_obvious();
}
string make_a_long() {
