...
void create() {
    ...
    set_long(
      ...
      "%^BOLD%^%^BLACK%^This is a place for people to sell their armour and get money for their travels. The room is dusty and looks as if it has not been utilized in years. Marvello has a list posted on the wall for all to read.");
