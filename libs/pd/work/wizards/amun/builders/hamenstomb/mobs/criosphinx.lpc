...
void create() {
    ...
    set("long", "%^RESET%^%^ORANGE%^The Sphinx stands proud as if all-knowing. She seems to be staring at the floor.%^RESET%^" );
    set("race", "Sphinx" ); 
    set_gender( "female" );
