...
void create() {
    ...
    set("long", "%^BOLD%^%^YELLOW%^The writings on the walls seem dimmer than before, but are still noticable under the Sphinx. Cracks are beginning to form at the base of the walls. The noise in the distance is getting louder the more the path leads west. There must be some big creature to the east.\n");
    ...
    set_exits( ([ "west" : ROOMS+"hamen_tomb_2", "east" : ROOMS+"hamen_tomb_6"]) );
}
void reset() {
    ::reset();
