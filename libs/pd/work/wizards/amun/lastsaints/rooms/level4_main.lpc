...
void create() {
    ...
    set("long", "%^BOLD%^%^WHITE%^The fourth floor of the Last Saints holds the halls for its members. The Clergy, Mage, fighter, Rouge and Wanderer halls go off into different directions. You can hear different sounds coming from each hall.%^RESET%^");
