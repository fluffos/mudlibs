...
void create() {
    ...
    set_long("A well traveled pathway winds down the inside of the mountain toward a small city.  Torches line the path but the smoke ventilation is slow, and the air is very thin.  Sounds of commotion echo across the walls, although it's not clear how far away it is coming from.  A light shines farther down the path.");
set_exits(([ "down" : ROOMS"mountainpath/72",
"east" : ROOMS"mountainpath/70",
]));
    set_items( ([
