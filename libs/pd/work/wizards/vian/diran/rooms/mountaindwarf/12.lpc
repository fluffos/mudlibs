...
void create() {
    ...
    set_long("A road of carefully set stones leads out of the tundra. It is kept fairly clean of snow.  It seems to be heading toward a huge gate.  There is a stone directly to your east.");
set_exits(([
"east" : ROOMS"mountaindwarf/9",
"west" : ROOMS"mountaindwarf/13",
