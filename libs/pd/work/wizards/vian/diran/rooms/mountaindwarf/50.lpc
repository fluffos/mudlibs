...
void create() {
    ...
    set_long("The huge gate surrounding Diran is fairly plain.  It is a giant wall made out of coarse stones, kept together with some sort of muddy cement.  There are holes cut out in the wall for archers to shoot from incase of a Duergar attack.  A small fire is burning in the middle of the room.");
set_exits(([
"south" : ROOMS"mountaindwarf/49",
"north" : ROOMS"mountaindwarf/51",
...
"fire":"The fire is fairly small, but still provides much needed warmth.",
]) );
