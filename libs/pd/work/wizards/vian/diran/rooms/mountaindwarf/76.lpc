...
void create() {
    ...
    set_long("A road of carefully set stones continues through the Mountain Dwarf city of Diran.  Citizens crowd the streets, it seems as if they may do most of their living outdoors.  The city continues to the west, while the tundra remains back to the east.");
set_exits(([
"east" : ROOMS"mountaindwarf/13",
"west" : ROOMS"mountaindwarf/77",
