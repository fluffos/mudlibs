...
set_long("A road of carefully set stones continues through the Mountain Dwarf city of Diran.  Citizens crowd the streets, it seems as if they may do most of their living outdoors.  The city continues to the east and west, and back to the north.  A few stones on the side of the road seem to be crumbling.");
set_exits(([
"east" : ROOMS"mountaindwarf/91",
"west" : ROOMS"mountaindwarf/93",
"north" : ROOMS"mountaindwarf/86",
