...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city. Moss is growing up the outside of the wall and sneaking into the parapet here.");
set_exits(([
"north" : ROOMS"mountaindwarf/33",
"south" : ROOMS"mountaindwarf/35",
