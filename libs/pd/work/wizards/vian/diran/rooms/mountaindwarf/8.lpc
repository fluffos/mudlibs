...
void create() {
    ...
    set_long("A road of carefully set stones leads out of the tundra, and is kept fairly clean of snow.  It seems to be heading toward a huge gate.  There is a small circular path surrounding a huge stone.  Weeds are growing in the space between the stone and the path.");
set_exits(([
"east" : ROOMS"mountaindwarf/7",
"south" : ROOMS"mountaindwarf/9",
