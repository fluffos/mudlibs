...
void create() {
    ...
    set_long("A road of carefully set stones leads out of the tundra, and is kept fairly clean of snow.  It seems to be heading toward a huge gate.  There is a small circular path surrounding a huge stone.  It looks like someone tried to break the stone down, but didn't get far.");
set_exits(([
"west" : ROOMS"mountaindwarf/8",
"south" : ROOMS"mountaindwarf/6",
