...
void create() {
    ...
    set_long("The huge gate surrounding Diran is fairly plain.  It is a giant wall made out of coarse stones, kept together with some sort of muddy cement.  There are holes cut out in the wall for archers to shoot from incase of a Duergar attack.  Someone has drawn some graffiti on the gate here.");
set_exits(([
"east" : ROOMS"mountaindwarf/55",
"west" : ROOMS"mountaindwarf/57",
...
"graffiti":"Someone has scrawled 'Obsidian is HOT!!!' on the gate.",
]) );
