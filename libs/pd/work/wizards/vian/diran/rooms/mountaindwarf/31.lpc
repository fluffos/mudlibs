...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city.  Commotion can be heard from the church below in the city.");
set_exits(([
"north" : ROOMS"mountaindwarf/30",
"south" : ROOMS"mountaindwarf/32",
