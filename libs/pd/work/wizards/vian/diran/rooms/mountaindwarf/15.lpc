...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city.  There are broken arrows littering the ground.");
set_exits(([
"south" : ROOMS"mountaindwarf/14",
"north" : ROOMS"mountaindwarf/16",
