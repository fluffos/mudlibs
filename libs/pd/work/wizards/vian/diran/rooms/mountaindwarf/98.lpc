...
void create() {
    ...
    set_long("The huge church is a building made of very polished stones with large stained glass windows.  Candles float throughout the air, lighting the church fully.  There are no benches, just a huge open space.  There appears to be a tall circular stone in the center of the church.  There is a small pool of dried blood in the corner of the room.");
set_exits(([
"east" : ROOMS"mountaindwarf/97",
"south" : ROOMS"mountaindwarf/99",
]));
    set_items( ([
...
"blood":"It seems someone was fighting in here.",
]) );
