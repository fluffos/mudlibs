...
void create() {
    ...
    set_long("The huge church is a building made of very polished stones with large stained glass windows.  Candles float throughout the air, lighting the church fully.  There are no benches, just a huge open space.  There appears to be a tall circular stone in the center of the church.  There is a cabinet against the southwest wall, containing potions and spellbooks.");
set_exits(([
"east" : ROOMS"mountaindwarf/101",
"north" : ROOMS"mountaindwarf/99",
]));
    set_items( ([
...
"cabinet":"The cabinet contains many valuable items, although it seems to have some sort of magical protection.",
]) );
