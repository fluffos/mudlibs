...
set_long("A road of carefully set stones continues through the Mountain Dwarf city of Diran.  Citizens crowd the streets, it seems as if they may do most of their living outdoors.  The city continues to the south, while there appears to be a shop to the north.");
set_exits(([
"south" : ROOMS"mountaindwarf/78",
"north" : ROOMS"mountaindwarf/82",
]));
    set_items( ([
