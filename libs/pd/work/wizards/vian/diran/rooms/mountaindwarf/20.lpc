...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city.  All is white for miles in any direction, save for a medium sized mountain.");
set_exits(([
"east" : ROOMS"mountaindwarf/19",
"west" : ROOMS"mountaindwarf/21",
