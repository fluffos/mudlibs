...
void create() {
    ...
    set_long("The huge gate surrounding Diran is fairly plain.  It is a giant wall made out of coarse stones, kept together with some sort of muddy cement.  There are holes cut out in the wall for archers to shoot from incase of a Duergar attack.  The ocean can be seen to the south through the holes in the wall.");
set_exits(([
"west" : ROOMS"mountaindwarf/65",
"east" : ROOMS"mountaindwarf/67",
...
"ocean":"The ocean is a bit far away, but visible.",
]) );
