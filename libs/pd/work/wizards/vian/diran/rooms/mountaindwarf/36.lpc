...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city.  Past a bit of snow to the south, the ocean can be seen.");
set_exits(([
"west" : ROOMS"mountaindwarf/35",
"east" : ROOMS"mountaindwarf/37",
