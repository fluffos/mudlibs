...
void create() {
    ...
    set_long("The huge church is a building made of very polished stones with large stained glass windows.  Candles float throughout the air, lighting the church fully.  There are no benches, just a huge open space.  There appears to be a tall circular stone in the center of the church.");
set_exits(([
"south" : ROOMS"mountaindwarf/94",
"north" : ROOMS"mountaindwarf/96",
"west" : ROOMS"mountaindwarf/102",
]));
    set_items( ([
