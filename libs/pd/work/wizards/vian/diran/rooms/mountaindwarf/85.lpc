...
set_long("A road of carefully set stones continues through the Mountain Dwarf city of Diran.  Citizens crowd the streets, it seems as if they may do most of their living outdoors.  The city continues to the north, east, and south.");
set_exits(([
"south" : ROOMS"mountaindwarf/86",
"north" : ROOMS"mountaindwarf/78",
"east" : ROOMS"mountaindwarf/88",
