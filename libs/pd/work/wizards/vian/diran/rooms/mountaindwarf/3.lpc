...
void create() {
    ...
    set_long("A road of carefully set stones leads out of the tundra. It is kept fairly clean of snow.  It seems to be heading toward a huge gate.  There is a large pile of snow on the side of the road, probably from sweeping the road clean.");
set_exits(([
"north" : ROOMS"mountaindwarf/4",
"south" : ROOMS"mountaindwarf/2",
