...
void create() {
    ...
    set_long("The huge gate surrounding Diran is fairly plain.  It is a giant wall made out of coarse stones, kept together with some sort of muddy cement.  There are holes cut out in the wall for archers to shoot from incase of a Duergar attack.  Shattered glass litters the floor here.");
set_exits(([
"south" : ROOMS"mountaindwarf/73",
"north" : ROOMS"mountaindwarf/75",
...
"glass":"The glass looks like it used to contain firebreathers.",
]) );
