...
void create() {
    ...
    set_long("A road of carefully set stones leads out of the tundra, and is kept fairly clean of snow.  It seems to be heading toward a huge gate.  There is a small circular path surrounding a huge stone.  There are smaller boulders on the ground surrounding the stone.");
set_exits(([
"east" : ROOMS"mountaindwarf/5",
"north" : ROOMS"mountaindwarf/7",
"south" : ROOMS"mountaindwarf/11",
