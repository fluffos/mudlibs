...
set_long("A road of carefully set stones continues through the Mountain Dwarf city of Diran.  Citizens crowd the streets, it seems as if they may do most of their living outdoors.  The city continues to the east and west.");
set_exits(([
"east" : ROOMS"mountaindwarf/89",
"west" : ROOMS"mountaindwarf/85",
