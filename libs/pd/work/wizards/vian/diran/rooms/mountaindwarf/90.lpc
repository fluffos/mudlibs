...
void create() {
    ...
    set_long("The road ends abruptly here at a large firepit, billowing smoke into the air.  There are many logs surrounding the firepit, and blankets strewn around the ground.  This appears to be a sleeping area for the Diran Mountain Dwarves.  The only exit is the same as the entrance.  Weapons surround the ground of the firepit, incase of an invasion.");
set_exits(([
"west" : ROOMS"mountaindwarf/87",
