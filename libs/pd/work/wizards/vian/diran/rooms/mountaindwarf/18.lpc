...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city.  A vat of molten metal lies by the wall.");
set_exits(([
"east" : ROOMS"mountaindwarf/17",
"west" : ROOMS"mountaindwarf/19",
...
"vat":"It looks like arrowheads are formed with this.",
]) );
