...
void create() {
    ...
    set_long("A road of carefully set stones leads out of the tundra. It is kept fairly clean of snow.  It seems to be heading toward a huge gate.  A stone can be seen to the west.");
set_exits(([
"west" : ROOMS"mountaindwarf/6",
"east" : ROOMS"mountaindwarf/4",
