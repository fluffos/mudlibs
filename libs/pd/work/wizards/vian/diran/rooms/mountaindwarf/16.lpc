...
void create() {
    ...
    set_long("The parapets atop the giant gate surrounding Diran are fairly plain.  There are large stone fortifications to hide behind, and holes in the walls to shoot arrows through if Duergar attempt to invade the city.  Wood chips from arrow construction litter the ground.");
set_exits(([
"south" : ROOMS"mountaindwarf/15",
"north" : ROOMS"mountaindwarf/17",
