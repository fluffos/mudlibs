...
void create() {
    ...
    set_long("The huge church is a building made of very polished stones with large stained glass windows.  Candles float throughout the air, lighting the church fully.  There are no benches, just a huge open space.  There appears to be a tall circular stone in the center of the church.  White rose petals form a circle on the floor here.");
set_exits(([
"south" : ROOMS"mountaindwarf/100",
"north" : ROOMS"mountaindwarf/98",
"east" : ROOMS"mountaindwarf/102",
]));
    set_items( ([
...
"rose petals":"They seem to be used in some sort of spell."
]) );
