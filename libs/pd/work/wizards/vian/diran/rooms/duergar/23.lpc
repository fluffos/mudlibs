...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  There is a skeleton chained into the gate here.");
set_exits(([ "east" : ROOMS"duergar/24",
"west" : ROOMS"duergar/22",
]));
    set_items( ([
...
"skeleton":"The skeleton is dusty and dirty, it looks like it has been here for a long time.",
]) );
