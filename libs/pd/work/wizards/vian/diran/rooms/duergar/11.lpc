...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  The remains of a small camp are here.");
set_exits(([ "west" : ROOMS"duergar/12",
"east" : ROOMS"duergar/10",
]));
    set_items( ([
