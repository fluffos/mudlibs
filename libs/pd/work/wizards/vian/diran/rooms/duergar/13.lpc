...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  There are hints of light peeking through holes in the wall.");
set_exits(([ "north" : ROOMS"duergar/14",
"south" : ROOMS"duergar/12",
]));
    set_items( ([
