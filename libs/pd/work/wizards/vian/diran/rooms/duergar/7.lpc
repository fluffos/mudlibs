...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  There are scratches on the stones of the gate.");
set_exits(([ "west" : ROOMS"duergar/8",
"east" : ROOMS"duergar/6",
]));
    set_items( ([
