...
void create() {
    ...
    set_long("The road leading through the Duergar city is dark and uninviting.  Flashes of light from burning torches can be seen in the distance, but the road is usually traveled on memory or with a carried lightsource.  Weeds are growing from cracks in the road.  Housing compounds appear to be to the north and south.");
set_exits(([ "east" : ROOMS"duergar/28",
"west" : ROOMS"duergar/26",
"north" : ROOMS"duergar/32",
"south" : ROOMS"duergar/34",
