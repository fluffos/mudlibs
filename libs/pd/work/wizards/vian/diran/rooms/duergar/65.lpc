...
void create() {
    ...
    set_long("The Wizard training hall of Duergar is a large and tidy room, filled with bookcases and cabinets full of books, vials, various potions and liquids, and gemstones.  There is a large open space as well, for practicing spellwork.  Many wizards study here in the day.");
set_exits(([
"out" : ROOMS"duergar/66",
