...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  Weeds sprout through the stone-covered ground here.");
set_exits(([ "north" : ROOMS"duergar/17",
"south" : ROOMS"duergar/15",
]));
    set_items( ([
