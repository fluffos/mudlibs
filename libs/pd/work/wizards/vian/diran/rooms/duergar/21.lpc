...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  This stretch of gate looks like it was attacked by a clawed animal.");
set_exits(([ "east" : ROOMS"duergar/22",
"west" : ROOMS"duergar/20",
]));
    set_items( ([
