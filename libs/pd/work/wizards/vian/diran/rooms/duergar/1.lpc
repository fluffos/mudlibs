...
void create() {
    ...
    set_long("The gate surrounding the Duergar City is a heavily fortified wall of black stones.  It continues up much higher than would be climbable.  Light is barely visible up on top of the gate.  There is a very narrow pathway around the gate.  Bright lights can be seen through cracks in the stone.");
set_exits(([ "north" : ROOMS"duergar/24",
"south" : ROOMS"duergar/2",
"east" : ROOMS"mountainpath/72",
]));
    set_items( ([
