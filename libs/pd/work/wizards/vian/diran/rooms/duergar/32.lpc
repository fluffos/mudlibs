...
void create() {
    ...
    set_long("The housing compounds of the Duergar city are quite ratty and tattered.  There are dirty cots scattered throughout the large room, taking up most of the floorspace.  A large wooden table sits in a corner.  These houses are shared by all of the citizens of Duergar.  They are all arranged the same, as to be fair and equal to each citizen.  There is a small bonfire burning in the middle of the room.");
set_exits(([
"out" : ROOMS"duergar/27",
...
"bonfire":"The bonfire is mostly embers now, but it provides a lot of heat and smoke.",
]) );
