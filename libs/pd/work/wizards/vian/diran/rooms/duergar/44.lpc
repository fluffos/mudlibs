...
void create() {
    ...
    set_long("The housing compounds of the Duergar city are quite ratty and tattered.  There are dirty cots scattered throughout the large room, taking up most of the floorspace.  A large wooden table sits in a corner.  These houses are shared by all of the citizens of Duergar.  They are all arranged the same, as to be fair and equal to each citizen.  This housing compound is full of trash, a sign that someone hasn't been doing their cleaning duties.");
set_exits(([
"out" : ROOMS"duergar/43",
