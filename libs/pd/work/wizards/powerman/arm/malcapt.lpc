...
::create();
set_name("Captain");
set_short("A Captain of Malcolm's army");
...
set_spell_chance(40);
set_spells(({"behead"}));
set_emotes(10, ({"%^CYAN%^The Captain screams:%^RESET%^ Charge!!!!!!!!!!", 
"The Captain eyes you suspiciously."}),0);
...
set_languages("farsi");
set_speech(35,"farsi",({"Attack Soldiers, Attack!", "My death will be an honorable one.", 
