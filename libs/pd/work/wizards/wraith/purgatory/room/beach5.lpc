...
"north, animal tracks lay scattered all around. The forest is alot closer "
...
set_smell("default","Saltwater and other smells of the sea permeate the air");
 set_exits( ([
               "north" : "/d/freepk/purgatory/pforest/room/102",
               "northwest" : "/d/freepk/purgatory/pforest/room/101",
              "southeast" : ROOMS"beach3"]) );
...
void reset() {
 ::reset();
  if (!present("shark", this_object()))
    new(MOBS"landshark" )->move(this_object());
