...
"%^ORANGE%^duration of their stay. A hastily built door rests in the "
"%^ORANGE%^east wall. A walkway leads to the north and the south. ");
     set_properties(([
        "light"       : 2,
        "night light" : 1,
        "no bump"     : 1,
