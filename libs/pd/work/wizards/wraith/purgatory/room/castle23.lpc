...
"%^MAGENTA%^who enters. ");
 ...
 set_exits( (["northwest" : ROOMS"castle30", 
              "west" : ROOMS"castle14",
              "south" : ROOMS"castle22",
              "east" : ROOMS"castle28"]) );
...
void reset() {
 ::reset();
  ...
  if (!present("lord", this_object()))
    new(MOBS"knuckle" )->move(this_object());
