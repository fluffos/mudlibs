...
void reset() {
 ::reset();
  ...
  if (!present("warrior 4", this_object()))
    new(MOBS"warrior" )->move(this_object());
  if (!present("warrior 5", this_object()))
    new(MOBS"warrior" )->move(this_object());
  if (!present("warrior 6", this_object()))
    new(MOBS"warrior" )->move(this_object());
  if (!present("warrior 7", this_object()))
    new(MOBS"warrior" )->move(this_object());
  if (!present("warrior 8", this_object()))
    new(MOBS"warrior" )->move(this_object());
  if (!present("warrior 9", this_object()))
    new(MOBS"warrior" )->move(this_object());
  if (!present("warrior 10", this_object()))
    new(MOBS"warrior" )->move(this_object());
