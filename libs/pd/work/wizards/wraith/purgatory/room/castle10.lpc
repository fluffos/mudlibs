...
"%^CYAN%^in the northwest sector. Breezy and open, it houses "
...
"%^CYAN%^to do their bidding. ");
 ...
 set_exits( (["northwest" : ROOMS"castle15", 
              "southwest" : ROOMS"castle19",
              "northeast" : ROOMS"castle21",
              "east" : ROOMS"castle32",
              "southeast" : ROOMS"castle4",
              "stairs" : ROOMS"guest19"]) );
...
void reset() {
    ::reset();
     if (children(MOBS"servant")==({})||
         sizeof(children(MOBS"servant"))<15)
