...
set_exits( (["south" :"/wizards/detach/roston/roston34"]));                  

}

int enter_hole(string what) {
  if (what != "hole") return 0;
this_player()->move_player("/wizards/detach/roston/drow/path1", "into the huge boulder and vanishes without a trace.");
    return 1;
}
