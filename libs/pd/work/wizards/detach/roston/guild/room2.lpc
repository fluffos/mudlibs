...
void create()
{
 ...
 set_exits( ([ "south" :"/wizards/detach/roston/guild/room1" ]) );
}
...
void reset()
{
 ::reset();
 if (!present("jeeves")) 
   new("/wizards/detach/roston/guild/jeeves")->move(this_object());
 if (!present("pam"))
   new("/wizards/detach/roston/dancer")->move(this_object());
}
