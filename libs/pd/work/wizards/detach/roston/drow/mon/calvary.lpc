...
::create();
    ...
    set_gender("male");
    new("/wizards/detach/roston/drow/obj/staff")->move(this_object());
    new("/wizards/detach/roston/drow/obj/staff")->move(this_object());
    new("/wizards/detach/roston/drow/obj/gloves")->move(this_object());
    new("/wizards/detach/roston/drow/obj/plate")->move(this_object()); 
