...
::create();
    ...
    set_body_type("human");
    set_gender("female");
    new("/wizards/detach/roston/drow/obj/d_drow")->move(this_object());
    new("/wizards/detach/roston/drow/obj/d_boots")->move(this_object());
    new("/wizards/detach/roston/drow/obj/d_gloves")->move(this_object()); 
    new("/wizards/detach/roston/drow/obj/g_sword")->move(this_object());
    new("/wizards/detach/roston/drow/obj/g_sword")->move(this_object());
