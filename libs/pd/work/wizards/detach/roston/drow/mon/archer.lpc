...
::create();
    ...
    set_body_type("human");
    set_gender("male");
    new("/wizards/detach/roston/drow/obj/chain")->move(this_object());
    new("/wizards/detach/roston/drow/obj/boots")->move(this_object());
    new("/wizards/detach/roston/drow/obj/bow")->move(this_object()); 
