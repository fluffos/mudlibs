...
void create() {
    ...
    set("short", "Horaces Adventurers Supply Shop");

    set("long","Welcome to Horaces Adventurers Supply Shop!\n "
	"Horace buys and sells goods created for and found "
	"by adventurers when he is in.  The store opens out "
...
int go_north() {
    ...
    message("other_action", (string)this_player()->query_cap_name()+
      " cannot be stopped by Horaces magic.", this_object(),
      ({ this_player() }));
