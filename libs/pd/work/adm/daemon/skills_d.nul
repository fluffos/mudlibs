...
mapping init_skills(string cl) {
  ...
  if(!cl) {
    ...
    if (member_array(race, ({"centaur", "raknid", "weimic"}) ) != -1)
      charge = 1;
    ...
    switch(cl) {
      ...
      switch (subcl) {
        ...
        skills["magic attack"] = (["level": 5, "points":0, "max": 10 ]);
        skills["magic defense"] = (["level": 3, "points":0, "max": 6 ]);
        skills["conjuring"] = (["level": 3, "points":0, "max": 8 ]);
        ...
        skills["magic defense"] = (["level":4, "points":0, "max": 8 ]);
        skills["healing"] = (["level":4, "points":0, "max": 9 ]);
        skills["conjuring"] = (["level":3, "points":0, "max": 6 ]);
      ...
      case "vampire":
        skills["attack"] = (["level": 5, "points": 0, "max": 11]);
        skills["defense"] = (["level": 4, "points": 0, "max": 9]);
        skills["double wielding"] = (["level": 3, "points": 0, "max": 6]);
        skills["melee"] = (["level": 5, "points": 0, "max": 11]);
        skills["agility"] = (["level": 4, "points": 0, "max": 8]);
        skills["bargaining"] = (["level": 2, "points": 0, "max": 5]);
        skills["ferocity"] = (["level": 4, "points": 0, "max": 9]);
        skills["flying"] = (["level": 4, "points": 0, "max": 8]);
        skills["perception"] = (["level": 6, "points": 0, "max": 12]);
        skills["stealth"] = (["level": 3, "points": 0, "max": 7]);
        skills["necromancy"] = (["level": 4, "points": 0, "max": 9]);
        skills["illusion"] = (["level": 4, "points": 0, "max": 8]);
        skills["axe"] = (["level": 2, "points": 0, "max": 4]);
        skills["blade"] = (["level": 4, "points": 0, "max": 8]);
        skills["blunt"] = (["level": 3, "points": 0, "max": 7]);
        skills["flail"] = (["level": 3, "points": 0, "max": 6]);
        skills["knife"] = (["level": 4, "points": 0, "max": 8]);
        skills["projectile"] = (["level": 2, "points": 0, "max": 4]);
        skills["ranged"] = (["level": 2, "points": 0, "max": 4]);
      break;
  ...
  switch (cl) {
    ...
    switch (subcl) {
      ...
      switch(skill) {
        ...
        case "charging":
            return lvl * lvl * 3/2;
        case "flail": case "projectile":
        case "riding":
            return lvl * lvl * 2;
        case "magic attack": case "magic defense":
            return lvl * lvl * 3;
        case "axe": case "knife": case "blunt":
        case "ranged":
        case "healing":
