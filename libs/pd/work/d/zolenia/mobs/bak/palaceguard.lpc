...
::create();
    ...
    set_short("%^RESET%^%^BLACK%^%^BOLD%^Zolenia%^RESET%^ palace guard");
    set_long("Very slender yet muscular, this black elf with white hair guards the palace of Zolenia.  He is well equipped and ready to guard his city.");
