...
void create() {
  ...
  set_long(
    "This young dragon plays in the water. She looks like a strong swimmer and "
    "can carry people south into the cove if they %^BOLD%^<ride>%^RESET%^ her."
  );
  set_level(30);
  set_race("dragon");
    ...
    switch (phase) {
      ...
      case 1:
        if (envfile == swim_room && sizeof(riders)) {
          ...
          riders->describe_current_room(1);
          command("say We've arrived, be careful in there.");
          counter = 1;
        }
        return;
      case 2:
