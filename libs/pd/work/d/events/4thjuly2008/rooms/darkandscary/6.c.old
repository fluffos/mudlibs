...
set_long("The dark tunnels steer in many directions, hopelessly leading to nowhere. Darkness makes traveling the tunnels dangerous. Specks of dirt float through the air, sticking to any sort of sweat or moisture. A dark rock falls from the ceiling, causing a thump that carries throughout the tunnels. Shadows seem to dance in the darkness, and some look like they might have knives.");
set_items(([
...
set_exits(([ "northwest" : ROOMS "/darkandscary/4.c",
"south" : ROOMS "/darkandscary/11.c",
"east" : ROOMS "/darkandscary/7.c"]));
}
