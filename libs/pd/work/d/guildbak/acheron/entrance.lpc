...
void create() {
    ::create();
     set_name("Entrance of Acheron");
     set_short("Entrance of Acheron");
     set_long("%^BOLD%^%^BLUE%^Welcome to the entrance of Acheron. The door ahead is well "
...
"%^BOLD%^%^BLUE%^carved over the top of the symbol.");
     set_night_long("%^BOLD%^%^BLUE%^Welcome to the entrance of Acheron. The door ahead is well "
"%^BOLD%^%^BLUE%^lit buy two %^BOLD%^%^RED%^f%^YELLOW%^lamin%^RED%^g%^RESET%^%^BOLD%^%^BLUE%^ torches. Above the door is the guild "
"%^BOLD%^%^BLUE%^symbol etched in %^BOLD%^%^YELLOW%^gold%^RESET%^%^BOLD%^%^BLUE%^. The letters A C H E R O N have been "
"%^BOLD%^%^BLUE%^carved over the top of the symbol.");
     set_properties(([
 ...
 set_exits( (["hall" : "/d/guilds/acheron/hall", 
              "out" : "/d/tirun/wganthus"]) );
...
this_player()->move_player("/d/guilds/acheron/hall");
return 1;
}
