...
set_long("%^BOLD%^BLACK%^The demon is tall and slender with charcol black skin and glistening black teeth and claws.  This demon bears the mark of strength upon its chest.%^RESET%^");
set("aggressive", 0);
set_id(({"strength", "winged demon", "demon of strength", "demon"}));
set_class("fighter");
