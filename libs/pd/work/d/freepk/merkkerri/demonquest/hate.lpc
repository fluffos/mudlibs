...
set_long("%^BOLD%^BLACK%^The demon is tall and slender with charcol black skin and glistening black teeth and claws.  This demon bears the mark of hatred upon its chest.%^RESET%^");
set("aggressive", 0);
set_id(({"hatred", "winged demon", "demon of hate", "hate", "demon"}));
set_class("fighter");
