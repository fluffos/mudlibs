...
set_long("%^GREEN%^The Sword of Chaos is a long single eadged sword with a silver-blue blade.  It's hilt is made of pure platinum and is adorned by two sapphires and an emerald.  A black star seems to float lazily inside the large emerald.%^RESET%^");
set_value(500);
set_weight(17);
set_wc(13);
set_ac(2);
