...
void create() {
  ...
  set_long("This ring is a circular band of silver with an emerald stone "
    "in the shape of a leaf set into the top of it.");
  set_mass(1);
...
int conversion(string str) {
  ...
  if(uses < 1)
    return notify_fail("The ring has lost its energy.\n");
