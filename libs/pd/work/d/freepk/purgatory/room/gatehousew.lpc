...
void create() {
    ::create();
     set_name("The West Gatehouse");
     set_short("The West Gatehouse");
...
"%^BOLD%^%^BLACK%^stairway that leads up into the gatehouse. Mortis Road can be "
...
"%^BOLD%^%^BLACK%^seen through the gates.");
 ...
 set_exits( ([//"west" : ROOMS"",
              "stairs" : ROOMS"gatehouseupw", 
              "gates" : ROOMS"purgatory21",
]) );
