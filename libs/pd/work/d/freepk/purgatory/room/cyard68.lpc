...
void create() {
    ::create();
     ...
     set_long("The %^RESET%^%^GREEN%^moss%^RESET%^ looks to have thickened around "
"the northern part of the walls. The floors seem less slippery. "
"Moving through the passage, there seems to be a light coming from the northwest.");
     set_properties(([
        "light"       : 2,
        "night light" : 0,
        "no bump"     : 1,
 ...
 set_exits( (["south" : ROOMS"cyard71", 
              "northwest" : ROOMS"yard2"]) );
