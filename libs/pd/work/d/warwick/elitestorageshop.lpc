...
inherit LOCKER;
void create() {
    set_path("/adm/save/votes/elitestorage");
    ::create();
   set_properties(([
       "light":2, "night light":2, "no attack":1, "no magic":1, 
       "no bump":1, "no steal":1, "indoors":1, "no teleport":1,
       ]));
    set("short", "Elite Locker Room");
    set("long",
"Welcome to the elite storage shop.  Large crates are stacked neatly behind a counter.  "
