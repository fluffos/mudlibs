               ...
               if(interact("you",recieved)) {
                   if(interact("pearl",recieved)) {
                         ...
                         if(interact("white",recieved)){
                            message("info","You have given me a White Pearl. Your prize is 30 gold.\n",this_player());
                              profit=30;
                                       }
                              else if(interact("black",recieved)){
                            message("info","You have given me a Black Pearl. Your prize is 500 gold.\n",this_player());
                              profit=500;
                                    }
                            ...
                            message("info","Oh by my crab ancestors!!Thats a STAR pearl!! I'll give you 250,000 gold for it.\n",this_player());
                                 profit=250000;
                                        }
                        ...
                        message("info","I only give rewards for pearls. I'll take your gift anyways after all i AM a hermit crab.\n",this_player());
			}
                   }
             }
