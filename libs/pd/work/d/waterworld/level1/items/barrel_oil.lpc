...
void set_their_mess(string str1, string str2, string str3) {
  _TColor = str1;
  _TFirst = str2;
  _TLast = str3;
}
...
string query_their_mess() {return "____"+ _TFirst +" ____ "+_TLast; }
string query_your_mess() {return _YourRubMessage; }
string query_heal_mess() {return _HealMessage; }
string query_action_command() {return _Action; }
int is_oil() {return 1; }
