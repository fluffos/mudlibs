...
string* trivia = ({
   ...
   ({"What family of animals do the sea otters belong to?","mustelidae"}),
   ({"What is the sea otters average body temperature?(in F)","100"}),
   ({"How long can a sea otter hold their breath for?(in minutes)","10"}),
   ({"How deep can a sea otter dive?(in feet)","430"}),
   ({"How many species of animals pray on Killer Whales in the wild?(enter a number)","0"}),
   ({"What other animal is a close relative of the killer whales, in fact they are from the same family of animals?","dolphins"}),
   ({"How much can an average killer whale weight?(in pounds)","1800"}),
   ({"What is the average length for a Killer Whale?(in feet)","36"}),
   ({"What is the most common species of Beaked whales?","Baird's Beaked Whale"}),
    ({"What do beaked whales primarily hunt? (____ and ____ )","cephalopods and tuna"}),
   ({"What is the average length of a Baird's Beaked whale in feet?","42"}),
   ({"What is the average weight of a Baird's Beaked whale in pounds? (no ,'s) ","11000"}),
   ({"What color is the Dorsal side of a Baird's Beaked whale? _____ or _____","blue-gray or black"}),
   ({"What color is the Ventral side of a Baird's Beaked whale? ( 2 words )","light gray"}),
   ({"How many Baird's Beaked Whales are in a typical herd? ___ to ___","6 to 30"}),
   ({"What is the scientific classification of a Baird's Beaked Whale?","berardius bairdii"}),
   ({"What is the scientific classification of a Beluga Whale?","delphinapterus leucas"}),
   ({"What do Beluga whales lack that differenciate it from other whale species? ___ ___","dorsal fins"}),
   ({"What is the average weight of a Beluga whale in pounds? (no ,'s) ","3000"}),
   ({"What is the average length of a Beluga whale in feet?","16"}),
   ({"What is the main food source of a Beluga whale? ____ and ____ ","squids and salmon"}),
   ({"How many pounds of food can an average Beluga whale consume in a day?","60"}),
   ({"What is the average weight of a Beluga whale's calf in pounds? ","120"}),
   ({"What is the average length of a Beluga whale's calf in feet?","6"}),
   ({"How many years does it take for a male Beluga whale calf to reach maturity?","8"}),
   ({"How many years does it take for a female Beluga whale calf to reach maturity?","5"}),
