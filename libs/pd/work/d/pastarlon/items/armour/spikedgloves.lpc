...
void create() {
    ...
    set_long("These gloves are made of black leather, with hard steel spikes on the knuckles.  They look like they could cause some pain.");
