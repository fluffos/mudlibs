...
void create() {
    ...
    set_level( 46 );
    set("short", "%^RESET%^%^ORANGE%^Baby R%^BOLD%^%^WHITE%^a%^RESET%^%^ORANGE%^ttleS%^BOLD%^%^WHITE%^n%^RESET%^%^ORANGE%^ake%^RESET%^" );
    ...
    set_class("fighter");
    set("aggressive", 40);
    set_emotes(20, ({"%^RESET%^%^ORANGE%^The R%^BOLD%^%^WHITE%^a%^RESET%^%^ORANGE%^ttles%^BOLD%^%^WHITE%^n%^RESET%^%^ORANGE%^ake  %^BOLD%^%^RED%^STRIKES%^RESET%^%^ORANGE%^ you!%^RESET%^"}), 1);
