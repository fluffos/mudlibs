...
void create() {
    ...
    set_long(
      "%^BOLD%^%^BLACK%^MARSH ARMORY%^RESET%^\n"
      "%^BOLD%^%^BLACK%^This is a place for people to sell their armour and get money for their travels. The room is dusty and looks as if it has not been utilized in years. Marvello has a sign posted on the wall for all to read.");
    set_items( ([ "shop": "This is a place for you to sell your armour and get money for your travels.", "sign": "Propety of Marvello. All goods approved and commissioned for sale.", ]) );
