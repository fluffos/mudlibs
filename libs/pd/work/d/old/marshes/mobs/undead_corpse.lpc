...
void create() {
    ...
    set("long", "%^BOLD%^%^BLACK%^The half rotted of what looks to be a man is here with a %^BOLD%^%^RED%^blood thursty %^BLACK%^look of %^RESET%^%^GREEN%^revenge %^BOLD%^%^BLACK%^in his e%^RESET%^%^RED%^y%^BOLD%^%^BLACK%^e." );
    set("race", "human" ); //
    set_gender( "male" );
    set_body_type("human");
