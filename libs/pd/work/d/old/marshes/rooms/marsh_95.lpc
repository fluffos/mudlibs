...
void create() {
    ...
    set_exits( ([ "east" : MARSHROOM+"marsh_94", "northeast" : MARSHROOM+"marsh_113", "west" : MARSHROOM+"marsh_96", "northwest" : MARSHROOM+"marsh_111", "southwest" : MARSHROOM+"marsh_91", "southeast" : MARSHROOM+"marsh_93", "south" : MARSHROOM+"marsh_92" ]) );
