...
void create() {
    ...
    set_exits( ([ "east" : MARSHROOM+"marsh_165", "northeast" : MARSHROOM+"marsh_178", "west" : MARSHROOM+"marsh_167", "northwest" : MARSHROOM+"marsh_176", "southwest" : MARSHROOM+"marsh_158", "southeast" : MARSHROOM+"marsh_160", "south" :
	MARSHROOM+"marsh_159" ]) );
