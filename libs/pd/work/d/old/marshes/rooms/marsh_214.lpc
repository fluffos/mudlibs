...
void create() {
    ...
    set_exits( ([ "east" : MARSHROOM+"marsh_215", "northeast" : MARSHROOM+"marsh_218", "west" : MARSHROOM+"marsh_213", "northwest" : MARSHROOM+"marsh_220", "southwest" : MARSHROOM+"marsh_202", "southeast" : MARSHROOM+"marsh_200", "south" :
	MARSHROOM+"marsh_201" ]) );
