...
void create() {
    ...
    set_exits( ([ "northwest" : MARSHROOM+"marsh_137", "northeast" : MARSHROOM+"marsh_135", "southeast" : MARSHROOM+"marsh_115", "south" :  MARSHROOM+"marsh_116", "southwest" : MARSHROOM+"marsh_117", "east" : MARSHROOM+"marsh_132", "west" : MARSHROOM+"marsh_130" ]) );
