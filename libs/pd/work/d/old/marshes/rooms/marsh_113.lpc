...
void create() {
    ...
    set_exits( ([ "northwest" : MARSHROOM+"marsh_115", "northeast" : MARSHROOM+"marsh_190", "southeast" : MARSHROOM+"marsh_172", "south" : MARSHROOM+"marsh_94", "southwest" : MARSHROOM+"marsh_95", "east" : MARSHROOM+"marsh_189", "west" : MARSHROOM+"marsh_112" ]) );
