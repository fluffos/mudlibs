...
void create() {
    ...
    set_exits( ([ "east" : MARSHROOM+"marsh_171", "northeast" : MARSHROOM+"marsh_172", "west" : MARSHROOM+"marsh_92", "northwest" : MARSHROOM+"marsh_95", "southwest" : MARSHROOM+"marsh_75", "southeast" : MARSHROOM+"marsh_154", "south" : MARSHROOM+"marsh_74" ]) );
