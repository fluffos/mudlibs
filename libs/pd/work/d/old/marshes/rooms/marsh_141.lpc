...
void create() {
    ...
    set_exits( ([ "northwest" : MARSHROOM+"marsh_145", "northeast" : MARSHROOM+"marsh_147", "southeast" : MARSHROOM+"marsh_127", "south" : MARSHROOM+"marsh_126", "southwest" : MARSHROOM+"marsh_125", "east" : MARSHROOM+"marsh_140", "west" : 
	MARSHROOM+"marsh_142" ]) );
