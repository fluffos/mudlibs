...
void create() {
    ...
    set_exits( ([ "northwest" : MARSHROOM+"marsh_141", "northeast" : MARSHROOM+"marsh_139", "southeast" : MARSHROOM+"marsh_119", "south" : MARSHROOM+"marsh_120", "southwest" : MARSHROOM+"marsh_121", "east" : MARSHROOM+"marsh_128", "west" : 
	MARSHROOM+"marsh_126" ]) );
