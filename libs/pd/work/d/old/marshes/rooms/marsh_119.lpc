...
void create() {
    ...
    set_exits( ([ "northwest" : MARSHROOM+"marsh_127", "northeast" : MARSHROOM+"marsh_129", "southeast" : MARSHROOM+"marsh_109", "south" : MARSHROOM+"marsh_108", "southwest" : MARSHROOM+"marsh_107", "east" : MARSHROOM+"marsh_118", "west" : 
	MARSHROOM+"marsh_120" ]) );
