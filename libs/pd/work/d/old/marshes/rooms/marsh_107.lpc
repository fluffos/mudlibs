...
void create() {
    ...
    set_exits( ([ "northwest" : MARSHROOM+"marsh_121", "northeast" : MARSHROOM+"marsh_119", "southeast" : MARSHROOM+"marsh_99", "south" : MARSHROOM+"marsh_100", "southwest" : MARSHROOM+"marsh_101", "east" : MARSHROOM+"marsh_108", "west" : MARSHROOM+"marsh_106" ]) );
