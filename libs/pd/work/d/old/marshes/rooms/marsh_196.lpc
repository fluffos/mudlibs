...
void create() {
    ...
    set_exits( ([ "east" : MARSHROOM+"marsh_197", "northeast" : MARSHROOM+"marsh_200", "west" : MARSHROOM+"marsh_195", "northwest" : MARSHROOM+"marsh_202", "southwest" : MARSHROOM+"marsh_184", "southeast" : MARSHROOM+"marsh_182", "south" :
	MARSHROOM+"marsh_183" ]) );
