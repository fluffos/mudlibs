...
void create() {
    ...
    set_exits( ([ "east" : MARSHROOM+"marsh_92", "northeast" : MARSHROOM+"marsh_95", "west" : MARSHROOM+"marsh_90", "northwest" : MARSHROOM+"marsh_97", "southwest" : MARSHROOM+"marsh_77", "southeast" : MARSHROOM+"marsh_75", "south" : MARSHROOM+"marsh_76" ]) );
