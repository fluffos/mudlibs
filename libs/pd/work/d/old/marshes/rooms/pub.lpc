...
void create() {
    ...
    set_short("%^BOLD%^%^BLACK%^Bloated Pub");
    set_long("%^BOLD%^%^BLACK%^Bloated Pub\n"
      "%^BOLD%^%^BLACK%^The Pub is quiet and dark.  You notice that there are pictures of the dead hanging on each wall around the room.  You feel very uneasy, you want to grab your drinks and go. ");
    set_items(
      (["pub" : "The pub is dead.",
