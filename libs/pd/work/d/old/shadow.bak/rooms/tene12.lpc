...
void create() {
  ...
  set("long","This is First Street which passes a variety of businesses "
    ...
    "bustle about, minding their own business.");
...
sunlight.",
    "sign":"The sign points south and says \"Shops to replenish your body, this way  --->\"",
    "stone":"The cobblestones are black and grey.  Like the sky."]));
  set_exits((["south":ROOMS "tene14","north":ROOMS "tene10"]));
}
