...
void create() {
  ::create();
    set("short", "Druid voting room");
    set_property("light", 2);
    set_property("indoors", 1);
    if(VOTING_D->election_day()) {
      set("long",
          "This is the voting room of the Druids.  Druids come "
      ...
      set("long",
          "Druids come here to the voting room of the Druids Hall "
    ...
    set_exits( 
              (["down" : ROOMS"clergy/druid/druid_hall"]) );
}
void init() {
  ::init();
