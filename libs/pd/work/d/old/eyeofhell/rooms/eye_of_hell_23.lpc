...
void create() {
    ...
    set("long","%^BOLD%^%^RED%^The path stretches winds around a large cliff.  The cave is filled with jagged rocks hanging from above that look as if they could fall on any who passes.  The smell of blood and human flesh is fresh in the air.%^RESET%^");
    ...
    set_exits( ([ "southeast": HELLROOM+"eye_of_hell_22", "northwest": HELLROOM+"eye_of_hell_24"  ]) );
