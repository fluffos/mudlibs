...
void create() {
    ...
    set("long","%^BOLD%^%^BLACK%^The path now breaks off into another direction.  The parth towards to northwest is darker and scarier than the one towards the east.  The sound of screaming is echoing off the cave walls.%^RESET%^");
    ...
    set_exits( ([ "west": HELLROOM+"eye_of_hell_31", "east": HELLROOM+"eye_of_hell_29", "southeast": HELLROOM+"middle_22" ]) );
