...
inherit ARMOUR;                                                                    						void create() {
    ::create();                                                                        				set_name("Helm Of Fire");
    set("id", ({ "helm" }) );
    set("short", "%^RESET%^%^ORANGE%^H%^BOLD%^%^BLACK%^e%^RESET%^%^ORANGE%^l%^RED%^m %^ORANGE%^O%^RED%^f %^ORANGE%^F%^BOLD%^%^BLACK%^i%^RESET%^%^ORANGE%^r%^RED%^e%^RESET%^");
