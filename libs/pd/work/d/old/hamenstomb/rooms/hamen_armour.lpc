...
void create() {
    ...
    set_long(
      "%^BOLD%^%^BLACK%^HAMENS ARMORY%^RESET%^\n"
      "%^BOLD%^%^YELLOW%^This is a place for you to sell your armour and get money for your travels.  Horus has a list posted on the wall for all to read.");
    set_items( ([ "shop": "This is a place for you to sell your armour and get money for your travels.", "sign": "Propety of Hamen. All goods approved and commissioned for sale.", "list": "look_at_list" ]) );
