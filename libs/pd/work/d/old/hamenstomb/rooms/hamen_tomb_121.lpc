...
void create() {
    ...
    set("long","%^RESET%^%^ORANGE%^The light is beginning to fade, yet you can still make out the writings on the walls.  Wondering still where the draft is coming from, you shiver like the torches.\n");
    ...
    set_exits( ([ "east": ROOMS+"hamen_tomb_123", "west": ROOMS+"hamen_tomb_119" ]) );
}
