...
void create() {
  ::create();
    ...
    set_long("A sturdy bracer made of steel, it has many intricate designs etched into it, and on the outer side a silvery wing extends outwards. It fits your right arm.");
