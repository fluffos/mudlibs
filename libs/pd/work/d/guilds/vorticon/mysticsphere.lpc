...
void create() {
    ...
    set_mass(2);
  // cut price from 1200 to 1080 - Nulvect 2008-12-16
   set_curr_value("gold", 1080);
    set_destroy();
}

//  BALANCE- made it random time
// 2008-12-16 Nulvect - this was way too strong, almost same power as ruby amulet (public version) and 9-18x length
// I cut it from 7 to 3 magic_protection and 1800+rand(1800) to 900+rand(200) time
// the guild leader chose this way
...
int invoke(string str) {
    ...
    de=900 + random(200);
    this_player()->add_magic_protection(({0, 3, de}));
