...
void create() {
    ...
    set_enter("pool");
    set_location("/d/guilds/AoD/portal");
    ...
    set_exits(([ "up":AoD"helgrath/hall", ]));
	...
	({"light", "white-light"}):"Soothing white light dances upon the "
	"water, reflecting upon the surrounding walls.",
