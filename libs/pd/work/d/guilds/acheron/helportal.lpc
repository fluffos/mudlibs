...
void create() {
    ::create();
     set_name("Acheron Helgrath Portal Room");
     set_short("Acheron Helgrath Portal Room"); 
...
"%^BOLD%^%^BLUE%^reading Tirun.");
 ...
 set_exits( (["east" : ROOMS"acheron/helhall", ]) );
...
int enter_portal(string str) {
  ...
  if(str != "portal") {
    ...
    this_player()->move_player(ROOMS"acheron/mainportal", " gets ported to Tirun.");
    return 1;}
  }
