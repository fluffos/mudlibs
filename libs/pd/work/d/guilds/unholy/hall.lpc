...
void create() {
    ...
    set_long("%^RED%^T%^BOLD%^h%^MAGENTA%^i%^RESET%^%^RED%^s is %^BOLD%^th"
      ...
      "%^BOLD%^ng %^MAGENTA%^is r%^RED%^ough rock wit%^MAGENTA%^h stal"
      "%^RESET%^%^RED%^actite%^BOLD%^s hangi%^MAGENTA%^ng down. B"
 ...
 set_properties( ([ "no attack"   : 1,
    ...
    board->set_short("Unholy's evil board of sins");
