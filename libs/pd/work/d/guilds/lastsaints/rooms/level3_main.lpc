...
void create() {
    ...
    set_exits( ([ "down" : GUILDROOM+"last_saints_board", "southwest" : GUILDROOM+"armour_room", "east" : GUILDROOM+"object_room", "southeast" : GUILDROOM+"weapon_room", "south" : GUILDROOM+"level3_1", "up" : GUILDROOM+"level4_main", "west" : GUILDROOM"heal_shop" ]) );
}
