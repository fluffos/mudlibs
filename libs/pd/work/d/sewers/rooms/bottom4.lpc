...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  Flashes of sparks can be seen "
      "across the pit as steel clashes with steel.");
    set_exits( (["south" : ROOMS+"bottom3"
	,"northeast" : ROOMS+"bottom5"
      ]) );
