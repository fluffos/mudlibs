...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The path has gotten very thin,"
      " allowing for little room for error while walking around.");
    set_exits( (["northeast" : ROOMS+"bottom10"
	,"south" : ROOMS+"bottom12"
      ]) );
