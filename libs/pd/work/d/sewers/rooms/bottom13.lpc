...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  This must be the far west "
      "side of the pit, because the entrance is to the right.");
    set_exits( (["northeast" : ROOMS+"bottom12"
	,"south" : ROOMS+"bottom14"
      ]) );
