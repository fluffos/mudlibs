...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  It is surprising how well "
      "the demons and angels fight on such a small ledge, probably because of their wings.");
    set_exits( (["north" : ROOMS+"bottom8"
	,"southeast" : ROOMS+"bottom6"
      ]) );
