...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  Flames shoot up, blocking "
      "vision of whats north.  The way to the south seems safer.");
    set_exits( (["north" : ROOMS+"bottom11"
	,"southwest" : ROOMS+"bottom13"
      ]) );
