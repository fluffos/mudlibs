...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The path here is a bit wider"
      " than it is to the north.  Moving further north looks dangerous.");
    set_exits( (["north" : ROOMS+"bottom6"
	,"southwest" : ROOMS+"bottom4"
      ]) );
