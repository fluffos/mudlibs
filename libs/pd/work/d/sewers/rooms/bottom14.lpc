...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  A rock falls down into the "
      "seemingly bottomless pit, nowhere to go but north or southeast.");
    set_exits( (["north" : ROOMS+"bottom13"
	,"southeast" : ROOMS+"bottom15"
      ]) );
