...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  Then entrance is luckily "
      "very close to the west, in case of a needed escape from this place.");
    set_exits( (["west" : ROOMS+"bottom1"
	,"northeast" : ROOMS+"bottom3"
      ]) );
