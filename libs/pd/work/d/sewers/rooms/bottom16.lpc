...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The pit is to the east,"
      " and the path goes to the southeast, close to the edge of the pit, "
      "and further north.");
    set_exits( (["north" : ROOMS+"bottom15"
	,"southeast" : ROOMS+"bottom17"
      ]) );
