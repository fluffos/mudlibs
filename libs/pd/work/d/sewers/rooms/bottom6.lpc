...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The western side of this pit"
      " seems to be a little less active, probably because of the thin ledge.");
    set_exits( (["northwest" : ROOMS+"bottom7"
	,"south" : ROOMS+"bottom5"
      ]) );
