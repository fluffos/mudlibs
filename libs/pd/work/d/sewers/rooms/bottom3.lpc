...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The path has been getting "
      "a bit thinner as it heads north, but is still easily managed here.");
    set_exits( (["southwest" : ROOMS+"bottom2"
	,"north" : ROOMS+"bottom4"
      ]) );
