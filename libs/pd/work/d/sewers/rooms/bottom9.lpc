...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
             ...
             " of the pit, meeting the awaiting angels.  The wall of the pit doesn't "
             "seem as steep here, but it would still be impossible to climb down.");
    set_exits( (["southeast" : ROOMS+"bottom8"
             ,"west" : ROOMS+"bottom18"
              ]) );
    set_items( ([ ({"rocks", "walls"}) : "The walls and ground are rough, unworked rocks."
                 ,"pit" : "The pit drops straight down into a firey inferno."
