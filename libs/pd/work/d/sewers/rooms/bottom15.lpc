...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The pit drops off to the east"
      " while the path heads northwest and south.");
    set_exits( (["northwest" : ROOMS+"bottom14"
	,"south" : ROOMS+"bottom16"
      ]) );
