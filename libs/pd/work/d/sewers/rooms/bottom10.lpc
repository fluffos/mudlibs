...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The northern part of this "
      "place seems to be the hottest, for some strange reason.");
    set_exits( (["east" : ROOMS+"bottom18"
	,"southwest" : ROOMS+"bottom11"
      ]) );
