...
void create() {
    ...
    set_long("%^RESET%^%^RED%^A stifiling heat emanates from the pit.\n%^RESET%^"
      ...
      " of the pit, meeting the awaiting angels.  The pit is to the northeast,"
      " and the path goes back to the east and around the pit to the northwest.");
    set_exits( (["east" : ROOMS+"bottom1"
	,"northwest" : ROOMS+"bottom16"
      ]) );
