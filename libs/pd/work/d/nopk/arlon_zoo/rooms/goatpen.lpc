...
void create() {
    ...
    set("long", "This is a large pen that houses animals for petting.  Several "+
      "goats graze on pretty much anything they can find here.  The main "+
      "petting zoo is back to the north.");
    set_exits( ([ "west" : ROOMS"goatpen2", 
	"south" : ROOMS"goatpen4", 
	"north" : ROOMS"zoopath3" ]) );
