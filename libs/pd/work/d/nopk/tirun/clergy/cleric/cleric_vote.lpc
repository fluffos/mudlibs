...
void create() {
  ::create();
    set("short", "Cleric voting room");
    set_property("light", 2);
    set_property("indoors", 1);
    if(VOTING_D->election_day()) {
      set("long",
          "This is the voting room of the Cleric Church.  Clerics come "
      ...
      set("long",
          "Clerics come here to the voting room of the Cleric Church "
