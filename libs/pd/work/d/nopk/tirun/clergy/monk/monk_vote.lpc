...
void create() {
  ::create();
    set("short", "Monk voting room");
    set_property("light", 2);
    set_property("indoors", 1);
    if(VOTING_D->election_day()) {
      set("long",
          "This is the voting room of the Monk monastary.  Monks come "
      ...
      set("long",
          "Monks come here to the voting room of the Monk monastary "
    ...
    set_exits( 
              (["west" : ROOMS "clergy/monk/monk_hall"]) );
}
void init() {
  ::init();
