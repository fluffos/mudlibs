...
void check_illusion(string *what)
{
 ...
 this_object()->force_me("say I see you met Soltan, the leader of the
Illusionists.");
 this_object()->force_me("say There is one more step in becoming a
Illusionist");
 ...
 shout("%^BLUE%^All hail "+(string)tp->query_cap_name()+" the new Illusionist!");
}
