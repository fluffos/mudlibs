...
void create() {
  ::create();
    set("short", "Rogue voting room");
    set_property("light", 2);
    set_property("indoors", 1);
    if(VOTING_D->election_day()) {
      set("long",
          "This is the voting room of the Wanderer Hall.  Wanderers come "
          "here during election time to vote for their leaders.  It is "
          "currently election time, so a list of all candidates is "
          "posted on the wall.");
    }
    else {
      set("long",
          "Wanderers come here to the voting room of the Wanderer Hall "
