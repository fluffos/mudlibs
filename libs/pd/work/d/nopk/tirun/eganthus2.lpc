...
void create() {
    ...
    set_night_long(
      ...
      "west and east.  ");
    set_exits(([
	"east"  : ROOMS"eganthus3",
        "enter monastery"  : ROOMS"monastery",
	"west"  : ROOMS"eganthus1",
      ]) );
add_exit_alias("enter monastery", "monastery");
add_exit_alias("enter monastery", "enter");
add_exit_alias("enter monastery", "n");
