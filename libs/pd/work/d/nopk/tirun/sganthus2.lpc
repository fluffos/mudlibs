...
void create() {
    ...
    set_night_long(
      ...
      "north and south.  ");
    set_exits(([
	"north"  : ROOMS"sganthus1",
	"south"  : ROOMS"swganthus",
       "enter tannery shop" : ROOMS"tannery",
      ]) );
add_exit_alias("enter tannery shop", "tannery");
add_exit_alias("enter tannery shop", "shop");
add_exit_alias("enter tannery shop", "tannery shop");
