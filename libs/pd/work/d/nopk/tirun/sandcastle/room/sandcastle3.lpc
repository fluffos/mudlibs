...
set_items((["room" : "This room is quite unstable, and badly made. It could collapse at any time it seems.", "ceiling" : "One touch of the ceiling and the whole thing would cave in.", "floor" : "The sand here is more muddy than the rest of the castle, acting like sloppy quicksand and slowly sinking your toes in, but not dangerously.", "walls" : "Large cracks in the walls lead you to believe that either someone was bad at making this, or it's just really old."]));
