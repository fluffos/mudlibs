...
void create() {
    ::create();
    set_name("moonblade");
    set_short("%^BOLD%^BLUE%^M%^RESET%^MAGENTA%^o%^RESET%^BOLD%^BLUE%^o%^RESET%^MAGENTA%^n%^RESET%^BOLD%^BLUE%^b%^RESET%^MAGENTA%^l%^RESET%^BOLD%^BLUE%^a%^RESET%^MAGENTA%^d%^RESET%^BOLD%^BLUE%^e%^RESET%^");
    set_id(({"moonblade"}));
