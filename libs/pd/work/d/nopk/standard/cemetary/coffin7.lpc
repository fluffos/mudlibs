 ...
 ::create();
   ...
   set_items(
    ...
    set_exits(([
                ...
                "south" : ROOMS"cemetary/coffin5",
                "north" : ROOMS"cemetary/coffin6",
                "northwest" : ROOMS"cemetary/coffin8",
                "southwest" : ROOMS"cemetary/coffin7",
                "southeast" : ROOMS"cemetary/coffin4",
                "northeast" : ROOMS"cemetary/coffin6",
                "west" : ROOMS"cemetary/coffin2" ]));
