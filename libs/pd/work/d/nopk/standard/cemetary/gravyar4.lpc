...
void create() {
   ::create();
    ...
    set_exits( 
              (["northeast" : ROOMS"cemetary/gravyar5",
                "northwest" : ROOMS"cemetary/gravyar2",
                "southwest" : ROOMS"cemetary/gravyar3"]) );
}

void reset() {
  ::reset();
    if (!present("ghost"))
      new(ROOMS"cemetary/mon/ghost4")->move(this_object());
}
