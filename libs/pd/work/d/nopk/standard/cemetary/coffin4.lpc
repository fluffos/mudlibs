...
void create() {
 ::create();
   ...
   set_items(
    ...
    set_exits(([
                "east" : ROOMS"cemetary/coffin3",
                "south" : ROOMS"cemetary/coffin4",
                "north" : ROOMS"cemetary/coffin4",
                "southeast" : ROOMS"cemetary/coffin5",
                "northwest" : ROOMS"cemetary/coffin4",
                "southwest" : ROOMS"cemetary/coffin4",
                "northeast" : ROOMS"cemetary/coffin4",
                "west" : ROOMS"cemetary/coffin4" ]));
