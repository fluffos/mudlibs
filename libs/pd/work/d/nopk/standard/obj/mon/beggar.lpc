...
/*   set_speed(60);
   ...
   set_gender("male");
   set_level(4);
   set_long("He has long, stringy, greasy, black hair that covers his face from "
     "under an old hat. The beggar has a long, grey beard. He spent his entire "
     "youth wandering about, leaching healing from others. Through begging he "
     "became rich, though one night he lost it all at the casinos. Strange how "
     "after becoming rich from pretending to be a poor beggar, he grows old as "
     "a filthy, tired, poor beggar.");
   set_alignment(30);
   set_race("human");
   set_body_type("human");
   set_max_hp(50);
   set_hp(50);
/*   set_lang_prof("selunian", 9);
   set_speech(5, "selunian", ({"Oh my poor missing hand!"}), 0);
...
void complete_quest(object ob) {
    if(!ob->set_mini_quest("beggar", 5000,
        ...
        set_speech(5, "selunian", ({ ob->query_cap_name()+" replaced my missing left hand!"}), 0);
        return;
    }
