...
void create() {
    ...
    set_listen("upstairs", "You hear the chanting of the monks of Carnage.");
    set_listen("chants", "We serve an old man in a dry season"
      "\nA lighthouse keeper in the desert sun,\n"
      "Dreamers of sleepers and white treason\n"
      "We dream of rain and the history of the gun\n");
    begging = ({});
    set_short("Tirun monastary");
    set_long(
        "You are in the ornate monastary of Tirun.\n"
        "In this huge open monastary run by Tirun monks, the wretched "
	...
	"basement. The Tirun Chapel where monks marry people is north. "
        "Honin is outside the monastary to the south. ");
    set_exits( 
	      (["south" : ROOMS "ehonin1",
		"east" : ROOMS "stairs",
		"north" : ROOMS "chapel"]) );
    ...
    set_items(
        (["monastery" : "The home of the Carnage monks.", 
...
void forgive(object ob) {
    ...
    begging -= ({ ob });
    tmp = (string)call_other(ROOMS+(string)ob->query_class()+"_hall",
      "get_new_title", ob);
