...
void create() {
    ...
    set("short", "Church of Tirun Clerics");
    set("long",
	"You are inside a humble cleric's church in the center of Tirun. "
...
int preview() {
    if((string)this_player()->query_class() != "child") {
        message("info", "Only fresh minds are capable of beconing"
...
int become(string str) {
    ...
    this_player()->setenv("start", "/d/standard/cleric_hall");
    return 1;
}
...
int go_north() {
    ...
    this_player()->move_player("/d/standard/cleric_hall", "through the light in the passage");
    return 1;
}
