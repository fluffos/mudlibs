...
void create()
{
    ...
    set_name("Warblade");
    set_short("Warblade");
    set_long("The blade shines with gold. Forming a half moon which allows for one who is familiar with the type of weapon to employ the weapon with great ease against foes.");
    set_weight(30);
    set_curr_value("gold",500+random(40));
    set_wc(13);
    set_type("blade");
    set_hands(1);
...
int weapon_hit(object atk)
{
	...
	result = (random(45) + ((this_player()->query_level())*(2/5)));
	if(random(100) < 75) 
	{
