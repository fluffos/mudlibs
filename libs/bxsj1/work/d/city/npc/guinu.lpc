...
int do_sell(string arg)
{
    	...
    	ob->move(this_object());
    	if( !ob->query("old_title")) ob->set("sell/title",ob->query("title"));
    	else ob->set("sell/title", ob->query("old_title"));
    	...
    	if(me->query("hooker")) {
        	...
        	command ("cry "+me->query("id"));
        		...
        		me->set("title",me->query("family/family_name")+"第"+
                	...
                	"代弟子");
        		else 	me->set("title",me->query("sell/title"));
