...
void create()
{
	...
	set("inquiry", ([
		...
		"摔跤" : (: ask_me :),
		"比试" : (: ask_me :),
		"计老人" : "就是计爷爷啊，他会酿又香又烈的美酒，会医牛羊马匹的疾病。\n",
...
int ask_me()
{
	...
	message_vision(CYN"$N看了$n一眼，用不太标准的汉话说道：我是未来的草原第一勇士，这位汉族"+RANK_D->query_respect(this_player())+"你就和我切搓(fight)几下吧？\n"NOR, this_object(), this_player());
...
int checking(object me, object ob)
{
	...
	if (( (int)me->query("qi")*100 / my_max_qi) <= 50 ) {
		...
		message_vision("$N交给$n一"+good->query("unit")+good->query("name")+"。\n", me,ob);
		return 1;
	     }
