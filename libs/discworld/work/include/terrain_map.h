 ...
 */
#define TERRAIN_MAP_HANDLER_BASE  TERRAIN_MAP + "handler_base.lpc"
/**
 ...
 */
#define TERRAIN_MAP_FACTORY     TERRAIN_MAP + "factory.lpc"
/**
 * The base to use for factories.  Do not include this into
 * production code.
 */
#define TERRAIN_MAP_FACTORY_BASE     TERRAIN_MAP + "factory_base.lpc"
/**
 ...
 */
#define TERRAIN_MAP_ROOM_BASE     TERRAIN_MAP + "terrain_room.lpc"
/**
 * The base file for outside areas.
 */
#define TERRAIN_MAP_OUTSIDE_BASE  TERRAIN_MAP + "outside_base.lpc"
/**
 * The base file for outside water areas.
 */
#define TERRAIN_MAP_WATER_OUTSIDE_BASE  TERRAIN_MAP + "water_outside_base.lpc"
/**
 * The base file for inside water areas.
 */
#define TERRAIN_MAP_WATER_INSIDE_BASE  TERRAIN_MAP + "water_inside_base.lpc"
/**
 * The base file for inside areas.
 */
#define TERRAIN_MAP_INSIDE_BASE   TERRAIN_MAP + "inside_base.lpc"
/**
 * The base for for air rooms.
 */
#define TERRAIN_MAP_AIR_BASE TERRAIN_MAP + "air_base.lpc"
