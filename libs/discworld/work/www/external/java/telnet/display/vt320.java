 ...
 * --
 * $Id: vt320.java,v 1.52 1998/02/17 13:11:44 marcus Exp $
 *
 ...
 *      </TABLE>
 * </DL>
 * @version $Id: vt320.java,v 1.52 1998/02/17 13:11:44 marcus Exp $
 * @author  Matthias L. Jugel, Marcus Mei遪er
 */
public class vt320 extends Terminal implements TerminalHost
{
   ...
   */
  public String toString() { return "$Id: vt320.java,v 1.52 1998/02/17 13:11:44 marcus Exp $ "+display.version; }
  ...
  public String[][] getParameterInfo() {
    ...
    {"F1 - F12",   "String",    "Programmable Function Keys"},
    };
    return pinfo;
  }
  ...
  public boolean handleEvent(Event evt) {
    ...
    */
    int id = evt.id;
    boolean control = evt.controlDown();
    boolean shift = evt.shiftDown();
    pressedKey:
    {
        if (pressedKey == 10
            && (evt.key == 10
 ...
 */
        ...
        } else if (vms && evt.key == 127 && !control) {
            if (shift)
    ...
    if (evt.id == evt.KEY_ACTION && !control)
    {
      ...
      switch (evt.key % 1000) {
      case KEYF1:
        input = FunctionKey[shift ? 11 : 1];
        break;
      case KEYF2:
        input = FunctionKey[shift ? 12 : 2];
        break;
      case KEYF3:
        input = FunctionKey[shift ? 13 : 3];
        break;
      case KEYF4:
        input = FunctionKey[shift ? 14 : 4];
        break;
      case KEYF5:
        input = FunctionKey[shift ? 15 : 5];
        break;
      case KEYF6:
        input = FunctionKey[shift ? 16 : 6];
        break;
      case KEYF7:
        input = FunctionKey[shift ? 17 : 7];
        break;
      case KEYF8:
        input = FunctionKey[shift ? 18 : 8];
        break;
      case KEYF9:
        input = FunctionKey[shift ? 19 : 9];
        break;
      case KEYF10:
        input = FunctionKey[shift ? 20 : 10];
        break;
      case KEYF11:
        if (!shift)
            input = Find;
