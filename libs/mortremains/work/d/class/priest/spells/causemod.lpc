...
#define ROLL random(10)+random(10)+random(10)+3
#define COST 12
#define SYNTAX "Syntax: invoke causemod at target\n"  
...
varargs int invoke_causemod (string str) {   
    object target;
    ...
    write("You begin casting cause moderate wounds...\n"+
...
Cause Moderate Wounds (Priest - Level II - Necromantic)
