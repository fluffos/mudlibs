...
int cast_dispel(string str, int obj) {
   ...
   if (!obj) {
      ...
      obj = lvl;
      write("You begin casting Dispel Magic...\n");
...
string spellcraft() {
    return (@EndSpell
Dispel magic (Level III Wizard Spell - Universal)

Cost: 20 Spell Points

When this spell is cast, all magic targeted checks
to see if it is ruined. The chance is based upon
opposing caster level.
EndSpell
    );
}
