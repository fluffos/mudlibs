...
string spellcraft() {
    return (@EndSpell
Tenser's Deadly Aim (Level IV Wizard Spell - Alteration)

Cost: 20 Spell Points

Tenser created this spell so that he would be able to
hit people in hand to hand combat. It simply grants
a bonus to hit rolls for a time.
EndSpell
    );
}
