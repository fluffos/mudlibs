...
void create(){
    ...
    set("long", wrap("This human has given up all hope of escaping the prison. His beard is almost long enough to touch the floor. The remainants of his clothes fall tattered over his frame, and he looks at you sadly."));
