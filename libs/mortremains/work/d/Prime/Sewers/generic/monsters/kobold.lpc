...
void create(){
    ...
    set("long", wrap("This kobold moves with short, furtive glances all around. It hasn't been in here very long, but apparently long enough to learn a healthy respect for its neighbors. It looks very frightened."));
