...
void create(){
    ...
    set("long", wrap("This ghoul shuffles its ways down the corridors, moaning as it moves. Your skin crawls at the thought that centuries ago, it might have been an adventurer like you, foolish enough to enter this area."));
    set("id", ({"ghoul", "Ghoul"}));
    set_name("Ghoul");
    enable_commands();
    set("gender", "male");
