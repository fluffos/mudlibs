...
//  26 Mar 98 - Cyanide added admin-only tracing of protected files.
...
int cmd_trace(string str) {
   ...
   if ((member_array(base_name(target), PROTECT)!=-1) &&
    !adminp(TP))
   {
      write("Sorry - you are not permitted to trace that object.\n");
      return 1;
   }
