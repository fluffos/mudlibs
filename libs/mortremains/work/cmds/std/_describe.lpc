...
// (04-08-98) Chronos fixed about 50000 typos in the help()
...
Describe allows you to alter your description, which people see when they
look at you.  It doesn't take an argument; instead, typing describe will
put you into the editor where you can enter the text, complete with line
feeds if you desire.  Try not to use more than 2 or 3 lines, though.. it's
more polite.
