...
look in it.  In brief mode, you will see the short description, which is
shorter, but less detailed.  Typing "brief" will change your mode and tell
you into the new mode.
HELP
  );
}
