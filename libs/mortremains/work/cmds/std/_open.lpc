...
string help() {
  return @ENDHELP
Usage: open [<dir> door] [<container>]

This command allows you to attempt to open a door or container in a room.
If there is more than one door in a room, you will have to specify which 
door you wish to open.  You cannot open a locked door or container.

See also: close, put, get, lock, unlock
ENDHELP
  ;
}
