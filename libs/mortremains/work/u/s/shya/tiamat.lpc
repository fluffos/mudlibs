...
void create () {
    ...
    set ("short", "Tiamat") ;
    set("long", @EndLong
The Great and Powerful Tiamat, the Queen of Dragonkind. This fearsome
creature has the body of the most massive of dragons, hundreds of feet
long, and five heads, each of a different color: black, blue, green, 
red, and white. All five heads hiss fearsomely as you enter.
EndLong
    );
    set ("id", ({ "dragon", "tiamat" }) ) ;
    set("gender", "female");
    set_size(200);
    set("armor_class", -30);
...
void special_attack() {
    ...
    object ob;
    int sv;   
    ob = this_object()->get_random_attacker();
