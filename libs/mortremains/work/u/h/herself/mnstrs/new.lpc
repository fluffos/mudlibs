...
EndText
    ...
    // combat.
    set ("chat_output", ({
      "The chicken eats a pebble.\n",
      "The chicken spazzes out and pecks at your eyes.\n",
    }) );
