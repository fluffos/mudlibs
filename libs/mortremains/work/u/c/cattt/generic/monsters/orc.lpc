...
void create(){
  ...
  set("long", "This orc has a large, hairy, muscular body. It breathes heavily, grunting often, and smells foul. He doesn't look to be very happy being stuck here.\n");
  set("id", ({"orc", "Orc"}) );
  set_name("Orc");
  enable_commands();
  set("gender", "male");
