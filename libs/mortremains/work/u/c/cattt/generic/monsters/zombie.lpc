...
void create(){
  ...
  set("long", "This zombie seems more an animated corpse than a living being. It moves, but seems motivated from some outside magicks. It glows slightly with the aura of evil.\n");
