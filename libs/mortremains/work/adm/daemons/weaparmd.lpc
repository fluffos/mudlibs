...
// The armor defines. Listed here for convenience.

#define CLOTHING	0	// Can be worn in any combination
#define SUIT		2	// Still allows helmets and boots
#define HELMET		3
#define SHIELD		4
#define GLOVES		5
#define BOOTS		6
...
void set_armor_type (object ob, string type) {
    ...
    switch (type) {
    case "amulet" : qual = ({ 500,1,0,AMULET });
	material = "metal/gold"; break;
    case "belt" : qual = ({ 20,25,0,BELT });
	material = "leather"; break;

	// This is the high-tech kind.
    case "body" : qual = ({ 1200,20,8,SUIT }); 
	material = "metal/steel"; break;

    case "boot" : 
    case "boots" : qual = ({ 1,1,0,BOOTS }); 
	material = "leather"; break;
    case "bracers" : qual = ({ 3,0,0,BRACERS }); 
	material = "leather"; break;
    case "cloak" : qual = ({ 5,1,0,CLOAK }); 
	material = "cloth"; break;
    case "clothing" : qual = ({ 0,0,0,CLOTHING }); break;
    case "banded" : qual = ({ 200,15,6,SUIT }); break;
    case "brigandine" : qual = ({ 120,25,4,SUIT }); break;
    case "chain" : qual = ({ 75,30,5,SUIT }); break;
    case "field plate" : qual = ({ 2000,35,8,SUIT }); break;
    case "full plate" : qual = ({ 6000,40,9,SUIT }); break;
    case "girdle" : qual = ({ 45,60,0,BELT });
	material = "leather"; break;
    case "gloves" : qual = ({ 1,0,0,GLOVES });
	material = "leather"; break;
    case "gauntlets" : qual = ({ 7,2,0,GLOVES }); break;
    case "helmet" : qual = ({ 30,5,0,HELMET }); break;
    case "hide" : qual = ({ 15,10,4,SUIT });
	material = "leather"; break;
    case "leather" : qual = ({ 5,7,2,SUIT });
	material = "leather"; break;
    case "padded" : qual = ({ 4,7,2,SUIT });
	material = "cloth"; break;
    case "plate" : case "plate mail" :
    case "platemail" : qual = ({ 600,35,7,SUIT }); break;
    case "ring" : qual = ({ 25,0,0,RING });
	material = "metal/gold"; break;
    case "robes" : qual = ({ 5,3,0,ROBES }); 
	material = "cloth"; break;
    case "ring mail" : qual = ({ 100,32,3,SUIT }); break;
    case "scale" : qual = ({ 120,33,4,SUIT }); break;
    case "shield" : qual = ({ 7,5,1,SHIELD });
	material = "wood"; break;
    case "splint" : qual = ({ 80,32,6,SUIT }); break;
    case "studded" : 
    case "studded leather" : qual = ({ 20,21,3,SUIT });
	material = "leather"; break;
    }

    switch (qual[3]) {
    case SUIT 		: ob->set ("type", "suit"); break;
    case HELMET 	: ob->set ("type", "helmet"); break;
    case SHIELD 	: ob->set ("type", "shield"); break;
    case GLOVES 	: ob->set ("type", "gloves"); break;
    case BOOTS 		: ob->set ("type", "boots"); break;
    case BRACERS 	: ob->set ("type", "bracers"); break;
    case RING 		: ob->set ("type", "ring"); break;
    case AMULET 	: ob->set ("type", "amulet"); break;
    case CLOAK 		: ob->set ("type", "cloak"); break;
    case ROBES 		: ob->set ("type", "robes"); break;
    case BELT 		: ob->set ("type", "belt"); break;
