...
// VALID_DAMAGE_TYPES are the types of damage that are accepted by
// recieve_damage().  All else are rejected.

#define VALID_DAMAGE_TYPES ({ "fire",  "cold", \
    "crushing", "dehydration", "suffocation", "bleeding", \
    "acid", "poison", "necromancy", "force", "electricity", \
"slashing", "piercing", "bludgeoning", "wizard", "mental" })
