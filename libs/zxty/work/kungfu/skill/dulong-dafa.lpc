...
{       
        ...
        switch (skill)
        {
                ...
                case "taiji-shengong"      : return 2;
                case "beiming-shengong"      : return 2;
                case "zixia-shengong"       : return 2;
                case "taixuan-gong": return 2;
                case "jiuyin-xinjing"  : return 2;
                case "kurong-changong"  : return 1;
                case "linji-zhuang"     : return 1;
                  case "shenzhao-jing"     : return -1;
                case "shenyuan-gong"    : return -1;
                case "damo-force"   : return -2;
                case "dulong-dafa"      : return -2;
                case "huagong-dafa"     : return -2;
                case "huntian-qigong"         : return -2;
                case "yunu-xinjing"     : return -3;
                case "shenghuo-shengong"   : return -3;
                case "bibo-shengong"  : return -3;
                case "xiantian-gong"  : return -4;
                default: return 1;
        }
}
