...
void create()
{
    ...
    set("score", 1000000);
    set_skill("force", 3150);
    set_skill("buddhism-force", 2750);
    set_skill("dodge", 3150);
    set_skill("shaolin-shenfa", 3150);
    set_skill("unarmed", 3100);
    set_skill("sword", 2200);
    set_skill("parry", 3100);
    set_skill("shaolin-shenfa", 3100);
    set_skill("staff", 3100);
    set_skill("club", 1600);
    set_skill("blade", 3200);
    set_skill("whip", 3100);
    set_skill("damo-jian", 3100);
    set_skill("jingang-quan", 3100);
    set_skill("buddhism", 1500);
    set_skill("literate", 1500);
    set_skill("riyue-bian", 2500);
