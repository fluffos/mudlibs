...
string ask_for_zigong()
{
        ...
        return "变性？这位公子可是泰国迷？算了，如果你决心已定(decide)，赶快告诉我。\n";
}
string ask_for_jingong()
{
        object me;
...
int do_decide()
{
        ...
        command("chat "+this_player()->name()+"变性成功，从今天开始，世界上有多了一名人妖……咳咳…女子…");
        command("hehe");
...
return "您是当今新秀使者，来这里升级莫非想用BUG？\n";
 ...
 me->delete("class");
        ...
        command("chat 恭喜"+me->name()+"由女性转为男性,重新做人!");
return "您顺利转性为男性,您为了转性成功！\n";
}
