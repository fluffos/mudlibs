...
void attempt_apprentice(object ob)
{
        ...
        if ((int)ob->query_skill("fanyun-force", 1) < 450) {
                command("say 你的翻云神功还学的不够啊。");
                return;
}
         message("vision",HIM"〖风云再起〗"NOR+":"+HIR" 听说"HIW+ob->short()+NOR HIB"拜入通吃帮帮主杨小邪门下!\n"NOR,users());
