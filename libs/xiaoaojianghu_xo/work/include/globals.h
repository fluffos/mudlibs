...
#define NATURE_DIR	    SYSTEM_CONFIG_DIR "nature/"
...
#define UNIQUE_D            DAEMON_DIR "uniqued.lpc"
...
#define MASTER_OB           "/secure/obj/master"
#define MAILBOX_OB          "/clone/misc/mailbox"
#define SILVER_OB           "/clone/money/silver"
#define SIMUL_EFUN_OB       "/secure/obj/simul_efun"
...
#define BULLETIN_BOARD      STD_DIR "bboard"
#define CHARACTER           STD_DIR "char"
#define CLASS_GUILD         STD_DIR "room/class_guild"
#define COMBINED_ITEM       STD_DIR "item/combined"
#define PILL		    STD_DIR "medicine/pill"
#define POWDER		    STD_DIR "medicine/powder"
#define EQUIP               STD_DIR "equip"
#define FORCE               STD_DIR "force"
#define HOCKSHOP            STD_DIR "room/hockshop"
#define ITEM                STD_DIR "item"
#define LIQUID              STD_DIR "liquid"
#define MONEY               STD_DIR "money"
#define NPC                 STD_DIR "char/npc"
// AGENTS.md §8g variant: ZUOJI ("mount"/steed base class) was never
// #define'd despite 3 files (`inherit ZUOJI;`) and the real target file
// (/system/std/char/zuoji.lpc) existing on disk.
...
#define SKILL               STD_DIR "skill"
// AGENTS.md §8g variant: EXERT_DIR was never #define'd anywhere in this
// archive despite being referenced by 6 files under system/skill/exert/
// and system/skill/{shaolin,wuliang,xkdao}/ -- the real directory
// (/system/skill/exert/) exists on disk, this is a genuinely missing
// macro, not missing content.
#define EXERT_DIR           "/system/skill/exert/"
#define SSERVER             STD_DIR "sserver"
#define ZUZHI               STD_DIR "zuzhi"
#define TASK                "/system/std/task.lpc"
// AGENTS.md §8g variant: GROUP_TASK was never #define'd anywhere in this
// archive despite `inherit GROUP_TASK;` appearing in 42 files (all under
// system/task/), even though the real target file
// (/system/std/group_task.lpc) exists on disk -- a genuinely missing
// macro, not a missing file. Fixing this one line resolves all 42
// cascaded "syntax error ... expecting L_STRING or '('" sweep failures
// at once.
...
// Features
#define F_ACTION            FEATURE_DIR "action.lpc"
#define F_ADD_ACTION        FEATURE_DIR "add_action.lpc"
#define F_ALIAS             FEATURE_DIR "alias.lpc"
#define F_APPRENTICE        FEATURE_DIR "apprentice.lpc"
#define F_ATTACK            FEATURE_DIR "attack.lpc"
#define F_ATTRIBUTE         FEATURE_DIR "attribute.lpc"
#define F_AUTOSAVE          FEATURE_DIR "autosave.lpc"
#define F_AUTOLOAD          FEATURE_DIR "autoload.lpc"
#define F_CLEAN_UP          FEATURE_DIR "clean_up.lpc"
#define F_COMMAND           FEATURE_DIR "command.lpc"
#define F_CONDITION         FEATURE_DIR "condition.lpc"
#define F_CLOTHNAME         FEATURE_DIR "clothname.lpc"
#define F_DAMAGE            FEATURE_DIR "damage.lpc"
#define F_DBASE             FEATURE_DIR "dbase.lpc"
#define F_EDIT              FEATURE_DIR "edit.lpc"
#define F_EQUIP             FEATURE_DIR "equip.lpc"
#define F_FINANCE           FEATURE_DIR "finance.lpc"
#define F_FRUIT             FEATURE_DIR "fruit.lpc"
#define F_FOOD              FEATURE_DIR "food.lpc"
#define F_LIQUID            FEATURE_DIR "liquid.lpc"
#define F_MASTER            STD_DIR "char/master.lpc"
#define F_MESSAGE           FEATURE_DIR "message.lpc"
#define F_MORE              FEATURE_DIR "more.lpc"
#define F_MOVE              FEATURE_DIR "move.lpc"
#define F_NAME              FEATURE_DIR "name.lpc"
#define F_SAVE              FEATURE_DIR "save.lpc"
#define F_NAMEDATA          FEATURE_DIR "namedata.lpc"
#define F_SKILL             FEATURE_DIR "skill.lpc"
#define F_TEAM              FEATURE_DIR "team.lpc"
#define F_TREEMAP           FEATURE_DIR "treemap.lpc"
#define F_VENDOR            FEATURE_DIR "vendor.lpc"
#define F_UNIQUE            FEATURE_DIR "unique.lpc"
#define F_FAMILY            FEATURE_DIR "family.lpc"
#define F_ZUZHI             FEATURE_DIR "zuzhi.lpc"
