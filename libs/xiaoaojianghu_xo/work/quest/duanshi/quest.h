    ...
    if( random_num == quest_num )
        {
            ...
            return
                ...
                "bonus":                5 + random(6),
                    "quest_msg":
"段无畏笑了一声，说：“府里丫鬟想找双" + name + "作样子，你就\n"
"去买一双回来吧。”\n",
                "reward_msg":
"段无畏点了点头说：“嗯，这么快就回来了，不错、不错。”\n",
                "delay_msg":
"段无畏叹了口气道：“叫你出门办事，就应快去快回，年青人也太过贪\n"
"玩了。”\n",
        ]); 
        }
    if( random_num == quest_num + 1)
        ...
        ([      "quest":                "取" + name,
                ...
                "bonus":                6 + random(5),
                "quest_msg":
"段无畏想了想说道：“要端午节了，府里要" + name + "，你这就\n"
"去买一点回来吧。”\n",
                "reward_msg":
"段无畏拿起一个" + name + "看了看，点头道：“好好，就是这种。”\n",
        ]);
        }            
    if( random_num == quest_num + 2)
        ...
        ([      "quest":                "取" + name,
                ...
                "bonus":                7 + random(4),
                "quest_msg":
"段无畏笑了一声，说：“府里让买点" + name + "做点夏天的水果盘，你这就去买一\n"
"点回来吧。”\n",
                "reward_msg":
"段无畏点了点头说：“这" + name + "倒还新鲜，你练功去吧。”\n",
        ]);
        }  
        ...
        ([      "quest":                "取" + name,
                ...
                "bonus":                2 + random(4),
                "quest_msg":
"段无畏说：“你去买点" + name + "回来吧，听总管说茶已经不多了。”\n",
                "reward_msg":
"段无畏拿起" + name + "看了看，“嗯，这" + name + "不太好，不过也将就了。你下去\n"
"休息吧。”\n",
        ]);
        }             
        ...
        ([      "quest":                "取" + name,
                ...
                "bonus":                4 + random(3),
                "quest_msg":
"段无畏沉吟了一下：“前两天客厅的" + name + "打破了，你去买个新的\n"
"回来吧。”\n",
                "reward_msg":
"段无畏仔细端详了一下，皱皱眉头：“好象有点瑕疵啊？...算了吧...”\n",
        ]);
        }
