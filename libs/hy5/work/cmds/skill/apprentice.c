...
int main(object me, string arg)
{
	...
	if( (object)ob->query_temp("pending/recruit") == me ) {
		if( (string)me->query("family/family_name") != (string)ob->query("family/family_name") && me->query("family")  ) {
          if (!userp(ob) && me->query("combat_exp")>999999999)
          {
