...
// yuj please fix it if i made any mistake :)
        ...
        int max = me->query_skill("force")*15 + me->query("combat_exp")/1000;
...
if ((!me->query("zhuanshen") && !me->query("guard/flag") && !me->query("zhuanbest") && !me->query("4zhuan") && !me->query("5zhuan")) || me->query("hyvip")==4) neili_gain=neili_gain*3+1;
//if (me->query("hyvip")==4) neili_gain=neili_gain*2;
	...
	if (exercise_cost > 0) {
		...
		tell_object(me, msg["exec_other_msg"]);
		return 1;
	}
