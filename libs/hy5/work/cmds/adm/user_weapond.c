...
int weaponmake(int sl,int ty,int lv)
{
...
if (yushi==6 && is>8) is=8;
if (yushi==5 && is>9) is=9;
if (yushi==4 && is>10) is=10;
if (yushi==3 && is>11) is=11;
...
name="W"+type["TYPE2"]+sl;
        write_file("/p/item/ritemw/"+name+".c",my_file,1);
//write("武器打造成功！！\n");
//if (!wizardp(me))
//{
...
int armormake(int sl,int ty,int lv)
{
...
//rm("/p/residence/weapon/"+name+".c");
        ...
        write_file("/p/item/ritema/"+name+".c",my_file,1);
