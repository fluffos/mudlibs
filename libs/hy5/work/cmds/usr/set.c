...
int main(object me, string arg)
{
    ...
    wiz_only=({"invisibility", "immortal", "combat"});

allset=({ "brief", "no_accept", "no_teach", "wimpy", "combatd","no_moutmsg","no_minmsg","combat_show","combatdother", 
     "prompt", "time_format", "public", "agree_heal", "no_tell","friendtalk","save_me",
     "kill_msg","showmap","bweapon" });

allwizset=({ "brief", "no_accept", "no_teach", "wimpy", "combatd","no_moutmsg","no_minmsg","combat_show","combatdother", 
     ...
     "kill_msg", "combat","showmap","bweapon" });
