...
([
"action" :"$N双目微睁，左手随意一挥，发出一道指劲直取$n咽喉。正是「一恨才人无行」",
"force" :60,
"damage" :40,
"damage_type": "内伤",
"lvl" : 0,
...
([
"action" :"$N右手食指、中指连弹，射出一金一蓝两道指劲，直奔$n胸口大穴。此乃「二恨红颜薄命」",
"force" :90,
"damage" :60,
"damage_type": "内伤",
"lvl" : 1,
...
([
"action" :"$N身形一闪，左手三个手指扣向$n后脑。「三恨江浪不息」",
"force" :120,
"damage" :80,
"damage_type": "内伤",
"lvl" : 2,
...
int valid_learn(object me)
{
	if( me->query_temp("weapon") || me->query_temp("secondary_weapon") )
		return notify_fail("练"+"恨天十二掌"+"必须空手。\n");
	if( (int)me->query("max_neili") < 50 )
		return notify_fail("你的内力太弱，无法练"+"恨天十二掌"+"。\n");
	return 1;
}
