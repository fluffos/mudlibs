...
int valid_learn(object me)
{
	if ((int)me->query("max_neili") < 800)
        ...
        if( (int)me->query_skill("xuantian-wuji", 1) < 100)
                return notify_fail("你的玄天无极功的修为不够，不能学两仪剑法! \n");
        if( (int)me->query_skill("xunlei-jian", 1) < 100 )
                return notify_fail("你的迅雷剑法还不到家，无法学两仪剑法！\n");
...
int practice_skill(object me)
{
    object weapon;
        if( (int)me->query_skill("xuantian-wuji", 1) < 100)
                return notify_fail("你的玄天无极功的修为不够，不能练两仪剑法! \n");
        if( (int)me->query_skill("xunlei-jian", 1) < 100 )
                return notify_fail("你的迅雷剑法还不到家，无法练两仪剑法！\n");
   if(me->query_skill_mapped("force") != "xuantian-wuji" )
	return notify_fail("你没有用玄天无极。\n");
