...
object target;
      ...
      if( random(me->query_skill("qianzhu-wandushou",1)) > 50 && random(3)==0) 
{
	  victim->receive_wound("qi", level2+random(20),me);
...
void skill_improved(object me)
{
  if(random(15) == 1 && me->query("per") > 5){
       ...
       if (me->query("combat_exp",1) > 50000) me->add("combat_exp",-10000);
       //me->add("per", -1);
  }
}
