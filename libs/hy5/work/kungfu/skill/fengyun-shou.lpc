...
([  "action" : "$N使一式「雷震四方」，四面八方出现无数掌影，一爪突出，抓向$n
的胸口",
    "force" : 220,
    "dodge" : 25,
    "damage": 100,
...
([  "action" : "$N岳立霆峙，一式「地老天荒」，在一阵暴雷声中，双手同时拍中$n
的七道死穴",
    "force" : 400,
    "dodge" : 56,
    "damage": 160,
...
int valid_combine(string combo) { return combo=="yingzhua-gong"|| combo=="duoluoye-zhi"; }
