...
mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	weapon = me->query_temp("weapon");
        ...
        nlevel= (int) me->query_skill("longzhua-gong",1);
...
if (damage_bonus <10) damage_bonus=10;
      if( random(me->query_skill("longzhua-gong",1)) > 100 ) 
{
	  victim->receive_wound("qi", ((random(nlevel)+20))/2);
        return HIY "$n被龙爪手抓住，一阵巨痛！\n" NOR;
}
}