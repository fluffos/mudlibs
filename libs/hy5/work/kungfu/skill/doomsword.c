...
mapping *action = ({
	([	"name":			"群魔乱舞",
		"action":		"$N使一招「白云皑皑」，手中$w狂风骤雨般地向$n的$l连攻数剑",
		"dodge":		-200,
		"parry" :		-200,
		"damage":		170,
		"force" : 		200,
	...
	([	"name":			"饿鬼拦路",
		"action":		"$N手中$w一抖，使出「鬼魅缠身」往$n的$l刺出一剑",
                "dodge":                -100,
                "parry" :               -100,
                "damage":               150,
                "force" :               150,
...
string *parry_msg = ({
        "$n不退反进，气走周天，一招「无边无际」，手中的$v狠狠磕开了$N的$w。\n",
	"$n回剑自守，一招「鬼火烽身」，架住了$N的$w。\n",
	"$n一招「群魔乱舞」，手中的$v化作千百把，护住了全身。\n",
	"$n手中的$v自上削下，几乎将$N的$w削成两段。\n",
});

string *unarmed_parry_msg = ({
        "$n使出一招「万碍之障」，在身前布起了一道铜墙铁壁，封住了$N的攻势。\n",
	"$n一抖手中的$v，使出一招「碧灵黄泉」，手中的$v护住了全身。\n",
