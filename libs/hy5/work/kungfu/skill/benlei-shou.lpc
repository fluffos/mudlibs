...
int valid_combine(string combo) { return combo=="baihua-cuocuff"; }
...
//        target = me->select_opponent();
	...
	if( userp(victim) && (random(12)==1 || random(level) > 150))
	{
        victim->receive_wound("qi", (damage_bonus+level+100) );	
        return HIY "「电闪雷动!!」！$N身形凝立不动，两掌间绽出万道霞光，将$n紧紧罩住!!!\n" NOR;
	}
