...
if (me->query("family/family_name")=="嵩山派" || me->query_skill("songshan-jian",1) >200)
{

        if ((int)me->query_skill("songshan-qigong", 1) < 50)
                return notify_fail("你的嵩山气功火候太浅。\n");
        if ((int)me->query_skill("songyang-strike", 1) < 50)
