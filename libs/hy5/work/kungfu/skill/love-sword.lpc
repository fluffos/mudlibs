...
return notify_fail("这门武功要找雁荡派的落雁老人才能学！\n");
         ...
         if( (me->query("potential",1 )-me->query("learned_points", 1))<50){
                tell_object(me, "你的潜能不到五十点, 无法练此剑法。\n");
                return 0;
         }
