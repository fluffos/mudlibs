...
if (random(6)==0 && level>=200 && me->query_skill_mapped("force") == "xiantian-qigong")
{
...
if (random(6)==0 && level>=300 && me->query_skill_mapped("force") == "xiantian-qigong")
{
...
level2= (int) me->query_skill("kongming-quan",1);             
	...
	victim->receive_wound("qi", (random(level2)/2+30));
