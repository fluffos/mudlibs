       ...
       msg = WHT  "$N转过"+ weapon->name()+HIG"，刷刷刷连进三棒，棒法快捷无伦，都是打狗棒法中的杀招！" NOR;
        ...
        msg = RED "第三招 $N横棒挥出，使出了拌字决！！" NOR;
          COMBAT_D->do_attack(me,target, me->query_temp("weapon"),TYPE_REGULAR,msg);
                ...
                //target->receive_wound("qi",random((int)me->query_skill("dagou-bang",1)));
                target->receive_damage("qi",(int)me->query_skill("dagou-bang",1)*8,me);
                target->receive_wound("qi",(int)me->query_skill("dagou-bang",1)*8,me);
        me->add_temp("apply/attack", - 200);
        me->add_temp("apply/damage", - 2800);
...
//weapon->unequip();
 ...
 msg = HIR"你咬紧牙关，双掌护身，心中默念降龙十八掌的口诀!"+HIY"亢"NOR+HIC"龙"NOR+HIW"无"NOR+HIR"悔!!"NOR+" ";
                ...
                target->receive_damage("qi",(int)me->query_skill("xianglong-zhang",1)*8,me);
                target->receive_wound("qi",(int)me->query_skill("xianglong-zhang",1)*8,me);
