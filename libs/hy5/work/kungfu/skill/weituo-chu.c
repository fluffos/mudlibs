 ...
 mixed hit_ob(object me, object victim, int damage_bonus, int factor)
{
	...
	weapon = me->query_temp("weapon");
        ...
        nlevel= (int) me->query_skill("weituo-chu",1);
...
if (damage_bonus <80) damage_bonus=80;
      if( random(me->query_skill("weituo-chu",1)) > 100 || random(3)==0) 
{
	  victim->receive_damage("qi", ((nlevel+150)));
	  victim->receive_wound("qi", ((nlevel))+100);
