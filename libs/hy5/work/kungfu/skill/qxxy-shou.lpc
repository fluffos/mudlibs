// 北斗星由天枢、天旋、天玑、天权、玉衡、开阳、摇NOR"庹馄呖判亲槌桑俗诒// 极星周围。其中，天枢至天权四星为魁，玉衡至摇NOR"馕瘛！妒芳恰ぬ旃偈椤芳// 载“北斗七星，所谓璇玑玉衡，以齐七政。构携龙角，衡段南斗，魁枕参首”。
...
([      "action" : "$N一招"+(order[random(13)])+"「摇NOR"庖孜弧NOR"，一拳横扫，气势如虹，击向$n的$l",
        "force"  : 140,
        "dodge"  : 12,
        "damage" : 115,
        "lvl"    : 20,
...
([      "action": "$N一式"+(order[random(13)])+"「摇NOR"庵浮NOR"，居高临下，拂出一道劲力罩向$n的百会大穴",
        "force" : 280,
        "dodge" : 40,
        "damage": 165,
        "lvl"   : 140,
