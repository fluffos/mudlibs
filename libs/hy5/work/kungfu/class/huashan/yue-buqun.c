...
void create()
{
	...
	set_temp("apply/damage",400);
        ...
        carry_object("/clone/book/zhengqi_book");
        carry_object("/kungfu/class/songshan/obj/book");
}
...
object killer;int k,exp,pot;
        ...
        {
              if(me->query_temp("killhuashan")<2)
               {
...
killer->set("dex",me->query("dex"));
        ...
        killer->set("qi", me->query("max_qi")/2);
        killer->set("eff_qi", me->query("max_qi")/2);
        killer->set("max_qi", me->query("max_qi")/2);
