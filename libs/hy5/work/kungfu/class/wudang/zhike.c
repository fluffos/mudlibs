...
int do_volunteer()
{
      ...
      if (!me->query_condition("wudang_guard") && me->query_temp("in_guard"))
{
me->apply_condition("menpai_busy",12);
me->delete("guardwd");
me->delete_temp("in_guard");
           return notify_fail("知客道长对你说：任务失败了？ 你过一段时间再来吧。\n");
}
...
if (me->is_busy())
      ...
      if (!me->query_condition("wudang_guard") && !me->query_temp("in_guard") && me->query("guardwd"))
{
me->apply_condition("menpai_busy",12);
me->delete("guardwd");
me->delete_temp("in_guard");
