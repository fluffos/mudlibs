...
void create()
{
   ...
   set("per",37);
	...
	set_skill("zhemei-shou",320);
	set_skill("liuyang-zhang",320);
        set_skill("tianyu-qijian",320);
	set_skill("yueying-wubu",320);
        ...
        if (userp(me))
{
        ...
        message("vision", me->name() + "增加了五百经验和五百潜能。\n", me);
