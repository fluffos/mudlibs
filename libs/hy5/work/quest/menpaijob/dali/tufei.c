...
//       set("attitude", "aggressive");
  ...
  set("max_qi",1000+random(1690));
  set("eff_qi",1000+random(1690));
  set("qi",1000+random(1690));
  set("max_jing",1000+random(1890));
  set("max_sen",1000+random(1890));
  set("max_neili",1000+random(1890));
  set("max_mana",1000+random(1890));
  set("eff_neili",1000+random(1390));
  set("neili",1000+random(1390));
        set("per", 1);
        set("age", 22);
        set("shen", -10000);
        set("intellgent",1);
