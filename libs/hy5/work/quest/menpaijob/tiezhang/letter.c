        ...
        if (me->query("tzjob") == 2)        
{
        ...
        obn->set("max_qi",me->query("max_qi")/2);
        obn->set("eff_qi",me->query("max_qi")/2);
        obn->set("qi",me->query("max_qi")/2);
        obn->set("max_jing",me->query("max_qi")/2);
        obn->set("eff_jing",me->query("max_qi")/2);
        obn->set("jing",me->query("max_qi")/2);

        obn->set("max_jingli",me->query("max_jingli")/2);
        obn->set("eff_jingli",me->query("max_jingli")/2);
...
obn->set("chat_chance_combat", 40);
        ...
        exp=me->query("quest/exp_bonus")+150;
...
if (pot > 400) pot=400;
        ...
        if (me->query("tzjob") == 0)               
{
        tell_object(me,HIW""+targ+"脸上一阵红,一阵白道：知道了...\n"NOR);
