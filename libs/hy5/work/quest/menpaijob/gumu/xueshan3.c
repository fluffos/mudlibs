...
int do_copy(object me)
{
      ...
      if(!me->query_temp("xx_rob")){
        ...
        ob->set_skill("dashou-yin", me->query_skill("force",1)* 3 / 4);
        ob->set_skill("xue-dao",me->query_skill("force",1)* 3 / 4);
        ob->set_skill("dodge", me->query_skill("force",1)* 3 / 4); 
        ob->set_skill("force", me->query_skill("force",1)* 3 / 4); 
        ob->set_skill("hand", me->query_skill("force",1)* 3 / 4); 
        ...
        ob->set_skill("blade", me->query_skill("force",1)* 3 / 4);
