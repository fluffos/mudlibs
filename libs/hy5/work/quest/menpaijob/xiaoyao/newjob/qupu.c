...
me->set_temp("singn",st1);
       if(!arg) return notify_fail("你想唱什么？\n");
        ...
        tell_object(me,"你对"+ob1->query("name")+"，点了点头。\n");
...
else    call_out("sing_stage", 2, me, ++stage, i, size);
   }
   else {
...
tell_object(me,ob1->query("name")+"听了后，心旷神移。对你微微一笑!\n");
//tell_object(me,"你的经验加了"+chinese_number(12+b1)+"点。\n");
//tell_object(me,"你的潜能加了"+chinese_number(8+b2)+"点。\n");
