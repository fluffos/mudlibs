...
int do_copy(object me)
{
      ...
      if(!me->query_temp("xx_rob")){
        ...
        message_vision(HIR"突然从船上窜出一个$N，二话不说就扑向了$n！\n"NOR, ob, me);
      ...
      temp=(int)me->query_skill("force",1)* 4 / 5;
...
if (killer && killer->query("id")==this_object()->query("killguan"))
{
if (userp(killer))
{
