...
int do_zhujia(object ob)
{
        ...
        {
        me->add("combat_exp",16+random(20));
        me->add("potential",16+random(10));
        }
        me->add("jing",-50);
        me->add("qi",-80);
        me->add("neili",-100);
        ...
        ob1->set("armor_prop/armor", b2);
        ob1->set("value", 15000);
if (random(60)==0 || wizardp(me))
{
yai=random(200)+1;
if (yai> 150 && random(2)==1) yai=random(150);
if (yai> 60 && random(2)==0) yai=random(60);
ob1=new("/p/item/ritema/Aarmor"+yai);
if (random(2)==0) ob1=new("/p/item/ritema/Acloth"+yai);
        message_vision(HIY"一道神光！闪过$N打造出来的装备上。\n"NOR,me); 
        
}

ob1->move(me);
message_vision(HIY"$N得到了"+ob1->query("name")+"。\n"NOR,me); 
        me->add("work/zhujia", 1);       
        return 1;
        }
} 
