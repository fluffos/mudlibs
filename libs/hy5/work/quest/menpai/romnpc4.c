...
if (me->query("str",1) < 30)
me->set("str",30);
if (me->query("dex",1) < 30)
me->set("dex",30);


if (me->query("max_qi",1) < (lv*20))
me->set("max_qi",lv*20);

if (me->query("max_jing",1) < (lv*20))
me->set("max_jing",lv*20);

if (me->query("max_neili",1) < (lv*28))
me->set("max_neili",lv*28);

if (me->query("isboss"))
	{
	me->set("max_qi",lv*300);
me->set("max_jing",lv*300);
me->set("max_neili",lv*300);
