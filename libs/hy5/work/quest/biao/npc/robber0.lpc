...
temp=(int)ob->query_skill("force",1);
        ...
        me->set_skill("huashan-sword", temp);
        ...
        me->map_skill("sword","huashan-sword");
...
me->set("qi",(ob->query("max_qi"))/4);
me->set("eff_qi",(ob->query("max_qi"))/4);
me->set("max_qi",(ob->query("max_qi"))/4);
me->set("max_jing",(ob->query("max_qi"))/4);
me->set("eff_jing",(ob->query("max_qi"))/4);        
me->set("jing",(ob->query("max_qi"))/4);
