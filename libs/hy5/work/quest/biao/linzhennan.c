...
"/d/foshan/dangpu","/d/xiangyang/dangpu","/d/suzhou/dangpu","/d/cangzhou/bank","/d/city4/qianzhuang","/d/chengdu/qianzhuang","/d/jinling/qianzhuang","/d/jinling/dangpu","/d/tanggu/dangpu","/d/kunming/dangpu","/d/jingzhou/qianzhuang","/d/hefei/qianzhuang","/d/changsha/qianzhuang","/d/guizhou/qianzhuang","/d/jiujiang/qianzhuang","/d/jiangling/qianzhuang","/d/suiye/qianzhuang","/d/nanchang/qianzhuang","/d/lanzhou/qianzhuang"});
string* dart_short=({"北京当铺","北京钱庄","扬州钱庄","英雄典当","襄阳当铺","苏州宝和记","天音阁","相记钱庄","川号钱庄","穆记钱庄","天马当铺","万福典当","昆明当铺","荆州钱庄","合肥钱庄","长沙钱庄","贵州文昌阁","九江钱庄","江陵钱庄","碎叶钱庄","南昌钱庄","兰州钱庄"});
string* dart_id=({"jia laoliu","qian laoben","qian yankai","lao chaofeng","qiu hang",
"wang heji","jiang tiaohou","tie suanpan","ma youcai","banker","xia tian","yin laoban","liu tong","qian defa","chang laoban","qian laoban","qian yan","qian laoban","chen afa","qian laoban","zhou laoban","qian mixin"});
string* dart_name=({"贾老六","钱老本","钱眼开","老朝奉","邱航","王合计","蒋调侯","铁算盘","马有财","穆守财","夏天","殷老板","刘通","钱得发","常老板","钱老板","钱眼","钱老板","陈阿发","钱老板","周老板","钱迷心"});
...
{   int n;
    ...
    if ( (int)ob->query("combat_exp") < 1000000 && ob->query("nbjob")!=47)
       return "护镖是件危险工作，我看"+RANK_D->query_respect(ob)+"似乎没有这能力！\n";
...
exp=exp/2+18;
addnl(ob,"exp",exp);        
ob->add_temp("nbjob48",1);

      MONEY_D->pay_player(ob, random(10000)+1000);
  command("pat "+ob->query("id"));
ob->apply_condition("menpai_busy",6);
