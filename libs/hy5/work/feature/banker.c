...
int do_deposit(string arg)                                                      
{
        ...
        set_temp("busy", 1);
        me->start_busy(1);
me->set_temp("isbank",1);
	if (me->query("age")==14) money_limit = 1000;
	if (me->query("age")>14) money_limit = 1000 + (me->query("age")-15) * 20;
	if (me->query("age")>20) money_limit = 2000 + (me->query("age")-20) * 20;
	if (me->query("age")>30) money_limit = 4000 + (me->query("age")-30) * 30;
	if (me->query("age")>40) money_limit = 8000 + (me->query("age")-40) * 40;
