...
({
    ...
    ({
        ...
        "sys",
        WIZARD,
        RED "【"RED"系"NOR RED"统"NOR RED"】"NOR,
        ([
                "time"          : 1,    // 显示时间
                "msgcolor"      : NOR RED,
        ]),
	...
	"combat",
	PLAYER,
        HIR "【"NOR RED"战"HIR"斗" NOR HIR"】"NOR,
	([
	        "time"	        : 1,
	        "notalk"	: 1,
                "msgcolor"      : NOR HIR,
	...
	"sport",
	PLAYER,
	WHT "【"NOR HIW"运"NOR WHT"动" NOR HIW"】"NOR,
	([
	        "msgcolor"      : NOR HIW,
	        "time"	:	1,
	        "notalk"	:	0,
