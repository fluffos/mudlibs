...
int perform(object me, object target)
{
  ...
  if( (skill = (int)me->query_skill("songyang-strike", 1)) < 140 )
  ...
  if (me->query_skill_prepared("strike") != "songyang-strike" ||
      me->query_skill_mapped("strike") != "songyang-strike")
