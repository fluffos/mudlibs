...
me->dismiss_team();
	...
	COMBAT_D->do_attack(obs[i],target, ob, TYPE_REGULAR,msg);
                ...
                target->receive_damage("qi", (extra+200) , me);
                target->receive_wound("qi", (extra+100), me);
...
if (me->query_skill("qixing-array",1) > 250)
{
	...
	COMBAT_D->do_attack(obs[i],target, ob, TYPE_REGULAR,msg);
COMBAT_D->do_attack(obs[i],target, ob, TYPE_REGULAR,msg);
                target->receive_damage("qi", (extra+500) , me);
                target->receive_wound("qi", (extra+200), me);
