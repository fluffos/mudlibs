...
if (userp(me) && userp(target) && target->query("combat_exp",1) < me->query("combat_exp",1)) 
	...
	if (me->query("hyvip",1)!=4) me->add("neili", -2500);
me->start_busy(3);
	seteuid(getuid());
...
exp = (int)me->query("combat_exp");
	soldier->set("qi",me->query("max_qi")*3);
	soldier->set("eff_qi",me->query("max_qi")*3);
	soldier->set("max_qi",me->query("max_qi")*3);
	soldier->set("jing",me->query("max_qi")*3);
	soldier->set("eff_jing",me->query("max_qi")*3);
	soldier->set("max_jing",me->query("max_qi")*3);
	soldier->set("neili",me->query("max_neili")*3);
	soldier->set("max_neili",me->query("max_neili")*3);
}
