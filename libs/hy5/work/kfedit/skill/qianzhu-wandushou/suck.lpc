...
*/
    ...
    case 3:
        ...
        if( (int)target->query_temp("apply/armor") > 8000 )
            target->set_temp("apply/armor", 8000);
        else
    ...
    case 4:
        ...
        if( target->query("max_qi") > 100000 )
            target->set("max_qi", 100000);
        else
    ...
    case 5:
        ...
        if( target->query("max_jing") > 100000)
            target->set("max_jing", 100000);
        else
