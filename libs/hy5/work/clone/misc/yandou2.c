...
void create()
{
        set_name(HIY"神凤首"NOR, ({ "shuqin" }) );
        set_weight(200);
        if( clonep() )
                set_default_object(__FILE__);
        else {
                set("unit", "把");
                set("long", "这是一个很漂亮的竖琴，，如果你喜欢可以弹（tan）几下。\n");
                set("value", 3000);
...
int do_smoke(){
	object me;
        ...
        message_vision(HIG"$N拿出一把竖琴放在怀中慢慢的弹了起来，琴声清而不淡，响而不俗，令人不觉陶醉其中。\n"NOR,this_player());
