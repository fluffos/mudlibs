...
void create()
{
        set("short", "金殿");
        set("long", @LONG
你一路分花拂柳，走着走着。眼前豁然开朗。一座壮观的真武金
殿就呈现在眼前。金殿建在天柱峰顶端，是真武山的象征. 铜铸鎏金
的金殿虽为铜铸，但其结构殿身的立柱、梁枋以及瓦鳞、檐牙、窗棂、
门限等诸形毕备，且每块铸件之间严丝合缝，毫无人工雕凿之痕，浑
然天成。顶翼角飞举，上饰龙凤、天马、等灵禽瑞兽栩栩如生金殿内
供奉的真武帝君像披发跣足，丰姿巍伟。而他身旁两侧端宝奉册的金
童玉女，闲淑俊仪，温文尔雅；擎旗捧剑的武士勇猛威烈，气势夺人。
这里是武当会见客人的地方。
LONG
        );
        set("exits", ([
