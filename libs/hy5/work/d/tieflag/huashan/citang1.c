...
中一棵古树上似乎有很多乌鸦的巢穴，不时传来乌鸦“呱呱”的叫声令人烦躁。荒草
没膝，在风中发出萧瑟的声音。院中是一个破烂的祠堂。
LONG
        );
    set("exits", ([ 
                "west" : __DIR__"hpath2",
...
string citang(){
   ...
   me = this_player();
        if(i == 3){
        weather = "阵风";
        if (random(5)==1)  weather = "狂风";
         if (random(5)==1)  weather = "雪";	
         if (random(5)==1)  weather = "大雪";	
if (random(6)==1)  weather = "雨";	
        if (random(6)==1)  weather = "大雨";	
