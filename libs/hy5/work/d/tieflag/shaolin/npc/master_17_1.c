...
void create()
{
    ...
    set("neili", 1500);
    set("long",
        "东林寺现任掌门人，由于东林常丢经书，现在喜怒无常，经常将守经书"
        "的弟子逐出东林。\n");
    create_family("东林寺", 17, "掌门");
...
int damo(){
   ...
   if(me->query("marks/面壁领悟")){
        ...
        message_vision("$N微微一耸眉说道：”易筋经乃东林至宝，一向只传有缘之人。。。”\n", this_object()); 
        ...
        if(me->query("class") != "shaolin") {
                message_vision("$N笑道：“你既非我东林，还是不要多问了。”\n", this_object());
                return 1;
