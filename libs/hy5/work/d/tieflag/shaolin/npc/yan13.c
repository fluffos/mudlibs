...
int ask_fight()
{
        object me;
        me = this_player();
        if (!me->query("marks/东林_神剑_燕十三") || me->query("marks/东林_神剑_谢晓峰"))
        {
                return 0;
        }
...
$N在竹林的飒飒天籁中忽然感到顿悟。\n",me);
                ...
                }else
                {
                        ...
                        me->delete("marks/东林_神剑_燕十三");
            me->set("marks/东林_神剑_死亡之剑",1); 
        }
        return 1;
} 
void die()
{
    ...
    if(objectp(killer = query_temp("last_damage_from")))
        {
                if (killer->query("marks/东林_神剑_燕十三"))
                {
                        killer->delete("marks/东林_神剑_燕十三");
                        killer->set("marks/东林_神剑_谢晓峰",1);
                }
        }
    ::die();
}  
