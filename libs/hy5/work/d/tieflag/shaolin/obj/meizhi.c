...
int do_study(string arg)
{
        ...
        if (me->query("marks/东林_神剑") || (string)me->query("class") != "shaolin")
        {
                tell_object(me,"你无法从梅枝的断口中领悟任何东西。\n");
                return 1;
        }
        if (me->query("marks/东林_神剑_梅枝"))
        { 
                tell_object(me,"你又研究了一会梅枝的断口，越来越觉得这一剑精妙入微，宛如天成。 \n");
           return 1;
        }
        if (me->query_temp("marks/东林_神剑_初级"))
        {
        ...
        }else if (i == 11)
        {
                        ...
                        {
                                tell_object(me,"你又研究了一会梅枝的断口，越来越觉得这一剑精妙入微，宛如天成。 \n");
                                me->set("marks/东林_神剑_梅枝",1);
                        }else
                        {
                                tell_object(me," 你又研究了一会梅枝的断口，觉得这一剑实在奥妙得难以理解。 ");
                                me->set_temp("marks/东林_神剑_初级",1);
                        }
                        me -> set_temp("looked",0);
