...
void create()
{
     set("short", "梅花小筑");
     set("long", @LONG
这是铁少夫妇歇息的地方，房中虽然收拾的一尘不染，皓白如雪，但却空空
荡荡没什么摆设，除了墙上挂着一副昔年铁少赠与雪蕊儿的“雪梅傲霜图”外，
便只有一大块青白玉石作床，当年铁少夫妇行走江湖，雪蕊儿被仇家所伤，几近
不治，铁少踏遍天涯，历尽艰辛，终于觅得这块产于极北苦寒之地的寒玉石为雪
蕊儿疗伤，果真是沉疴除尽。
LONG
        );
    set("exits", ([ 
...
void curePlayer(object me)
{
        ...
        {
                tell_object(me,"你慢慢觉得寒气渐去，感觉心头愈来愈暖，丹田之中气息流转不停。\n ");
                if(me->query("eff_qi") != me->query("max_qi"))
                {
                        tell_object(me,"你身上的伤势竟神奇般得好了！\n");
...
/*      
        if("/cmds/std/exercise"->main(me,arg))
        {
           ...
           if(kee_regain)
                {
                        write(HIG"你暗运真气，心中一片清明，内息运转愈来愈快，却又平和通畅，浑身但觉舒畅无比。。 \n"NOR);
