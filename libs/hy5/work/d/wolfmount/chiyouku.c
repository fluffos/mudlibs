...
地之威，睥睨天下之势，竟然是上古传说的大神蚩尤；神像头顶，一根放射出万道
金华的法杖没顶而插；其余十座塑像，分别为蛮、夷、戎、狄、黑、蛰、邪、兽、
鬼，蚩尤统领的各部落首领，塑工古朴，年代久远，每具塑像均向蚩尤顶礼膜拜。
四周满山遍野皆是森森白骨，排列得整齐异常，头向蚩尤巨像，虔诚膜拜。
LONG);
        set("staff", 1);
        set("type","street");
        set("exits",([
...
int do_pull(string arg){
        ...
        if(me->query("neili") > 80 && me->query_str() > 30 ) {
...
int valid_leave(object obj, string dir){
        if(dir == "north" && present("chi you", this_object())){
                message_vision(RED"蚩尤散发着无穷杀机的血色赤眸盯着$N一字字道：蚩尤重生，君临天下！\n"NOR, obj); 
