...
void greeting(object ob)
{
        ...
        {
        message_vision("$N色迷迷盯着$n，抚摩着$n的酥胸，呓语般道：美人儿，\n睡吧，睡吧，你会享受到人间极乐的感觉。\n", this_object(),ob );
...
void wake(object ob)
{
        ...
        if(!ob->is_ghost())
        {
           message_vision("$N睁开了眼睛，觉得身上凉嗖嗖的，伸手一摸，不禁大声尖叫起来。\n", ob); 
   message_vision("$N正自惊吓，扭头一看，柳三郎呲牙咧嘴捂着要害，苦着脸对柳幺妹悲泣道：我说幺妹\n啊，你平时那个俏哥这个乖弟，我说什么了么？偏生我就难得出墙一次，你。。竟然把\n我活生生废了!呜~~呜~~\n",ob);  
                return;
        }
        return;
}      
