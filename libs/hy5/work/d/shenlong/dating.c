...
set("roomif","$botten#抢书任务|任务失败|疗毒|钓杆:ask hong about job|ask hong about 失败|ask hong about 疗毒|ask hong about 钓杆$#");
...
int valid_leave(object me, string dir)
{
	if (dir != "south" )
	{
		if(userp(me) && me->query("party/party_name") !=HIY "神龙教" NOR)
		{
