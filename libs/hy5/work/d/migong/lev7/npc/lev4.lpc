  ...
  set("neili",1500+random(2000));
	...
	set("pursuer",1);
        set("combat_exp", 1700000+random(500000));
                 set_skill("finger", 250+random(40));

 set_skill("linji-zhuang", 250+random(40));

set_skill("force", 250+random(40));
set_skill("tiangang-zhi", 250+random(40));
...
set_skill("zhutian-bu", 250+random(40));

set_skill("yanxing-dao", 250+random(40));
