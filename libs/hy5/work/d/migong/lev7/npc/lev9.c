  ...
  set("neili",4500+random(2000));
	...
	set("pursuer",1);
        set("combat_exp", 1700000+random(500000));
                 set_skill("axe", 250+random(40));

 set_skill("tiezhang-zhangfa", 250+random(40));
...
set_skill("shuishangpiao", 250+random(40));

set_skill("guiyuan-tunafa", 250+random(40));

set_skill("duanyun-fu", 250+random(40));
...
set("chat_chance_combat", 80);
     ...
     set("chat_chance", 30);
        ...
        setup();
if (random(3)==0) initlvl(240+random(70));
        carry_object("/d/migong/obj/cloth")->wear();
  
carry_object("/d/migong/obj/axe")->wield();
