...
if (me->query("max_qi",1) < (lv*200))
me->set("max_qi",lv*200);

if (me->query("max_jing",1) < (lv*200))
me->set("max_jing",lv*200);

if (me->query("max_neili",1) < (lv*280))
me->set("max_neili",lv*280);
...
//me->set_name(os, ({ os }));
		...
		shoe->move(me);
		//shoe->wear();
	 me->set_temp("apply/armor", 600);
       me->set_temp("apply/damage", 600);
   if (random(10)== 0  )
	{
       me->set_temp("apply/defense", random(200)+10);
       me->set_temp("apply/armor", random(5000)+1000);
       me->set_temp("apply/damage", random(5000)+1000);
