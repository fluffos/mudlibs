...
set("eff_qi",8000+random(10000));
	...
	set("combat_exp",45000000+random(9000000));
...
set_skill("spells",400+random(300));
      ...
      set_skill("magic-ice", 450+random(300));
      set_skill("magic-earth", 450+random(300));
...
if (!me) return;        
        ...
        message("vision", me->name() + HIG"成功杀死"+ob->query("name")+",增加了200经验和100潜能。\n"NOR, me);
...
message("vision", me->name() + HIG"找到了"+corpse->query("name")+"。\n"NOR, me);
}
