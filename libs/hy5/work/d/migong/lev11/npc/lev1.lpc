...
set_skill("shenyuan-gong", 360+random(60));

set_skill("xingyi-zhang", 360+random(60));

set_skill("force", 360+random(60));
set_skill("murong-jianfa", 360+random(60));
...
set_skill("yanling-shenfa", 360+random(60));

set_skill("douzhuan-xingyi", 360+random(60));

  
        map_skill("sword", "murong-jianfa");
  
      map_skill("parry", "douzhuan-xingy");
...
prepare_skill("finger", "canhhe-zhi");
...
(: perform_action, "sword.yihuajiemu" :),
