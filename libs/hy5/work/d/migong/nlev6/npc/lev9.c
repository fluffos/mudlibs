  ...
  set("neili",1500+random(1500));
	...
	set("pursuer",1);
        set("combat_exp", 1200000+random(500000));
                 set_skill("unarmed", 310+random(40));

set_skill("shenlong-xinfa", 310+random(40));

set_skill("yangsheshu", 310+random(40));

set_skill("zhaosheshu", 310+random(40));

set_skill("parry", 310+random(40));

set_skill("dodge", 310+random(40));
 ...
 set("chat_chance_combat", 90);
   ...
   (: random_move :),
     ...
     set("chat_chance", 30);
        ...
        setup();
if (random(3)==0) initlvl(220+random(70));
