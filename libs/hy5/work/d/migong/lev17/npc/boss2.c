...

{
   ...
   set_name(order[random(13)]+"溫蒂妮"NOR, ({ "undine"}));
if (random(2)==0)
	set("magicgift",1);
else 	set("magicgift",2);
	set("magicset",1);
       set("title",HIB"水之精灵王"NOR);
       set("zhuanbest",1);
       set("long",
"一位可怕的水之精灵王。\n");
...
map_skill("spells", "magic-water");
        set("no_get",1);
b=2168000+random(68000);
a=2188000+random(68000);
d=38+random(60);
set("str",d);
set("dex",30+d);
set("int",d);
...
if (!me) return;        
        ...
        me->add("score",1);
if (!present("water cloth", me)

)
{
        jla=new("/clone/magic/obj/armor12");
        jla->move(me);
