...
set_skill("sanyin-wugongzhao", 190+random(30));
            set_skill("force", 190+random(30));
set_skill("throwing", 190+random(30));

set_skill("parry", 190+random(30));

set_skill("dodge", 190+random(30));

set_skill("feixing-shu", 190+random(30));

set_skill("zhaixinggong", 190+random(30));

set_skill("huagong-dafa", 190+random(30));
...
set("chat_chance_combat", 80);
   ...
   carry_object("/d/migong/obj/lianzi")->wield();
