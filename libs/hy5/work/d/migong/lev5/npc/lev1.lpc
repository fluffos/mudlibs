...
set_skill("hunyuan-zhang", 190+random(30));
...
set_skill("huashan-sword", 190+random(30));

set_skill("feiyan-huixiang", 190+random(30));

set_skill("zixia-shengong", 190+random(30));
