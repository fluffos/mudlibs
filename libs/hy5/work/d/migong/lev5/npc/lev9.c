  ...
  set("neili",2000+random(1500));
	...
	set("pursuer",1);
        set("combat_exp", 1000000+random(250000));
                 set_skill("hand", 190+random(30));

set_skill("dashou-yin", 190+random(30));

set_skill("force", 190+random(30));
set_skill("staff", 190+random(30));

set_skill("parry", 190+random(30));

set_skill("dodge", 190+random(30));

set_skill("xiangmo-chu", 190+random(30));

set_skill("shenkong-xing", 190+random(30));

set_skill("longxiang", 190+random(30));
