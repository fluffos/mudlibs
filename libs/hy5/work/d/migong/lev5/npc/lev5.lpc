...
set_skill("shenyuan-gong", 190+random(30));
...
set_skill("murong-daofa", 190+random(30));

set_skill("yanling-shenfa", 190+random(30));

set_skill("xingyi-zhang", 190+random(30));
