...
set("force_factor",100+random(200));
  set("max_qi",8000+random(2500));
  set("max_jing",6500+random(2500));
  set("max_sen",3000+random(2500));
  set("max_neili",6000+random(2500));
  set("max_mana",3000+random(2500));
  set("eff_neili",6000+random(2500));
...
set("chat_chance_combat", 90);
   ...
   (: exert_function, "wuzhuan" :),	
     ...
     set("chat_chance", 30);
        ...
        setup();
if (random(3)==0) initlvl(280+random(70));
