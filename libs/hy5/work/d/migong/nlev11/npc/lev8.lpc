...
set_skill("hamagong", 360+random(60));

set_skill("chanchu-bufa", 360+random(60));

set_skill("force", 360+random(60));
set_skill("hamashengong", 360+random(60));
...
set_skill("dodge", 360+random(60));
        ...
        map_skill("parry", "hamashengong");

 map_skill("force", "hamagong");

 map_skill("dodge", "chanchu-bufa");
 
prepare_skill("unarmed", "hamashengong");
