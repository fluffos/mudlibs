...
if (!killer) return;    
        ...
        if (userp(killer)&& (int)killer->query("combat_exp") < 18000000)
        {
if (random(25) < 1)
{
             ...
             jla->move(killer);
       message("vision", killer->name() + "为江湖除害,增加了1600经验和900潜能。\n", killer);
        killer->add("combat_exp",1600);
        killer->add("potential",900);             
