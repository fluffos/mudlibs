...
set_skill("jiuyang-shengong", 300+random(50));

set_skill("qiankun-danuoyi", 300+random(50));
...
set_skill("sougu", 300+random(50));

set_skill("qingfu-shenfa", 300+random(50));
