  ...
  set("neili",2000+random(2000));
	...
	set("pursuer",1);
        set("combat_exp", 2500000+random(800000));
                 set_skill("strike", 300+random(50));

set_skill("tiexue-hammer", 300+random(50));

set_skill("guiyuan-tunafa", 300+random(50));
...
set_skill("shuishangpiao", 300+random(50));

set_skill("tiezhang-zhangfa", 300+random(50));
