...
int valid_leave(object me, string dir)
{
    ...
    if(me->is_busy() && dir == "west")
       ...
       if ( !present("dark jian", me) && dir == "west" )
        return notify_fail("一股神奇的力量挡住了你!!需要 暗黑之剑才能打开通道。 \n");


       if ( !present("light jian", me) && dir == "west" )
        return notify_fail("一股神奇的力量挡住了你!! 需要 光之剑才能打开通道。\n");
