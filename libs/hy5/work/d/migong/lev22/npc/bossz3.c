...
"这个世界的创造神之一。\n");
	...
	set("combat_exp",390000000+random(8000000));
...
if (random(3)==0)
{
      ...
      map_skill("claw", "jiuyin-shenzhua");
        set("no_get",1);
b=9999000+random(916000);
a=9999000+random(915000);
d=350+random(60);
set("str",d);
set("dex",130+d);
set("int",d);
...
if (!me->query("migong/lev22"))
{
exp = 580000+random(488000);
pot = exp/2;
score = random(300)+950;
 me->set_temp("magicov1",1);
 me->set("migong/lev22",1);
