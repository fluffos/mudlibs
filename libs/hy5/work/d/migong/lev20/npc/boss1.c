...

{
   ...
   set_name(order[random(13)]+"爱尔麦蒂"NOR, ({ "Armaiti"}));
if (random(2)==0)
	set("magicgift",5);
else 	set("magicgift",6);
	set("magicset",1);
       set("title",HIW"虔敬之天使"NOR);
       set("zhuanbest",1);
       set("long",
"一位可怕的虔敬之天使。\n");
	...
	set_skill("unarmed",750+random(300));
	set_skill("sword",750+random(300));
...
set_skill("spells",600+random(300));
      set_skill("magic-unarmed", 750+random(300));
      set_skill("magic-sword", 750+random(200));
...
b=2438000+random(68000);
a=2478000+random(68000);
d=158+random(60);
set("str",d);
set("dex",40+d);
set("int",d);
...
if (!me) return;        
        ...
        me->add("score",1);
if (!present("light sword", me)

)
{
        jla=new("/clone/magic/obj/sword15");
        jla->move(me);
