...
string *order = ({""HIY"", ""HIG"", ""RED"", ""MAG"", ""YEL"", ""HIW"", ""HIW"", ""HIR"",""HIB"", ""CYN"",""WHT"",""HIM"",""BLU""});
...
\n"NOR
	...
	set_skill("unarmed",280);
      set_skill("spells", 650+random(1301));
      set_skill("magic-light", 600+random(1500));
