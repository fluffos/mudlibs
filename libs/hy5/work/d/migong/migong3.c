...
me->move(mapm);
	...
	if(arg=="lev16" ) {
        if (present("fire hat", me) || me->query_skill("magic-fire",1)>=1 ) 
{
...
me->move("/d/migong/lev16/dong22");
	...
	if(arg=="lev17") {
        if (present("water armor", me) || me->query_skill("magic-water",1)>=1 ) 
{
        message_vision(HIW "一阵光辉笼罩了$N!\n" NOR, me);
me->move("/d/migong/lev17/dong22");
	...
	if(arg=="lev18") {
        if (present("earth shield", me) || me->query_skill("magic-earth",1)>=1 ) 
{
        message_vision(HIW "一阵光辉笼罩了$N!\n" NOR, me);
me->move("/d/migong/lev18/dong22");
	...
	if(arg=="lev19") {
        if (present("air boot", me)  || me->query_skill("magic-ice",1)>=1) 
{
        message_vision(HIW "一阵光辉笼罩了$N!\n" NOR, me);
me->move("/d/migong/lev19/dong22");
	...
	if(arg=="lev20") {
        if (present("light jian", me)  || me->query_skill("magic-light",1)>=1) 
{
        message_vision(HIW "一阵光辉笼罩了$N!\n" NOR, me);
me->move("/d/migong/lev20/dong22");
	...
	if(arg=="lev21") {
        if (present("dark jian", me)  || me->query_skill("magic-dark",1)>=1) 
{
        message_vision(HIW "一阵光辉笼罩了$N!\n" NOR, me);
