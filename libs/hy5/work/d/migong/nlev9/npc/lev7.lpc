...
set_skill("fengyun-shou", 330+random(50));
...
set_skill("yingzhua-gong", 330+random(50));
...
prepare_skill("unarmed", "fengyun-shou");
prepare_skill("claw", "jingzhua-gong");
set("chat_chance_combat", 80);
        set("chat_msg_combat", ({
              	
      (: perform_action, "unarmed.foguang" :),
	
       (: perform_action, "claw.yingzhua" :),
