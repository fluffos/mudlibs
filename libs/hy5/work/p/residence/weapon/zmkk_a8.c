...
void create()
{
	      set_name("[1;36m霜火手套[2;37;0m", ({ "bad hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
宾之手套[2;37;0m这是一副由极为坚硬的[32m青铜[2;37;0m加上[1;37m棉花[2;37;0m制成，重一斤零两一钱的[1;36m宾之手套[2;37;0m。
综合评价[32m精致细美[2;37;0m 看起来极为坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[33m土[2;37;0m:[35m标准[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
上面还刻了一些符字：
