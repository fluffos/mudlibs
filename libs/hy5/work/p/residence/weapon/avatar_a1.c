...
void create()
{
	      set_name("[1;32m神之铠甲[2;37;0m", ({ "good cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
蝉鬓之服装[2;37;0m这是一件由无比坚硬的[31m流花石[2;37;0m加上[1;33m苎麻[2;37;0m制成，重六斤二两零钱的[1;32m蝉鬓之服装[2;37;0m。
...
紫石:[32m粗糙[2;37;0m 
以及一排古篆字【 [1;32m阿凡达[2;37;0m 】。和一些【 [1;32m棍法[2;37;0m 】的技巧。
