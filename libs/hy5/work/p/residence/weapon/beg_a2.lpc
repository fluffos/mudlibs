...
void create()
{
	      set_name("[36m女娲石[2;37;0m", ({ "chiyu neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[37m赤玉之项链[2;37;0m这是一串由无比坚硬的[1;33m金铁[2;37;0m加上[1;37m冰蚕丝[2;37;0m制成，重六斤八两九钱的[37m赤玉之项链[2;37;0m。
...
白石:[36m不错[2;37;0m 紫石:[34m细碎[2;37;0m 长生:[36m不错[2;37;0m 不老:[36m不错[2;37;0m 
