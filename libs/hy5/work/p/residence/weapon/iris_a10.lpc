...
void create()
{
	      set_name("[1;31m星火灭绝[2;37;0m", ({ "taie hands", "hands" }));
        set_weight(1000);
        if( clonep() )
...
[2;37;0m这是一副由无比坚硬的[1;36m万年寒冰铁[2;37;0m加上[1;33m龙茧蚕丝[2;37;0m制成，重二斤二两六钱的[31m太阿之手套[2;37;0m。
