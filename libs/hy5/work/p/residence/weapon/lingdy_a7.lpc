...
void create()
{
	      set_name("[1;36m秋菊之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
秋菊之肚带[2;37;0m这是一条由无比坚硬的[31m流花石[2;37;0m加上[1;33m木棉花[2;37;0m制成，重三斤二两三钱的[1;36m秋菊之肚带[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[40m地[2;37;0m:[33m很高[2;37;0m [1;31m魔[2;37;0m:[1;33m天圣[2;37;0m 
上面还刻了一些符字：
