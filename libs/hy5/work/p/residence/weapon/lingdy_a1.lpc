...
void create()
{
	      set_name("[1;36m阴蛇之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
阴蛇之护腕[2;37;0m这是一双由无比坚硬的[1;37m软银[2;37;0m加上[1;33m木棉花[2;37;0m制成，重三斤四两五钱的[1;36m阴蛇之护腕[2;37;0m。
...
以及一排古篆字【 [1;32m风风[2;37;0m 】。和一些【 [1;32m棍法[2;37;0m 】的技巧。
