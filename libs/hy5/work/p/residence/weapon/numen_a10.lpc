...
void create()
{
	      set_name("[1;32m守护护腕[2;37;0m", ({ "general wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
巨威之护腕[2;37;0m这是一双由无比坚硬的[33m软铁[2;37;0m加上[33m大麻[2;37;0m制成，重一斤八两八钱的[1;32m巨威之护腕[2;37;0m。
...
体灵:[32m极差[2;37;0m 周天:[34m细碎[2;37;0m 不老:[36m不错[2;37;0m 
