...
void create()
{
	set_name("[1;32m湮灭之剑[2;37;0m", ({ "bad sword", "sword" }));
	set_weight(3745);
	if (clonep())
		...
		set("unit", "把");
		set("long", @LONG
铜之剑[2;37;0m这是一把由十分坚硬的[32m青铜[2;37;0m制成，重七斤四两九钱的[1;32m铜之剑[2;37;0m。
综合评价[32m精致细美[2;37;0m 看起来十分锋利，具有[32m水准以上[2;37;0m的威力！
上面还刻了一些符字：
锋利:[33m很高[2;37;0m 长生:[32m极差[2;37;0m 不老:[33m一般[2;37;0m 
以及一排古篆字【 [1;32m云雨潇[2;37;0m 】。和一些【 [1;32m拳法[2;37;0m 】的技巧。
