...
void create()
{
	      set_name("[1;34m地雨之头盔[2;37;0m", ({ "good head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
地雨之头盔[2;37;0m这是一顶由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤二两九钱的[1;34m地雨之头盔[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[1;34m电[2;37;0m:[1;32m魔王[2;37;0m 
上面还刻了一些符字：
坚硬:[1;31m开元[2;37;0m 天灵:[34m细碎[2;37;0m 天宇:[36m不错[2;37;0m 巧制:[33m一般[2;37;0m 
不老:[33m一般[2;37;0m 
