...
void create()
{
	      set_name("[31m云竹之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
云竹之手套[2;37;0m这是一副由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤零两八钱的[31m云竹之手套[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[37m天[2;37;0m:[34m细碎[2;37;0m 
上面还刻了一些符字：
坚硬:[32m粗糙[2;37;0m 巧制:[33m一般[2;37;0m 
紫石:[36m不错[2;37;0m 不老:[36m不错[2;37;0m 威力:[36m不错[2;37;0m 
