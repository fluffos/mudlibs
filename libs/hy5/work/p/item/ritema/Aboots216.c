...
void create()
{
	      set_name("[1;31m必胜之靴[2;37;0m", ({ "good boots", "boots" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
必胜之靴[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两零钱的[1;31m必胜之靴[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[1;37m雷[2;37;0m:[1;34m举世[2;37;0m 
上面还刻了一些符字：
坚硬:[1;33m天圣[2;37;0m 天渊:[33m一般[2;37;0m 天玄:[36m不错[2;37;0m 巧制:[33m一般[2;37;0m 
闪电:[34m细碎[2;37;0m 
