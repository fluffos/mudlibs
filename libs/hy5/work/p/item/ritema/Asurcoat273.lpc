...
void create()
{
	      set_name("[1;33m无敌之肚带[2;37;0m", ({ "good surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
无敌之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重零斤九两九钱的[1;33m无敌之肚带[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[1;35m风[2;37;0m:[1;36m完美[2;37;0m 

上面还刻了一些符字：
坚硬:[1;31m开元[2;37;0m 天灵:[36m不错[2;37;0m 绝代:[36m不错[2;37;0m 巧制:[34m细碎[2;37;0m 
