...
void create()
{
	      set_name("[31m幽兰之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
幽兰之腰带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤二两五钱的[31m幽兰之腰带[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[32m水[2;37;0m:[1;36m完美[2;37;0m 
上面还刻了一些符字：
坚硬:[33m很高[2;37;0m 绝代:[32m极差[2;37;0m 天渊:[33m一般[2;37;0m 巧制:[32m极差[2;37;0m 
