...
void create()
{
	      set_name("[1;32m小之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
小之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤一两二钱的[1;32m小之头盔[2;37;0m。
综合评价[32m精致细美[2;37;0m 看起来极为坚固，具有[36m一般[2;37;0m的防护力！
上面还刻了一些符字：
坚硬:[32m粗糙[2;37;0m 巧制:[33m一般[2;37;0m 
紫石:[33m一般[2;37;0m 不老:[33m一般[2;37;0m 威力:[33m一般[2;37;0m 
