...
void create()
{
	      set_name("[1;37m老君之护腕[2;37;0m", ({ "good wrists", "wrists" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "双");
		set("long", @LONG
老君之护腕[2;37;0m这是一双由无比坚硬的精钢加上[33m大麻[2;37;0m制成，重一斤四两七钱的[1;37m老君之护腕[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面还刻了一些符字：
坚硬:[1;31m无双[2;37;0m 福源:[36m不错[2;37;0m 
天玄:[33m一般[2;37;0m 巧制:[34m细碎[2;37;0m 
