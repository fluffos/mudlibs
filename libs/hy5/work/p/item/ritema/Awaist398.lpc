...
void create()
{
	      set_name("[1;32m武翼之腰带[2;37;0m", ({ "wuyi waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;32m武翼之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤五两四钱的[1;32m武翼之腰带[2;37;0m。
...
体灵:[36m不错[2;37;0m 白石:[33m很高[2;37;0m 周天:[33m很高[2;37;0m 
