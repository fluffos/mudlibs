...
void create()
{
	      set_name("[1;37m幽兰之手套[2;37;0m", ({ "general hands", "hands" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "副");
		set("long", @LONG
幽兰之手套[2;37;0m这是一副由绝对坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤七两九钱的[1;37m幽兰之手套[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来绝对坚固，具有[36m一般[2;37;0m的防护力！
上面还刻了一些符字：
坚硬:[33m很高[2;37;0m 天灵:[36m不错[2;37;0m 天玄:[32m极差[2;37;0m 巧制:[36m不错[2;37;0m 
