...
void create()
{
	      set_name("[36m冰薇之肚带[2;37;0m", ({ "general surcoat", "surcoat" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
冰薇之肚带[2;37;0m这是一条由无比坚硬的精钢加上[33m亚麻[2;37;0m制成，重一斤三两五钱的[36m冰薇之肚带[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比坚固，具有[36m一般[2;37;0m的防护力！
上面还刻了一些符字：
坚硬:[33m很高[2;37;0m 巧制:[33m一般[2;37;0m 
体灵:[36m不错[2;37;0m 白石:[36m不错[2;37;0m 威力:[36m不错[2;37;0m 
