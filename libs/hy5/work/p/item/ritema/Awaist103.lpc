...
void create()
{
	      set_name("[1;33m霞蔚之腰带[2;37;0m", ({ "general waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
霞蔚之腰带[2;37;0m这是一条由极其坚硬的精钢加上[33m亚麻[2;37;0m制成，重零斤八两七钱的[1;33m霞蔚之腰带[2;37;0m。
...
体灵:[33m一般[2;37;0m 周天:[34m细碎[2;37;0m 
