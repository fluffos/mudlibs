...
void create()
{
	      set_name("[36m帝王之项链[2;37;0m", ({ "diwang neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[36m帝王之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤三两四钱的[36m帝王之项链[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来无比坚固，具有[36m不小[2;37;0m的防护力！
上面刻了几个古符号：
[1;37m雷[2;37;0m:[33m很高[2;37;0m [1;34m电[2;37;0m:[1;33m天圣[2;37;0m 
上面还刻了一些符字：
