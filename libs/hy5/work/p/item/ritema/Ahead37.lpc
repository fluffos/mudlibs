...
void create()
{
	      set_name("[37m叠之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
叠之头盔[2;37;0m这是一顶由极为坚硬的精钢加上[1;37m棉花[2;37;0m制成，重零斤六两五钱的[37m叠之头盔[2;37;0m。
综合评价[32m精致细美[2;37;0m 看起来极为坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[1;36m人[2;37;0m:[36m不错[2;37;0m 
上面还刻了一些符字：
坚硬:[34m细碎[2;37;0m 巧制:[32m极差[2;37;0m 
体灵:[33m一般[2;37;0m 白石:[32m极差[2;37;0m 不老:[33m一般[2;37;0m 
