...
void create()
{
	      set_name("[33m铜之头盔[2;37;0m", ({ "bad head", "head" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "顶");
		set("long", @LONG
铜之头盔[2;37;0m这是一顶由比较坚硬的精钢加上[1;37m棉花[2;37;0m制成，重一斤三两四钱的[33m铜之头盔[2;37;0m。
综合评价[32m精致细美[2;37;0m 看起来比较坚固，具有[36m一般[2;37;0m的防护力！
上面刻了几个古符号：
[1;33m金[2;37;0m:[31m精致[2;37;0m [37m天[2;37;0m:[34m细碎[2;37;0m 
上面还刻了一些符字：
