...
void create()
{
	set_name("[35m天枢之暗器[2;37;0m★", ({ "tianqu throwing", "throwing" }));
	set_weight(269);
	if (clonep())
		...
		set("unit", "支");
		set("long", @LONG
[35m天枢之暗器[2;37;0m这是一支由无比坚硬的[1;32m绿石[2;37;0m制成，重零斤五两三钱的[35m天枢之暗器[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来无比锋利，具有[1;32m开天劈地[2;37;0m的威力！
上面刻了几个古符号：
[1;35m风[2;37;0m:[1;36m完美[2;37;0m 
[40m地[2;37;0m:[35m标准[2;37;0m 
上面还刻了一些符字：
锋利:[1;31m毁天[2;37;0m 天渊:[36m不错[2;37;0m 天玄:[36m不错[2;37;0m 不老:[32m粗糙[2;37;0m 
