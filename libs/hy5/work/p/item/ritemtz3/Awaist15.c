...
void create()
{
	      set_name("[37m蓝玉之腰带[2;37;0m★", ({ "lanyu waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[37m蓝玉之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤二两四钱的[37m蓝玉之腰带[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来无比坚固，具有[36m不小[2;37;0m的防护力！
上面刻了几个古符号：
[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [1;36m人[2;37;0m:[31m精致[2;37;0m 
上面还刻了一些符字：
