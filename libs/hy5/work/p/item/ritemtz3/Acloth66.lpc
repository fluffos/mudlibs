...
void create()
{
	      set_name("[34m魔王之服装[2;37;0m★", ({ "mowang cloth", "cloth" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[34m魔王之服装[2;37;0m这是一件由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两八钱的[34m魔王之服装[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来无比坚固，具有[35m极其可怕[2;37;0m的防护力！
上面刻了几个古符号：
[1;37m雷[2;37;0m:[1;32m魔王[2;37;0m [40m地[2;37;0m:[31m精致[2;37;0m 
上面还刻了一些符字：
