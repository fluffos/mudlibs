...
void create()
{
	      set_name("[1;32m鸟翔之项链[2;37;0m★", ({ "niaoxiang neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[1;32m鸟翔之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两二钱的[1;32m鸟翔之项链[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来无比坚固，具有[36m不小[2;37;0m的防护力！
上面刻了几个古符号：
[1;37m雷[2;37;0m:[1;33m天圣[2;37;0m [1;31m魔[2;37;0m:[1;31m无双[2;37;0m 
上面还刻了一些符字：
