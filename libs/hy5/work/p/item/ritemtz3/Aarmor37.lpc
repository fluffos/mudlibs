...
void create()
{
	      set_name("[33m黄龙之披风[2;37;0m★", ({ "huanglong armor", "armor" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "件");
		set("long", @LONG
[33m黄龙之披风[2;37;0m这是一件由绝对坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重零斤八两九钱的[33m黄龙之披风[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来绝对坚固，具有[36m不小[2;37;0m的防护力！
上面还刻了一些符字：
坚硬:[1;31m毁天[2;37;0m 福源:[34m细碎[2;37;0m 
巧制:[34m细碎[2;37;0m 
白石:[35m标准[2;37;0m 威力:[34m细碎[2;37;0m 
