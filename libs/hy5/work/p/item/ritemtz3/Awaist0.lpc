...
void create()
{
	      set_name("[1;37m白虎之腰带[2;37;0m★", ({ "baihu waist", "waist" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "条");
		set("long", @LONG
[1;37m白虎之腰带[2;37;0m这是一条由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤四两四钱的[1;37m白虎之腰带[2;37;0m。
...
紫石:[34m细碎[2;37;0m 周天:[34m细碎[2;37;0m 长生:[34m细碎[2;37;0m 
