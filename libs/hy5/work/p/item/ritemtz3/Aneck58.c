...
void create()
{
	      set_name("[36m凝霜之项链[2;37;0m★", ({ "ningshuang neck", "neck" }));
        set_weight(1000);
        if( clonep() )
                ...
                set("unit", "串");
		set("long", @LONG
[36m凝霜之项链[2;37;0m这是一串由无比坚硬的精钢加上[1;33m苎麻[2;37;0m制成，重一斤一两八钱的[36m凝霜之项链[2;37;0m。
综合评价[37m绝世无双[2;37;0m 看起来无比坚固，具有[36m不小[2;37;0m的防护力！
上面还刻了一些符字：
坚硬:[1;31m开元[2;37;0m 天灵:[32m粗糙[2;37;0m 巧制:[35m标准[2;37;0m 
体灵:[35m标准[2;37;0m 不老:[33m很高[2;37;0m 威力:[34m细碎[2;37;0m 
