...
void create()
{
	set_name("[31m龙菊之斧[2;37;0m", ({ "general axe", "axe" }));
	set_weight(8412);
	if (clonep())
		...
		set("unit", "柄");
		set("long", @LONG
龙菊之斧[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重十六斤八两二钱的[31m龙菊之斧[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比锋利，具有[35m极其可怕[2;37;0m的威力！
上面刻了几个古符号：
[1;35m风[2;37;0m:[33m很高[2;37;0m 

上面还刻了一些符字：
锋利:[31m精致[2;37;0m 绝代:[33m一般[2;37;0m 紫石:[36m不错[2;37;0m 闪电:[36m不错[2;37;0m 
长生:[33m一般[2;37;0m 
