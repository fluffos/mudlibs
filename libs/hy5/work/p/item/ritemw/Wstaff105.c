...
void create()
{
	set_name("[1;37m芍药之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(12242);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
芍药之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十四斤四两八钱的[1;37m芍药之杖[2;37;0m。
...
周天:[36m不错[2;37;0m 长生:[34m细碎[2;37;0m 不老:[36m不错[2;37;0m 
