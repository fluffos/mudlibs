...
void create()
{
	set_name("[36m聚泉之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(1692);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
聚泉之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重三斤三两八钱的[36m聚泉之杖[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比锋利，具有[32m水准以上[2;37;0m的威力！
上面刻了几个古符号：
[1;35m风[2;37;0m:[35m标准[2;37;0m 

上面还刻了一些符字：
锋利:[31m精致[2;37;0m 绝代:[33m一般[2;37;0m 巧制:[32m极差[2;37;0m 
