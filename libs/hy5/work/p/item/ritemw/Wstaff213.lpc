...
void create()
{
	set_name("[37m天竹之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(8648);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
天竹之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十七斤二两九钱的[37m天竹之杖[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比锋利，具有[1;34m倚天屠龙[2;37;0m的威力！
上面刻了几个古符号：
[1;33m金[2;37;0m:[1;34m举世[2;37;0m 
上面还刻了一些符字：
锋利:[1;31m无双[2;37;0m 绝代:[36m不错[2;37;0m 天渊:[36m不错[2;37;0m 巧制:[33m一般[2;37;0m 
长生:[33m一般[2;37;0m 
