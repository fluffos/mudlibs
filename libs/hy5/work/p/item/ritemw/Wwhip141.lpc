...
void create()
{
	set_name("[31m含翠之鞭[2;37;0m", ({ "general whip", "whip" }));
	set_weight(6699);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
含翠之鞭[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十三斤三两九钱的[31m含翠之鞭[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比锋利，具有[32m水准以上[2;37;0m的威力！
上面还刻了一些符字：
锋利:[33m很高[2;37;0m 天宇:[32m极差[2;37;0m 天渊:[33m一般[2;37;0m 天玄:[33m一般[2;37;0m 体灵:[34m细碎[2;37;0m 长生:[36m不错[2;37;0m 不老:[34m细碎[2;37;0m 
