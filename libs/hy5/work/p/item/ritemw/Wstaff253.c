...
void create()
{
	set_name("[36m虎泉之杖[2;37;0m", ({ "good staff", "staff" }));
	set_weight(9304);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
虎泉之杖[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重十八斤六两零钱的[36m虎泉之杖[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比锋利，具有[35m极其可怕[2;37;0m的威力！
上面刻了几个古符号：
[37m天[2;37;0m:[31m精致[2;37;0m 
上面还刻了一些符字：
锋利:[1;35m绝世[2;37;0m 天玄:[36m不错[2;37;0m 不老:[32m粗糙[2;37;0m 
