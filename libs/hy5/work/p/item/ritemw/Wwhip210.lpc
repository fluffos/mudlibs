...
void create()
{
	set_name("[33m春兰之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(10632);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
春兰之鞭[2;37;0m这是一根由无比坚硬的[33m软铁[2;37;0m制成，重二十一斤二两六钱的[33m春兰之鞭[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比锋利，具有[31m无与伦比[2;37;0m的威力！
上面还刻了一些符字：
锋利:[1;35m绝世[2;37;0m 天灵:[36m不错[2;37;0m 白石:[36m不错[2;37;0m 闪电:[34m细碎[2;37;0m 
周天:[32m粗糙[2;37;0m 不老:[36m不错[2;37;0m 威力:[36m不错[2;37;0m 
