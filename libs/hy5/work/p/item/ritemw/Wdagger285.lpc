...
void create()
{
	set_name("[34m阡陌之匕首[2;37;0m", ({ "good dagger", "dagger" }));
	set_weight(1802);
	if (clonep())
		...
		set("unit", "把");
		set("long", @LONG
阡陌之匕首[2;37;0m这是一把由无比坚硬的[33m软铁[2;37;0m制成，重三斤六两零钱的[34m阡陌之匕首[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来无比锋利，具有[35m极其可怕[2;37;0m的威力！
上面刻了几个古符号：
[1;34m电[2;37;0m:[1;34m举世[2;37;0m 
上面还刻了一些符字：
锋利:[1;31m无双[2;37;0m 巧制:[36m不错[2;37;0m 
体灵:[34m细碎[2;37;0m 白石:[32m粗糙[2;37;0m 长生:[36m不错[2;37;0m 不老:[33m一般[2;37;0m 
