...
void create()
{
	set_name("[1;31m巧之杖[2;37;0m", ({ "bad staff", "staff" }));
	set_weight(5097);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
巧之杖[2;37;0m这是一根由非常坚硬的[32m青铜[2;37;0m制成，重十斤一两九钱的[1;31m巧之杖[2;37;0m。
综合评价[32m精致细美[2;37;0m 看起来非常锋利，具有[34m不错[2;37;0m的威力！
上面刻了几个古符号：
[33m土[2;37;0m:[31m精致[2;37;0m [1;37m雷[2;37;0m:[33m很高[2;37;0m 
上面还刻了一些符字：
