...
void create()
{
	set_name("[33m延永之鞭[2;37;0m", ({ "good whip", "whip" }));
	set_weight(5636);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
延永之鞭[2;37;0m这是一根由相当坚硬的[33m软铁[2;37;0m制成，重十一斤二两七钱的[33m延永之鞭[2;37;0m。
综合评价[1;34m举世罕见[2;37;0m 看起来相当锋利，具有[35m极其可怕[2;37;0m的威力！
上面刻了几个古符号：
[1;37m雷[2;37;0m:[1;36m完美[2;37;0m 
上面还刻了一些符字：
锋利:[1;33m天圣[2;37;0m 紫石:[32m粗糙[2;37;0m 周天:[32m粗糙[2;37;0m 不老:[32m粗糙[2;37;0m 
