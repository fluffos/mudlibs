...
void create()
{
	set_name("[35m裂心之锤[2;37;0m", ({ "general hammer", "hammer" }));
	set_weight(11987);
	if (clonep())
		...
		set("unit", "柄");
		set("long", @LONG
裂心之锤[2;37;0m这是一柄由无比坚硬的[33m生铁[2;37;0m制成，重二十三斤九两七钱的[35m裂心之锤[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比锋利，具有[35m极其可怕[2;37;0m的威力！
上面还刻了一些符字：
锋利:[31m精致[2;37;0m 福源:[33m一般[2;37;0m 
绝代:[33m一般[2;37;0m 体灵:[32m极差[2;37;0m 闪电:[32m极差[2;37;0m 
不老:[34m细碎[2;37;0m 
