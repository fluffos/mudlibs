...
void create()
{
	set_name("[1;36m天威之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(11897);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
天威之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重二十三斤七两九钱的[1;36m天威之杖[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比锋利，具有[34m不错[2;37;0m的威力！
上面刻了几个古符号：
[1;34m电[2;37;0m:[33m很高[2;37;0m 
上面还刻了一些符字：
锋利:[35m标准[2;37;0m 天灵:[32m极差[2;37;0m 福源:[32m极差[2;37;0m 
