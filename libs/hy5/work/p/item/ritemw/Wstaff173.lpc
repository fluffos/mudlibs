...
void create()
{
	set_name("[1;31m白荷之杖[2;37;0m", ({ "general staff", "staff" }));
	set_weight(6010);
	if (clonep())
		...
		set("unit", "根");
		set("long", @LONG
白荷之杖[2;37;0m这是一根由无比坚硬的[33m生铁[2;37;0m制成，重十二斤零两二钱的[1;31m白荷之杖[2;37;0m。
综合评价[31m完美精致[2;37;0m 看起来无比锋利，具有[32m水准以上[2;37;0m的威力！
上面刻了几个古符号：
[1;35m风[2;37;0m:[1;36m完美[2;37;0m 
[1;37m雷[2;37;0m:[1;34m举世[2;37;0m [37m天[2;37;0m:[1;34m举世[2;37;0m 
上面还刻了一些符字：
