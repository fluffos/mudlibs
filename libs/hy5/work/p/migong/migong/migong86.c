...
string tname="migong86";
string oname="/d/jingzhou/sanxia1";
string mnpc="/p/migong/migong/npc/npc86";
string mboss="/p/migong/migong/npc/boss86";
...
void create ()
{
  ...
  set ("short", "西陵峡");
  set ("long", @LONG
西陵峡以滩多水急著称。著名的新滩、崆岭滩和腰叉河均在西陵峡内。
LONG );
 //set("maze",1);
set("mglvl",950);
  set("hxsdmigong",1);
