...
string tname="migong18";
string oname="/d/qilian/yumenguan";
string mnpc="/p/migong/migong/npc/npc19";
string mboss="/p/migong/migong/npc/boss19";
...
void create ()
{
  ...
  set ("short", "敦煌莫高窟");
  set ("long", @LONG
环顾洞窟的四周和窟顶，到处都画着佛像、飞天、伎乐、仙女·赤身女人等。
LONG );
 //set("maze",1);
set("mglvl",280);
  set("hxsdmigong",1);
