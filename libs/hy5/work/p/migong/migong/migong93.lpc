...
string tname="migong93";
string oname="/d/xinjiang/emin";
string mnpc="/p/migong/migong/npc/npc93";
string mboss="/p/migong/migong/npc/boss93";
...
void create ()
{
  ...
  set ("short", "魔鬼城");
  set ("long", @LONG
魔鬼城又称乌尔禾风城。哈萨克人称为“沙依坦克尔西”，意为魔鬼城
LONG );
 //set("maze",1);
set("mglvl",1020);
  set("hxsdmigong",1);
