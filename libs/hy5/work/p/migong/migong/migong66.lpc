...
string tname="migong66";
string oname="/d/huangshan/mingxuan";
string mnpc="/p/migong/migong/npc/npc66";
string mboss="/p/migong/migong/npc/boss66";
...
void create ()
{
  ...
  set ("short", "牯牛降历溪");
  set ("long", @LONG
牯牛降历溪位於牯牛降山脚下，群山环抱。村中人家，世代聚族而居，过著世外桃源般的田园生活。 
LONG );
 //set("maze",1);
set("mglvl",750);
  set("hxsdmigong",1);
