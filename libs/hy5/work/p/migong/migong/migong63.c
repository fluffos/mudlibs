...
string tname="migong63";
string oname="/d/taishan/daimiao";
string mnpc="/p/migong/migong/npc/npc63";
string mboss="/p/migong/migong/npc/boss63";
