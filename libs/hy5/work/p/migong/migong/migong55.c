...
string tname="migong55";
string oname="/d/guizhou/tulu2";
string mnpc="/p/migong/migong/npc/npc55";
string mboss="/p/migong/migong/npc/boss55";
...
void create ()
{
  ...
  set ("short", "都匀斗篷山");
  set ("long", @LONG
斗篷山山间林地蓄水丰盈，共有大小溪流100余条。其中茶园河及谷江河布满巨大的卵石，有如来自远古的船舶。
LONG );
 //set("maze",1);
set("mglvl",640);
  set("hxsdmigong",1);
