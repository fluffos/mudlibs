...
string tname="migong37";
string oname="/d/xinan/shanlu09";
string mnpc="/p/migong/migong/npc/npc37";
string mboss="/p/migong/migong/npc/boss37";
...
void create ()
{
  ...
  set ("short", "米亚罗");
  set ("long", @LONG
米亚罗藏语译为好玩的坝子，米亚罗到了金秋时节，万树姹紫嫣红，争奇形怪状斗艳。
LONG );
 //set("maze",1);
set("mglvl",460);
  set("hxsdmigong",1);
