...
string tname="migong25";
string oname="/d/fuzhou/shulin";
string mnpc="/p/migong/migong/npc/npc26";
string mboss="/p/migong/migong/npc/boss26";
...
void create ()
{
  ...
  set ("short", "泰宁古镇");
  set ("long", @LONG
泰宁曾有汉唐古镇，两宋名城之称，早在新石器时代就有人类在这里繁衍生息。
LONG );
 //set("maze",1);
set("mglvl",350);
  set("hxsdmigong",1);
