...
string tname="migong20";
string oname="/d/kaifeng/wroad3";
string mnpc="/p/migong/migong/npc/npc21";
string mboss="/p/migong/migong/npc/boss21";
...
void create ()
{
  ...
  set ("short", "洛阳白马");
  set ("long", @LONG
洛阳白马寺创建于东汉永平十一年68年，为中国第一古刹，世界著名伽蓝，是佛教传入中国后兴建的第一座寺院。
LONG );
 //set("maze",1);
set("mglvl",300);
  set("hxsdmigong",1);
