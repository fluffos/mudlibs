...
string tname="migong31";
string oname="/d/kunming/qingshilu2";
string mnpc="/p/migong/migong/npc/npc31";
string mboss="/p/migong/migong/npc/boss31";
...
void create ()
{
  ...
  set ("short", "和顺镇");
  set ("long", @LONG
和顺古镇古名阳温暾，因境内有一条小河绕村而过，更名河顺，后取士和民顺之意，雅化为和顺乡。
LONG );
 //set("maze",1);
set("mglvl",400);
  set("hxsdmigong",1);
