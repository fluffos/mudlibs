...
string tname="migong98";
string oname="/d/zangbei/mount2";
string mnpc="/p/migong/migong/npc/npc98";
string mboss="/p/migong/migong/npc/boss98";
...
void create ()
{
  ...
  set ("short", "科迦寺");
  set ("long", @LONG
科迦寺是普兰县大寺，历史悠久，在当地享有盛名，每年都有阿里地区札达、噶  建筑尔等县及境外尼泊尔的信徒前来朝拜。
LONG );
 //set("maze",1);
set("mglvl",1070);
  set("hxsdmigong",1);
