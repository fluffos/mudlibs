...
string tname="migong73";
string oname="/d/huashan/lianhua";
string mnpc="/p/migong/migong/npc/npc73";
string mboss="/p/migong/migong/npc/boss73";
...
void create ()
{
  ...
  set ("short", "华山西峰");
  set ("long", @LONG
华山主峰，因位置居西得名。又因峰巅 有巨石形状好似莲花瓣，古代文人多称其为莲花峰、芙蓉峰。
LONG );
 //set("maze",1);
set("mglvl",820);
  set("hxsdmigong",1);
