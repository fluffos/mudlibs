...
string tname="migong39";
string oname="/d/hangzhou/hupaoquan";
string mnpc="/p/migong/migong/npc/npc39";
string mboss="/p/migong/migong/npc/boss39";
...
void create ()
{
  ...
  set ("short", "天目溪");
  set ("long", @LONG
天目溪是富春江上的一条支流，水质清澈，摇曳的水草，形态不一的鹅卵石清晰见底。
LONG );
 //set("maze",1);
set("mglvl",480);
  set("hxsdmigong",1);
