...
string tname="migong14";
string oname="/d/xinan/leshan";
string mnpc="/p/migong/migong/npc/npc15";
string mboss="/p/migong/migong/npc/boss15";
...
void create ()
{
  ...
  set ("short", "乐山大佛");
  set ("long", @LONG
乐山大佛，又名凌云大佛，地处中国四川省乐山市，岷江、青衣江和大渡河三江汇流处。
LONG );
 //set("maze",1);
set("mglvl",240);
  set("hxsdmigong",1);
