...
string tname="migong80";
string oname="/d/hengshan/xuangengsong";
string mnpc="/p/migong/migong/npc/npc80";
string mboss="/p/migong/migong/npc/boss80";
