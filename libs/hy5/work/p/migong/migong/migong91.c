...
string tname="migong91";
string oname="/d/hainan/pubu";
string mnpc="/p/migong/migong/npc/npc91";
string mboss="/p/migong/migong/npc/boss91";
...
void create ()
{
  ...
  set ("short", "万泉河");
  set ("long", @LONG
沿河两岸典型的热带雨林景观和巧夺天工的地貌，令人叹为观止。万泉河生态环境优美的热带河流，被誉为中国的“亚马逊河”。
LONG );
 //set("maze",1);
set("mglvl",1000);
  set("hxsdmigong",1);
