...
string tname="migong88";
string oname="/d/jingzhou/sanxia2";
string mnpc="/p/migong/migong/npc/npc88";
string mboss="/p/migong/migong/npc/boss88";
...
void create ()
{
  ...
  set ("short", "巫峡");
  set ("long", @LONG
巫峡谷深狭长，日照时短，峡中湿气蒸郁不散，容易成云致雾，云雾千姿万态。
LONG );
 //set("maze",1);
set("mglvl",970);
  set("hxsdmigong",1);
