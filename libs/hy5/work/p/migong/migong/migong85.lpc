...
string tname="migong85";
string oname="/d/jiangling/huanghelou";
string mnpc="/p/migong/migong/npc/npc85";
string mboss="/p/migong/migong/npc/boss85";
...
void create ()
{
  ...
  set ("short", "黄鹤楼");
  set ("long", @LONG
相传也始建于三国，唐时名声始盛，这主要得之于诗人崔颢昔人已乘黄鹤去，此地空余黄鹤楼诗句
LONG );
 //set("maze",1);
set("mglvl",940);
  set("hxsdmigong",1);
