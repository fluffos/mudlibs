...
string tname="migong58";
string oname="/d/tianshui/yidao5";
string mnpc="/p/migong/migong/npc/npc58";
string mboss="/p/migong/migong/npc/boss58";
...
void create ()
{
  ...
  set ("short", "麦积山");
  set ("long", @LONG
天水市东南方50公里的麦积区麦积山乡南侧，是西秦岭山脉小陇山中的一座孤峰。
LONG );
 //set("maze",1);
set("mglvl",670);
  set("hxsdmigong",1);
