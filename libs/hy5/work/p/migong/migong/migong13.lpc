...
string tname="migong13";
string oname="/d/suzhou/yanyutang";
string mnpc="/p/migong/migong/npc/npc14";
string mboss="/p/migong/migong/npc/boss14";
...
void create ()
{
  ...
  set ("short", "苏州园林");
  set ("long", @LONG
这里素来以山水秀丽，园林典雅而闻名天下，有江南园林甲天下，苏州园林甲江南的美称。
LONG );
 //set("maze",1);
set("mglvl",230);
  set("hxsdmigong",1);
