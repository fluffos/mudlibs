...
string tname="migong65";
string oname="/d/huangshan/feicui";
string mnpc="/p/migong/migong/npc/npc65";
string mboss="/p/migong/migong/npc/boss65";
...
void create ()
{
  ...
  set ("short", "黄山松谷");
  set ("long", @LONG
一路千峰竞秀，万壑争奇，巧石名潭尤为佳妙。特别是山高林密，空气清新，真可谓是清凉世界。
LONG );
 //set("maze",1);
set("mglvl",740);
  set("hxsdmigong",1);
