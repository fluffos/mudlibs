...
string tname="migong99";
string oname="/d/taiwan/hongmaocheng";
string mnpc="/p/migong/migong/npc/npc99";
string mboss="/p/migong/migong/npc/boss99";
...
void create ()
{
  ...
  set ("short", "红毛城");
  set ("long", @LONG
红毛城炮台城垣红毛城伫立在淡水街尾往淡海方向，高踞淡水河出海口的山巅。
LONG );
 //set("maze",1);
set("mglvl",1080);
  set("hxsdmigong",1);
