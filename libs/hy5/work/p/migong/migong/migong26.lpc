...
string tname="migong26";
string oname="/d/taiyuan/sroad6";
string mnpc="/p/migong/migong/npc/npc27";
string mboss="/p/migong/migong/npc/boss27";
...
void create ()
{
  ...
  set ("short", "山西张壁");
  set ("long", @LONG
山西张壁是尉迟恭帮刘武周与李世民交战守介休时所为，是明筑城堡、暗挖地道时的遗物。
LONG );
 //set("maze",1);
set("mglvl",360);
  set("hxsdmigong",1);
