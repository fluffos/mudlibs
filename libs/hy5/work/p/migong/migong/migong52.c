...
string tname="migong52";
string oname="/d/xinan/shanlu07";
string mnpc="/p/migong/migong/npc/npc52";
string mboss="/p/migong/migong/npc/boss52";
...
void create ()
{
  ...
  set ("short", "贡嘎山");
  set ("long", @LONG
贡嘎山是最难以征服的大尺度极高山，其登顶难度远远大于珠穆朗玛峰。
LONG );
 //set("maze",1);
set("mglvl",610);
  set("hxsdmigong",1);
