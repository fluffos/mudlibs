...
string tname="migong16";
string oname="/d/city4/apanggong";
string mnpc="/p/migong/migong/npc/npc17";
string mboss="/p/migong/migong/npc/boss17";
...
void create ()
{
  ...
  set ("short", "秦始皇兵马俑");
  set ("long", @LONG
兵马俑中那数千名手执兵器的武士，数百匹曳车的战马，一列列、一行行，构成规模宏伟、气势磅礴的阵容。
LONG );
 //set("maze",1);
set("mglvl",260);
  set("hxsdmigong",1);
