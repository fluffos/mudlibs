...
string tname="migong57";
string oname="/d/city4/road5";
string mnpc="/p/migong/migong/npc/npc57";
string mboss="/p/migong/migong/npc/boss57";
...
void create ()
{
  ...
  set ("short", "黄帝陵");
  set ("long", @LONG
黄帝陵，是中华民族始祖黄帝的陵墓，相传黄帝得道升天，故此陵墓为衣冠冢。
LONG );
 //set("maze",1);
set("mglvl",660);
  set("hxsdmigong",1);
