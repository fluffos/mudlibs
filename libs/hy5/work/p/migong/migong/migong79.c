...
string tname="migong79";
string oname="/d/hengshan/hufengkou";
string mnpc="/p/migong/migong/npc/npc79";
string mboss="/p/migong/migong/npc/boss79";
...
void create ()
{
  ...
  set ("short", "虎风口");
  set ("long", @LONG
虎风口是一个峰回路转的陡峭路口，刮起风来，声如虎啸，由此得名。
LONG );
 //set("maze",1);
set("mglvl",880);
  set("hxsdmigong",1);
