...
string tname="migong46";
string oname="/d/fuzhou/yushan";
string mnpc="/p/migong/migong/npc/npc46";
string mboss="/p/migong/migong/npc/boss46";
...
void create ()
{
  ...
  set ("short", "鼓浪屿");
  set ("long", @LONG
鼓浪屿因岛西南方有一礁石，每当涨潮水涌，浪击礁石，声似擂鼓，人们称鼓浪石，鼓浪屿因此而得名。
LONG );
 //set("maze",1);
set("mglvl",550);
  set("hxsdmigong",1);
