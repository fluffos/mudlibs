...
string tname="migong56";
string oname="/d/guizhou/beimen";
string mnpc="/p/migong/migong/npc/npc56";
string mboss="/p/migong/migong/npc/boss56";
...
void create ()
{
  ...
  set ("short", "九龙洞");
  set ("long", @LONG
九龙洞地处伏牛山南麓，西接秦岭，东与熊耳山主峰毗连，南与玉皇尖相望，属长江流域。
LONG );
 //set("maze",1);
set("mglvl",650);
  set("hxsdmigong",1);
