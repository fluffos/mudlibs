...
string tname="migong97";
string oname="/d/xizang/deadneck";
string mnpc="/p/migong/migong/npc/npc97";
string mboss="/p/migong/migong/npc/boss97";
...
void create ()
{
  ...
  set ("short", "古格故城");
  set ("long", @LONG
巍峨的古格故城坐落于阿里扎达县扎布让区境内托林镇西北的象泉河南岸。为曾经拥有百万之众的金戈铁马的吐蕃王室后裔所建。
LONG );
 //set("maze",1);
set("mglvl",1060);
  set("hxsdmigong",1);
