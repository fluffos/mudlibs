...
string tname="migong67";
string oname="/d/huangshan/chayuan";
string mnpc="/p/migong/migong/npc/npc67";
string mboss="/p/migong/migong/npc/boss67";
...
void create ()
{
  ...
  set ("short", "古城岩");
  set ("long", @LONG
古城岩，座落在休宁县万安镇东侧，虽是低低的一面山峦，却以众多的古迹遗址。
LONG );
 //set("maze",1);
set("mglvl",760);
  set("hxsdmigong",1);
