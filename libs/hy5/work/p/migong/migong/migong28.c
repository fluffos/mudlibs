...
string tname="migong28";
string oname="/d/hangzhou/shuiledong";
string mnpc="/p/migong/migong/npc/npc29";
string mboss="/p/migong/migong/npc/boss29";
...
void create ()
{
  ...
  set ("short", "南浔镇");
  set ("long", @LONG
南浔镇是历史悠久的文化重镇。南浔素有鱼米之乡、丝绸之府之美誉。南宋时起，南浔镇就商贾云集，经济繁荣
LONG );
 //set("maze",1);
set("mglvl",380);
  set("hxsdmigong",1);
