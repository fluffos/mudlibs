...
string tname="migong45";
string oname="/d/huangshan/mroad2";
string mnpc="/p/migong/migong/npc/npc45";
string mboss="/p/migong/migong/npc/boss45";
...
void create ()
{
  ...
  set ("short", "太极洞");
  set ("long", @LONG
太极洞为石灰岩溶洞，长5．4公里，由上洞、下洞、水洞、旱洞组成。
LONG );
 //set("maze",1);
set("mglvl",540);
  set("hxsdmigong",1);
