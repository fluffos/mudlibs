...
string tname="migong69";
string oname="/d/songshan/chaotian";
string mnpc="/p/migong/migong/npc/npc69";
string mboss="/p/migong/migong/npc/boss69";
...
void create ()
{
  ...
  set ("short", "观星台 ");
  set ("long", @LONG
观星台由台身由石圭、表槽组成。台身上小下大，形似覆斗。台面呈方形。
LONG );
 //set("maze",1);
set("mglvl",780);
  set("hxsdmigong",1);
