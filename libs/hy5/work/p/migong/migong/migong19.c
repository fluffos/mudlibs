...
string tname="migong19";
string oname="/d/xizang/birdroad2";
string mnpc="/p/migong/migong/npc/npc20";
string mboss="/p/migong/migong/npc/boss20";
...
void create ()
{
  ...
  set ("short", "布达拉宫");
  set ("long", @LONG
最初是松赞干布为迎娶文成公主而兴建的。整座宫殿具有鲜明的藏式风格，依山而建，气势雄伟。
LONG );
 //set("maze",1);
set("mglvl",290);
  set("hxsdmigong",1);
