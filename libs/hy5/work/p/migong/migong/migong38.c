...
string tname="migong38";
string oname="/d/taiyuan/nroad1";
string mnpc="/p/migong/migong/npc/npc38";
string mboss="/p/migong/migong/npc/boss38";
...
void create ()
{
  ...
  set ("short", "广胜寺");
  set ("long", @LONG
广胜寺位于洪洞县城东北的霍山南麓，霍泉亦发源于此地，寺区古柏苍翠，山清水秀。
LONG );
 //set("maze",1);
set("mglvl",470);
  set("hxsdmigong",1);
