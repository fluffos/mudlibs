...
string tname="migong74";
string oname="/d/huashan/yuntai";
string mnpc="/p/migong/migong/npc/npc74";
string mboss="/p/migong/migong/npc/boss74";
...
void create ()
{
  ...
  set ("short", "华山北峰");
  set ("long", @LONG
华山主峰，因位置居北得名。北峰四面悬绝，上冠景云，下通地脉，巍然独秀，有若云台，因此又名云台峰。
LONG );
 //set("maze",1);
set("mglvl",830);
  set("hxsdmigong",1);
