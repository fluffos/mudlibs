...
string tname="migong89";
string oname="/d/hainan/underhill2";
string mnpc="/p/migong/migong/npc/npc89";
string mboss="/p/migong/migong/npc/boss89";
...
void create ()
{
  ...
  set ("short", "天涯海角");
  set ("long", @LONG
海湾沙滩上大小百块石耸立，“天涯”、“海角”和“南天一柱”巨石突兀其间，昂首天外，峥嵘壮观
LONG );
 //set("maze",1);
set("mglvl",980);
  set("hxsdmigong",1);
