...
string tname="migong40";
string oname="/d/lanzhou/caroad8";
string mnpc="/p/migong/migong/npc/npc40";
string mboss="/p/migong/migong/npc/boss40";
...
void create ()
{
  ...
  set ("short", "法门寺");
  set ("long", @LONG
法门寺为佛骨圣地，拥有世界最高佛塔。因安置释迦牟尼佛指骨舍利而成为举国仰望的佛教圣地。
LONG );
 //set("maze",1);
set("mglvl",490);
  set("hxsdmigong",1);
