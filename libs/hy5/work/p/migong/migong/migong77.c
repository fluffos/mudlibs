...
string tname="migong77";
string oname="/d/henshan/wangyuetai";
string mnpc="/p/migong/migong/npc/npc77";
string mboss="/p/migong/migong/npc/boss77";
...
void create ()
{
  ...
  set ("short", "南台寺");
  set ("long", @LONG
南台寺在于瑞应峰下的三生塔南面，号称天下法源，南朝梁天监年间创建，唐天宝年间禅宗七祖弟子希迁和尚将它定名为南台寺。
LONG );
 //set("maze",1);
set("mglvl",860);
  set("hxsdmigong",1);
