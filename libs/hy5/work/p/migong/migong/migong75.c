...
string tname="migong75";
string oname="/d/huashan/yunu";
string mnpc="/p/migong/migong/npc/npc75";
string mboss="/p/migong/migong/npc/boss75";
...
void create ()
{
  ...
  set ("short", "华山中峰");
  set ("long", @LONG
华山主峰。居东、西、南三峰中央，峰上林木葱茏，环境清幽，奇花异草多不知名，峰头有道舍名玉女祠，因此峰又被称为玉女峰。
LONG );
 //set("maze",1);
set("mglvl",840);
  set("hxsdmigong",1);
