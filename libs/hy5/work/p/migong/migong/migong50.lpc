...
string tname="migong50";
string oname="/d/guizhou/dadao2";
string mnpc="/p/migong/migong/npc/npc50";
string mboss="/p/migong/migong/npc/boss50";
...
void create ()
{
  ...
  set ("short", "芙蓉江");
  set ("long", @LONG
芙蓉江景色秀丽，山青、水秀、崖雄、峰奇、峡幽、涧深、滩险、流急、瀑飞、泉涌，天作画廊，美不胜收。
LONG );
 //set("maze",1);
set("mglvl",590);
  set("hxsdmigong",1);
