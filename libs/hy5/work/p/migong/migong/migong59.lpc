...
string tname="migong59";
string oname="/d/xinjiang/chairong";
string mnpc="/p/migong/migong/npc/npc59";
string mboss="/p/migong/migong/npc/boss59";
...
void create ()
{
  ...
  set ("short", "博斯腾湖");
  set ("long", @LONG
我国最大的内陆淡水湖。 风起时波浪滔滔，宛如沧海,风静时波光潋滟，湖水连天。
LONG );
 //set("maze",1);
set("mglvl",680);
  set("hxsdmigong",1);
