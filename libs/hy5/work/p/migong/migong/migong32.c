...
string tname="migong32";
string oname="/d/henshan/hsroad9";
string mnpc="/p/migong/migong/npc/npc32";
string mboss="/p/migong/migong/npc/boss32";
...
void create ()
{
  ...
  set ("short", "七星岩");
  set ("long", @LONG
七星岩景区由散落在广阔湖区的七岩、八洞、五湖、六岗组成，以山奇水秀、湖山相映、洞穴幽奇见胜。。
LONG );
 //set("maze",1);
set("mglvl",410);
  set("hxsdmigong",1);
