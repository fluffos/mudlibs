...
string tname="migong22";
string oname="/d/hangzhou/suti7";
string mnpc="/p/migong/migong/npc/npc23";
string mboss="/p/migong/migong/npc/boss23";
...
void create ()
{
  ...
  set ("short", "周庄");
  set ("long", @LONG
古镇周庄始建于1086年，因邑人周迪功先生捐地修全福寺而得名。
LONG );
 //set("maze",1);
set("mglvl",320);
  set("hxsdmigong",1);
