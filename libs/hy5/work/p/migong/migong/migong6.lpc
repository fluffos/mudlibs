...
string tname="migong6";
string oname="/d/tiezhang/road-3";
string mnpc="/p/migong/migong/npc/npc7";
string mboss="/p/migong/migong/npc/boss1";
...
void create ()
{
  ...
  set ("short", "天子山");
  set ("long", @LONG
天子山因明初土家族领袖农民起义领袖向大坤自号向王天子，而得名。
LONG );
 //set("maze",1);
set("mglvl",160);
  set("hxsdmigong",1);
