...
string tname="migong72";
string oname="/d/huashan/sheshen";
string mnpc="/p/migong/migong/npc/npc72";
string mboss="/p/migong/migong/npc/boss72";
...
void create ()
{
  ...
  set ("short", "华山南峰");
  set ("long", @LONG
华山主峰，也是五岳的最高峰，古人尊称它是华山元首。登上南峰绝顶，顿感天近咫尺，星斗可摘。
LONG );
 //set("maze",1);
set("mglvl",810);
  set("hxsdmigong",1);
