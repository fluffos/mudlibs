...
string tname="migong41";
string oname="/d/xingxiu/xxroad1";
string mnpc="/p/migong/migong/npc/npc41";
string mboss="/p/migong/migong/npc/boss41";
...
void create ()
{
  ...
  set ("short", "郎木寺");
  set ("long", @LONG
郎木寺(虎女寺)位于四川、甘肃交界地带，自古以来就是川、甘、青各族民众朝拜黑虎女神的圣地。
LONG );
 //set("maze",1);
set("mglvl",500);
  set("hxsdmigong",1);
