...
string tname="migong11";
string oname="/d/taiwan/riyuetan";
string mnpc="/p/migong/migong/npc/npc12";
string mboss="/p/migong/migong/npc/boss12";
