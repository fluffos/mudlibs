...
string tname="migong21";
string oname="/d/hangzhou/road4";
string mnpc="/p/migong/migong/npc/npc22";
string mboss="/p/migong/migong/npc/boss22";
...
void create ()
{
  ...
  set ("short", "乌镇");
  set ("long", @LONG
乌镇曾名乌墩和青墩，具有六千余年悠久历史。素有鱼米之乡，丝绸之府之称。
LONG );
 //set("maze",1);
set("mglvl",310);
  set("hxsdmigong",1);
