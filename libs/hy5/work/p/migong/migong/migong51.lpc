...
string tname="migong51";
string oname="/d/resort/smallroad";
string mnpc="/p/migong/migong/npc/npc51";
string mboss="/p/migong/migong/npc/boss51";
...
void create ()
{
  ...
  set ("short", "黄龙寺");
  set ("long", @LONG
黄龙寺薜萝丛生，花木竞秀，碧水清泉，漫台滚泻，形成千百块迂回周折、层层嵌砌的彩池。
LONG );
 //set("maze",1);
set("mglvl",600);
  set("hxsdmigong",1);
