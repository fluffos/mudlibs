...
string tname="migong87";
string oname="/d/jiangling/shennongjia";
string mnpc="/p/migong/migong/npc/npc87";
string mboss="/p/migong/migong/npc/boss87";
...
void create ()
{
  ...
  set ("short", "神农架");
  set ("long", @LONG
上古时代的神农氏曾在这里遍尝百草为民除病，由于崖高壁陡，珍稀药草不易采到，神农氏就伐木搭架而上，因此后人称这里为“神农架”。
LONG );
 //set("maze",1);
set("mglvl",960);
  set("hxsdmigong",1);
