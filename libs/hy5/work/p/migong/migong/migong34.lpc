...
string tname="migong34";
string oname="/d/taiyuan/road4";
string mnpc="/p/migong/migong/npc/npc34";
string mboss="/p/migong/migong/npc/boss34";
...
void create ()
{
  ...
  set ("short", "平遥城");
  set ("long", @LONG
平遥旧称古陶，明朝初年，为防御外族南扰，始建城墙，洪武三年公元1370年在旧墙垣基础上重筑扩修，并全面包砖。
LONG );
 //set("maze",1);
set("mglvl",430);
  set("hxsdmigong",1);
