...
string tname="migong42";
string oname="/d/lanzhouchen/road3";
string mnpc="/p/migong/migong/npc/npc42";
string mboss="/p/migong/migong/npc/boss42";
...
void create ()
{
  ...
  set ("short", "伏羲庙");
  set ("long", @LONG
伏羲庙本名太昊宫，俗称人宗庙，庙内院落重重相套，四进四院，宏阔幽深。
LONG );
 //set("maze",1);
set("mglvl",510);
  set("hxsdmigong",1);
