...
string tname="migong60";
string oname="/d/kunming/qingshilu";
string mnpc="/p/migong/migong/npc/npc60";
string mboss="/p/migong/migong/npc/boss60";
...
void create ()
{
  ...
  set ("short", "腾冲热地");
  set ("long", @LONG
腾冲有万年火山热海，千年古道边关，百年翡翠商城,有99座火山雄歭苍穹、88处温泉喷珠溅玉。
LONG );
 //set("maze",1);
set("mglvl",690);
  set("hxsdmigong",1);
