...
string tname="migong49";
string oname="/d/fuzhou/fzroad4";
string mnpc="/p/migong/migong/npc/npc49";
string mboss="/p/migong/migong/npc/boss49";
...
void create ()
{
  ...
  set ("short", "丹霞山");
  set ("long", @LONG
丹霞山分数为数层。有始建于北宋的锦石岩石窟寺、梦觉关、通天洞、百丈峡及最典型的赤壁丹崖。
LONG );
 //set("maze",1);
set("mglvl",580);
  set("hxsdmigong",1);
