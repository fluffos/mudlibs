...
string tname="migong36";
string oname="/d/yanping/road1";
string mnpc="/p/migong/migong/npc/npc36";
string mboss="/p/migong/migong/npc/boss36";
...
void create ()
{
  ...
  set ("short", "阳朔城");
  set ("long", @LONG
阳朔是一个历史悠久的古城，唐诗中一句说得好：城郭并无二里大，人家都在万山中。
LONG );
 //set("maze",1);
set("mglvl",450);
  set("hxsdmigong",1);
