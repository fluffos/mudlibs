...
string tname="migong71";
string oname="/d/huashan/chaoyang";
string mnpc="/p/migong/migong/npc/npc71";
string mboss="/p/migong/migong/npc/boss71";
...
void create ()
{
  ...
  set ("short", "华山东峰");
  set ("long", @LONG
华山主峰，因位置居东得名。峰顶有一平台，居高临险，视野开阔，是著名的观日出的地方，人称朝阳台，东峰也因之被称为朝阳峰。
LONG );
 //set("maze",1);
set("mglvl",800);
  set("hxsdmigong",1);
