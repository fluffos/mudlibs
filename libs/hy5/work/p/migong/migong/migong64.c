...
string tname="migong64";
string oname="/d/taishan/aishen";
string mnpc="/p/migong/migong/npc/npc64";
string mboss="/p/migong/migong/npc/boss64";
...
void create ()
{
  ...
  set ("short", "舍身崖");
  set ("long", @LONG
泰山日凤峰南，因旧时常有人于此为父母求福投崖舍身而得名。易名为舍身崖。。
LONG );
 //set("maze",1);
set("mglvl",730);
  set("hxsdmigong",1);
