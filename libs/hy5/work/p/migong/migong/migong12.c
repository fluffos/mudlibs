...
string tname="migong12";
string oname="/d/kunming/shilin2";
string mnpc="/p/migong/migong/npc/npc13";
string mboss="/p/migong/migong/npc/boss13";
...
void create ()
{
  ...
  set ("short", "云南石林");
  set ("long", @LONG
冬无严寒、夏无酷暑、四季如春，素有天下第一奇观石林博物馆的美誉
LONG );
 //set("maze",1);
set("mglvl",220);
  set("hxsdmigong",1);
