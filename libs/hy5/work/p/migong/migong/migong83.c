...
string tname="migong83";
string oname="/d/changsha/dongmen";
string mnpc="/p/migong/migong/npc/npc83";
string mboss="/p/migong/migong/npc/boss83";
...
void create ()
{
  ...
  set ("short", "天心阁");
  set ("long", @LONG
天心阁在长沙市中心地区东南角上，是长沙古城的一座城楼。为长沙重要名胜，也是长沙仅存的古城标志。
LONG );
 //set("maze",1);
set("mglvl",920);
  set("hxsdmigong",1);
