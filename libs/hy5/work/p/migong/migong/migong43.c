...
string tname="migong43";
string oname="/d/lanzhou/caroad2";
string mnpc="/p/migong/migong/npc/npc43";
string mboss="/p/migong/migong/npc/boss43";
...
void create ()
{
  ...
  set ("short", "麦积山石窟");
  set ("long", @LONG
麦积山者，北跨清渭，麦积处其半，崛起一块石，高百万寻，望之团团，如农家积麦之状，故有此名。
LONG );
 //set("maze",1);
set("mglvl",520);
  set("hxsdmigong",1);
