...
string tname="migong62";
string oname="/d/taishan/yaocan";
string mnpc="/p/migong/migong/npc/npc62";
string mboss="/p/migong/migong/npc/boss62";
...
void create ()
{
  ...
  set ("short", "遥参亭");
  set ("long", @LONG
旧称草参亭，为岱庙前亭。古人祭泰山必先至此简单参拜，尔后入庙祭祀。今院内举办了泰安民俗 。
LONG );
 //set("maze",1);
set("mglvl",710);
  set("hxsdmigong",1);
