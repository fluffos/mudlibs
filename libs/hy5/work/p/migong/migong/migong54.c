...
string tname="migong54";
string oname="/d/xinan/shanlu11";
string mnpc="/p/migong/migong/npc/npc54";
string mboss="/p/migong/migong/npc/boss54";
...
void create ()
{
  ...
  set ("short", "光雾山");
  set ("long", @LONG
光雾山是一方神奇秀丽的自然山水，地形复杂，峰峦迭嶂，峰林俊美，洞穴幽深。
LONG );
 //set("maze",1);
set("mglvl",630);
  set("hxsdmigong",1);
