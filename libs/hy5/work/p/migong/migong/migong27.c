...
string tname="migong27";
string oname="/d/hangzhou/shiwudong";
string mnpc="/p/migong/migong/npc/npc28";
string mboss="/p/migong/migong/npc/boss28";
...
void create ()
{
  ...
  set ("short", "李庄");
  set ("long", @LONG
李庄，坐落在孕育了华夏文明的母亲河——长江的南岸，与大桂轮山隔山相望，依山傍水，风景宜人。
LONG );
 //set("maze",1);
set("mglvl",370);
  set("hxsdmigong",1);
