...
string tname="migong1";
string oname="/d/baling/edao5";
string mnpc="/p/migong/migong/npc/npc2";
string mboss="/p/migong/migong/npc/boss2";
...
void create ()
{
  ...
  set ("short", "缙云山");
  set ("long", @LONG
缙云山位于嘉陵江温塘峡畔，古名巴山。古木参天，翠竹成林，环境清幽。
LONG );
 //set("maze",1);
set("mglvl",110);
  set("hxsdmigong",1);
