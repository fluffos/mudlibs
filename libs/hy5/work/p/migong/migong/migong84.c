...
string tname="migong84";
string oname="/d/henshan/hsroad8";
string mnpc="/p/migong/migong/npc/npc84";
string mboss="/p/migong/migong/npc/boss84";
...
void create ()
{
  ...
  set ("short", "苏仙岭");
  set ("long", @LONG
自古享有“天下第十八福地”、“湘南胜地”的美称。苏仙岭因苏仙神奇、美丽的传说而驰名海内外。
LONG );
 //set("maze",1);
set("mglvl",930);
  set("hxsdmigong",1);
