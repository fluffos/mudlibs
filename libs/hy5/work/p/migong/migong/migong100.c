...
string tname="migong100";
string oname="/d/taiwan/lugang";
string mnpc="/p/migong/migong/npc/npc100";
string mboss="/p/migong/migong/npc/boss100";
...
void create ()
{
  ...
  set ("short", "龙山寺");
  set ("long", @LONG
鹿港龙山寺规模宏伟，坐向为东朝西，格局十分方正，山门为三进两廊九开间纵深式建筑。
LONG );
 //set("maze",1);
set("mglvl",1090);
  set("hxsdmigong",1);
