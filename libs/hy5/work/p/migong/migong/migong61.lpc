...
string tname="migong61";
string oname="/d/taishan/baozang";
string mnpc="/p/migong/migong/npc/npc61";
string mboss="/p/migong/migong/npc/boss61";
...
void create ()
{
  ...
  set ("short", "后石坞");
  set ("long", @LONG
在泰山的背面，此处危岩峭壁，怪石突立，饰以苍松翠柏，幽径小溪，景致尤具别趣。。
LONG );
 //set("maze",1);
set("mglvl",700);
  set("hxsdmigong",1);
