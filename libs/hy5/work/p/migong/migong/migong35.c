...
string tname="migong35";
string oname="/d/taiyuan/road5";
string mnpc="/p/migong/migong/npc/npc35";
string mboss="/p/migong/migong/npc/boss35";
...
void create ()
{
  ...
  set ("short", "云冈石窟");
  set ("long", @LONG
云冈石窟位于武周山南麓，依山而凿，东西绵延约一公里，气势恢弘，内容丰富。
LONG );
 //set("maze",1);
set("mglvl",440);
  set("hxsdmigong",1);
