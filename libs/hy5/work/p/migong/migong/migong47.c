...
string tname="migong47";
string oname="/d/changsha/road1";
string mnpc="/p/migong/migong/npc/npc47";
string mboss="/p/migong/migong/npc/boss47";
...
void create ()
{
  ...
  set ("short", "武陵源");
  set ("long", @LONG
武陵源，美在神秘，美在天然。与自然风光相映成趣的，是纯朴的田园风光。
LONG );
 //set("maze",1);
set("mglvl",560);
  set("hxsdmigong",1);
