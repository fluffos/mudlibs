...
string tname="migong68";
string oname="/d/songshan/tianzhongge";
string mnpc="/p/migong/migong/npc/npc68";
string mboss="/p/migong/migong/npc/boss68";
...
void create ()
{
  ...
  set ("short", "中岳庙");
  set ("long", @LONG
道教圣地圣景，五岳居冠居中。慢慢游览这块三清净地，感受道家反朴归真回复自然的理想。
LONG );
 //set("maze",1);
set("mglvl",770);
  set("hxsdmigong",1);
