...
string tname="migong70";
string oname="/d/songshan/shuyuan";
string mnpc="/p/migong/migong/npc/npc70";
string mboss="/p/migong/migong/npc/boss70";
...
void create ()
{
  ...
  set ("short", "嵩阳书院");
  set ("long", @LONG
嵩阳书院东西山岭环抱，逍遥谷溪水缓缓南流，嵩岳寺溪水汩汩西来，两道清澈的溪水，在嵩阳书院前面汇合。
LONG );
 //set("maze",1);
set("mglvl",790);
  set("hxsdmigong",1);
