...
string tname="migong17";
string oname="/d/changcheng/nroad1";
string mnpc="/p/migong/migong/npc/npc18";
string mboss="/p/migong/migong/npc/boss18";
...
void create ()
{
  ...
  set ("short", "承德避暑山庄");
  set ("long", @LONG
避暑山庄以朴素淡雅的山村野趣为格调，取自然山水之本色，吸收江南塞北  避暑山庄之风光
LONG );
 //set("maze",1);
set("mglvl",270);
  set("hxsdmigong",1);
