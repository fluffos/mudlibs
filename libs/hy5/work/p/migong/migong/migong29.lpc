...
string tname="migong29";
string oname="/d/hangzhou/shanlu4";
string mnpc="/p/migong/migong/npc/npc30";
string mboss="/p/migong/migong/npc/boss30";
...
void create ()
{
  ...
  set ("short", "同里镇");
  set ("long", @LONG
同里旧称富土。唐初改为铜里。宋时将旧名拆字为同里。同里风景优美，镇外四面环水。
LONG );
 //set("maze",1);
set("mglvl",390);
  set("hxsdmigong",1);
