...
string tname="migong76";
string oname="/d/henshan/zhurongfeng";
string mnpc="/p/migong/migong/npc/npc76";
string mboss="/p/migong/migong/npc/boss76";
