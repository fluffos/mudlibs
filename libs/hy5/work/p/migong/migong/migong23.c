...
string tname="migong23";
string oname="/d/huangshan/taoyuan";
string mnpc="/p/migong/migong/npc/npc24";
string mboss="/p/migong/migong/npc/boss24";
