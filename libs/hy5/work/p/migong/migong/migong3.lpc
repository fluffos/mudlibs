...
string tname="migong3";
string oname="/d/taiyuan/road1";
string mnpc="/p/migong/migong/npc/npc4";
string mboss="/p/migong/migong/npc/boss4";
...
void create ()
{
  ...
  set ("short", "五台山");
  set ("long", @LONG
五台山与四川峨嵋山、安徽九华山、浙江普陀山共称中国佛教四大名山。
LONG );
 //set("maze",1);
set("mglvl",130);
  set("hxsdmigong",1);
