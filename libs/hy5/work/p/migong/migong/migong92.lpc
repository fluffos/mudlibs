...
string tname="migong92";
string oname="/d/hainan/underhill3";
string mnpc="/p/migong/migong/npc/npc92";
string mboss="/p/migong/migong/npc/boss92";
...
void create ()
{
  ...
  set ("short", "博鳌");
  set ("long", @LONG
“博鳌浦莫村都（在县东民疍）”。因此“民疍”是博鳌最早的居民，博鳌的名称应该是“民疍”所起。
LONG );
 //set("maze",1);
set("mglvl",1010);
  set("hxsdmigong",1);
