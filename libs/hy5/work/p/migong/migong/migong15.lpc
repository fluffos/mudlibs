...
string tname="migong15";
string oname="/d/jinan/road2";
string mnpc="/p/migong/migong/npc/npc16";
string mboss="/p/migong/migong/npc/boss16";
...
void create ()
{
  ...
  set ("short", "曲阜三孔");
  set ("long", @LONG
东方圣城。千年礼乐归东鲁，万古衣冠拜素王曲阜之所以享誉中华，是与孔子的名字紧密相连的。 
LONG );
 //set("maze",1);
set("mglvl",250);
  set("hxsdmigong",1);
