...
string tname="migong44";
string oname="/d/xinjiang/aiding";
string mnpc="/p/migong/migong/npc/npc44";
string mboss="/p/migong/migong/npc/boss44";
...
void create ()
{
  ...
  set ("short", "艾丁湖");
  set ("long", @LONG
艾丁湖位于觉洛塔格山北麓，古代文人墨客叫它觉洛浣。维吾尔族人，则叫它艾丁库勒，意为月光湖、月亮湖。
LONG );
 //set("maze",1);
set("mglvl",530);
  set("hxsdmigong",1);
