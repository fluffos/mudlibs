...
string tname="migong90";
string oname="/d/hainan/road4";
string mnpc="/p/migong/migong/npc/npc90";
string mboss="/p/migong/migong/npc/boss90";
...
void create ()
{
  ...
  set ("short", "五指山");
  set ("long", @LONG
五指山市周围群山环抱，森林茂密，是有名的“翡翠山城”。它以海南岛上最高山峰五指山因而得名。
LONG );
 //set("maze",1);
set("mglvl",990);
  set("hxsdmigong",1);
