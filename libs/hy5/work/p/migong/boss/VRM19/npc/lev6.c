...

{
   ...
   set_name(order[random(13)]+"精灵法师"NOR, ({ "arch magi"}));
	set("magicgift",4);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一只可怕的精灵法师。\n");
	...
	set("combat_exp",46000000+random(8000000));
...
b=96700+random(111500);
a=99700+random(111500);
d=89+random(60);
set("str",d);
set("dex",35+d);
set("int",d);
...
if (!ob->is_busy())
             ob->start_busy(4);
           msg = HIY"$N"HIY"突然对着$n"HIY"召出了精灵之力量 !!结果$n"HIY"被困的不能动了!\n"NOR;
