...
"一只可怕的泰坦巨人。\n");
	       ...
	       set("max_qi",900+random(500));
	set("combat_exp",49000000+random(8000000));
	...
	set_skill("parry",990+random(300));
      ...
      set_skill("magic-earth", 990+random(200));
...
b=123000+random(96000);
a=126000+random(98000);
d=90+random(60);
set("str",d);
set("dex",30+d);
set("int",d);
...
set("kar",d);
   ...
   setup();
if (random(3)==0) initlvl(850+random(370));
