...

{
   ...
   set_name(order[random(13)]+"树妖卫士"NOR, ({ "dendroid"}));
	set("magicgift",4);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一只可怕的树妖卫士。\n");
	...
	set("combat_exp",36000000+random(8000000));
...
b=74700+random(84500);
a=77700+random(84500);
d=59+random(60);
set("str",d);
set("dex",35+d);
set("int",d);
...
if (!ob->is_busy())
             ob->start_busy(4);
           msg = HIY"$N"HIY"突然对着$n"HIY"伸出树技!!结果$n"HIY"被困的不能动了!\n"NOR;
