...

{
   ...
   set_name(order[random(13)]+"独角兽"NOR, ({ "unicorn"}));
	set("magicgift",3);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一位可怕的独角兽。\n");
	...
	set("combat_exp",37000000+random(8000000));
        set_skill("spells",950+random(300));
	...
	set_skill("parry",950+random(300));
      ...
      set_skill("magic-ice", 950+random(200));
...
b=87500+random(85000);
a=88500+random(85000);
d=69+random(60);
set("str",d);
set("dex",80+d);
set("int",d);
...
if (!ob->is_busy())
             ob->start_busy(3);
           msg = HIC"$N"HIC"独角发光!!$n被神光定"HIC"了!\n"NOR;
