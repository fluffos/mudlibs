...
void create()
{
	set_name( HIR "闻沧海" NOR, ({ "boss killer",  "boss" }) );
	set("long", HIB "他就是东海门掌门。\n\n" NOR);
	set("title",  HIY"东海门掌门"NOR);
	set("gender",  "男性");
	set("age", 30);
	set("no_get", 1);
	set("shen_type", -1);
