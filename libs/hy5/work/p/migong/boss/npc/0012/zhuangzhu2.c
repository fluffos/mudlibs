...
void create()
{
	set_name( HIB "谷啸风" NOR, ({ "boss killer", "boss" }) );
	set("long", HIB "他就是谷啸风。\n\n" NOR);
	set("title",  HIY"二十四桥桥主"NOR);
	set("gender",  "男性");
	set("age", 30);
	set("no_get", 1);
	set("shen_type", -1);
...
mixed hit_ob(object me, object ob, int damage_bouns)
{
	...
	return "$N阴阴一笑，刺中$n的膻中大穴，"HIC "$n" HIC "顿觉全身内力如水银般循孔飞泄而出！\n" NOR;
}
