...
//inherit  NPC;
//inherit  NPC;
#include "/d/migong/romnpcboss.c"
int boss_attack();

void create()
{
	set_name( HIR "秦如梦" NOR, ({ "boss killer","boss" }) );
	set("long", HIY "他就是武林三凤。\n\n" NOR);
	...
	map_skill("unarmed", "changquan");
        set_skill("boss-ai",500);
       map_skill("spells", "boss-ai");
	...
	set("chat_msg_combatboss", ({
	(: perform_action, "spells.1" :),
	(: perform_action, "spells.2" :),
	(: perform_action, "spells.1" :),
	}));
...
initlvl(860+random(30),(20+random(2)));
}
