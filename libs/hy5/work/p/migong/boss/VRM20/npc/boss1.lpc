...
"一位可怕的虔敬之天使。\n");
	       ...
	       set("max_qi",11500+random(500));
	set("combat_exp",65000000+random(8000000));
        set_skill("force",1550+random(300));
	set_skill("unarmed",1750+random(300));
	set_skill("sword",1750+random(300));
...
mixed hit_ob(object me, object ob, int damage_bouns)
{
        ...
        //ob->apply_condition("new_poison1", 8);
