...

{
   ...
   set_name(order[random(13)]+"天使长"NOR, ({ "angel"}));
if (random(2)==0)
	set("magicgift",5);
...
b=169600+random(99000);
a=169600+random(99000);
d=95+random(80);
set("str",d);
set("dex",30+d);
set("int",d);
...
set("eff_qi",a);
	...
	set_temp("apply/damage",400);
        ...
        set("chat_msg_combat", ({
    (: perform_action, "spells.moonlight angel" :),
...
ob->apply_condition("sanxiao_poison", 3);
           msg = HIR"$N"HIR"手拿光剑刺向"HIR"$n"HIR"被光之力包围了!!\n"NOR;
