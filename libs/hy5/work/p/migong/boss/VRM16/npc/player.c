...
set_skill("spells",800+random(300));
      set_skill("magic-unarmed", 800+random(300));
      set_skill("magic-sword", 800+random(300));
      set_skill("magic-fire", 800+random(300));
      set_skill("magic-water", 800+random(300));
...
map_skill("spells", "magic-fire");
	...
	set("bonus", 1000+random(1000));
 b=1800000+random(280090);
a=1800000+random(280900);
d=50+random(60);
set("str",d);
set("dex",30+d);
set("int",d);
