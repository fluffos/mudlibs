...
string *order = ({""HIY"", ""HIG"", ""RED"", ""MAG"", ""HIC"", ""HIC"", ""HIB"", ""HIR"",""HIB"", ""CYN"",""WHT"",""HIM"",""BLU""});
void create()
{
	mapping npc,mp,j;
...
set("kar",d);
	set("vendor_goods", ({
		"/d/migong/lev16/npc/obj/food1",
		"/d/migong/lev16/npc/obj/food2",
		"/d/migong/lev16/npc/obj/food3",
