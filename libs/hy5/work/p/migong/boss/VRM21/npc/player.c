...
set("eff_qi",118000+random(10000));
	...
	set("combat_exp",55000000+random(9000000));
        set_skill("force",890+random(500));
	set_skill("unarmed",890+random(500));
	set_skill("sword",890+random(500));
	set_skill("club",890+random(500));
	set_skill("whip",890+random(500));
	set_skill("throwing",890+random(500));
	set_skill("parry",890+random(500));
set_skill("spells",890+random(500));
      set_skill("magic-unarmed", 890+random(500));
      set_skill("magic-sword", 890+random(500));
      set_skill("magic-dark", 890+random(500));
      set_skill("magic-light", 890+random(500));
...
map_skill("spells", "magic-light");
    ...
    (: perform_action, "spells.sunarrow" :),                                                    
       ...
       set_temp("apply/attack", 200);
        ...
        set_temp("apply/armor", 7400);
        set_temp("apply/damage", 7300);
        set("killer_reward", ([
                "FI&/clone/box/gbox"   :   680,
                "TW&480"   :  480,
                "TA&480"   :  480,
        ]));
	set("bonus", 1200+random(1200));
 b=3500000+random(280090);
a=3500000+random(280900);
d=80+random(80);
set("str",d);
set("dex",30+d);
set("int",d);
...
set("kar",d);
	...
	set_temp("apply/attack",200);
	set_temp("apply/defense",200);
	set_temp("apply/armor",6500);
	set_temp("apply/damage",6500);
  setup();
 if (random(2)==0)
{
 	 initlvl(1050+random(600));
}
else
	{
...
{
ob->apply_condition("new_poison1", 10); 
