...
#define GEMOTE_Q        (AUX_PATH+"gemote_q")   // added by Find.
#define GEMOTE_A        (AUX_PATH+"gemote_a")   // added by Find.
...
#define DNS_GEMOTE_Q    "gemote_q"      // added by Find.
#define DNS_GEMOTE_A    "gemote_a"      // added by Find.
