...
#define ADM_PATH ({"/cmds/adm/", "/cmds/arch/", "/cmds/debug/", "/cmds/sage/", "/cmds/wiz/", "/cmds/imm/", "/cmds/usr/","/cmds/std/"})
#define ARC_PATH ({"/cmds/arch/", "/cmds/debug/","/cmds/sage/", "/cmds/wiz/", "/cmds/imm/", "/cmds/usr/","/cmds/std/"})
#define SAG_PATH ({"/cmds/sage/", "/cmds/debug/","/cmds/wiz/", "/cmds/imm/", "/cmds/usr/","/cmds/std/"})
#define WIZ_PATH ({"/cmds/debug/","/cmds/imm/", "/cmds/usr/", "/cmds/std/", "/cmds/wiz/"})
