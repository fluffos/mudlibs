...
([	"action": "$N左手向上划弧拦出，右手使一招「碣石潇湘」，手掌不住晃动，不离$n头顶
方寸之间",
]),
});
...
([      "action" : "$N双掌缩入袖中，双袖飞起扫向$n的$l，却是一招「长江流水」，仪
态潇洒",
        "force" : 180,
        "dodge" : 20,
        "damage": 50,
...
([      "action" : "$N左手向上划弧拦出，右手使一招「碣石潇湘」，手掌不住晃动，不
离$n头顶方寸之间",
        "force" : 100,
        "dodge" : 10,
        "damage": 150,
...
int valid_combine(string combo) { return combo=="sun-finger"; }
