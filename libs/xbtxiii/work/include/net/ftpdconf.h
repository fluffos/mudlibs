...
#define FTP_BUGS_EMAIL "evilgod@163.net"
...
#define READ_LEVEL (WRITE_LIMIT_READ)
 ...
 */
//#define FTP_USERS ({ "alvins","evilgod","diabloa" ,"rongg","lightning","tony"})
...
#define TP_CRE "mudplayer"
//#define TP(x) find_player(TP_CRE)?(tell_object(find_player(TP_CRE),x)): 
/*
-----------------------------------------------
   log file defines.
-----------------------------------------------
