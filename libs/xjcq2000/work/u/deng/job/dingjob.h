int ask_job()
{
        ...
        quest = "/quest/xhquest"->query_quest();
        ...
        if (me->query_temp("jobok") ==1 )
        {
                ...
                me->add("potential", 300+random(180));
                me->add("combat_exp", 520+random(110));
                me->add("shen", 100+random(400));
               me->delete_temp("jobstart");
            me->add("kill",50);
        ...
        ob=new("/u/deng/job/dizi");
        ob->set_name("嵩山派弟子",({"di zi","zi"}));
