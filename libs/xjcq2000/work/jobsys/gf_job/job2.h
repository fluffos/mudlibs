...
mapping *quest = ({
  ({
  (["name":                "江湖宵小",
    "where" :              "/jobsys/gf_job/npc/xiaoxiao",]), 
   (["name":                "山贼", 
    "where" :              "/jobsys/gf_job/npc/shanzei",]),
    }), 
    ({
     (["name":                "山贼", 
    "where" :              "/jobsys/gf_job/npc/shanzei",]),
     (["name":                "盖一鸣",
     "where" :              "/jobsys/gf_job/npc/gaiyiming",]),
     (["name":                "常长风",
     "where" :              "/jobsys/gf_job/npc/chang",]),
      (["name":                "花剑影",
     "where" :                "/jobsys/gf_job/npc/hua",]),
      (["name":                "黄须道人",
     "where" :                "/jobsys/gf_job/npc/huangxu",]),
     (["name":                "恶僧",
     "where" :                "/jobsys/gf_job/npc/eseng",]),
      (["name":                "曹化淳",
     "where" :                "/jobsys/gf_job/npc/cao",]),
      (["name":                "朱安国",
     "where" :                "/jobsys/gf_job/npc/zhu",]),
      }), 
      ({
         (["name":                "江洋大盗 王三",
     "where" :                "/jobsys/gf_job/npc/dadao",]),
       (["name":                "草寇",
     "where" :                "/jobsys/gf_job/npc/caokou",]),
      (["name":                "恶霸",
     "where" :                "/jobsys/gf_job/npc/eba",]),
      (["name":                "宋扬",
     "where" :                 "/jobsys/gf_job/npc/songyang",]),
      (["name":               "全二风",
     "where" :                 "/jobsys/gf_job/npc/quan",]),
      (["name":               "孟正鹏",
     "where" :                 "/jobsys/gf_job/npc/meng",]),
      (["name":               "鲜于通",
     "where" :                 "/jobsys/gf_job/npc/xian",]),
      (["name":               "麦鲸",
     "where" :                 "/jobsys/gf_job/npc/maijing",]),
      (["name":               "过三拳",
     "where" :                 "/jobsys/gf_job/npc/guo",]),
       }), 
      ({
      (["name":               "赵一伤",
     "where" :                 "/jobsys/gf_job/npc/zhaoyishang",]),   
      (["name":               "钱二败",
     "where" :                 "/jobsys/gf_job/npc/qian",]),    
      (["name":               "孙三毁",
     "where" :                 "/jobsys/gf_job/npc/sun",]),  
      (["name":               "李四摧",
     "where" :                 "/jobsys/gf_job/npc/li",]), 
      (["name":               "周五输",
     "where" :                 "/jobsys/gf_job/npc/zhou",]), 
      (["name":               "吴六破",
     "where" :                 "/jobsys/gf_job/npc/wu",]), 
      (["name":               "郑七灭",
     "where" :                 "/jobsys/gf_job/npc/zheng",]), 
      (["name":               "元广波",
     "where" :                 "/jobsys/gf_job/npc/yuan",]), 
      (["name":               "徐长老",
     "where" :                 "/jobsys/gf_job/npc/xu",]), 
      (["name":               "单正",
     "where" :                 "/jobsys/gf_job/npc/shan",]), 
      (["name":               "霍元风",
     "where" :                 "/jobsys/gf_job/npc/huo",]),
      }), 
      ({
      (["name":               "阿大",
     "where" :                 "/jobsys/gf_job/npc/ada",]),  
      (["name":               "阿二",
     "where" :                 "/jobsys/gf_job/npc/aer",]), 
      (["name":               "阿三",
     "where" :                 "/jobsys/gf_job/npc/asan",]), 
      (["name":               "玉真子",
     "where" :                 "/jobsys/gf_job/npc/yu",]),    
     }),
     });
mapping *wheres=({
          
      (["chinese":                "大理",
       "weizhi" :              "/d/dali/anning",]),  
      (["chinese":                "扬州",
       "weizhi" :              "/d/city/xjs",]),  
     (["chinese":                "峨嵋",
...
//        target = quest[random(sizeof(quest))];
	...
	me->set_temp("guanfu_target", target["name"]);
        ...
        new("/jobsys/gf_job/wenshu1")->move(me);
