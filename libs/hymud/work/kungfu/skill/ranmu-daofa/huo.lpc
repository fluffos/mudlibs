...
int perform(object me, object target)
{
        ...
        if (ap / 4 + random(ap) > dp || random(2)==0)
        {
                target->start_busy(1);
	...
	msg += RED "只闻一股焦臭从$n" RED "处传来，已被"
        ...
        me->add_temp("attack",100);
        me->add_temp("damage",1800);
          	target->receive_damage("qi",(int)me->query_skill("ranmu-daofa", 1)*5,me);
          	target->receive_wound("qi",(int)me->query_skill("ranmu-daofa", 1)*4,me);
