...
mapping *action = ({
   ([   "action":
"$N打出一道 "HIC"审判之圣雷"NOR" 手中$w向$n的$l直劈过来。",
             "force" : 8620,
     "dodge":     100,
     "parry":                300,
     "damage":     8600,
   ...
   ([   "action":
"$N打出一道 "HIY"大阳之箭"NOR" 手中$w向$n的$l斜劈过来。",
             "force" : 8620,
     "dodge":     100,
     "parry":                300,
     "damage":     8600,
   ...
   ([   "action":
"$N打出一道 "HIB"暗黑核融术"NOR" 手中的$w划了一个三角，向$n的$l刺了过去。",
             "force" : 8620,
     "dodge":     100,
     "parry":                300,
     "damage":     8600,
   ...
   ([   "action":
"$N打出一道 "HIW"绝对零冰冻"NOR"手中的$w划了个大圆，向$n的$l刺了过去。",
             "force" : 8620,
     "dodge":     100,
     "parry":                300,
     "damage":     8600,
   ...
   ([   "action":
"$N打出一道 "HIM"地狱力场"NOR"手中的$w对着$n的$l旋了过去。",
             "force" : 8620,
     "dodge":     100,
     "parry":                300,
     "damage":     8600,
   ...
   ([   "action":
"$N打出一道 "HIR"琰魔焦热地狱"NOR"手中的$w对着$n的$l旋了过去。",
             "force" : 8620,
     "dodge":     100,
     "parry":                300,
     "damage":     8600,
...
{
        int i, level;
        level = (int)me->query_skill("magic-swordboss", 1);
...
damage=random(me->query_skill("magic-swordboss",1))*2+300;
