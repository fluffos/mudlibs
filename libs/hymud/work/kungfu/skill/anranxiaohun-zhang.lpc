...
mixed hit_ob(object me, object victim, int damage_bonus)
{
    ...
    lvl = me->query_skill("anranxiaohun-zhang", 1);
    if( damage_bonus < 30 ) return 0;
    if( !random(5) && !victim->is_busy() && j > 140
...
{
		victim->receive_wound("qi", (j+100),me  );
		victim->receive_damage("qi", (j+150),me );
...
if (random(5)==0 && level2>=300 && (me->query_skill_mapped("force") == "yunv-xinfa"))
{
j = -damage/2; 
