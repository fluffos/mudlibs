...
lvl=(int)me->query_skill("yiyang-zhi", 1);
	...
	&& me->query_skill_mapped("unarmed") == "yiyang-zhi" 
		...
		victim->receive_damage("qi", (me->query_skill("yiyang-zhi",1)+damage_bonus/2),me);
        victim->receive_wound("qi", (me->query_skill("yiyang-zhi",1)+damage_bonus/2+80),me);   
...
{ 
	...
	{
          if((!random(3)) && (me->query("neili")>200) && me->query_skill("yiyang-zhi", 1) > 60
          	&& me->query_skill_mapped("unarmed") == "yiyang-zhi" 
        && me->query_skill_mapped("parry") == "yiyang-zhi"         )
	   {
  if( !victim->is_busy() )
{ 
		...
		victim->add("neili",-30);
		victim->receive_damage("qi", (me->query_skill("yiyang-zhi",1)/2+damage_bonus/2),me);
        victim->receive_wound("qi", (me->query_skill("yiyang-zhi",1)/2+damage_bonus/2+80),me);       
