...
//if (!userp(me))
//	return notify_fail("非玩家不会这个技能。\n");

if (target->query_condition("ill_fashao"))
	target->clear_condition("ill_fashao");

if (target->query_condition("ill_kesou"))
	target->clear_condition("ill_kesou");

if (target->query_condition("ill_shanghan"))
	target->clear_condition("ill_shanghan");

if (target->query_condition("ill_zhongshu"))
	target->clear_condition("ill_zhongshu");

if (target->query_condition("ill_dongshang"))
	target->clear_condition("ill_dongshang");
