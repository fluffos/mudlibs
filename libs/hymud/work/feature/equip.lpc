...
int unequip()
{
	...
	if(!environment() && (query("makeritem")||query("systemmake")) )
{		
set("equipped",0);
	delete("equipped");
this_object()->set("equipped",0);
this_object()->delete("equipped");
		return 1;
}
