...

{
   ...
   set_name(order[random(13)]+"牧师"NOR, ({ "Priests"}));
if (random(2)==0)
	set("magicgift",5);
...
b=139600+random(99000);
a=139600+random(99000);
d=95+random(80);
set("str",d);
set("dex",30+d);
set("int",d);
...
set("eff_qi",a);
 ...
 set("chat_chance_combat", 90);
        set("chat_msg_combat", ({
    (: perform_action, "spells.moonlight Priests" :),
...
if (!ob->is_busy())
             ob->start_busy(3);
           msg = HIC"$N"HIC"突然使用圣光弹打向$n!! $n看来受伤不小!\n"NOR;
