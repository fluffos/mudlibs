...

{
   ...
   set_name(order[random(13)]+"穴居者"NOR, ({ "troglodyte"}));
	set("magicgift",1);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一只可怕的穴居者。\n");
	...
	set("combat_exp",20000000+random(8000000));
        set_skill("force",900+random(200));
	set_skill("unarmed",900+random(200));
	set_skill("sword",900+random(200));
	set_skill("club",900+random(200));
	set_skill("whip",900+random(200));
	set_skill("throwing",900+random(200));
	set_skill("parry",900+random(200));
...
map_skill("spells", "magic-water");
        set("no_get",1);
b=65000+random(76000);
a=66000+random(75000);
d=40+random(60);
set("str",d);
set("dex",30+d);
set("int",d);
