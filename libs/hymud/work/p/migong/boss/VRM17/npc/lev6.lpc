...

{
   ...
   set_name(order[random(13)]+"邪眼"NOR, ({ "evil eye"}));
	set("magicgift",1);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一只可怕的邪眼。\n");
	...
	set("combat_exp",26000000+random(8000000));
...
map_skill("spells", "magic-water");
        set("no_get",1);
b=65000+random(86000);
a=66000+random(85000);
d=40+random(60);
set("str",d);
set("dex",35+d);
set("int",d);
...
if (!ob->is_busy())
             ob->start_busy(2);
           msg = HIY"$N"HIY"突然对着$n"HIY"射出金光!!结果$n"HIY"被射中了!\n"NOR;
