...

{
   ...
   set_name(order[random(13)]+"美杜莎女王"NOR, ({ "medusa queen"}));
	set("magicgift",3);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一位可怕的美杜莎女王。\n");
	...
	set("combat_exp",27000000+random(8000000));
...
map_skill("spells", "magic-water");
        set("no_get",1);
b=65000+random(96000);
a=66000+random(95000);
d=40+random(60);
set("str",d);
set("dex",30+d);
set("int",d);
...
if (!ob->is_busy())
             ob->start_busy(3);
           msg = HIC"$N"HIC"双目发光!!$n被石化住"HIC"了!\n"NOR;
