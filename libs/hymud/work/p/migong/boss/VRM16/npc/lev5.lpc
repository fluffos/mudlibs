...

{
   ...
   set_name(order[random(13)]+"狼骑兵"NOR, ({ "wolfrider"}));
	set("magicgift",2);
	set("magicset",1);
       set("zhuanbest",1);
       set("long",
"一只可怕的狼骑兵。\n");
	...
	set("combat_exp",19000000+random(8000000));
...
map_skill("spells", "magic-fire");
        set("no_get",1);
b=93500+random(64500);
a=94500+random(64500);
d=60+random(60);
set("str",d);
set("dex",30+d);
set("int",d);
        ...
        if(random((int)me->query("combat_exp")) > ob->query("combat_exp")/3)   
{
 ob->apply_condition("new_poison3", 8); 
           ...
           msg = HIG"$N"HIG"进攻后,骑狼向前突刺，$n"HIG"结果被刺中了!\n"NOR;
