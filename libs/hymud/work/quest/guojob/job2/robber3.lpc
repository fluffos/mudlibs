...
me->set("max_neili",(ob->query("max_neili"))/2);
me->set("neili",(ob->query("max_neili"))/2);
        ...
        me->set("ygjg",ob);
        me->set("max_qi",    hp_status["max_qi"]*5/4);
...
if ((int)ob->query_skill("jiuyin-zhengong",1)>480 || random(30)==0)
{
