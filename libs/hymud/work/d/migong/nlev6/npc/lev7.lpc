...
set_skill("xuantian-wuji", 210+random(40));
...
set_skill("zhentian-quan", 210+random(40));

set_skill("kunlun-shenfa", 210+random(40));

set_skill("chuanyun-tui", 210+random(40));
...
prepare_skill("unarmed", "chuanyun-tui");
set("chat_chance_combat", 80);
        set("chat_msg_combat", ({
               
      (: perform_action, "unarmed.shangjue" :),
