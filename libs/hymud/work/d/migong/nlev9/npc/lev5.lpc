...
set_skill("zixia-shengong", 330+random(50));

set_skill("huashan-zhangfa", 330+random(50));

set_skill("force", 330+random(50));
set_skill("lonely-sword", 330+random(50));

set_skill("parry", 330+random(50));

set_skill("dodge", 330+random(50));

set_skill("feiyan-huixiang", 330+random(50));
