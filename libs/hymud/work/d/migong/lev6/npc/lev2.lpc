  ...
  set("neili",3500+random(1500));
	...
	set("pursuer",1);
        set("combat_exp", 1200000+random(500000));
                 set_skill("hand", 210+random(40));

set_skill("dashou-yin", 210+random(40));

set_skill("longxiang", 210+random(40));
...
set_skill("lamaism", 210+random(40));

set_skill("blade", 210+random(40));

set_skill("xue-dao", 210+random(40));

set_skill("shenkong-xing", 210+random(40));
