...
set_skill("hunyuan-yiqi", 210+random(40));

set_skill("yijinjing", 210+random(40));
...
set_skill("jingang-quan", 210+random(40));

set_skill("shaolin-shenfa", 210+random(40));
...
map_skill("unarmed"  , "jingang-quan");
prepare_skill("unarmed", "jingang-quan");
set("chat_chance_combat", 80);
        set("chat_msg_combat", ({
                (: perform_action, "unarmed.jin" :),
	
      (: perform_action, "unarmed.jigang" :),
