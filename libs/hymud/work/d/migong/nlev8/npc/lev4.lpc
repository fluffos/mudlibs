...
"武功高强，心狠手辣的武林败类。\n");
  ...
  set("max_neili",2000+random(3000));
  set("max_mana",2000+random(2000));
  set("eff_neili",2000+random(3000));
...
set_skill("taixuan-gong", 300+random(50));
...
set_skill("jiuyin-baiguzhao", 300+random(50));
