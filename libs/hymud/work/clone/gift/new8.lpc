...
int give_gift()
{
        ...
        if (sizeof(players) >= 10)
        {
                for (i = 0; i < 10; i++)
                {
                        ...
                        //if (ob->query("story/shenzhao")) continue;                                                
                                
                }
if(!ob) return 1;
        if (ob->query_skill("ningxue-shenzhua", 1) < 380)
                ob->set_skill("ningxue-shenzhua", 380);
