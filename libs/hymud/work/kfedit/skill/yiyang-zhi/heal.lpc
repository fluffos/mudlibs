...
if (target ==me)
{
         if (target->query("qi") >= 18000)
                target->set("qi", 18000);

         if (target->query("eff_qi") >= 18000)
                target->set("eff_qi", 18000);

         if (target->query("jing") >= 18000)
                target->set("jing", 18000);

         if (target->query("eff_jing") >= 18000)
                target->set("eff_jing", 18000);
}

if (target !=me && userp(target))
{
         if (target->query("qi") >= 8000)
                target->set("qi", 8000);

         if (target->query("eff_qi") >= 8000)
                target->set("eff_qi", 8000);

         if (target->query("jing") >= 8000)
                target->set("jing", 8000);

         if (target->query("eff_jing") >= 8000)
                target->set("eff_jing", 8000);
}


if (target !=me && !userp(target))
{
if (target->query("qi",1) < 200000)
{
         if (target->query("qi") >= 180000)
                target->set("qi", 180000);

         if (target->query("eff_qi") >= 180000)
                target->set("eff_qi", 180000);
}
if (target->query("jing",1) < 200000)
{

         if (target->query("jing") >= 180000)
                target->set("jing", 180000);

         if (target->query("eff_jing") >= 180000)
                target->set("eff_jing", 180000);
}                
}
