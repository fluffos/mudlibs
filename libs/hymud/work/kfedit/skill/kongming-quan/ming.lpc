...
*/
        ...
        if( me->query_skill("xiantian-qigong",1) < 100 )
		return notify_fail("你的先天功火候未到，无法施展！\n");
...
if (random(2)==0) target->start_busy(3);
	...
	me->add_temp("apply/damage",  -1800);
                ...
                target->receive_damage("qi", (skill+random(500)) , me);
                target->receive_wound("qi", (skill+random(300)), me);
