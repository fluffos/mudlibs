...
/*			i = 100 + random(time()-who->query( "yunbiao/start" )-who->query( "yunbiao/time" ))/5;
	...
	ob->move(who);
          CHANNEL_D->do_channel("【镖局传闻","林镇南",sprintf(HIR+" who"+"替老夫将镖银押往"+ target[str[ran]] +"的手里～～～\n"));
