...
// Daemons
#define YEER_RPG     "/adm/daemons/yeer_rpg"
...
#define QUEST_D(x)           ("/quest/quest_wei/qlist" + x)
...
#define CHAT_ROOM            "/adm/daemons/chat_room"
