...
string *city_name=({"扬州城","泉州城","襄阳城","灵鹫宫","白驼山","北京城"});
string site_name;
int haojie_times;
...
void haojie_begin(int num)
{
     ...
     message("channel:rumor", HIR"【武林浩劫】"HIW"江湖英雄令"
...
void haojie_new(int num) 
{
     ...
     {
          haojie_times=1;
          message("channel:rumor", HIR"【武林浩劫】经过一段时间的殊死"
...
void haojie_close()
{
   ...
   message("channel:rumor", HIR"【武林浩劫】经过各路武林豪杰的殊死抗争，"
