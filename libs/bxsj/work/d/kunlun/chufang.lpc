...
int do_tap(string arg)
{
	...
	if( !me->query_temp("marks/sit") )
		return notify_fail("你敲了敲桌子，却没想到周围一群人愕然地看着你。\n");

        if( me->query_temp("marks/served") ){
		  message_vision("仆人不耐烦地对$N说道：刚给你上过茶你接着就要，你不累可我累啊！\n", me);
		  return notify_fail("");
	}
...
int valid_leave(object me, string dir)
{
	 ...
	 switch (random(2)){
 	  case 0:
             tell_object(me,"仆人伸手拦住了你：还是先把东西吃完了再走吧。");
	     return notify_fail("\n");
	     break;
	  case 1:
	     tell_object(me,"仆人拦住你道：何掌门吩咐，饮食不得带出茶房。");
	     return notify_fail("\n");
	     break;
	 }
