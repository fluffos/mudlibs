...
void create()
{
	set("short", HIR"猩猩滩"NOR);
	set("long", @LONG
只见一片长滩，山石殷红如血，水流湍急，这便是有名的猩猩滩，对面岸
边停泊着几艘小船(boat) ，要过对面就要靠这几艘小船了。
LONG
	);
	set("outdoors", "黑木崖");
	set("exits", ([ 
...
int du_jiang()
{
	...
	tell_room(environment(me), HIG + me->name() + "捡起一段芦苇抛入水中，紧跟着飞身跃上芦苇，长袖飘飘，渡过了猩猩滩。\n" NOR, ({me}));
	write("你使出「一苇渡江」渡过了猩猩滩。\n");
	me->move(SHIP_TO);
