...
void create()
{
        set("short",HIB"小山洞"NOR);
        set("long",@long
这里是假山里的地下密室。密室虽小，却也五脏俱全，石桌石椅，石几石
床，连室内放的几件器皿，也都是石制的。看来似乎很久以前有人在这里住过。
墙壁(wall)上好象刻着些什么。
long);
        set("item_desc", ([
...
int do_study(string arg)
{
	...
	if ( (int)me->query_skill("sword", 1) < 51 && (int)me->query_skill("sword", 1) >= 31){
...
int do_break(string arg)
{
	...
	message_vision("$N深吸一口气，双掌同时拍出。\n", this_player());

	if (n>=200) {
		message_vision("$N只听一声“轰”的一声，$N把岩石震开了！一个向上的洞口出现在你面前。\n", this_player());
