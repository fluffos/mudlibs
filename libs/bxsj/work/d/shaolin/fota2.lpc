...
void create()
{
	set("short", "圣僧塔");
	set("long", @LONG
本层供奉着少林上代几位有德高僧的灵体法台，塔做六角之形，分六个
方位，分别乃是无色台(wuse),无相牌（wuxiang)，天鸣禅台  (tianming),
苦智灵碑(kuzhi)，苦慧屏(kuhui)，晦智圣座(huizhi)。  几缕天光透过塔
窗洒在塔内，似乎为千年古塔增添了一点活力。   
LONG
	);
