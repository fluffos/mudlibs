...
//        if (ob->query("combat_exp") < 10000)
        ...
        if ((ob->query("family/beggarlvl") == 0
           && count_le(ob->query("combat_exp"), 10000))
           || (ob->query("family/beggarlvl") == 1
           && count_le(ob->query("combat_exp"), 20000))
           || (ob->query("family/beggarlvl") == 2
           && count_le(ob->query("combat_exp"), 50000))
           || (ob->query("family/beggarlvl") == 3
           && count_le(ob->query("combat_exp"), 100000))
           || (ob->query("family/beggarlvl") == 4
           && count_le(ob->query("combat_exp"), 200000))
           || (ob->query("family/beggarlvl") == 5
           && count_le(ob->query("combat_exp"), 300000))
           || (ob->query("family/beggarlvl") == 6
           && count_le(ob->query("combat_exp"), 500000))
           || (ob->query("family/beggarlvl") >= 7
           && count_le(ob->query("combat_exp"), 800000)))
        {
