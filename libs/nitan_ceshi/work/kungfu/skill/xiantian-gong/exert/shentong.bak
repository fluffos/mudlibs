...
int exert(object me, object target)
{
	...
	if( me->query("can_exert/xiantian-gong/shentong") < 60 )
	...
	if( me->query_skill("taoism") < 90 )
        ...
        value = skill * (1 + random(me->query("can_exert/xiantian-gong/shentong") * 5));
...
//	disabled adding jingli since player exploiting this to add max jingli
        ...
        me->add_temp( "apply/unarmed_damage",value/500  );
