...
{        
   ...
   printf(HIC"≡"HIY"────────────────────────────"HIC"≡\n"NOR);
    ...
    printf(HIC" 〖食物〗%s%6d/%6d [%3d%%]\n"NOR,status_color(my["food"],max_food_capacity()),my["food"], max_food_capacity(),my["food"]*100/max_food_capacity());
    ...
    printf(HIC" 〖饮水〗%s%6d/%6d [%3d%%]\n"NOR,status_color(my["water"], max_water_capacity()), my["water"], max_water_capacity(),my["water"]*100/max_water_capacity());
