  ...
  for (i = 1; i <= times; i++) {
    ...
    if (learn_pot > 0) {
      if (item == 22) {
        me->improve_skill(
          skill_name[item],
          random((int)me->query("ker")) + (10 + random((int)me->query_int() - 9)) / 200
        );
        ...
        me->improve_skill(
          skill_name[item],
          random((int)me->query("ker")) + (10 + random((int)me->query_int() - 9)) / 20
        );
        me->add("qi", -random(me->query("int")));
        success = 1;
        ...
        me->improve_skill(
          skill_name[item],
          random((int)me->query("ker")) + (10 + random((int)me->query_int() - 9)) / 10
        );
        me->add("qi", -random(me->query("int")));
        success = 1;
      } else if (me->query("combat_exp") > 150000000) {
        ...
        me->improve_skill(
          skill_name[item],
          random((int)me->query("ker")) + (10 + random((int)me->query_int() - 9)) / 18
        );
        me->add("qi", -random(me->query("int")));
        success = 1;
      }
