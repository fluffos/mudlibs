...
//                      "filter":1,
    ...
    "chat": ([  "msg_speak": MAG+"【"+HIG"江湖风云"NOR+MAG"】%s：%s\n" NOR,
            "msg_emote": HIC+"【"+HIG"江湖风云"NOR+MAG"】"+"%s" NOR,
            "msg_color": NOR+HIY,            
        ]),

    "new": ([  "msg_speak": HIM+"【"+HIW+"初入江湖"+HIM+"】%s：%s\n" NOR,
            "msg_emote": HIM+"【"+HIY+"初入江湖"+HIM+"】"+HIM+"%s" NOR,
            "msg_color": NOR+CYN,                      
        ]),
    ...
    "es":   ([  "msg_speak": HIC+"【"+HIB+"天涯海角"+HIC"】"+HIC+"%s：%s\n" NOR,
            "msg_emote": HIC+"【"+HIB+"天涯海角"+HIC+"】"+HIC+"%s" NOR,
            "msg_color": NOR+HIB,
            "intermud": GCHANNEL,
            "intermud_emote": 1,
            "channel": "es",
     	...
     	"jh":   ([     "msg_speak": WHT "【江湖】"+NOR+WHT+"%s：%s\n" NOR,
            		"msg_emote": WHT "【江湖】"+NOR+WHT+"%s" NOR,
            		"msg_color": NOR+WHT,

        	]),        
   "jhwiz":   ([   "msg_speak": HIR "【江湖巫师】"+NOR+WHT+"%s：%s\n" NOR,
            		"msg_emote": HIR "【江湖巫师】"+NOR+WHT+"%s" NOR,
            		"msg_color": NOR+WHT,
            		"wiz_only": 1,
            		"intermud": GCHANNEL,
            		"intermud_emote": 1,
      ...
      if (time() - (int)me->query("chblk_channel") < 3600)
         ...
         switch (verb){
                ...
                case "chat"  : if (time() - (int)me->query("chblk_channel/chat") < 3600)
                        return notify_fail("你的聊天频道被关闭了！\n");
                    break;
                case "shout" : if (time() - (int)me->query("chblk_channel/shout") < 3600)
                        return notify_fail("你的门派频道被关闭了！\n");
                    break;
                case "es"    : if (time() - (int)me->query("chblk_channel/es") < 3600)
                        return notify_fail("你的网际闲聊频道被关闭了！\n");
                    break;
                case "jhfy"    : if (time() - (int)me->query("chblk_channel/ldj") < 3600)
                        return notify_fail("你的江湖风云频道被关闭了！\n");
                    break;
                }
        }
