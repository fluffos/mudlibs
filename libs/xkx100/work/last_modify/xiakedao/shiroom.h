...
int do_study(string arg)
{
	...
	if ( stringp( me->query( "xkd/skill" ) ) && skill_name[item] != me->query( "xkd/skill" ) )
	{
		write( "学武最忌三心二意，你还是专心钻研" + to_chinese( me->query( "xkd/skill" ) ) + "去吧。\n" );
		return 1;
	}
	me->set( "xkd/skill", skill_name[item] );
