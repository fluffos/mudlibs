...
由 Coollizard 与 xkx100 团队制作于 2003-2004 年，曾运营于 yoyo.xm.fj.cn/xkx100，与另外单独完成的 GitHub `fluffos/xkx100` 仓库是完全不同的代码库，只是恰好同名。它的地图规模在同类档案里数一数二：从长安、洛阳、大理、襄阳等中原城池，一路延伸到漠北草原、哈萨克斯坦、台湾等边疆/海外场景，几乎覆盖了整个古代中国的地理版图。角色创建也格外精细——可从五个出生地中挑选一个、自由分配属性点，并从一份性格特质菜单里挑选角色的个性，比常见的"选性别就完事"要丰富得多。
