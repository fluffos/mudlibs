#include <ansi.h>
#include <combat.h>
string query_name() { return MAG"雾"; }
...
int perform(object me, object target)
{
	...
	if( (int)me->query_skill("qiulin-shiye", 1) < 60 )
	...
	if( (int)me->query_skill("biyun-xinfa", 1) < 60 )
        ...
        if (me->query_skill_mapped("dodge") != "qiulin-shiye")
     ...
     msg = HIW"$N身形如竹叶飞舞，随风绕着圈出招飘动，" +
      ...
      improve = (int)me->query_dex() * 3;
//      me->add_temp("apply/dodge", improve);
//      me->add_temp("apply/defense", improve);
      
      me->set_temp("tmwu",1);  
      me->add("neili", -(350-(int)me->query_skill("qiulin-shiye",1)/10));    
            
      me->start_call_out( (: call_other, __FILE__, "remove_effect", me, improve :), me->query_skill("qiulin-shiye") * 2/3 );
      return 1;
}
