...
string name() { return HIR "修罗炼狱" NOR; } 
string query_name() { return "修罗"ZJBR"炼狱"; }
int perform(object me, object target)
{
        ...
        sexs=me->query("gender") == "男性"?"修罗神般威武":"修罗女神般曼妙多姿";
        ...
        {
                damage = me->query_skill("lunhui-sword"); 
                damage *= 3;
                me->add("neili", -2000);
                ...
                if (random(3) == 1)
                {
                        target->receive_damage("jing", damage / 35, me);
                        target->receive_wound("jing", damage / 35, me);
