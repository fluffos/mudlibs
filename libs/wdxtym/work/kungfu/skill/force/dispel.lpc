...
int exert(object me, object target)
{
	...
	if (me == target)
	{
		...
		tell_object(me, YEL "你默运" + force_name + "，开始排除身体中的异常症状。"NOR"\n");
		 me->add("neili", -100);
	} else
	{
		message_vision(HIW "$N" HIW "深吸一口气，将手掌粘到$n" HIW "的背后。"NOR"\n",
			       me, target);
		tell_object(me, YEL "你默运" + force_name + "，开始帮助" + target->name() + "排除身体中的异常症状。"NOR"\n");
		tell_object(target, YEL + me->name() + "正在运功帮助你排除身体中的异常症状。"NOR"\n");
		me->add("neili", -250);
	}
