...
string query_name() { return "御剑"ZJBR"飞升"; }
...
int perform(object me, object target)
{
        ...
        if( me->query_temp("jueji/sword/feisheng") )
                return notify_fail( WHT "你无法连续使用「御剑飞升」绝迹！\n" NOR );
        ...
        damage = (int)me->query_skill("sword") +
                 ...
                 (int)me->query_skill("xianfeng-spells", 1) +
...
int perform2(object me, object target)
{
	...
	||	(int)me->query("neili") < 150 )
        {
                write(HIW "你剑至中途，可怎奈内息或法力不足，只好停止御剑。\n" NOR);
                call_out("end_perform2", 30, me, weapon, damage); 
                return 1;
        }
