...
lvl = (int)me->query_skill("xiuxian-gongfa", 1);
...
string main_skill()
{
return "xiuxian-gongfa";
}

mapping sub_skills = ([
"taiyan-dijing": 12000,
"wushang-jianjing": 12000,
"douzhan-shengjing": 12000,
"shanggu-mijing": 12000,
"lianyu-mojing": 12000,
]);
...
dp = me->query_skill("xiuxian-gongfa", 1);
...
lvl = me->query_skill("xiuxian-gongfa", 1);
...
{
return __DIR__"xiuxian-gongfa/perform/" + action;
}

string exert_function_file(string action)
{
return __DIR__"xiuxian-gongfa/exert/" + action;
}
