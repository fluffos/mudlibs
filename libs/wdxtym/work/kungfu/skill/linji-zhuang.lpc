...
void skill_improved(object me)
{
	...
	{
	case 30:
		tell_object(me, HIG "你已经把天地庄练成了！"NOR"\n" );
		break;
	case 60:
		tell_object(me, HIG "你已经把之心庄练成了！"NOR"\n" );
		break;
	case 90:
		tell_object(me, HIG "你已经把龙鹏庄练成了！"NOR"\n" );
		break;
	case 120:
		tell_object(me, HIG "你已经把风云庄练成了！"NOR"\n" );
		break;
	case 150:
		tell_object(me, HIG "你已经把大小庄练成了！"NOR"\n" );
		break;
	case 180:
		tell_object(me, HIG "你已经把幽冥庄练成了！"NOR"\n" );
		break;
	}
	return;
}
