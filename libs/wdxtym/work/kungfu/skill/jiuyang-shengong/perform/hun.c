...
string query_name() { return "混沌"ZJBR"一阳"; }
int perform(object me, object target)
{
        ...
        if (userp(me) && ! me->query("can_perform/jiuyang-shengong/hun"))
                return notify_fail("你还没有受过高人指点，无法施展" HUN "。\n");
        ...
        ap = me->query_skill("force") + me->query_con();
        dp = target->query_skill("force") + target->query_con();
