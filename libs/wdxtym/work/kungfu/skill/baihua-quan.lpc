...
string query_txt()
{
	return "要求：空手，基本内功150，内力1500，臂力28，悟性28，等级不能超过基本拳脚、拳法、掌法、爪法和手法";
}
...
int valid_learn(object me)
{
	...
	if ((int)me->query("str") < 28)
		return notify_fail("你先天臂力不足，无法学习百花错拳。\n");

	if ((int)me->query("int") < 28)
		return notify_fail("你先天悟性不足，无法学习百花错拳。\n");
	...
	if ((int)me->query_skill("unarmed", 1) < (int)me->query_skill("baihua-quan", 1))
