...
string query_name() { return "远古"ZJBR"战影"; }
...
int perform(object me, object target)
{
        ...
        if (lvl < 100)
                return notify_fail("你太始帝经火候不够，难以施展" TIAN "。\n");
        ...
        ap = me->query_skill("force") + me->query_skill("yinyangjiuzhuanshierchongtian", 1);
