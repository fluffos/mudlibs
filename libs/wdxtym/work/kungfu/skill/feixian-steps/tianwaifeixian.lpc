...
int perform(object me, object target)
{
	...
	/*if (! me->query("family/family_name") ||
            me->query("family/family_name") != "白云城")
                return notify_fail("天外飞仙只有白云城的人能用！\n");*/
	...
	extra = me->query_skill("feixian-sword",1) / 24;
	extra += me->query_skill("feixian-steps",1) /24;
