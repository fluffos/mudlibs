...
mapping *action = ({
([      "action" : "$N手中$w横推，使出一招破海,由上至下向$n砍去",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
([      "action" : "$N一招山崩,刀锋自下而上划了个半弧，$w一提一收，平刃挥向$n的颈部",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
([      "action" : "$N一招灭地，左脚跃步落地，$w顺势往前，挟风声劈向$n的$l",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
([      "action" : "$N蓦的使一招吞天，顿时刀光中无数朵刀花从四面八方涌向$n全身",
	"force"  : 600,
	"attack" : 600,
	"parry"  : 600,
	"dodge"  : 600,
...
int get_finish(object me)
{
        ...
        {
                tell_object(me, "你觉得有所感悟，或许再演练一次就能融会贯通，练成天道刀。\n");
                return 0;
        }
        ...
        CHANNEL_D->do_channel(this_object(), "rumor", "听说" + me->name() + "演练出"HIY"天道刀"HIM"。\n");
        return 1;
}
...
int valid_learn(object me)
{
	...
	if ((int)me->query_skill("blade", 1) < (int)me->query_skill("tiandaodao", 1))
		return notify_fail("你的基本刀法水平有限。\n");
...
mixed hit_ob(object me, object victim, int damage_bonus)
{
	...
	if (i > 100)
	{
		if (i < 200)
		{
			...
			return HIC "只见$N" HIC "身形一探，刀芒陡涨，正中$n！"NOR"\n";
		}
		if (i < 400)
		{
			victim->receive_wound("qi", damage_bonus / 2);
			return HIY "只看$N" HIY "一声清啸，刀气横飞，$n" HIY "连连中招！"NOR"\n";
		} else
		{
			victim->receive_wound("qi", damage_bonus);
			return HIW "但见$N" HIW "微微一笑，缓缓移动天刀，$n" HIW "已然中招！"NOR"\n";
		}
	}
}
...
{
   int i, j, level;
   level   = (int) me->query_skill("tiandaodao",1);
...
{
	return __DIR__"tiandaodao/" + action;
}
