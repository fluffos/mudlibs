...
LONG );
	...
	set_skill("huagong-dafa", 22000);
	set_skill("guixi-gong", 20000);
	set_skill("throwing", 20010);
	set_skill("feixing-shu", 21000);
	set_skill("dodge", 18000);
	set_skill("zhaixinggong", 18000);
	set_skill("strike", 18005);
	set_skill("chousui-zhang", 18005);
	set_skill("claw", 18000);
	set_skill("sanyin-wugongzhao", 10080);
	set_skill("whip", 10080);
	set_skill("chanhun-suo", 18000);
	set_skill("parry", 18005);
	set_skill("staff", 19000);
	set_skill("poison", 20055);
	set_skill("tianshan-zhang", 19000);
	set_skill("literate", 120);
	set_skill("medical", 26005);
	set_skill("xingxiu-qishu", 26500);
...
void attempt_apprentice(object me)
{
	...
	} else
	{
		...
		message_vision("星宿老怪微闭双眼，手捻长须，一副等人"ZJURL("cmds:flatter 星宿老仙 德配天地 威震寰宇 古今无比")+ZJSIZE(20)+"拍马屁"NOR"(flatter)的样子。\n",
		this_player());
