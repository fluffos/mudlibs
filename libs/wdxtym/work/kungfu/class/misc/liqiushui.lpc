...
void create()
{
	...
	set_skill("dodge", 2720);
	set_skill("lingbo-weibu", 2270);
	set_skill("liuyang-zhang", 2240);
	set_skill("parry", 2270);
	set_skill("zhemei-shou", 2240);
	set_skill("hand", 2420);
	set_skill("strike", 2240);
	set_skill("literate", 2200);
	set_skill("medical", 2290);
	set_skill("xiaoyao-qixue", 2290);
