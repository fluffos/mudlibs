...
void attempt_apprentice(object ob)
{
	...
	if((int)ob->query("combat_exp") < 200000)
	{
		...
		command("say 你的修为还不够，先和我的侄儿欧阳克学习武功吧。");
		return ;
	}
...
mixed ask_me()
{
	...
	tell_object(me, HIG "你学会了千蛇出洞。"NOR"\n");
...
mixed ask_wanshi()
{
	...
	message_vision(HIY "$n" HIY "微微颔首，随手拣起一根木条点向$N"
		       ...
		       "来，$P" HIY "大吃一惊，慌乱不迭。"NOR"\n",
		       me, this_object());
	command("smile");
	command("say 你可明白了？");
	tell_object(me, HIG "你学会了千蛇万噬。"NOR"\n");
	if (me->can_improve_skill("staff"))
