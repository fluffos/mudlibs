...
LONG );
	...
	set_skill("zhemei-shou", 2500);
	set_skill("liuyang-zhang", 2500);
	set_skill("yueying-wubu", 2400);
	set_skill("bahuang-gong", 2070);
	set_skill("tianyu-qijian", 2400);
	set_skill("lingjiu-xinfa", 1200);
...
void attempt_apprentice(object ob)
{
	...
	{
		command("say 你实战修为不足，还是好好锻炼一下再说吧。");
		return;
	}
