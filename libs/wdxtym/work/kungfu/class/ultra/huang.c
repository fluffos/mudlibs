...
int accept_kill(object me)
{
	...
	{
		message_vision("$N大怒道：“无名小辈捣什么乱？给我滚！”说罢一掌把$n劈倒在地。\n",
			       this_object(), me);
		me->unconcious();
		return -1;
	}
...
int recognize_apprentice(object me, string skill)
{
	...
	{
		command("say 大丈夫处世，不论善恶行事一定要光明磊落，你生性不是这种人。");
		return -1;
	}
	...
	if (! ultrap(me))
	{
		command("say 想学我的九阴神功？你还不够资格，等你成了大宗师再说吧！");
		return -1;
	}
	...
	command("nod");
	command("say 很好，我就传你九阴神功吧，可不要忘记做人的根本！");
	return 1;
}
