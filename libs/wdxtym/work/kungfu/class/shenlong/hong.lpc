...
void create()
{
	...
	set("inquiry", ([
		"神龙教" : "一般人是入不了我神龙教的"ZJURL("cmds:join shenlongjiao")+ZJSIZE(20)+"入教"NOR"(join shenlongjiao)。",
		"入教"   : "一般人是入不了我神龙教的"ZJURL("cmds:join shenlongjiao")+ZJSIZE(20)+"入教"NOR"(join shenlongjiao)。",
		"洪安通" : "你不想活了是不是？",
		"教主"   : "我就是神龙教教主。",
		"绝招"   : "你想学什么绝技啊？",
		"绝技"   : "你想学什么绝技啊？",
...
int do_flatter(string arg)
{
	...
	message_vision(CYN "$N大声说道：" + arg + ""NOR"\n",
		       this_player());
...
mixed ask_fei()
{
	...
	tell_object(me, HIG "你学会了飞仙术。"NOR"\n");
...
mixed ask_xian()
{
	...
	tell_object(me, HIG "你学会了神龙再现。"NOR"\n");
	if (me->can_improve_skill("sword"))
		me->improve_skill("sword", 90000);
...
mixed ask_cui()
{
	...
	tell_object(me, HIG "你学会了摧心断肠。"NOR"\n");
	if (me->can_improve_skill("sword"))
		me->improve_skill("sword", 90000);
	if (me->can_improve_skill("staff"))
		me->improve_skill("staff", 90000);
...
void attempt_apprentice(object ob)
{
	...
	} else
	{
		...
		message_vision("洪安通微闭双眼，手捻长须，一副"
			       "等人拍马"ZJURL("cmds:flatter 万年不老 永享仙福 寿与天齐 文武仁圣")+ZJSIZE(20)+"拍马屁"NOR"(flatter)的样子。\n",
			       this_player());
