...
void create()
{
	...
	set_skill("taiji-shengong", 3000);
	set_skill("wudang-xinfa", 3000);
	set_skill("dodge", 2600);
	set_skill("tiyunzong", 2060);
	set_skill("unarmed", 2090);
	set_skill("taiji-quan", 2900);
	set_skill("strike", 2900);
	set_skill("wudang-zhang", 2090);
	set_skill("hand", 2900);
	set_skill("paiyun-shou", 2900);
	set_skill("parry", 3000);
	set_skill("sword", 3000);
	set_skill("wudang-jian", 3000);
	set_skill("taiji-jian", 3000);
	set_skill("blade", 260);
	set_skill("taiji-dao", 2060);
...
void attempt_apprentice(object ob)
{
	...
	{
		command("say 你现在修为尚浅，不能领会高深的武功，先锻炼要紧。");
		return;
	}
