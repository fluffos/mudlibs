...
void create()
{
	...
	set_skill("dodge", 1205);
	set_skill("shaolin-shenfa", 1205);
	set_skill("parry", 1205);
	set_skill("cuff", 1250);
	set_skill("club", 1205);
	set_skill("finger", 1250);
	set_skill("strike", 1250);
	set_skill("jingang-quan", 1250);
	set_skill("wuchang-zhang", 1205);
	set_skill("yizhi-chan", 1205);
	set_skill("banruo-zhang", 1205);
	set_skill("buddhism", 125);
	set_skill("literate", 125);
	set_skill("medical", 180);
	set_skill("shaolin-yishu", 1800);
