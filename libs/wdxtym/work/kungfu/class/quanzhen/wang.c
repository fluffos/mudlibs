...
void create()
{
	...
	set_skill("quanzhen-xinfa", 2800);
	set_skill("xiantian-gong", 2080);
	set_skill("sword", 2060);
	set_skill("quanzhen-jian",2060);
	set_skill("dodge", 2060);
	set_skill("jinyan-gong", 2600);
	set_skill("parry", 2080);
	set_skill("jinguan-yusuo", 2080);
	set_skill("strike", 2600);
	set_skill("chongyang-shenzhang", 2600);
	set_skill("haotian-zhang", 0260);
	set_skill("literate", 200);
	set_skill("finger", 2060);
	set_skill("taoism", 300);
	set_skill("finger", 2060);
	set_skill("zhongnan-zhi", 2600);
	set_skill("sun-finger", 2600);
	set_skill("medical", 2800);
	set_skill("liandan-shu", 2800);
...
void attempt_apprentice(object ob)
{
	...
	{
		command("say 你的实战修为太差，看来难以领略更高深的武功。");
		return;
	}
