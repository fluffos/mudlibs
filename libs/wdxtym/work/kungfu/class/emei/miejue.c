...
void create()
{
	...
	set_skill("throwing", 2010);
	set_skill("force", 2200);
	set_skill("dodge", 2000);
	set_skill("finger", 1900);
	set_skill("parry", 2020);
	set_skill("strike", 1090);
	set_skill("sword", 2200);
	set_skill("blade", 2000);
	set_skill("literate", 120);
	set_skill("mahayana", 220);
	set_skill("buddhism", 210);
	set_skill("jinding-zhang", 1900);
	set_skill("tiangang-zhi", 1900);
	set_skill("huifeng-jian", 2020);
	set_skill("yanxing-dao", 2000);
	set_skill("zhutian-bu", 2000);
	set_skill("emei-xinfa", 2020);
	set_skill("linji-zhuang", 2020);
	set_skill("piaoxue-zhang", 2200);
