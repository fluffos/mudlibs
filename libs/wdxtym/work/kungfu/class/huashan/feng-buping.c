...
void create()
{
	...
	set_skill("huashan-sword", 9999);
	set_skill("kuangfeng-jian", 9999);
	set_skill("huashan-xinfa", 9999);
	set_skill("huashan-quanfa", 9999);
	set_skill("huashan-zhangfa", 9999);
	set_skill("huashan-shenfa", 9999);
