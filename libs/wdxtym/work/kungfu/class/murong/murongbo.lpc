...
LONG );
	...
	set_skill("cibei-dao", 2500);
	set_skill("damo-jian", 2500);
	set_skill("fengyun-shou", 2500);
	set_skill("fumo-jian", 2050);
	set_skill("hunyuan-yiqi", 2500);
	set_skill("shaolin-xinfa", 2500);
	set_skill("jingang-quan", 2500);
	set_skill("longzhua-gong", 2500);
	set_skill("luohan-quan", 2500);
	set_skill("nianhua-zhi", 2500);
	set_skill("pudu-zhang", 2500);
	set_skill("qianye-shou", 2500);
	set_skill("sanhua-zhang", 2500);
	set_skill("riyue-bian", 2050);
	set_skill("shaolin-shenfa", 2500);
	set_skill("weituo-gun", 2050);
	set_skill("wuchang-zhang", 2500);
	set_skill("xiuluo-dao", 2500);
	set_skill("yingzhua-gong", 2500);
	set_skill("yizhi-chan", 2500);
	set_skill("zui-gun", 2500);

	// murong skill
	set_skill("zihui-xinfa", 2700);
	set_skill("douzhuan-xingyi", 2700);
	set_skill("beidou-xianzong", 2700);
	set_skill("canhe-zhi", 2700);
	set_skill("qixing-quan", 2700);
	set_skill("murong-sword", 2700);
...
void attempt_apprentice(object ob)
{
	...
	if((int)ob->query("combat_exp") < 200000)
	{
		...
		command("say 你的修为还不够，先和我儿慕容复学习吧！");
		return ;
	}
