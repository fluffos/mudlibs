...
int do_heal(string arg)
{
	...
	tell_object(me, HIC "在实践过程中你的「针灸术」提高了！"NOR"\n");

	if (me == ob) s = "$N";
		 else s = "$n";

	msg = HIW "$N" HIW "手捏银针，小心翼翼地向" + s + HIW "的穴道刺去，"NOR"\n";
	...
	} else
	{
		    ...
		    ! flag)
		{
			...
			tell_object(me, HIC "你获得了" + chinese_number(exp) +
				"点修为和" + chinese_number(pot) + "点潜能。"NOR"\n");
		}
