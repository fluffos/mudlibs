...
void create()
{
	...
	set("max_qi", 50000000000000000);
	set("max_jing", 50000000000000000);
	set("qi", 50000000000000000);
	set("jing", 50000000000000000);
	set("neili", 50000000000000000);
	set("max_neili", 50000000000000000);
...
*/
        ...
        me->add("gongji",5);
		me->add("disha_jifen11",15);
      if(me->query("huoyuedian")<80)
{
      me->add("huoyuedian",5);
}

 		obj = new("/clone/8yue/tiangang");
		obj->set_amount(1);
        obj->move(me);		
