...
set("title", HIY"È«Õæ°ÜÀà"NOR);
   set("gender", "ÄÐÐÔ" );
 set("long",
"ÒòÆÛÊ¦Ãð×æ±»Öð³öÊ¦ÃÅµÄÈ«Õæ¸ßÊÖ¡£\n");
        set("attitude", "aggressive");
        set("vendetta/authority",1);
	  set("force_factor",100+random(200));
  set("max_qi",28500+random(2000));
  set("max_jing",28500+random(2000));
  set("max_sen",28500+random(2000));
  set("max_neili",18500+random(2000));
  set("max_mana",18500+random(2000));
  set("eff_neili",18500+random(2000));
  set("neili",8500+random(2000));
        set("per", 1);
        set("age", 32);
...
if (!me) return;
     ...
     message("vision", me->name() + "Îª½­ºþ³ýº¦,Ôö¼ÓÁË4000ÐÞÎªºÍ1500Ç±ÄÜ¡£\n", me);
