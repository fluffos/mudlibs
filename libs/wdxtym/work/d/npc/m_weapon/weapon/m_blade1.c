...
//读入数据
	...
	if( me->query("weapon/wield_msg"))
		...
		set("wield_msg", "$N往腰中一抽，拔出了一把"+name+"在手中。\n");
...
else if (me->query("weapon/pin") == "孤星二十九阶")
		init_blade(w_lv * 105 *dj);					
else if (me->query("weapon/pin") == "孤星三十阶")
		init_blade(w_lv * 106 *dj);					
else if (me->query("weapon/pin") == "孤星三十一阶")
		init_blade(w_lv * 107 *dj);					
else if (me->query("weapon/pin") == "孤星三十二阶")
		init_blade(w_lv * 108 *dj);					
else if (me->query("weapon/pin") == "孤星三十三阶")
		init_blade(w_lv * 109 *dj);					
 if (me->query("weapon/pin") == "孤星三十四阶")
		init_blade(w_lv * 110 *dj);	
else if (me->query("weapon/pin") == "孤星三十五阶")
		init_blade(w_lv * 111 *dj);					
else if (me->query("weapon/pin") == "孤星三十六阶")
		init_blade(w_lv * 112 *dj);					
else if (me->query("weapon/pin") == "孤星三十七阶")
		init_blade(w_lv * 113 *dj);					
else if (me->query("weapon/pin") == "孤星三十八阶")
		init_blade(w_lv * 114 *dj);					
else if (me->query("weapon/pin") == "孤星三十九阶")
		init_blade(w_lv * 115 *dj);					
else if (me->query("weapon/pin") == "孤星四十阶")
		init_blade(w_lv * 116 *dj);					
else if (me->query("weapon/pin") == "孤星四十一阶")
		init_blade(w_lv * 117 *dj);					
else if (me->query("weapon/pin") == "孤星四十二阶")
		init_blade(w_lv * 118 *dj);					
else if (me->query("weapon/pin") == "孤星四十三阶")
		init_blade(w_lv * 119 *dj);					
else if (me->query("weapon/pin") == "孤星四十四阶")
		init_blade(w_lv * 120 *dj);					
else if (me->query("weapon/pin") == "孤星四十五阶")
		init_blade(w_lv * 121 *dj);					
else if (me->query("weapon/pin") == "孤星四十六阶")
		init_blade(w_lv * 122 *dj);					
else if (me->query("weapon/pin") == "孤星四十七阶")
		init_blade(w_lv * 123 *dj);					
else if (me->query("weapon/pin") == "孤星四十八阶")
		init_blade(w_lv * 124 *dj);					
else if (me->query("weapon/pin") == "孤星四十九阶")
		init_blade(w_lv * 125 *dj);					
else if (me->query("weapon/pin") == "孤星五十阶")
		init_blade(w_lv * 126 *dj);					
else if (me->query("weapon/pin") == "孤星五十一阶")
		init_blade(w_lv * 127 *dj);					
else if (me->query("weapon/pin") == "孤星五十二阶")
		init_blade(w_lv * 128 *dj);					
else if (me->query("weapon/pin") == "孤星五十三阶")
		init_blade(w_lv * 129 *dj);					
else if (me->query("weapon/pin") == "孤星五十四阶")
		init_blade(w_lv * 130 *dj);					
else if (me->query("weapon/pin") == "孤星五十五阶")
		init_blade(w_lv * 131 *dj);					
else if (me->query("weapon/pin") == "孤星五十六阶")
		init_blade(w_lv * 132 *dj);					
else if (me->query("weapon/pin") == "孤星五十七阶")
		init_blade(w_lv * 133 *dj);					
else if (me->query("weapon/pin") == "孤星五十八阶")
		init_blade(w_lv * 134 *dj);					
else if (me->query("weapon/pin") == "孤星五十九阶")
		init_blade(w_lv * 135 *dj);					
else if (me->query("weapon/pin") == "孤星六十阶")
		init_blade(w_lv * 136 *dj);						
else if (me->query("weapon/pin") == "孤星六十一阶")
		init_blade(w_lv * 137 *dj);						
else if (me->query("weapon/pin") == "孤星六十二阶")
		init_blade(w_lv * 138 *dj);						
else if (me->query("weapon/pin") == "孤星六十三阶")
		init_blade(w_lv * 139 *dj);						
else if (me->query("weapon/pin") == "孤星六十四阶")
		init_blade(w_lv * 140 *dj);						
else if (me->query("weapon/pin") == "孤星六十五阶")
		init_blade(w_lv * 141 *dj);						
else if (me->query("weapon/pin") == "孤星六十六阶")
		init_blade(w_lv * 142 *dj);						
else if (me->query("weapon/pin") == "孤星六十七阶")
		init_blade(w_lv * 143 *dj);						
else if (me->query("weapon/pin") == "孤星六十八阶")
		init_blade(w_lv * 144 *dj);			
else if (me->query("weapon/pin") == "孤星六十九阶")
		init_blade(w_lv * 145 *dj);		
else if (me->query("weapon/pin") == "孤星七十阶")
		init_blade(w_lv * 146 *dj);			
else if (me->query("weapon/pin") == "孤星七十一阶")
		init_blade(w_lv * 147 *dj);			
else if (me->query("weapon/pin") == "孤星七十二阶")
		init_blade(w_lv * 148 *dj);			
else if (me->query("weapon/pin") == "孤星七十三阶")
		init_blade(w_lv * 149 *dj);			
else if (me->query("weapon/pin") == "孤星七十四阶")
		init_blade(w_lv * 150 *dj);			
else if (me->query("weapon/pin") == "孤星七十五阶")
		init_blade(w_lv * 151 *dj);			
else if (me->query("weapon/pin") == "孤星七十六阶")
		init_blade(w_lv * 152 *dj);			
else if (me->query("weapon/pin") == "孤星七十七阶")
		init_blade(w_lv * 153 *dj);			
else if (me->query("weapon/pin") == "孤星七十八阶")
		init_blade(w_lv * 154 *dj);			
else if (me->query("weapon/pin") == "孤星七十九阶")
		init_blade(w_lv * 155 *dj);			
else if (me->query("weapon/pin") == "孤星八十阶")
		init_blade(w_lv * 156 *dj);			
else if (me->query("weapon/pin") == "孤星八十一阶")
		init_blade(w_lv * 157 *dj);			
else if (me->query("weapon/pin") == "孤星八十二阶")
		init_blade(w_lv * 158 *dj);			
else if (me->query("weapon/pin") == "孤星八十三阶")
		init_blade(w_lv * 159 *dj);			
else if (me->query("weapon/pin") == "孤星八十四阶")
		init_blade(w_lv * 160 *dj);			
else if (me->query("weapon/pin") == "孤星八十五阶")
		init_blade(w_lv * 161 *dj);			
else if (me->query("weapon/pin") == "孤星八十六阶")
		init_blade(w_lv * 162 *dj);			
else if (me->query("weapon/pin") == "孤星八十七阶")
		init_blade(w_lv * 163 *dj);			
else if (me->query("weapon/pin") == "孤星八十八阶")
		init_blade(w_lv * 164 *dj);														
else if (me->query("weapon/pin") == "孤星八十九阶")
		init_blade(w_lv * 165 *dj);				
else if (me->query("weapon/pin") == "孤星九十阶")
		init_blade(w_lv * 166 *dj);				
 if (me->query("weapon/pin") == "淬金一阶")
		init_blade(w_lv * 167 *dj);		
else if (me->query("weapon/pin") == "淬金二阶")
		init_blade(w_lv * 168 *dj);		
else if (me->query("weapon/pin") == "淬金三阶")
		init_blade(w_lv * 169 *dj);		
else if (me->query("weapon/pin") == "淬金四阶")
		init_blade(w_lv * 170 *dj);		
else if (me->query("weapon/pin") == "淬金五阶")
		init_blade(w_lv * 171 *dj);		
else if (me->query("weapon/pin") == "淬金六阶")
		init_blade(w_lv * 172 *dj);		
else if (me->query("weapon/pin") == "淬金七阶")
		init_blade(w_lv * 173 *dj);		
else if (me->query("weapon/pin") == "淬金八阶")
		init_blade(w_lv * 174 *dj);		
else if (me->query("weapon/pin") == "淬金九阶")
		init_blade(w_lv * 175 *dj);		
else if (me->query("weapon/pin") == "淬金十阶")
		init_blade(w_lv * 176 *dj);		
else if (me->query("weapon/pin") == "淬金十一阶")
		init_blade(w_lv * 177 *dj);		
else if (me->query("weapon/pin") == "淬金十二阶")
		init_blade(w_lv * 178 *dj);		
else if (me->query("weapon/pin") == "淬金十三阶")
		init_blade(w_lv * 179 *dj);		
else if (me->query("weapon/pin") == "淬金十四阶")
		init_blade(w_lv * 180 *dj);		
else if (me->query("weapon/pin") == "淬金十五阶")
		init_blade(w_lv * 181 *dj);		
else if (me->query("weapon/pin") == "淬金十六阶")
		init_blade(w_lv * 182 *dj);		
else if (me->query("weapon/pin") == "淬金十七阶")
		init_blade(w_lv * 183 *dj);		
else if (me->query("weapon/pin") == "淬金十八阶")
		init_blade(w_lv * 184 *dj);		
else if (me->query("weapon/pin") == "淬金十九阶")
		init_blade(w_lv * 185 *dj);		
else if (me->query("weapon/pin") == "淬金二十阶")
		init_blade(w_lv * 186 *dj);		
else if (me->query("weapon/pin") == "淬金二十一阶")
		init_blade(w_lv * 187 *dj);		
else if (me->query("weapon/pin") == "淬金二十二阶")
		init_blade(w_lv * 188 *dj);		
else if (me->query("weapon/pin") == "淬金二十三阶")
		init_blade(w_lv * 189 *dj);		
else if (me->query("weapon/pin") == "淬金二十四阶")
		init_blade(w_lv * 190 *dj);		
else if (me->query("weapon/pin") == "淬金二十五阶")
		init_blade(w_lv * 191 *dj);		
else if (me->query("weapon/pin") == "淬金二十六阶")
		init_blade(w_lv * 192 *dj);		
else if (me->query("weapon/pin") == "淬金二十七阶")
		init_blade(w_lv * 193 *dj);		
else if (me->query("weapon/pin") == "淬金二十八阶")
		init_blade(w_lv * 194 *dj);		
else if (me->query("weapon/pin") == "淬金二十九阶")
		init_blade(w_lv * 195 *dj);		
else if (me->query("weapon/pin") == "淬金三十阶")
