// ITEM Made by player(仙人:fengfeng) /data/item/f/fengfeng-fyi.c
...
void create()
{
	set_name("[41;1m[1;33m金丹·披风[2;37;0m", ({ "fyi" }));
	set_weight(1);
	set("item_make", 1);
	set("unit", "件");
	set("long", "这是由[1;37m灵石[2;37;0m炼制而成的一件披风。
");
	set("makeinfo", "[1;31m
仙人(fengfeng)[1;31m 装备
[2;37;0m");
	set("value", 10);
	set("point", 500);
