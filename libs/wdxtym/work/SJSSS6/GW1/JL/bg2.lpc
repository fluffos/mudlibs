...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【分神限定】"NOR"分神系列								
"HIG"《套装加成：修仙真法等级+350，攻击力60000》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 6000);
	set("armor_prop/leech_qi", 1);
	set("armor_prop/reduce_poison", 1);
	set("armor_prop/reduce_magic", 1);
	set("armor_prop/unarmed_damage", 6000+lv1+lv2+lv3);
	set("armor_prop/damage", 6000+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","boots");
				 set("suit",HIR"分神套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","分神·护甲");
		set("suit_mod/finger","分神·戒指");
		set("suit_mod/head","分神·头饰");
		set("suit_mod/neck","分神·项链");
		set("suit_mod/pants","分神·护腿");
		set("suit_mod/boots","分神·护靴");
		set("suit_mod/cloth","分神·衣服");
		set("suit_mod/waist","分神·腰带");
		set("suit_mod/wrists","分神·护腕");
		...
		set("suit_eff/strength",random(20)+40);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff/constitution",60);      //3件
		set("suit_eff/spirituality",60);      // 5件
		set("suit_eff/intelligence",60);      //7件
		set("suit_eff/strength",60);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/xiuxian-gongfa",350+me->query("taozhuang/lv"));
	setup();
}
