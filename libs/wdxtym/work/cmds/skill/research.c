...
int main(object me, string arg)
{
	...
	{
		skill = arg;
		return notify_fail(INPUTTXT("请输入研究的等级：","yanjiu "+arg+" $txt#")+"\n");
	}

	if (times < 1 || times > 999999)
		return notify_fail("研究最少1级，最多999999级。\n");
	...
	if (lvl >= 600+lvls)
		return notify_fail("你目前最高可研究到"+(600+lvls)+"级，如需继续提升请前往华山转世。\n");	
	...
	if (lvl > 500)
		improve /= lvl / 100 - 5 + 2;
	if (intlv >23)
		improve += improve*(1)/300;//原300现150
	if (improve < 2)
		improve = 2;
