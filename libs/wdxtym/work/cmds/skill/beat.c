...
int main(object me, string arg)
{
	...
	if (!arg)
	{
	    ...
	    HIR"手 三阳经："NOR""YEL"破甲增加"NOR""+me->query("gain/break")+YEL"点。"NOR""ZJBR
	    HIR"手 三阴经："NOR""YEL"护体增加"NOR""+me->query("gain/armor")+YEL"点。"NOR"\n"
	...
	if ((int)me->query("max_neili") <100)
		return notify_fail(HIR"你现在的内力太少了，无法冲脉。\n"NOR);
