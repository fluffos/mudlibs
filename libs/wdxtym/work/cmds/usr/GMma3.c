...
int main(object me, string arg)
{
        ...
        return notify_fail(INPUTTXT(ZJSIZE(24)HIR"请输入GM码：无限灵石"NOR,"GMma3 $txt#")+"\n");
	    switch (arg) {
	    case "无限灵石" :
		me->add_temp("sword",1);
		write("哦豁！\n");
		message("vision","GM码正确，白日做梦，扣除1000枚灵石以示警戒！"+me->name()+"！\n",me);
		
		break;
	  default :
		return notify_fail("GM码错误，扣除1000枚灵石以示警戒！\n");
