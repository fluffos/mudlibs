...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【炼气限定】"NOR"炼气系列								
"HIG"《套装加成：修仙真法等级+100，攻击力10000》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 1000);
	set("armor_prop/unarmed_damage", 1000+lv1+lv2+lv3);
	set("armor_prop/damage", 1000+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","boots");
				 set("suit",HIR"炼气套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","炼气·护甲");
		set("suit_mod/finger","炼气·戒指");
		set("suit_mod/head","炼气·头饰");
		set("suit_mod/neck","炼气·项链");
		set("suit_mod/pants","炼气·护腿");
		set("suit_mod/boots","炼气·护靴");
		set("suit_mod/cloth","炼气·衣服");
		set("suit_mod/waist","炼气·腰带");
		set("suit_mod/wrists","炼气·护腕");
		...
		set("suit_eff/strength",random(20)+40);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff/constitution",10);      //3件
		set("suit_eff/spirituality",10);      // 5件
		set("suit_eff/intelligence",10);      //7件
		set("suit_eff/strength",10);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/xiuxian-gongfa",100+me->query("taozhuang/lv"));
	setup();
}
