...
if (me)
{
        if (userp(me))
{
if (me->query("family/family_name")!= ob->query("family/family_name")){message("vision", me->name() + "Ôö¼ÓÁË300ÐÞÎªºÍ200Ç±ÄÜ¡£\n", me);
        
        
        message("vision", me->name() + "Ôö¼ÓÁË300ÐÞÎªºÍ200Ç±ÄÜ¡£\n", me);
