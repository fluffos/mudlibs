...
//        if( i < 100) i = 100;
        ...
        ob->set_skill("force", i/2);
        ob->set_skill("sword", i/2);
        ob->set_skill("unarmed", i/2);
        ob->set_skill("cuff",  i/2);
	ob->set_skill("blade", i/2);
        ob->set_skill("dodge", i/2);
        ob->set_skill("parry", i/2);
        ob->set_skill("taiji-shengong", i/2);
        ob->set_skill("wuxing-dun", i/2);
        ob->set_skill("shiren-jianfa", i/2);
        ob->set_skill("shiren-quanfa", i/2);
        set_skill("taiji-shengong",i/2);
...
if (random(10)>8)
{
	...
	ob->set_skill("blade", i*2/3);
        ...
        ob->set_skill("taiji-shengong", i*2/3);
        ob->set_skill("shiren-jianfa", i*2/3);
        ob->set_skill("shiren-quanfa", i*2/3);
        ob->set_skill("wuxing-dun", i*2/3);
        set_skill("taiji-shengong",i*2/3);
}
