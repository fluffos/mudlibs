...
//        if( i < 100) i = 100;
	...
	ob->set_skill("blade", i*2/3);
        ...
        ob->set_skill("huifeng-jian", i*2/3);
        ob->set_skill("zhutian-bu", i*2/3);
        ob->set_skill("jinding-zhang", i*2/3);
        ob->set_skill("linji-zhuang", i*2/3);
        set_skill("linji-zhuang",i*2/3);
