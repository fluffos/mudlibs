...
//读入数据
	...
	set("unit", "件");
		set("long", HIC"【大乘限定】"NOR"大乘系列								
"HIG"《套装加成：修仙真法等级+450，攻击力80000》"NOR"\n");
	set("value",1000);
	set("armor_prop/armor", 8000);
	set("armor_prop/leech_qi", 1);
	set("armor_prop/reduce_poison", 1);
	set("armor_prop/reduce_magic", 1);
	set("armor_prop/unarmed_damage", 8000+lv1+lv2+lv3);
	set("armor_prop/damage", 8000+lv1+lv2+lv3);	
	set("no_get",1);
	set("no_drop",1);
	set("no_put",1);
	...
	set("armor_type","boots");
				 set("suit",HIR"大乘套装"NOR);  //套装名称
		set("suit_lvl",6);	     //套装等级
		set("suit_count",9);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","大乘·护甲");
		set("suit_mod/finger","大乘·戒指");
		set("suit_mod/head","大乘·头饰");
		set("suit_mod/neck","大乘·项链");
		set("suit_mod/pants","大乘·护腿");
		set("suit_mod/boots","大乘·护靴");
		set("suit_mod/cloth","大乘·衣服");
		set("suit_mod/waist","大乘·腰带");
		set("suit_mod/wrists","大乘·护腕");
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/constitution",random(20)+10);      //3件
		set("suit_eff/spirituality",random(20)+10);      // 5件
		set("suit_eff/intelligence",random(20)+10);      //7件
		set("suit_eff/strength",random(20)+40);      //9件
	       //套装全部附加技能效果，一整套
		set("suit_eff/constitution",80);      //3件
		set("suit_eff/spirituality",80);      // 5件
		set("suit_eff/intelligence",80);      //7件
		set("suit_eff/strength",80);      //9件
	       //套装全部附加技能效果，一整套
        set("suit_eff_skill/xiuxian-gongfa",450+me->query("taozhuang/lv"));
	setup();
}
