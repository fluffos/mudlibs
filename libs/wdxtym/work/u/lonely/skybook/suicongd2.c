...
*/
        "武动仙途"    : ({"少侠·风清扬","少侠·令狐冲","少侠·平一指","少侠·东方不败","少侠·任盈盈","少侠·桃谷六仙","少侠·林平之","少侠·岳不群","少侠·任我行", "少侠·梅庄四杰", 
...
mapping SUICONG_LIST2 = ([
        ...
        "宗师·葵花太监"    : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/SFORCE-ALL:5:1", "效果描述": "所有内功的系数提升5%-15%，每级+1%"     ]),

        "少侠·风清扬"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/SKILL-dugu-jiujian:5:1",  "效果描述": "独孤九剑伤害输出提升5%～15%，每级+1%"     ]),
        "少侠·令狐冲"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/YANJIU-dugu-jiujian:10:1", "效果描述": "独孤九剑研究效率提升10%-20%，每级+1%"     ]),
        "少侠·平一指"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/LIMIT_jingli:10:1",       "效果描述": "精力上限提升10%-20%，每级+1%"     ]),
        "少侠·东方不败"    : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/SKILL-kuihua-mogong:10:1", "效果描述": "葵花魔功伤害输出提升10%～20%，每级+1%"     ]),
        "少侠·任盈盈"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/JIALI-none:5:1",          "效果描述": "加力上限提高5%-15%，每级+1%"     ]),
        "少侠·桃谷六仙"    : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/COMBAT-busy:10:1", "效果描述": "战斗中被BUSY生效后，降低10%-20%BUSY时间，每级+1%"     ]),
  "少侠·林平之"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/SKILL-pixie-jian:10:1", "效果描述": "辟邪剑法伤害输出提升10%-20%，每级+1%"     ]),
  "少侠·岳不群"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/SFORCE-zixia-shengong:10:2", "效果描述": "紫霞神功内功系数加成提升1%-10%，每级+1%"     ]),     
        "少侠·任我行"      : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/SKILL-xixing-dafa:10:1", "效果描述": "吸星大法吸取内力效果提升10%-20%，每级+1%"     ]),
        "少侠·梅庄四杰"    : ([ "所属天书":"武动仙途", "修炼难度":3, "特殊效果":"SKBSUICONG/GIFT-experence:5:1", "效果描述": "战斗体会奖励提升5%-15%，每级+1%"   ]),

        "大侠·风清扬"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/SKILL-dugu-jiujian:20:2",  "效果描述": "独孤九剑伤害输出提升20%～40%，每级+2%"     ]),
        "大侠·令狐冲"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/YANJIU-dugu-jiujian:20:2", "效果描述": "独孤九剑研究效率提升20%-40%，每级+2%"     ]),
        "大侠·平一指"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/LIMIT_jingli:20:2",       "效果描述": "精力上限提升20%-40%，每级+2%"     ]),
        "大侠·东方不败"    : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/SKILL-kuihua-mogong:20:2", "效果描述": "葵花魔功伤害输出提升20%～40%，每级+2%"     ]),
        "大侠·任盈盈"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/JIALI-none:20:1",          "效果描述": "加力上限提高20%-30%，每级+1%"     ]),
        "大侠·桃谷六仙"    : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/COMBAT-busy:20:1", "效果描述": "战斗中被BUSY生效后，降低20%-30%BUSY时间，每级+1%"     ]),
  "大侠·林平之"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/SKILL-pixie-jian:20:2", "效果描述": "辟邪剑法伤害输出提升20%-40%，每级+2%"     ]),
  "大侠·岳不群"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/SFORCE-zixia-shengong:5:1", "效果描述": "紫霞神功内功系数加成提升5%-15%，每级+1%"     ]), 
        "大侠·任我行"      : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/SKILL-xixing-dafa:20:1", "效果描述": "吸星大法吸取内力效果提升20%-30%，每级+1%"     ]),
        "大侠·梅庄四杰"    : ([ "所属天书":"武动仙途", "修炼难度":4, "特殊效果":"SKBSUICONG/GIFT-experence:10:1", "效果描述": "战斗体会奖励提升10%-20%，每级+1%"   ]),

        "宗师·风清扬"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/SKILL-dugu-jiujian:40:2",  "效果描述": "独孤九剑伤害输出提升40%～60%，每级+2%"     ]),
        "宗师·令狐冲"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/YANJIU-dugu-jiujian:40:2", "效果描述": "独孤九剑研究效率提升40%-60%，每级+2%"     ]),
        "宗师·平一指"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/LIMIT_jingli:40:2",       "效果描述": "精力上限提升40%-60%，每级+2%"     ]),
        "宗师·东方不败"    : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/SKILL-kuihua-mogong:40:2", "效果描述": "葵花魔功伤害输出提升40%～60%，每级+2%"     ]),
        "宗师·任盈盈"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/JIALI-none:30:1",          "效果描述": "加力上限提高30%-40%，每级+1%"     ]),
        "宗师·桃谷六仙"    : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/COMBAT-busy:30:5", "效果描述": "战斗中被BUSY生效后，降低30%-50%BUSY时间，每级+2%"     ]),
  "宗师·林平之"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/SKILL-pixie-jian:40:2", "效果描述": "辟邪剑法伤害输出提升40%-60%，每级+2%"     ]),
  "宗师·岳不群"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/SFORCE-zixia-shengong:15:1", "效果描述": "紫霞神功内功系数加成提升15%-25%，每级+1%"     ]),     
        "宗师·任我行"      : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/SKILL-xixing-dafa:40:1", "效果描述": "吸星大法吸取内力效果提升40%-50%，每级+1%"     ]),
        "宗师·梅庄四杰"    : ([ "所属天书":"武动仙途", "修炼难度":5, "特殊效果":"SKBSUICONG/GIFT-experence:20:1", "效果描述": "战斗体会奖励提升20%-30%，每级+1%"   ]),
]);
...
// 计算当前随从升级所需的修为值，随从难度系数在原有基础上每点难度系数增加25%所需修为
...
int show_suicong_target(object me, string sName)
{
        ...
        sMsg+= "所属天书：《" + sBook + "》\n" +
               ...
               ((mapp(mySuicongInfo) && mySuicongInfo["level"] >= SUICONG_MAX_LEVEL) ? "升级修为：" HIG "已满级" NOR:
               "升级修为：" + (mapp(mySuicongInfo) ? sprintf("%d/%d", mySuicongInfo["exp"], need_exp(sName,  mySuicongInfo["level"])) : "未获得") +
...
public void give_end_gift(object me, string sBook, string sNandu)
{
        ...
        if (random(100) < 5)
        {
                ...
                {
                                tell_object(me, HIR "获得了超级随从，不过你已经有了，自动转化为随从修为" + sprintf("%d点。\n", SUICONG_LEVELUP / 5));
        ...
        {
                        tell_object(me, HIR "获得了随从【" +sSuicong + "】，不过你已经有了，自动转化为随从修为" + sprintf("%d点。\n", SUICONG_LEVELUP / 10));
