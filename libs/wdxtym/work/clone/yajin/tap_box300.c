...
int do_effect(object me)
{
	...
	gifts = ([
		"/clone/aaa/dan_chongmai2":300,	//1无量经书
	//	"/clone/vip/dan_chongmai2":250,
		"/clone/aaa/putao1":50,			//1葡萄
		"/clone/aaa/dan_jiuzhuan":9,
		"/clone/aaa/book_wuliang":300,
		//"/clone/aaa/jinsha":300,
	]);
