...
void create()
{
        set_name(HIW"潜"HIW"能"HIW"石"NOR, ({"potcard"}));
        set_weight(1);
        if (clonep())
                set_default_object(__FILE__);
        else {
                set("unit", "颗");
		set("text" , "这是一颗潜能石，能存贮潜能（每次存取5万点，最多2000万，加收5%手续费）有"ZJURL("cmds:zhuru potential")+ZJSIZE(20)+"注入"NOR"(zhuru potential)和"ZJURL("cmds:xi potential")+ZJSIZE(20)+"汲取"NOR"(xi potential)的功效。"NOR"\n");
...
tell_object(me,HIR"目前潜能石中存贮"+me-> query("potential1")+"点潜能。"NOR"\n");
