...
void create()
{
	set_name(HIW "《葵花宝典2》" NOR, ({ "kuihua baodian2", "baodian2", "book2", "kuihua2"}));
	set_weight(600);
	if (clonep())
		set_default_object(__FILE__);
	else {
		set("unit", "本");
		set("long", HIR "这就是武林第一秘籍《葵花宝典2》，相传是一位宫中太监所作的手抄真迹，你可以"
				ZJURL("cmds:study kuihua baodian2")+ZJSIZE(22)+"研读"NOR+HIR"看看。"NOR"\n");
		set("value", 1);
		set("material", "paper");
		set("no_put", 1);
		set("no_sell", 1);
