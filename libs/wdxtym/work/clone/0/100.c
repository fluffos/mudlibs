...
void create()
{
	set_name(HIY"100奖励" NOR, ({"100gift"}));
	if (clonep())
...
int do_effect(object me)
{
	...
	gifts = ([
			"/clone/vip2/dan_chongmai2":200,	//1无量经书
		"/clone/vip2/dan_chongmai1":200,
		"/clone/0/shimen1":1,	//极品脉丹
		"/clone/vip2/putao1":200,			//1葡萄
		"/clone/vip2/dan_jiuzhuan":200,
			"/clone/aaa/yajin/neili_dan1":1,	//1无量经书
		"/clone/aaa/smczl":1,	//师门卡
		"/clone/0/1000xue":20,    //上帝
	]);
