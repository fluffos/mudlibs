...
void create()
{
	set_name(HIY"300奖励" NOR, ({"300gift"}));
	if (clonep())
...
int do_effect(object me)
{
	...
	gifts = ([
			"/clone/vip2/dan_chongmai2":1000,	//1无量经书
		"/clone/vip2/dan_chongmai1":1000,
			"/clone/vip2/dan_chongmai3":1000,	//1无量经书
		"/clone/0/shimen1":5,	//极品脉丹
		"/clone/vip2/putao1":1000,			//1葡萄
		"/clone/vip2/dan_jiuzhuan":1000,
			"/clone/aaa/yajin/neili_dan1":2,	//1无量经书
		"/clone/aaa/smczl":3,	//师门卡
		"/clone/0/1000xue":50,    //上帝
	]);
