...
int do_openbox()
{
	...
	string *box= ({
		...
		"/clone/shizhe/tianling3","/clone/gift/putao1","/clone/gift/fdiamond","/clone/gift/fcrystal",
		"/clone/gift/fagate","/clone/gift/shenliwan","/clone/book/mengzi",
		"/clone/gift/unknowdan","/clone/gift/xiandan","/clone/gift/xisuidan",
