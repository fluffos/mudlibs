...
int do_eat_2(string arg)
{
	...
	yang = ({"sword","blade","whip","staff","throwing","unarmed","strike","cuff","finger","hand","club","claw","hammer","dagger","leg"});
	...
	else
	{
		...
		if(arg == "阳跷脉")
			msg += 	"剑法:chongsujm "+arg+" for sword"ZJSEP
				...
				"棍法:chongsujm "+arg+" for club"ZJSEP 
			    "爪法:chongsujm "+arg+" for claw"ZJSEP
				"锤法:chongsujm "+arg+" for hammer"ZJSEP
				"短兵:chongsujm "+arg+" for dagger"ZJSEP
