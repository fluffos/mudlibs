...
void create()
{
	set_name(HIR "地狱之戒-昆仑" NOR, ({"kly1 finger"}));
	set_weight(500);
	if( clonep() )
		set_default_object(__FILE__);
	else {
		set("unit", "枚");
		set("long", "邪神级的[地狱之戒-昆仑\n");
	...
	set("armor_prop/warm", 1);   //保暖
	 ...
	 //---------------------------------------------------------------
	      //套装参数
		 set("suit",HIR"地狱-昆仑"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",7);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","地狱正装-昆仑");
		set("suit_mod/finger","地狱之戒-昆仑");
		set("suit_mod/boots","地狱步履-昆仑");
//		set("suit_mod/hands","地狱之握-昆仑");
		set("suit_mod/head","地狱头冠-昆仑");
		set("suit_mod/neck","地狱之锁-昆仑");
		set("suit_mod/pants","地狱腿绑-昆仑");			     
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/spirituality",random(1)+7);      //两件
		set("suit_eff/constitution",random(1)+8);       // 五件 
		set("suit_eff/intelligence",random(1)+9);      //三件  
		set("suit_eff/strength",random(1)+10);      //    一套  
	       //套装全部附加技能效果   
		set("suit_eff_skill/force",10);   //一套
		set("suit_eff_skill/dodge",15);
		set("suit_eff_skill/parry",15);
		set("suit_eff_skill/sword",15);
		set("suit_eff_skill/liangyi-shengong",10);
		set("suit_eff_skill/chuanyun-bu",15);
		set("suit_eff_skill/zhengliangyi-jian",10);
