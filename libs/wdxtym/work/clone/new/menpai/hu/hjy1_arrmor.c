...
void create()
{
	set_name(HIR "地狱正装-胡家" NOR, ({"hjy1 arrmor"}));
	set_weight(3000);
	if( clonep() )
		set_default_object(__FILE__);
	else {
		set("unit", "件");
		set("long", "邪神级的[地狱正装-胡家]\n");
		set("material", "armor");
	...
	set("armor_prop/warm", 20);   //保暖
	 ...
	 //---------------------------------------------------------------
	      //套装参数
		 set("suit",HIR"地狱-胡家"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",7);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","地狱正装-胡家");
		set("suit_mod/finger","地狱之戒-胡家");
		set("suit_mod/boots","地狱步履-胡家");
//		set("suit_mod/hands","地狱之握-胡家");
		set("suit_mod/head","地狱头冠-胡家");
		set("suit_mod/neck","地狱之锁-胡家");
		set("suit_mod/pants","地狱腿绑-胡家");			     
