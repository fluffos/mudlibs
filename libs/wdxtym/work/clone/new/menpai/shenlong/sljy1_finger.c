...
void create()
{
	set_name(HIR "地狱之戒-神龙" NOR, ({"sljy1 finger"}));
	set_weight(500);
	if( clonep() )
		set_default_object(__FILE__);
	else {
		set("unit", "枚");
		set("long", "邪神级的[地狱之戒-神龙]\n");
	...
	//---------------------------------------------------------------
	      //套装参数
		 set("suit",HIR"地狱-神龙"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",7);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","地狱正装-神龙");
		set("suit_mod/finger","地狱之戒-神龙");
		set("suit_mod/boots","地狱步履-神龙");
//		set("suit_mod/hands","地狱之握-神龙");
		set("suit_mod/head","地狱头冠-神龙");
		set("suit_mod/neck","地狱之锁-神龙");
		set("suit_mod/pants","地狱腿绑-神龙");			     
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/spirituality",random(1)+8);      //两件
		...
		set("suit_eff_skill/shenlong-xinfa",10);
		set("suit_eff_skill/shedao-qigong",10);
		set("suit_eff_skill/huagu-mianzhang",15);
