...
void create()
{
	set_name(HIR "地狱之握-移花" NOR, ({"ymy1 hands"}));
	set_weight(3000);
	if( clonep() )
		set_default_object(__FILE__);
	else {
		set("unit", "双");
		set("long", "邪神级的[地狱之握-移花]\n");
		set("material", "neck");    //类型
	set("armor_prop/armor", random(50)+180);  //防御
	set("armor_prop/unarmed_damage", random(70)+210);
	...
	//---------------------------------------------------------------
	      //套装参数
		 set("suit",HIR"地狱-移花"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",7);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","地狱正装-移花");
		set("suit_mod/finger","地狱之戒-移花");
		set("suit_mod/boots","地狱步履-移花");
//		set("suit_mod/hands","地狱之握-移花");
		set("suit_mod/head","地狱头冠-移花");
		set("suit_mod/neck","地狱之锁-移花");
		set("suit_mod/pants","地狱腿绑-移花");			     
	    //套装全部附加天赋效果  //身法第一，根骨第二，悟性第三，臂力第四
		set("suit_eff/spirituality",random(2)+10);      //两件
		set("suit_eff/constitution",random(1)+9);       // 五件 
		set("suit_eff/intelligence",random(3)+10);      //三件  
