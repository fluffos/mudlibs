...
void create()
{
	set_name(HIR "地狱之戒-桃花" NOR, ({"thy1 finger"}));
	set_weight(500);
	if( clonep() )
	...
	//---------------------------------------------------------------
	      //套装参数
		 set("suit",HIR"地狱-桃花"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",7);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","地狱正装-桃花");
		set("suit_mod/finger","地狱之戒-桃花");
		set("suit_mod/boots","地狱步履-桃花");
//		set("suit_mod/hands","地狱之握-桃花");
		set("suit_mod/head","地狱头冠-桃花");
		set("suit_mod/neck","地狱之锁-桃花");
		set("suit_mod/pants","地狱腿绑-桃花");			     
		...
		set("suit_eff_skill/bibo-shengong",10);
		set("suit_eff_skill/tanzhi-shentong",10);
		set("suit_eff_skill/lanhua-shou",15);
