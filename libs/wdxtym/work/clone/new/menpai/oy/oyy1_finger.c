...
void create()
{
	set_name(HIR "地狱之戒-欧阳" NOR, ({"oyy1 finger"}));
	set_weight(500);
	if( clonep() )
		set_default_object(__FILE__);
	else {
		set("unit", "枚");
		set("long", "邪神级的[地狱之戒-欧阳]\n");
	...
	set("armor_prop/warm", 1);   //保暖
	 ...
	 //---------------------------------------------------------------
	      //套装参数
		 set("suit",HIR"地狱-欧阳"NOR);  //套装名称
		set("suit_lvl",5);	     //套装等级
		set("suit_count",7);	   //套装部件数量
	      //套装各部件
		set("suit_mod/arrmor","地狱正装-欧阳");
		set("suit_mod/finger","地狱之戒-欧阳");
		set("suit_mod/boots","地狱步履-欧阳");
//		set("suit_mod/hands","地狱之握-欧阳");
		set("suit_mod/head","地狱头冠-欧阳");
		set("suit_mod/neck","地狱之锁-欧阳");
		set("suit_mod/pants","地狱腿绑-欧阳");			     
