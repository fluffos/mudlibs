...
void create()
{
	...
	if( clonep() )
       ...
       {
	    set("long",
		"这是系统奖励的"+this_object()->query("name")+",\n使用(openbox newbox1)"ZJURL("cmds:openbox newbox1")ZJSIZE(15)"打开"NOR"看看!\n");
	    set("unit","个");
	    set("win_box",1);
	}
}
...
int do_openbox()
{
  ...
  */
   string *box=
({
"/clone/new/y3/y3_arrmor","/clone/new/y3/y3_finger","/clone/new/y3/y3_hands","/clone/new/y3/y3_head","/clone/new/y3/y3_pants","/clone/new/y3/y3_boots","/clone/new/y3/y3_neck",
});
