...
int do_openbox()
{
  ...
  */
   string *box=
({
"/clone/new/e1/e1_arrmor","/clone/new/e1/e1_finger","/clone/new/e1/e1_hands","/clone/new/e1/e1_head","/clone/new/e1/e1_pants","/clone/new/e1/e1_blade","/clone/new/e1/e1_neck",
});
