...
int do_openbox()
{
  ...
  */
   string *box=
({
"/clone/new/e3/e3_arrmor","/clone/new/e3/e3_finger","/clone/new/e3/e3_hands","/clone/new/e3/e3_head","/clone/new/e3/e3_pants","/clone/new/e3/e3_boots","/clone/new/e3/e3_neck",
});
