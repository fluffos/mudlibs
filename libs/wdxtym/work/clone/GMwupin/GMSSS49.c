...
void create()
{
	set_name(HIB"高级灵石卡"NOR, ({"lss3 dai"}));
	if (clonep())
...
if (i>=2 && i<3){
me->add("yuanbao",1800);
message_vision(HIR"$N获得了1800灵石！"NOR"\n", me, this_object());
}
if (i>=4 && i<5){
me->add("yuanbao",1600);
message_vision(HIR"$N获得了1600灵石！"NOR"\n", me, this_object());
}
if (i>=6 && i<7){
me->add("yuanbao",1400);
message_vision(HIR"$N获得了1400灵石！"NOR"\n", me, this_object());
}
if (i>=8 && i<9){
me->add("yuanbao",1200);
message_vision(HIR"$N获得了1200灵石！"NOR"\n", me, this_object());
}
if (i>=10 && i<11){
me->add("yuanbao",1000);
