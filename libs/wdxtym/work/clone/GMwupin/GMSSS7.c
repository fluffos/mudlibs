...
void create()
{
        set_name(HIY "八龙化生丹·上品" NOR, ({"bmsd danSS"}));
        if (clonep())
...
{    
   int effect;
	 mapping my;
        ...
        log_file("static/using", sprintf("%s(%s) eat 八龙化生丹·上品 at %s.\n",
