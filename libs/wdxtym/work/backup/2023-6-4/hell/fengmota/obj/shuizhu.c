...
set("no_steal",1);
                ...
                set("long","传说中的五行宝珠之一，佩之可避水淹，并可发出水系法术。为祈雨所必需之物。\n");
...
if(ob->query("use_times")>10)
{
message_vision("$N手中的水灵珠突然发出一道光芒，慢慢的暗了下来。\n", who, target); 
remove_call_out("shuizhuconditions");
}
else
call_out("shuizhuconditions",25,who,ob);
}


void owner_is_killed()
{
write(HIY"只见眼前金光一闪....水灵珠突然破裂了!\n"NOR);
