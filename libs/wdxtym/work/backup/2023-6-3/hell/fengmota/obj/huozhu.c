...
set("no_steal",1);
                set("value",10000);
                set("long","´«ËµÖĞµÄÎåĞĞ±¦ÖéÖ®Ò»£¬ÅåÖ®¿É±Ü»ğÉÕ£¬²¢¿É·¢³ö»ğÏµ·¨Êõ¡£ÎªÆíÓêËù±ØĞèÖ®Îï¡£\n");
...
{
message_vision("$NÊÖÖĞµÄ»ğÁéÖéÍ»È»·¢³öÒ»µÀ¹âÃ¢£¬ÂıÂıµÄ°µÁËÏÂÀ´¡£\n", who, target); 
remove_call_out("conditionhuozhu");
}
else
...
ÓÖ´ıÆ¬¿Ì£¬ÎåÖéºôµÄÒ»°µ£¬$NÊÖÖĞÈ´¶àÁËÒ»¿ÅË¶´óµÄÍ¸Ã÷±¦Öé£¬²»Ê±·¢³öÎå²ÊºÁ¹â¡£\n",who);
       ...
       //message("channel:rumor",RED+"¡¾Ò¥ÑÔ¡¿Ä³ÈË£º"+who->query("name")+"ÄÃµ½Ê¥ÁéÖéÁË£¡\n"+NOR,users() );
          message("system",HIC"¡¼"HIW"ÊñÉ½ÅÉ"HIC"¡½"HIY+who->query("name")+HIG"ÄÃµ½ÁË[1;37mÊ¥ÁéÖé£¡[2;37;0m\n"NOR,users());    

        
         shengzhu = new("/data/hell/fengmota/obj/shengzhu");
        shengzhu->move(who);
        destruct(wind);
        destruct(water);
        destruct(earth);
...
{
write(HIY"Ö»¼ûÑÛÇ°½ğ¹âÒ»ÉÁ....»ğÁéÖéÍ»È»ÆÆÁÑÁË!\n"NOR);
destruct(this_object());
}