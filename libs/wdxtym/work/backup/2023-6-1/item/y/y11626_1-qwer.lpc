// ITEM Made by player(焚寂:y11626_1) /data/item/y/y11626_1-qwer.c
...
void create()
{
	set_name("逍遥护腕[2;37;0m", ({ "qwer" }));
	set_weight(250);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;37m世界[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：焚寂(y11626_1)
");
	set("value", 200100000);
	set("point", 5500);
	set("material", "silk");
	set("wear_msg", "[33m$N[33m装备逍遥护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了逍遥护腕[2;37;0m[33m。[2;37;0m\n");
