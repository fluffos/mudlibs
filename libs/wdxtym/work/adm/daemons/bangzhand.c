...
void heart_beat()
{
	...
	{	
     ...
     tell_object(players[i],HIW"恭喜你的帮派获得了帮派战的胜利，"+HIG+"你因此获得了："+exps+"修为，"+pots+"潜能，"+mots+"体会。\n"NOR); 
     
     log_file("adm/bangzhan", sprintf("%s："+short+"获得了胜利，帮派在线成员："+players[i]->name()+"，他是"+players[i]->query("banghui/name")+" 帮派成员。\n",ctime(time())));
