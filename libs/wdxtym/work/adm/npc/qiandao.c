...
int do_daka()
{
	...
	i = 2000+random(2000);
		...
		tell_object(me, sprintf(CYN + "你获得一个挑战令牌 \n"NOR, i, i));
		tell_object(me, sprintf(CYN + "魔物副本任务以刷新 \n"NOR, i, i));
		tell_object(me, sprintf(CYN + "你获得100战令修为值 \n"NOR, i, i));
		tell_object(me, sprintf(CYN"今日签到成功！祝你游戏愉快，你获得200元宝！\n"NOR));
