...
//#include "/std/weapon/poison_weapon.lpc"
#include "ansi.h"
...
// AGENTS.md §8g variant: CLUB/F_CLUB were never added to this table even
// though /std/weapon/club.lpc and /std/weapon/_club.lpc both exist on
// disk (2 files -- obj/weapon/qimeigun.lpc, obj/weapon/changqiang.lpc --
// failed to compile with "unexpected L_IDENTIFIER" on `inherit CLUB;`
// since CLUB resolved to a bare undefined identifier, not a string).
#define CLUB			"/std/weapon/club"
#define F_CLUB		"/std/weapon/_club"
...
#define WEAPON_COMBO       "/std/weapon/weapon_combo"  //组合

#define M_WEAPON            "/std/weapon/weapon"        // 制造兵器
