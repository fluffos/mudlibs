// Created by waiwai@2003/01/20  NPC总调用
// 任何人增添路径时严格注意不要重复，不要写错
// 并且注明系统类型。特殊ROOM请在最顶部添加
// 继承这个后，房间内注意删除 inherit ROOM 
...
//巫师/U/WAIWAI(系统)
#define WAI_ROOM		"/u/waiwai/"
#define WAI_NPC		"/u/waiwai/npc/"
#define WAI_OBJ		"/u/waiwai/obj/"
#define WAIROOM		"/u/waiwai/room/auroom"
