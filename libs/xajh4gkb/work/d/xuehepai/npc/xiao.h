...
/*            if ( (int)ob->query("shen") > -100000)
        ...
        if (ob->query("combat_exp")<1000000)
	{
        ...
        if((int)ob->query_skill("yiqiguan-riyue",1)< 300){
                command("say 你对本门一气贯日月心法领悟的不够。");
		return ;
	}
        if((int)ob->query("max_neili")< 10000){
		command("say 你的内力太差了。");
		return ;
	}
        	command("say 好吧，我就收下你了。");
             if ((my_fam && my_fam["generation"]>14) || (me->query("cloth")=="/d/xuehepai/obj/cloth1")){
                command("say 这件一道金的血衣你收好，它代表你在本派的地位。");
                obb=new("/d/xuehepai/obj/cloth2");
                obb->move(ob);
				ob->set("cloth","/d/xuehepai/obj/cloth2");
                 }
