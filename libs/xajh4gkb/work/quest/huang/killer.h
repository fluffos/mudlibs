int do_copy(object me,int maxpot)
{
        ...
        i=maxpot;
		if( i < 100) i = 100;
		ob->set("xyzx_sys/level", (me->query("xyzx_sys/level")+200)/2);
//        ob->set("combat_exp", (me->query("combat_exp")+random(me->query("combat_exp")))*2/4);
        ...
        ob->set("max_qi",     me->query("max_qi")*1/10); 
        ob->set("max_jing", me->query("max_jing")*1/10); 
        ob->set("max_neili",  me->query("max_neili")*1/10); 
		ob->set("max_jingli",  me->query("max_jingli")*1/10); 
        ob->reincarnate(); 
