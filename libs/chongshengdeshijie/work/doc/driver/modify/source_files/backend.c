...
nosave void look_for_objects_to_swap PROT((void));
nosave void call_heart_beat PROT((void));

#if 0
nosave void report_holes PROT((void));
#endif
...
*/
nosave void look_for_objects_to_swap()
{
    nosave int next_time;
#ifndef NO_IP_DEMON
    extern int no_ip_demon;
    nosave int next_server_time;
#endif
    object_t *ob;
...
nosave heart_beat_t *heart_beats = 0;
nosave int max_heart_beats = 0;
nosave int heart_beat_index = 0;
nosave int num_hb_objs = 0;
nosave int num_hb_to_do = 0;

nosave int num_hb_calls = 0;	/* starts */
nosave float perc_hb_probes = 100.0;	/* decaying avge of how many complete */
...
nosave double load_av = 0.0;
nosave int load_now = 0;
...
nosave double compile_av = 0.0;
nosave int compile_now = 0;
