...
// 11-1-95
// ES
#define MUDLIST_DNS ({ get_system_config(DATA_CONFIG_DIR "net.h", "FIRST_DNS_IP"), get_system_config(DATA_CONFIG_DIR "net.h", "FIRST_DNS_PORT") })
// enchanted rock
#define MUDLIST_BAK ({ get_system_config(DATA_CONFIG_DIR "net.h", "SECONDLY_DNS_IP"), get_system_config(DATA_CONFIG_DIR "net.h", "SECONDLY_DNS_PORT") })


#define LISTNODES ([ \
"DXTWO" : "58.52.115.201 5559",\
"TTONE" : "222.51.9.138 5570",\
])
