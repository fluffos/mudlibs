...
// AGENTS.md: F_UNIQUE was referenced (inherit F_UNIQUE;) by ~91 clone item
// files in this lib but never #define'd here, despite /feature/unique.lpc
// existing (same gap found in dtsl(#8)/llmud_datangshuanglong(#18), same
// lineage's clone/weapon+armor content).
#define F_UNIQUE                "/feature/unique.lpc"
// Same shape as F_UNIQUE above: F_BACKUP referenced (inherit F_BACKUP;) by
// obj/fabao.lpc and obj/jiasha.lpc but never #define'd, despite
// /feature/backup.lpc existing.
