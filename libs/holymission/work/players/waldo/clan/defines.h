...
#define ACTION "/players/waldo/clan/actions/actions.lpc"
...
#define SERVER "/players/waldo/clan/server.lpc"

#define MEMBERS ([ "waldo":"soke", "tetsuhara":"renshi", "turbo":"renshi", \
