...
#define _tpe  evaluate(call,_tp,"enhanced_dam")
...
#define _lg     evaluate(call,_tp,"query_legend_level")
//#define _lg  (evaluate(call,_tp,"query_property","monk_legend")+1)
#define _dam(x)  (x + _tpe + ( (_lg * x) / 20) )
