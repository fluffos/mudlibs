...
void create()
{
        set("short", "草场");
        set("long", @LONG
这一族哈萨克人大概已经习惯了定居生活，于是做了个大草场。春夏把远
处肥嫩的水草割下来堆在这里，以备秋冬季节畜生的食料。这里堆满了一堆堆
帐篷大小的草堆和干草(gancao)，看起来不下千堆。
LONG);
        set("exits", ([
...
{      
        ...
        if( me->is_busy() || me->is_fighting()) return notify_fail("你现在没空。\n");
        if(!arg || arg != "gancao"){    
