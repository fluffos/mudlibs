...
void xyjob_2()  // 任务开始
{
  ...
  object *defenders = filter_array(
    "/cmds/std/xyjob"->player_list(),
    (: $1->query_temp("xyjob/xy_defend") :)
  );
  string room;
...
*/
    ...
    TASKREWARD_D->get_reward(
      ...
      0,
      4,
      attackers[i]->query_temp("xyjob/attack") - 1,
      3400 + random(101)
    );
...
*/
    ...
    TASKREWARD_D->get_reward(
      ...
      0,
      4,
      defenders[i]->query_temp("xyjob/defend") - 1,
      3400 + random(101)
    );
