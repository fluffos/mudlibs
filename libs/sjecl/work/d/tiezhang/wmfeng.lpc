...
void create()
{
	...
	set("long", @LONG
跨过路上的荆棘和荒草，你终于登上了无名峰的峰顶。由于这里地处五峰
之中，四周有其它山峰阻挡，因此风势很小，常年笼罩在一片云雾之中。峰顶
长满了齐腰的荒草，怪石嶙峋，一片荒凉景色。在峰顶的正中，赫然矗立着一
座岩石砌就的坟墓，坟墓的前面立着一块一人多高的花岗岩的墓碑(bei)。
LONG
	);

	set("exits", ([
"southdown" : __DIR__"hclu-6",
]));
