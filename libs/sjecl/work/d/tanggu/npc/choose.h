void choose_exp(string arg, object me) {
  ...
  if (arg == "Q" || arg == "q") {
    ...
    log_file(
      "quest/zhaoqin",
      sprintf("%-8s%-10s 取消比武招亲choose_exp", me->query("name"), me->query("id")),
      me
    );
    return;
  }
...
void choose_per(string arg, object me) {
  ...
  if (arg == "Q" || arg == "q") {
    ...
    log_file(
      "quest/zhaoqin",
      sprintf("%-8s%-10s 取消比武招亲choose_per", me->query("name"), me->query("id")),
      me
    );
    return;
  }
...
void choose_age(string arg, object me) {
  ...
  if (arg == "Q" || arg == "q") {
    ...
    log_file(
      "quest/zhaoqin",
      sprintf("%-8s%-10s 取消比武招亲choose_age", me->query("name"), me->query("id")),
      me
    );
    return;
  }
