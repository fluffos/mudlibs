...
void caiyao_finish(object me, string yaocai) {
  ...
  i = obj->query("need_lvl");
  if (i < 80) { i = 80; if (level > 150) level = 150; } else if (i < 160) {
    i = 160; if (level > 250) level = 250;
  } else if (i < 240) { i = 280; if (level > 350) level = 350; } else if (i < 320) {
    i = 360; if (level > 450) level = 450;
  } else if (i < 360) { i = 400; if (level > 500) level = 500; } else if (i < 390) {
    i = 500; if (level > 500) level = 500;
