...
int perform(object me, object target)
{
	...
	if(!wizardp(me) && !me->query_temp("test_jm"))
		return 0;
...
//		return notify_fail("你没有领悟剑意，不知如何才能运用「剑芒」。\n");
	...
	if( !me->query_temp("th_jianmang") && me->query_temp("th_wait_jianmang"))
		return notify_fail("你气血翻涌，无法运用「剑芒」！\n");

//	if( !me->query_temp("th_jianmang2") && me->query_temp("th_wait_jianmang2"))
//		return notify_fail("你气血翻涌，无法运用「剑芒」！\n");
...
*/
	...
	me->add("neili", -300);
	me->add("jingli", -50);
	me->add_temp("th_jianmang", sword/2); 
...
void checking(object me, object weapon,int speed, int damage)
{
	...
	else if( me->query_skill_mapped("sword") != "final-sword"
	 || me->query_skill_mapped("force") != "final-force" )
	{
		remove_effect1(me, weapon, speed, damage);
