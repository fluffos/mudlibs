...
static mapping family_skills_award=([
					  ...
					  "古墓派"	:({"lovingness","yunu-xinjing","yunu-jianfa","meinu-quan"}),
					  "灵鹫宫"	:({"music","bahuang-gong","liuyang-zhang","zhemei-shou"}),
					  ]);
...
static mapping family_master_basefile=([
					  ...
					  "古墓派"	:"/kungfu/class/gumu/npc/yangguo",
...
static mapping *gumu_message = ({
	...
	([
		"job_tell_mode":"oppose_pker",
		"pk_npc" : "$N说道:“近日在$ROOM附近有恶徒残杀百姓，你速去将其除去。”\n"
		]),
	([
		"job_tell_mode":"protect",
		"npc" : "$N说道:“近来江湖动乱，常有无辜百姓被邪派妖人所杀，搞得江湖人心惶惶。\n"
				"刚才有人求上门来，向我派寻求保护，我派你去$ROOM处等他，护送他去目的地。”\n"
		]),
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"神雕侠已经传下号令，令古墓弟子速回终南山古墓大厅召开本门大会。\n"NOR,
		"send_to" : "古墓派弟子听了！",
		"send_to1":	"三日后于终南山古墓大厅召开本门大会，凡我古墓派门下，务必准时参加。",
		"kick_out": "$N说道：“现在古墓派正在召开重要会议，闲杂人等请速离去。”\n",
		"kick_out_player": "$N将$n请了出去。\n",
		"family":"$N说道：“我古墓派自祖师婆婆开创以来，一直行侠江湖，除恶扬善。本次大会，重在考核各门人近来所作所为。”\n",
		"assess_start":"$N说道：“古墓派评定大会正式开始。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为我古墓派所做贡献不小，现授予你我教至高武学精义，望今后行侠仗义，多做我辈善事！”\n",
		"assess_punish":"$N说道：“$P，你数次违我古墓派意旨，该当严惩！”\n",
		"assess_award_common":"$N说道：“还望各位能牢记祖师婆婆所训，行侠仗义，除恶扬善。”\n",
		"assess_end":"$N说道：“本次评定大会到此结束。”\n"
...
static mapping *lingjiu_message = ({
	...
	([
		"job_tell_mode":"oppose_pker",
		"pk_npc" : "$N说道:“近日在$ROOM附近有人与我灵鹫宫做对，你速去将其除去。”\n"
		]),
	([
		"job_tell_mode":"protect",
		"npc" : "$N说道:“近来江湖动乱，常有无辜百姓被邪派妖人所杀，搞得江湖人心惶惶。\n"
				"刚才有人求上门来，向我灵鹫宫寻求保护，我派你去$ROOM处等他，护送他去目的地。”\n"
		]),
	...
	([
		...
		([
		"job_tell_mode":"assess",		
		"prompt":HIY"姥姥已经传下命令，令白驼弟子速回天山灵鹫宫召开评议大会。\n"NOR,
		"send_to" : "灵鹫宫弟子听了！",
		"send_to1":	"三日后于天山灵鹫宫召开评议大会，到时务必参加。",
		"kick_out": "$N说道：“现在灵鹫宫正在召开重要会议，闲杂人等请速离去。”\n",
		"kick_out_player": "$N将$n请了出去。\n",
		"family":"$N说道：“我天山灵鹫宫自创建以来，向来我行我素，凡有阻碍我灵鹫宫之人，一律杀无赦！”\n",
		"assess_start":"$N说道：“灵鹫宫评定大会正式开始。”\n",
		"assess_award_best":"$N说道：“$P，近段时间内，你为灵鹫宫做贡献不小，现传授你内功要决，望多为灵鹫宫争口气！”\n",
		"assess_punish":"$N说道：“$P，你数次违我意旨，该当严惩！”\n",
		"assess_award_common":"$N说道：“还望各位能牢记我的训斥。”\n",
		"assess_end":"$N说道：“本次评定大会到此结束。”\n"
