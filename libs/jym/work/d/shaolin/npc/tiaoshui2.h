...
void reward_dest(object me, object obj)
{
	...
	me->add("potential", (80+ random(20))* expMultiple);
	if(me->query("potential") > me->query("max_potential"))
		me->set("potential", me->query("max_potential"));
	if(me->query("combat_exp") < 100000)
		me->add("combat_exp", (310 + random(50))* expMultiple);
	else if (me->query("combat_exp") < 300000)
		me->add("combat_exp", (250 + random(60))* expMultiple);
		else me->add("combat_exp", (180 + random(50))* expMultiple);
	return;
}
