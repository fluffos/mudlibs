...
End Function
--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="kuang5_admin_add_save.asp?id=<%=id%>" name="FrontPage_Form1">
	<div align="center">
		　<p>　</p>
		<table border="1" width="600" id="table1" cellspacing="0" cellpadding="7" style="border-collapse: collapse" bordercolor="#C0C0C0">
			...
			<tr>
				<td width="127" align="center">二级栏目权限</td>
				<td>
				<%
