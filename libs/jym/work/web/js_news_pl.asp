...
document.write("<table border='0' cellspacing='2' cellpadding='2' width='100%' id='table1' style='border-collapse: collapse'>");
...
document.write("<td align='left' style='font-size:9pt;word-break:break-all'>　<font color=66666><%=username%>　<%=addtime%>　评论说：</font><br><img border=0 src=images/bbstitle.gif width=16 height=15>　<%=content%></td>");
document.write("</tr>");
<%
rs.movenext
wend
...
%>
	...
	document.write("<div align='center'><table width='100%' cellpadding='5' cellspacing='2' bordercolor='#C0C0C0' id='table1' style='border-collapse: collapse'><tr>");
	document.write("<td  align='center'>姓名</td><td align='left'>&nbsp;&nbsp;");
	document.write("<input type='text' name='username' size='20' style='background-color: #F5F5F5' maxlength='8'></td>");
	document.write("</tr><tr><td align='center'>评论</td><td align='left'>&nbsp;&nbsp;");
	document.write("<textarea rows='4' name='content' cols='60'></textarea></td>");
	document.write("</tr></table></div>");
	document.write("<div align='center'><input type='submit' value=' 提 交 ' name='B1'>&nbsp;&nbsp;&nbsp; <input type='reset' value=' 重 置 ' name='B2'></div></form>");
<%
end if
