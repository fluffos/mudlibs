...
#define sk_double 180
#define lit_double 100
...
#define SMTP_D	        "/adm/daemons/smtp_d"//备注
#define BASE64_D	        "/adm/daemons/base64_d"//备注
#define JOB_GIFTD	"/adm/daemons/job_giftd"
...
#define JOBNAME_D		"/include/npc/name_setup.lpc"

#define SAVE_OB			"/inherit/save.lpc"

//quest job add by muder
