 ...
 */
#undef NO_WIZARDS // modify by ken@XAJH
 ...
 */
#define DEFAULT_PRAGMAS PRAGMA_STRICT_TYPES + PRAGMA_WARNINGS + PRAGMA_SAVE_BINARY + PRAGMA_OPTIMIZE + PRAGMA_ERROR_CONTEXT
 ...
 *
 */
#define PACKAGE_UIDS // modify by ken@XAJH
 ...
 */
#define LARGEST_PRINTABLE_STRING 16384 // modify by ken@XAJH

/* MESSAGE_BUFFER_SIZE: determines the size of the buffer for output that
 *   is sent to users.
 */
#define MESSAGE_BUFFER_SIZE 16384 // modify by ken@XAJH
