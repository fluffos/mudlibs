...
void create()
{
        ...
        set("vendor_goods",({
                   "/u/zhangm/fenghuang/obj/blade",
                   "/u/zhangm/fenghuang/obj/sword",
                   "/u/zhangm/fenghuang/obj/gun",
                   "/u/zhangm/fenghuang/obj/ganggun",
                   "/u/zhangm/fenghuang/obj/bishou",
      }));
...
void compelete_trade(object who, string what)
{
        ...
        if( what=="blade" )  ob = new("/u/zhangm/fenghuang/obj/blade");
        if( what=="sword" )  ob = new("/u/zhangm/fenghuang/obj/sword");
        ob->move(who);
        if( what=="blade" )
