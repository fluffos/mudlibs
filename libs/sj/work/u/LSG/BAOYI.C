...
int full(string str)
{
  ...
  me->clear_condition();
  message_vision( sprintf("$N想了想，说到，行了。\n"),
                  this_player());
