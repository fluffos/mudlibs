...
#define WELCOME2         "/adm/etc/welcome2"
#define WELCOME3         "/adm/etc/welcome3"
#define WELCOME4         "/adm/etc/welcome4"
#define WELCOME5         "/adm/etc/welcome5"
#define WELCOME6         "/adm/etc/welcome6"
