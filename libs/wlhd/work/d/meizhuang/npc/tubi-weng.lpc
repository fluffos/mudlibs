...
void attempt_apprentice(object ob)
{
        ...
        if ((int)ob->query("meizhuangshuaiyitie") < 1) {
                command("say 想入我门下，" + RANK_D->query_respect(ob) +
                        "就去帮我把率意帖找来给我？");
                return;
        }
         message("vision",HIY"〖风云再起〗"NOR+":"+HIR" 听说"HIW+ob->short()+NOR HIB"拜入梅庄三庄主秃笔翁门下!\n"NOR,users());
