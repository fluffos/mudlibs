...
int exert(object me, object target)
{
   ...
   if( me->query_temp("wait_yinshen") > time() )
       return notify_fail("您刚刚隐身完毕休息一下再隐身吧。\n");
   ...
   me->set_temp("zjb_yinshen",1);
    me->set_temp("zjb_bubai", 1);
...
void remove_effect(object me, int amount)
{
    ...
    me->set_temp("wait_yinshen",time()+60);
    me->delete_temp("zjb_yinshen");
    me->delete_temp("zjb_bubai");
