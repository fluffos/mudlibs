...
// 11-1-95
// ES
//#define MUDLIST_DNS  ({ "210.34.3.133", 6368 })
// enchanted rock
//#define MUDLIST_BAK ({ "193.10.174.41", 5563 }
#define MUDLIST_DNS  ({ "128.1.100.244", 5555 })
// enchanted rock
#define MUDLIST_BAK ({ "128.1.100.244", 5555})

#define LISTNODES ([ \
        "sy" : "202.97.182.36 5559",\
 ...
 * add by ken@chinesemud.net
 */
#define Big5IP ({ "140","207","209","203","129", "208", "206", "139" })
