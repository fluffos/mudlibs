...
//this message 
string *answer_msg =({
    HIW "不错，看在你平日的积德，加上你近日的磨练，就饶你这一次，你去见见判官吧。\n" NOR,
    HIW "嗯，你的罪孽已经差不多了，在过一段时间就可以了。\n"NOR,
    HIW "你心中积恶还未洗清，不能回家。"NOR,
    HIW "你罪孽深重，还是先等着吧。"NOR,
    HIW "哼，你孽似海深，还是老实点，多受些苦吧。"NOR,
    "",//万一有人是300，就是这行。
});
string ask_me();
...
{   int rein_time,mud_age,i;
    ...
    rein_time=(int)who->query("rein_time");
    i=rein_time-mud_age;
    i=i>=0?i:0;
    i/=60;
    if(i>=4)
