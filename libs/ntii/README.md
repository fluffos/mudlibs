...
泥潭II 是与 [nte](../nte/)（泥潭）同属 ES2/Annihilator 引擎家族的姊妹版本，两者的登录、姓名、版本同步等核心基础设施档案逐字节相同，但全库约一万个游戏内容档案各自独立开发，并非同一份内容的重复压缩包。和 nte 一样，真正的"出生"要先完成一段创世神话 NPC 对话构成的仪式，玩家在此之前无法正常使用 `score` 等基本命令，这是设计好的叙事关卡而非缺失内容。
