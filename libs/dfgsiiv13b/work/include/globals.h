...
// MUD_NAME removed: this driver auto-predefines it from config's "name" setting, redefining collides ("Illegal to redefine a predefined value")
...
#define F_DRINK		"/feature/drink.lpc"
