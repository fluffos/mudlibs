...
{   
	if(query("no_save")||query("rumor")||!query("save_flag")) 
	return 0;
	...
	return query("strong")+" "+
	       ...
	       query("unequip_msg")+" "+
	       query("unwield_msg")+" "+
	       query("weapon_prop/strength")+" "+
	       query("weapon_prop/dodge")+" "+
	       query("weapon_prop/armor")+" "+
	       query("weapon_prop/intelligence")+" "+
	       query("weapon_prop/personality")+" "+
	       query("weapon_prop/constitution")+" "+
	       query("weapon_prop/karma")+" "+
...
{   
	...
	{   
	    ...
	    set("weapon_prop/strength",w_str);
	    set("weapon_prop/dodge",w_dodge);
	    set("weapon_prop/armor",w_armor);
	    set("weapon_prop/intelligence",w_int);
	    set("weapon_prop/personality",w_per);
	    set("weapon_prop/constitution",w_con);
	    set("weapon_prop/karma",w_kar);
