...
/* Last modify by dsm at Jianghu, 3/20/1999.
   Add CHECK_PLAYER_PASSWORD
   */
...
#define FTP_BUGS_EMAIL "realyanyan@sohu.com"
...
/* define this to only check password for player */	//ADD BY DSM
#undef CHECK_PLAYER_PASSWORD
 ...
 * Example:
 */
#define FTP_USERS ({ "forever","chris","yanyan","fire","baimo","rain"})
...
/* check password */			//ADD BY DSM
#if defined(CHECK_PLAYER_PASSWORD)
#define NON_DIR "/ftp/"
#endif
