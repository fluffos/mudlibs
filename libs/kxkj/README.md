...
辽宁热线站等多个库同属 ES II 大家族。背景设定是一个"古代中国"的
江湖世界，主打门派、帮派制度和轻功、内功养成；新手报到的"狂想空间
新手入门房间"里直接给出新手介绍、指令快速上手、帮派说明、小秘技等
导览，非常照顾第一次玩这类 Mud 的玩家。创角时要在体格、定性、悟性、
胆识、根骨、灵性、容貌七项属性间分配天赋点数，另有一项"根骨/福气"
按剩余点数自动计算。
