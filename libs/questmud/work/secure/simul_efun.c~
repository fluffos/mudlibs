...
varargs void log_file(string file, string str, status no_send_to_chan )
{
    string object_name;
    int *st;
...
string creator(object ob) { return (string)getuid(ob); }
string domain(object ob) { return (string)getuid(ob); }
