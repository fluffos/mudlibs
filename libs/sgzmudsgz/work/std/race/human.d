...
inherit RACE;
/*
 * This is the name of the race.  It is used in the initial selection
screen,
...
string short_description() {
  return //"Humans are pretty average.  If this were a real mud, a betterdescription would be provided (we hope).\n";
         "人类属于中等水平。\n";
}
/*
 ...
 * number should be adjusted into the range [50..100].  This has three
effects:
 *
 * (1) All members of the race will have at least 50 constitution.
 * (2) 100 is the max for all races.
 * (3) Races that start out with a bonus advance slower (since the range
is
 *     compressed).  For example, if your base stats go up by 10, then
your
