        ...
        if (present("jiuhuan xizhang",ob))
         {
           ...
           got_pot=(obj_exp/my_exp)*20+random((int)ob->query_skill("buddhism",1)/10);
           got_pot=got_pot*3/2;
           ob->add("potential",got_pot);
           ob->add("neili",-random(600)); 
           ...
           ob->add("potential",((obj_exp/my_exp)*20+random((int)ob->query_skill("buddhism",1))/10)*3);              
       	   got_pot=got_pot*3/2;
           ob->add("neili", -200);
           ob->add("jing",-200);
           if ((int)ob->query("neili",1)<0){
