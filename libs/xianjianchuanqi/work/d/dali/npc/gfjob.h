...
mapping *quest = ({
  ({
  (["name":                "江湖宵小",
    "where" :              __DIR__"npc/job/xiaoxiao",]), 
   (["name":                "山贼", 
    "where" :              __DIR__"npc/job/shanzei",]),
    }), 
    ({
     (["name":                "山贼", 
    "where" :              __DIR__"npc/job/shanzei",]),
     (["name":                "盖一鸣",
     "where" :              __DIR__"npc/job/gaiyiming",]),
     (["name":                "常长风",
     "where" :              __DIR__"npc/job/chang",]),
      (["name":                "花剑影",
     "where" :                __DIR__"npc/job/hua",]),
      (["name":                "黄须道人",
     "where" :                __DIR__"npc/job/huangxu",]),
     (["name":                "恶僧",
     "where" :                __DIR__"npc/job/eseng",]),
      (["name":                "曹化淳",
     "where" :                __DIR__"npc/job/cao",]),
      (["name":                "朱安国",
     "where" :                __DIR__"npc/job/zhu",]),
      }), 
      ({
         (["name":                "江洋大盗",
     "where" :                __DIR__"npc/job/dadao",]),
       (["name":                "草寇",
     "where" :                __DIR__"npc/job/caokou",]),
      (["name":                "恶霸",
     "where" :                __DIR__"npc/job/eba",]),
      (["name":                "宋扬",
     "where" :                 __DIR__"npc/job/songyang",]),
      (["name":               "全二风",
     "where" :                 __DIR__"npc/job/quan",]),
      (["name":               "孟正鹏",
     "where" :                 __DIR__"npc/job/meng",]),
      (["name":               "鲜于通",
     "where" :                 __DIR__"npc/job/xian",]),
      (["name":               "麦鲸",
     "where" :                 __DIR__"npc/job/maijing",]),
      (["name":               "过三拳",
     "where" :                 __DIR__"npc/job/guo",]),
       }), 
      ({
      (["name":               "赵一伤",
     "where" :                 __DIR__"npc/job/zhaoyishang",]),   
      (["name":               "钱二败",
     "where" :                 __DIR__"npc/job/qian",]),    
      (["name":               "孙三毁",
     "where" :                 __DIR__"npc/job/sun",]),  
      (["name":               "李四摧",
     "where" :                 __DIR__"npc/job/li",]), 
      (["name":               "周五输",
     "where" :                 __DIR__"npc/job/zhou",]), 
      (["name":               "吴六破",
     "where" :                 __DIR__"npc/job/wu",]), 
      (["name":               "郑七灭",
     "where" :                 __DIR__"npc/job/zheng",]), 
      (["name":               "元广波",
     "where" :                 __DIR__"npc/job/yuan",]), 
      (["name":               "徐长老",
     "where" :                 __DIR__"npc/job/xu",]), 
      (["name":               "单正",
     "where" :                 __DIR__"npc/job/shan",]), 
      (["name":               "霍元风",
     "where" :                 __DIR__"npc/job/huo",]),
      }), 
      ({
      (["name":               "阿大",
     "where" :                 __DIR__"npc/job/ada",]),  
      (["name":               "阿二",
     "where" :                 __DIR__"npc/job/aer",]), 
      (["name":               "阿三",
     "where" :                 __DIR__"npc/job/asan",]), 
      (["name":               "高三娘子",
     "where" :                 __DIR__"npc/job/gao3",]),
      (["name":               "风良",
     "where" :                 __DIR__"npc/job/feng2",]),
      (["name":               "吕正平",
     "where" :                 __DIR__"npc/job/luzhenping",]),
      (["name":               "范一飞",
     "where" :                 __DIR__"npc/job/fanyifei",]),
      (["name":               "成大洋",
     "where" :                 __DIR__"npc/job/chengdayang",]),
      (["name":               "容彩本",
     "where" :                 __DIR__"npc/job/rongcaiben",]),
      (["name":               "洪胜海",
     "where" :                 __DIR__"npc/job/hongshenhai",]),     
      (["name":               "郑起云",
     "where" :                 __DIR__"npc/job/zhengqiyun",]),
      (["name":               "尤得胜",     
     "where" :                 __DIR__"npc/job/youdesheng",]),
      (["name":               "黄伯流",     
     "where" :                 __DIR__"npc/job/huangboliu",]),
      (["name":               "程青竹",     
     "where" :                 __DIR__"npc/job/chengqingzu",]),            
      (["name":               "萧远山",
     "where" :                 __DIR__"npc/job/xiaoyuanshan",]),     
      (["name":               "玉真子",
     "where" :                 __DIR__"npc/job/yu",]),    
     }),
     });
mapping *wheres=({
      (["chinese":                "扬州",
...
int do_jie(string arg)
{
    ...
    if(exp<50000)
        ...
        new(__DIR__"obj/wenshu")->move(me);
