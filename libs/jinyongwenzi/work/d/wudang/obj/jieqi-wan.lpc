...
void create()
{
        set_name(HIG"九转结气丸"NOR, ({"jieqi wan","wan"}));
        if (clonep())
...
int do_eat(string arg)
{
        ...
        { 
                message_vision(HIR "$N吃下一颗九转结气丸，只觉得药性平平，难以再提高你的修为了！\n" NOR, me);
        }
        else
        {
                me->add("max_neili", 1);
                message_vision(HIG "$N吃下一颗九转结气丸，只觉得体内真力源源滋生，过百汇，入丹田，遍走奇筋八脉，全身功力顿然提高！\n" NOR, me);
