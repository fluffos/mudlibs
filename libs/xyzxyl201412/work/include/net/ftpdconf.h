...
*/
#define FTPD_PORT get_system_config(DATA_CONFIG_DIR "net.h", "FTP_PORT")
...
#define FTP_BUGS_EMAIL "long_sheng_hua@163.com"
 ...
 * Example:
#define FTP_USERS ({ "jfeng", "shuang", "duan","rtm" })
 */
#undef FTP_USERS ({"lisa", "wenwu"})
