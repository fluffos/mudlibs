...
set("short", "春院");
set("long", @long
万木竟秀，百花争妍，映山红簇满峰崖，斗奇吐彩，绚丽夺目，相映
成画。天女木兰花白如玉，花朵硕大，幽微吐香，置身其中另人心旷神怡。
露水汇聚成池，熟透了的水果跌落一地。
long
);
        set("exits", ([
"north" : __DIR__"berjaya5",
"south" : __DIR__"berjaya3",
"east" : __DIR__"zack3",
]));
set("objects", ([
                "/d/wolfmount/obj/yeguo" : 3,
       ]) );
        set("coor/x",X_COOR);
        set("coor/y",Y_COOR);
        set("coor/z",Z_COOR);
