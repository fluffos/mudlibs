...
- 世界观真的是"金庸+欧洲中世纪+漫画"三合一：除了华山、武当、丐帮
  等门派场景，`d/lodoss/` 直接搬来了日本奇幻小说《罗德岛战记》
  （Record of Lodoss War）的地理设定——王国阿拉尼亚（Alania）、沙
  漠王国弗雷姆（Frame）等国家背景文字原样收录，是这批档案里最跳
  脱传统武侠框架的一个。
- 角色创建除了性别，还要选择种族（0-5），呼应世界观的跨文化设定，
  不是单一汉人门派体系。
