...
{   
	...
	return 
	       ...
	       query("armor_prop/strength")+" "+
	       query("armor_prop/intelligence")+" "+
	       query("armor_prop/constitution")+" "+
	       query("armor_prop/dodgeaction")+" "+
	       
	       query("armor_prop/personality")+" "+
	       query("armor_prop/karma")+" "+
...
{   
	...
	{   	    
	    ...
	    set("armor_prop/strength",str);
	    set("armor_prop/intelligence",intl);
	    set("armor_prop/constitution",con);
	    set("armor_prop/dodgeaction",dex);
	    
	    set("armor_prop/personality",per);
	    set("armor_prop/karma",kar);
