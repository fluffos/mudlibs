...
string ask_canjun()
{
        ...
        if (me->query("age") < 18)
                return RANK_D->query_respect(me) + "，你还小，以后再来为国效力吧！\n";

        if (me->query("combat_exp") < 1000000)
                return RANK_D->query_respect(me) + "其志可嘉，无奈手无缚鸡之力，还是请回吧！\n";

        if (me->query("combat_exp") > 200000000)
                return "朝廷误信奸人所言，不敢重用真正的能将，怕你造反，你还是回去吧！\n";
