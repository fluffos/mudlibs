...
#define DRUG_D(x)	        ("/clone/drug/" + x)      //new koker      
#define HERB_D(x)	        ("/clone/herb/" + x)      //new koker
#define CLASS_D(x)		("/daemon/class/" + x)
#define SKILL_D(x)		("/daemon/skill/" + x)
#define CONDITION_D(x)	        ("/daemon/condition/" + x)
#define RTIME_D	                "/cmds/usr/ttime"         //new koker
#define NEWS_D		        "/cmds/usr/news"          //new koker
...
//#define F_YAO		        "/feature/yaocai.lpc"      //new koker
