...
ppl++;
        ...
        {
        if (j != k)
        message("system",HIG"【仙侣情缘】太白金星：听说有"+chinese_number(ppl)+"名"
        ...
        {
        message("system",HIG"【仙侣情缘】太白金星慢慢地卷着竹帘，似乎在想着无限心事。\n"NOR,users());
        remove_call_out("choose_npc");
        call_out("choose_npc",60);
        }
}