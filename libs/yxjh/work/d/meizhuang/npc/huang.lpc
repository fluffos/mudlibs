...
void create()
{
        ...
        set_skill("force", 1750);
        set_skill("wuzheng-xinfa", 1750);
        set_skill("dodge", 1750);
        set_skill("piaoyibu", 1750);
        set_skill("parry", 1650);
        set_skill("sword", 1750);
         set_skill("wuxing-jianfa", 1550);
        set_skill("literate", 1500);


        map_skill("force", "wuzheng-xinfa");
        map_skill("dodge", "piaoyibu");
        map_skill("parry", "wuxing-jianfa");
        map_skill("sword", "wuxing-jianfa");
...
void attempt_apprentice(object ob)
{
        ...
        if ((int)ob->query("meizhuangguangling") < 1) {
