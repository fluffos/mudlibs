...
#define __INHERIT_CHAIN_SIZE__      CFG_INT(5)
#define __MAX_EVAL_COST__           CFG_INT(6)
#define __MAX_ARRAY_SIZE__          CFG_INT(7)
#define __MAX_BUFFER_SIZE__         CFG_INT(8)
#define __MAX_MAPPING_SIZE__        CFG_INT(9)
#define __MAX_STRING_LENGTH__       CFG_INT(10)
#define __MAX_BITFIELD_BITS__       CFG_INT(11)
#define __MAX_BYTE_TRANSFER__       CFG_INT(12)
#define __MAX_READ_FILE_SIZE__      CFG_INT(13)
#define __RESERVED_MEM_SIZE__       CFG_INT(14)
#define __SHARED_STRING_HASH_TABLE_SIZE__ CFG_INT(15)
#define __OBJECT_HASH_TABLE_SIZE__        CFG_INT(16)
#define __COMPILER_STACK_SIZE__     CFG_INT(17)

#define __FD6_PORT__		    CFG_INT(18)
#define __FD6_KIND__		    CFG_INT(19)

#define __EVALUATOR_STACK_SIZE__    CFG_INT(20)
#define __MAX_LOCAL_VARIABLES__     CFG_INT(21)
#define __MAX_CALL_DEPTH__          CFG_INT(22)
