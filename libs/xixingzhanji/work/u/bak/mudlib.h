...
#define MUDLIB_NAME                     "西行战记"
#define MUDLIB_VERSION_NUMBER           "1.5"
#define MUDLIB_VERSION                  (MUDLIB_NAME + " " + MUDLIB_VERSION_NUMBER)

#define INTERMUD_MUD_NAME               "xxzj.sd"
#define INTERMUD_NAME                   "西行战记"
#define CHINESE_MUD_NAME                "西行战记[山东站]"
#define MUD_ADMIN                       "xxzj@10mail.net"
#define MUD_WEB                         "http://zmud.chutian.net"
