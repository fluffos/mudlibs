...
// 11-1-95
// ES
#define MUDLIST_DNS ({ "202.108.122.195",6665 })
// enchanted rock
#define MUDLIST_BAK ({ "202.108.122.195",6665 })

#define LISTNODES ([ \
        "XXZJ.AH":"202.102.202.100 8892",\
        "XXZJ.SH":"202.109.73.244 6670",\
        "XXZJ.JS":"61.132.36.68 8892",\
        "XXZJ.BJ":"202.108.122.195 8892",\
        "WLLZII.FH":"202.104.32.221 2004",\
        "WLLZII.KC":"61.156.17.111 2004",\
        "WLLZI.NH":"202.104.16.44 5559",\
])
/* These IP are not welcome
 * add by ken@chinesemud.net
 */
#define BANDLIST ([\
        "The.Admin.Mud" : "202.108.122.195 8892",\
])
