...
void init()
{
	...
	//set("combat_exp",ob->query("combat_exp")/2);
      set("no_quest",1);
	set("chat_chance", 50);
	set("chat_msg", ({
		(: random_move :)
...
{
	string *lname = ({
"ha","han","kang","bi","zai","fao","te","er","gen","peng","mo","non","lou","song","ce","nei","den","feng","er","li","win","ring","yiu","yu",
"pui","vn","hun","nvn","cun","duan","fei","gan","huan","jian","kou","lang","mai","nie","peng","qian","rang","san","tai","wang","xian","ying","zheng","chang",
"zhai","shao","thao",
			});
			 return (lname[random(51)] + " "+lname[random(51)]);
}
