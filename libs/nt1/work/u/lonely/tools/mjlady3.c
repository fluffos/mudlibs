...
void create()
{
	set_name("Âé½«°¢ÒÌ",({"mj lady","lady"}));
	set("long",@LONG

Ò»¸öÅÖÅÖµÄ°¢ÒÌÕıÔÚ¶¢ÖøÄã¡£
...
void init()
{
   ...
   add_action("do_look","k");
   add_action("do_look","k1");
   add_action("do_look","k2");
   add_action("do_look","k3");
   add_action("do_look","k4");
   add_action("do_look","kk");
   add_action("do_look","k0");   
