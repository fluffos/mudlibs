...
int main(object me, string arg)
{
        ...
        case "str":
                ...
                tell_object(me, HIG "你的「" + HIR + "膂力" + NOR + HIG "」提升了 " + HIR + chinese_number(jnd) + NOR + HIG + " 点！\n" NOR);
                break;
        case "悟性":
        case "int":
                me->add("improve/int", jnd);
                tell_object(me, HIY "冥冥中，你似乎感觉有一道光芒射入你的体内！\n" NOR);
                tell_object(me, HIG "你的「" + HIR + "悟性" + NOR + HIG "」提升了 " + HIR + chinese_number(jnd) + NOR + HIG + " 点！\n" NOR);
                break;
        case "根骨":  
        case "con":  
                me->add("improve/con", jnd);
                tell_object(me, HIY "冥冥中，你似乎感觉有一道光芒射入你的体内！\n" NOR);
                tell_object(me, HIG "你的「" + HIR + "根骨" + NOR + HIG "」提升了 " + HIR + chinese_number(jnd) + NOR + HIG + " 点！\n" NOR);
                break;
        case "身法":
        case "dex":
                me->add("improve/dex", jnd);
                tell_object(me, HIY "冥冥中，你似乎感觉有一道光芒射入你的体内！\n" NOR);
                tell_object(me, HIG "你的「" + HIR + "身法" + NOR + HIG "」提升了 " + HIR + chinese_number(jnd) + NOR + HIG + " 点！\n" NOR);
                break;
        default:  
                return notify_fail("指令格式：allocate <后天属性> <技能点数>\n");
                break;
