...
int main(object me, string arg)
{
	...
	message_vision("$N盘膝坐下，开始冥神运功，闭关修行阴阳九转十二重天。\n", me);
        ...
        me->set("yinyang-shiertian/xiulian", sign);
...
int mending(object me)
{
	...
	switch ((string)me->query("yinyang-shiertian/xiulian"))	
        {
        case "shier":
        ...
        if (random(4000000) < me->query_skill("yinyang-shiertian", 1))
        {
	        ...
	        if ((string)me->query("yinyang-shiertian/xiulian") == "shier")
	        {
	                me->add("yinyang-shiertian/shier", 1);
		        if ((int)me->query("yinyang-shiertian/shier") == 12)
		        {
                ...
                if ((string)me->query("yinyang-shiertian/xiulian") == "qiankun")
	        {
	                me->add("yinyang-shiertian/jiu", 1);
		        if ((int)me->query("yinyang-shiertian/jiu") == 9)
		        {
			        me->delete("yinyang-shiertian");
                ...
                if ((string)me->query("yinyang-shiertian/xiulian") == "yinyang")
	        {
        ...
        if ((string)me->query("yinyang-shiertian/xiulian") == "yinyang")
        {
                if ((string)me->query("yinyang-shiertian/zhen") == "yin")
		        msg = "$N脚下不丁不八，倚着浑厚的大地身形凝重如山，一股寒阴之气"
		              "自地底极深处传入$N的四经八脉。\n";
                else
                if ((string)me->query("yinyang-shiertian/zhen") == "yinyang")
                {
                        if (random(2) == 1)
