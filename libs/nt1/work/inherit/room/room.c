...
/*
// by Lonely for messages
void init()
{
        if (interactive(this_player()) && mapp(query_temp("messages")) &&
            this_player()->query("id") == query_temp("messages/who")  &&
            ! this_player()->is_fighting())
        {
                tell_object(this_player(), query_temp("messages/msg"));
                delete_temp("messages");
        }
}
*/
