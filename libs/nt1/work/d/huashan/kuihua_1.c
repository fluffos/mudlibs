...
int do_look(string arg)
{
        ...
        {
                if (query("over")) return notify_fail("一扇紧闭着的窗户，没什么好瞧的。\n");
                if (query("begin")) return notify_fail("窗户里两个人影正在谈话，要偷听就别动。\n");
                if (objectp(inv)) return notify_fail("东西已经到手了，还是赶紧离开为好。\n");
                if (me->query("gender") != "无性") return notify_fail("一扇紧闭着的窗户，没什么好瞧的。\n");
                else
                {
                message_vision(HIB "$N望窗户瞧去，只见窗前立着两个淡淡的人影，正在低声细语，$N" HIB
                                   "忍耐不住好奇，悄悄\n"
                                   "的走到窗前偷听两人的对话。\n" NOR,me);
...
int do_talk1(object me)
{
        message_vision( WHT "\n只听得一位女子的声音说道：“师哥，我觉得你近来神色不对，是不是练那紫霞神功有\n"
                              "些儿麻烦？可别太求精进，惹出乱子来。”听声音似乎是华山掌门夫人宁中则。\n" NOR,me);
...
{
        message_vision( WHT "\n那女子又道：“你别瞒我，为甚么你近来说话的嗓子变了，又尖又高，倒像女人似的。”\n" NOR,me);
...
{
        message_vision( HIB "\n你听得那男子说这句话，嗓声果然相当尖，确像是个女子在大发脾气。\n" NOR,me);
...
int do_talk14(object me)
{
        message_vision( WHT "\n那女子说道：“我又何必偷看这才知道？你说话的声音，就已经全然变了，人人都听得\n"
                              "出来，难道你自己反而不觉得？每天早晨，你被窝里总是落下了许多胡须……”\n" NOR,me);
...
int do_talk20(object me)
{
        ...
        message_vision( HIR "\n$N大吃一惊，便想出声阻止，剑谱乃不世之物，管他有益有害，岳老贼可无权毁去。便\n"
                              ...
                              "即缩将回来，当真幸运得紧，竟将那袈裟勾到了，没落入天声峡下的万仞深渊中。\n\n" NOR,me);
        set("over",1);
        me->set_temp("over",1);
        message_vision( HIY "$N得到一本《葵花宝典》。\n" NOR, me);
