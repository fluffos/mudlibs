...
void create()
{
	set("short", "金牛武馆");
	set("long", @LONG
「金牛武馆」在江湖中很有名声，很多大侠自小就是从这里走进江湖。
虽然他们在江湖早已成名立万，这里的师傅年纪也都大了，却是他们的启
蒙业师，他们也常回来看望师傅们，因此这里长久得到黑白两道的尊重，
不容侵犯。这里是武馆大厅。馆主马五德在此请授：基本轻功，基本内功，
基本招架，基本手法，基本刀法。墙上贴着个贴子(tiezi)。
LONG );
	set("objects", ([
