...
void create()
{
        ...
        set_skill("xuantian-shengong",SPE_SKILL);
        set_skill("liangyi-jian", SPE_SKILL);
        set_skill("taxue-wuhen", SPE_SKILL);
        set_skill("sanyin-zhua",SPE_SKILL);
           
           map_skill("dodge", "taxue-wuhen");
           map_skill("force", "xuantian-shengong");
           map_skill("parry", "liangyi-jian");
           map_skill("sword", "liangyi-jian");
           map_skill("unarmed","sanyin-zhua");   
 

    create_family("昆仑派", 16, "弟子");
    setup();
