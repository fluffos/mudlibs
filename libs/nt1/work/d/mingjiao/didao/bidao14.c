...
{ 
       set("short","秘室");
       set("long", @LONG
这是一个较大的秘室。是明教历代教主练功的地方，秘室内用器样样
具全，东边有一张大石床，床上躺着一具已干枯的的男性骸骨(haigu），
只有毛发和衣服尚没腐烂，床延伏着一具较为瘦小的骸骨(haigu），衣着
为女性衣服，骸骨上插着一把短剑，想是当年自尽而忙。秘室四周皆为石
壁(wall)，没有任何的出路通何外面。
LONG );
        set("objects",([
                 "/d/mingjiao/npc/haigu1"  : 1,
                 "/d/mingjiao/npc/haigu2"  : 1,
        ]));
        set("item_desc", ([
