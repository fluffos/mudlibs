...
void create()
{
        ...
        set("long", @LONG
这里就是有名的古赤壁，对岸一面巨大的悬崖上书有“赤壁”两个大
字，想当年曹操百万精兵在此被周愈杀的片甲不留，含恨而归，大文学家
苏东坡游临此地，感慨的留下了“遥想公谨当年，小乔初嫁了，羽扇纶巾，
雄姿英发，谈笑间，强虏灰飞烟灭。。。。”令后人引为佳句。从这里向
江面看去，只见滚滚江水东流去，江面上若隐若现一条条大铁索(tiesuo)，
原来是当年吴国为了抵御曹操而修的锁江链。
LONG );
