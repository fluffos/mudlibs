// SN:2Ig2fl^aW^AhUHU`
// File(/data/room/noone/huayuan.c) of noone's room
...
void create()
{
	set("short", "后花园");
	set ("long", @LONG
这是神话传说的后花园，种着一些决不拜师采自五湖四海、名山
大川的奇花异草，美丽非常。决不拜师有时读书练武疲倦了，就到这
