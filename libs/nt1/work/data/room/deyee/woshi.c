// SN:I@8T`8XIKgo4\hjF
// File(/data/room/deyee/woshi.c) of deyee's room
...
void create()
{
        set("short", "无影门卧室");
	set ("long", @LONG
巧雅别致的猫儿窝。一进门，扑面而来一种悠悠的清香，圆锥型
的屋顶尖镶嵌着一颗美丽的夜明珠，壁上挂着一幅猫儿亲手绘制的仕
女图。西窗下摆放着一张心型的寒冰床，隐约中释放着丝丝的寒气。
一袭淡紫色的纱帐轻拢着小床，微风轻轻拂过，紫纱也随风飞舞。透
过小巧的窗户，可以看到院落的的小竹林。[2;37;0m
LONG );
