// SN:e`6M=^QWX\3]LnWH
// File(/data/room/xiaodongxi/qianting.c) of xiaodongxi's room
...
void create()
{
        ...
        set("short", "°®µÄĞ¡ÎİÇ°Í¥");
	set ("long", @LONG
´©¹ıÔºÂä£¬¾¹È»±ğÓĞ¶´Ìì¡£µ«ÊÇËÆºõ°²¾²Òì³££¬Í¥ÔºÖĞ²»ÉÙÊ÷Ä¾
ÒÑÈ»ÓĞÕÚÌìÖ®ÊÆ£¬ÄÜ¿´µ½Äñ¶ùµÄÉíÓ°£¬È´Ìı²»¼ûßóßóÔûÔûµÄÃù½Ğ.....
±±ÃæÓĞÒ»ÉÈË®¾§ÃÅ½ô½ôµÄ¹Ø±Õ×Å¡£[2;37;0m
LONG );
