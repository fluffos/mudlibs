// SN:;d;ZXjNFCPk@O6I^
// ITEM Made by player(洛神:lshen) /data/item/l/lshen-xgw.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Jan 10 12:56:35 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m小钢腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m小钢腕[2;37;0m[33m。[2;37;0m\n");
