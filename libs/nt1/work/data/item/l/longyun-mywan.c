// SN::`cd`LZ7OKG`XMoe
// ITEM Made by player(龙云:longyun) /data/item/l/longyun-mywan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed May 26 11:29:46 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("青龙[2;37;0m", ({ "mywan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：龙云(longyun)
");
	set("value", 2100000);
	set("point", 7525);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备青龙[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了青龙[2;37;0m[33m。[2;37;0m\n");
