// SN:E>5l>Ji5_U8JRZe3
// ITEM Made by player(洛神:lshen) /data/item/l/lshen-zqyce.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug 17 17:46:40 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m朱雀[1;33m头盔[2;37;0m", ({ "zqyce" }));
	set_weight(4500);
	set("item_make", 1);
	set("unit", "顶");
