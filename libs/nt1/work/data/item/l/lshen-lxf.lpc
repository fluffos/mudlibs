// SN:LK`U@ad1fMelVVdQ
// ITEM Made by player(洛神:lshen) /data/item/l/lshen-lxf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Jan 21 19:17:09 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[34m绣花护腕[2;37;0m", ({ "lxf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[2;37;0m[34m绣花护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[2;37;0m[34m绣花护腕[2;37;0m[33m。[2;37;0m\n");
