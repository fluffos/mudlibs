// SN:5;52K^XYdQFMB9A>
// ITEM Made by player(南宫图:leslieace) /data/item/l/leslieace-lab.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Jan  1 12:27:32 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m龙[1;33m之[1;31m腕[2;37;0m", ({ "lab" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：南宫图(leslieace)
");
	set("value", 2100000);
	set("point", 73);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;31m龙[1;33m之[1;31m腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m龙[1;33m之[1;31m腕[2;37;0m[33m。[2;37;0m\n");
