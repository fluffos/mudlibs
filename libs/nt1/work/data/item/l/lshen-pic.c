// SN:TSTBXj68>9PT[^aZ
// ITEM Made by player(洛神:lshen) /data/item/l/lshen-pic.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Jan 16 00:00:46 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备皮腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了皮腕[2;37;0m[33m。[2;37;0m\n");
