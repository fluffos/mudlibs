// SN:1U]o_;d0L@X^U7\o
// ITEM Made by player(空浪:ldz) /data/item/l/ldz-qllbk.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Apr 20 19:46:41 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m青龙[1;33m鳞二腕[2;37;0m", ({ "qllbk" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m青龙[1;33m鳞二腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m青龙[1;33m鳞二腕[2;37;0m[33m。[2;37;0m\n");
