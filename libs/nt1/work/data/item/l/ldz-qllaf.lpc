// SN:MJ<H=Dek8LD[c]l<
// ITEM Made by player(浪荡子:ldz) /data/item/l/ldz-qllaf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Mar 15 23:51:42 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m青龙[1;33m鳞一腕[2;37;0m", ({ "qllaf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m青龙[1;33m鳞一腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m青龙[1;33m鳞一腕[2;37;0m[33m。[2;37;0m\n");
