// SN:[c3Cm4il`MBf:DX[
// ITEM Made by player(云破月:live) /data/item/l/live-lyf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Oct 24 00:27:23 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;35m流光[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m流光[2;37;0m[33m。[2;37;0m\n");
