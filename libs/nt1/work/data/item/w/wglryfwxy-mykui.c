// SN:IWa@kK\5_GQHQ1KZ
// ITEM Made by player(云涛:wglryfwxy) /data/item/w/wglryfwxy-mykui.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Sep 30 00:54:38 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;34m云涛宝盔[2;37;0m", ({ "mykui" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：云涛(wglryfwxy)
");
	set("value", 2100000);
	set("point", 58);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;34m云涛宝盔[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;34m云涛宝盔[2;37;0m[33m。[2;37;0m\n");
