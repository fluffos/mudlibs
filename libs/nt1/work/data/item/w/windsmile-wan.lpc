// SN:dZ[NgT:kk8?nTKlh
// ITEM Made by player(段子羽:windsmile) /data/item/w/windsmile-wan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Dec  4 23:08:30 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m苍狼[1;37m之腕[2;37;0m", ({ "wan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m苍狼[1;37m之腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m苍狼[1;37m之腕[2;37;0m[33m。[2;37;0m\n");
