// SN:Icb\B<R5=FPokHmS
// ITEM Made by player(王小石:wxs) /data/item/w/wxs-sne.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Jul 18 09:14:02 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m兽香不断[2;37;0m", ({ "sne" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;35m兽香不断[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m兽香不断[2;37;0m[33m。[2;37;0m\n");
