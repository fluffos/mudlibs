// SN:M1^FS>Q6f?LjfF=0
// ITEM Made by player(给我新鲜:whz) /data/item/w/whz-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat May 22 01:53:47 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[37m战神护腕[2;37;0m", ({ "huwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[2;37;0m[37m战神护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[2;37;0m[37m战神护腕[2;37;0m[33m。[2;37;0m\n");
