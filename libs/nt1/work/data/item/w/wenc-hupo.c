// SN:d^dDP?3R5Gkm^bUT
// ITEM Made by player(虚欧:wenc) /data/item/w/wenc-hupo.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun May 30 18:26:07 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m琥珀环[2;37;0m", ({ "hupo" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;33m琥珀环[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m琥珀环[2;37;0m[33m。[2;37;0m\n");
