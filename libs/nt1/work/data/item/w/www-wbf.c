// SN:1]=<7nf:f`MCoTAL
// ITEM Made by player(悟空:www) /data/item/w/www-wbf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Apr 22 04:57:58 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m混元[1;32m盘金锁[2;37;0m", ({ "wbf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
镇元大仙的神兵之一，除了能增加佩带者的灵气血气外，还能增强主人的能力。[2;37;0m
护腕缘上刻着一行小字：悟空(www)
");
	set("value", 2100000);
	set("point", 212);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;37m混元[1;32m盘金锁[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m混元[1;32m盘金锁[2;37;0m[33m。[2;37;0m\n");
