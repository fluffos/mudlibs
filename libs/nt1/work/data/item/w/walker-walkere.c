// SN:G75J`M<Do:g2\h0<
// ITEM Made by player(拾荒者:walker) /data/item/w/walker-walkere.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Sep 11 03:38:32 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[33m德鲁依[37m护腕[2;37;0m", ({ "walkere" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[2;37;0m[33m德鲁依[37m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[2;37;0m[33m德鲁依[37m护腕[2;37;0m[33m。[2;37;0m\n");
