// SN:eQ0l>dC3VAbiLP?8
// ITEM Made by player(武林列传:wllz) /data/item/w/wllz-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Sep  7 11:59:26 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m武林列传[2;37;0m", ({ "huwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：武林列传(wllz)
");
	set("value", 2100000);
	set("point", 775);
