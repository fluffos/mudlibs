// SN:NFH[V<W9S4H`[SFQ
// ITEM Made by player(段子羽:windsmile) /data/item/w/windsmile-windf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Jul 28 13:39:04 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m太白[1;37m灭星腕[2;37;0m", ({ "windf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：段子羽(windsmile)
");
	set("value", 2100000);
	set("point", 236);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m太白[1;37m灭星腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m太白[1;37m灭星腕[2;37;0m[33m。[2;37;0m\n");
