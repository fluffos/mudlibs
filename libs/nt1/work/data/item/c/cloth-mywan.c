// SN:R>hN^c4B87U;60H:
// ITEM Made by player(布衣:cloth) /data/item/c/cloth-mywan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Aug 12 22:15:09 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m上帝之腕[2;37;0m", ({ "mywan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;33m上帝之腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m上帝之腕[2;37;0m[33m。[2;37;0m\n");
