// SN:Lb[E`hVbZ[;Olf`f
// ITEM Made by player(韩明远:cry) /data/item/c/cry-teiwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Aug 18 15:32:30 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[33m铁腕[2;37;0m", ({ "teiwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[2;37;0m[33m铁腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[2;37;0m[33m铁腕[2;37;0m[33m。[2;37;0m\n");
