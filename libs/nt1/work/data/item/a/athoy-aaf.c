// SN:>;b58le:H=;`^PU:
// ITEM Made by player(神游:athoy) /data/item/a/athoy-aaf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Apr  1 22:23:44 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m收云琢[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m收云琢[2;37;0m[33m。[2;37;0m\n");
