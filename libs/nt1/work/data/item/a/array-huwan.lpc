// SN:_Hd^hM1_WZVfj@ej
// ITEM Made by player(艾汀:array) /data/item/a/array-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Sep  8 09:42:21 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m武林护腕[2;37;0m", ({ "huwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m武林护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m武林护腕[2;37;0m[33m。[2;37;0m\n");
