// SN:VS=ZPkU0el=V5Ani
// ITEM Made by player(逗你玩:asd) /data/item/a/asd-asde.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug  3 22:26:26 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备补天腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了补天腕[2;37;0m[33m。[2;37;0m\n");
