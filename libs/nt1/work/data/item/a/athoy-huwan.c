// SN:9m6Gn398FgBEnmH1
// ITEM Made by player(神游:athoy) /data/item/a/athoy-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Jun 30 17:06:56 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m收云琢[2;37;0m", ({ "huwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[1;37m戴上收云琢[2;37;0m\n");
	set("remove_msg", "[1;37m天玄脱下收云琢[2;37;0m\n");
