// SN:8VEa4?B6b3l33_5P
// ITEM Made by player(神游:athoy) /data/item/a/athoy-lankui.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Nov 23 14:16:20 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m雪[1;31m狼盔[2;37;0m", ({ "lankui" }));
	set_weight(4500);
	set("item_make", 1);
	set("unit", "顶");
