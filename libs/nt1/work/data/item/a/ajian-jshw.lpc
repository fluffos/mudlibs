// SN:gom7nF?27iQ>1^cd
// ITEM Made by player(啊健:ajian) /data/item/a/ajian-jshw.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Oct 18 14:49:18 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m绝世好腕[2;37;0m", ({ "jshw" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m绝世好腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m绝世好腕[2;37;0m[33m。[2;37;0m\n");
