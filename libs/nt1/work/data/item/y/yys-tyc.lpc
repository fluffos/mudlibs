// SN:C:h[Jb[hIP9PgGgH
// ITEM Made by player(阴阳师:yys) /data/item/y/yys-tyc.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Apr 14 19:07:32 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m天阴腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m天阴腕[2;37;0m[33m。[2;37;0m\n");
