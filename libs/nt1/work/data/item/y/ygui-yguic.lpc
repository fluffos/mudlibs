// SN:H8Cf=2Wd2h=3k[JZ
// ITEM Made by player(夜鬼:ygui) /data/item/y/ygui-yguic.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Apr 16 14:41:49 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m虚空[2;37;0m", ({ "yguic" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m虚空[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m虚空[2;37;0m[33m。[2;37;0m\n");
