// SN:L<KH?J5QP]06kL@g
// ITEM Made by player(浦饭幽助:youzhu) /data/item/y/youzhu-zhanyi.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Sep 21 07:36:33 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m圣灵披风[2;37;0m", ({ "zhanyi" }));
	set_weight(1400);
	set("item_make", 1);
	set("unit", "件");
