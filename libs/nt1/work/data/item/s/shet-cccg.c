// SN:jN69?`8a@C<7cKPE
// ITEM Made by player(慕容星:shet) /data/item/s/shet-cccg.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Sep 21 15:52:49 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m素衣莫起风尘叹[2;37;0m", ({ "cccg" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m素衣莫起风尘叹[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m素衣莫起风尘叹[2;37;0m[33m。[2;37;0m\n");
