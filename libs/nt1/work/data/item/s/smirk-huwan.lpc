// SN:fBbFEPU=R808GXe4
// ITEM Made by player(段浪:smirk) /data/item/s/smirk-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Sep 21 09:47:15 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m雷电[2;37;0m", ({ "huwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m雷电[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m雷电[2;37;0m[33m。[2;37;0m\n");
