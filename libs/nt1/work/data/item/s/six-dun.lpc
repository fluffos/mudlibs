// SN:oTE1QY2]8??fAX23
// ITEM Made by player(渡段:six) /data/item/s/six-dun.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Jan  1 22:39:45 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[1;33m拿出天皇盾[2;37;0m\n");
	set("remove_msg", "[1;33m放下天皇盾[2;37;0m\n");
