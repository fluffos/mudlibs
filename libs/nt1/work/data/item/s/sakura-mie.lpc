// SN:M`8VA>FkBJX[iC2V
// ITEM Made by player(真宫寺樱:sakura) /data/item/s/sakura-mie.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Mar 24 09:54:14 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m灭却[2;37;0m", ({ "mie" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：真宫寺樱(sakura)
");
	set("value", 2100000);
	set("point", 78);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m灭却[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m灭却[2;37;0m[33m。[2;37;0m\n");
