// SN:R\KIENLdP<KNX>g@
// ITEM Made by player(段剑:swordmo) /data/item/s/swordmo-shoulian.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Oct  6 06:38:04 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m紫金[1;33m手链[2;37;0m", ({ "shoulian" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：段剑(swordmo)
");
	set("value", 2100000);
	set("point", 47);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m紫金[1;33m手链[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m紫金[1;33m手链[2;37;0m[33m。[2;37;0m\n");
