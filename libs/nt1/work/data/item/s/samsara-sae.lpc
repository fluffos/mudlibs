// SN:8Om0SV3@G?SJXAMK
// ITEM Made by player(前世今生:samsara) /data/item/s/samsara-sae.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Dec 16 13:04:03 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[37m骷髅王冠[2;37;0m", ({ "sae" }));
	set_weight(4500);
	set("item_make", 1);
	set("unit", "顶");
