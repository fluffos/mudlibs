// SN:8Z63>DW@[K0glX>a
// ITEM Made by player(魔影:steel) /data/item/s/steel-steeld.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue May  4 10:46:43 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m护腕[2;37;0m", ({ "steeld" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m护腕[2;37;0m[33m。[2;37;0m\n");
