// SN:mRd9aW4?d;A>1c>1
// ITEM Made by player(太子:taizi) /data/item/t/taizi-kkxf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Feb 29 18:37:01 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;34m千杀水翔[2;37;0m", ({ "kkxf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;34m千杀水翔[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;34m千杀水翔[2;37;0m[33m。[2;37;0m\n");
