// SN:cCCfCY<GK_l3Bn]Q
// ITEM Made by player(太子:taizi) /data/item/t/taizi-dog.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Aug  4 15:03:28 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m道具七号[2;37;0m", ({ "dog" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m道具七号[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m道具七号[2;37;0m[33m。[2;37;0m\n");
