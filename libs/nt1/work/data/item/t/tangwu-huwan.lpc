// SN:QUX^HdU4<W]`ke`K
// ITEM Made by player(唐五藏:tangwu) /data/item/t/tangwu-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Dec 13 21:28:13 2003
#include <ansi.h>
#include <armor.h>
...
看上去挺普通的东东，不过伴随主人纵横江湖很多年了。[2;37;0m
护腕缘上刻着一行小字：唐五藏(tangwu)
");
	set("value", 2100000);
	set("point", 59);
	set("material", "magic stone");
	set("wear_msg", "[1;33m$N将一副$n[1;33m套在腕上。[2;37;0m\n");
