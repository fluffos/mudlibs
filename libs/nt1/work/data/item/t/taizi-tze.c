// SN:[?ZZ?Uck>[f_VYXa
// ITEM Made by player(太子:taizi) /data/item/t/taizi-tze.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Feb  8 11:23:06 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m我[1;33m爱你永远[2;37;0m", ({ "tze" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m我[1;33m爱你永远[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m我[1;33m爱你永远[2;37;0m[33m。[2;37;0m\n");
