// SN:S[NZ:X0Y>FOULYfJ
// ITEM Made by player(太子:taizi) /data/item/t/taizi-leafs.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Jan 31 14:31:14 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m落叶[2;37;0m", ({ "leafs" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;33m落叶[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m落叶[2;37;0m[33m。[2;37;0m\n");
