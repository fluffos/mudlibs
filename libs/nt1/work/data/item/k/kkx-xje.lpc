// SN:g1IW?\C[_\oGmF\V
// ITEM Made by player(卡卡西:kkx) /data/item/k/kkx-xje.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Mar 21 20:52:36 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m邪手[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m邪手[2;37;0m[33m。[2;37;0m\n");
