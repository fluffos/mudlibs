// SN:m0UbJ8DbW2j03;Vf
// ITEM Made by player(闲聊:klatch) /data/item/k/klatch-xxw.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug  3 22:34:55 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("闲腕[2;37;0m", ({ "xxw" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：闲聊(klatch)
");
	set("value", 2100000);
	set("point", 261);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备闲腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了闲腕[2;37;0m[33m。[2;37;0m\n");
