// SN:ZOmC:QR?lE[@mo7H
// ITEM Made by player(伯约:boyuezi) /data/item/b/boyuezi-baf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Jun  3 19:06:48 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[37m五岳真气[2;37;0m", ({ "baf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
