// SN:R]FofZ>l>jB<<^HL
// ITEM Made by player(伯约:boyuezi) /data/item/b/boyuezi-hand.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Aug 18 06:43:04 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[31m轩辕之心[2;37;0m", ({ "hand" }));
	set_weight(2700);
	set("item_make", 1);
	set("unit", "双");
