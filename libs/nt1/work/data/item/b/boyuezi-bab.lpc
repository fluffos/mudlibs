// SN:bMZK_cIbgmG_ZH^Z
// ITEM Made by player(伯约:boyuezi) /data/item/b/boyuezi-bab.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Jun  3 19:11:48 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[34m乾坤袈裟[2;37;0m", ({ "bab" }));
	set_weight(1400);
	set("item_make", 1);
	set("unit", "件");
