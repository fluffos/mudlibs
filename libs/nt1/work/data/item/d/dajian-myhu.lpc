// SN:\gdeFHH]F\N>gNXX
// ITEM Made by player(步小嘉:dajian) /data/item/d/dajian-myhu.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Sep  4 15:23:11 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备烈火护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了烈火护腕[2;37;0m[33m。[2;37;0m\n");
