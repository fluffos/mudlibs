// SN:LWcEQOld>D43bmiD
// ITEM Made by player(藏马:donb) /data/item/d/donb-zhuo.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Oct  6 13:44:24 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[35m毁灭手镯[2;37;0m", ({ "zhuo" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[2;37;0m[35m毁灭手镯[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[2;37;0m[35m毁灭手镯[2;37;0m[33m。[2;37;0m\n");
