// SN:^_:fi6De4lFa7\5M
// ITEM Made by player(段誉:duanyu) /data/item/d/duanyu-dyab.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Aug 20 17:00:21 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m白莲[1;33m护腕[2;37;0m", ({ "dyab" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：段誉(duanyu)
");
	set("value", 2100000);
	set("point", 265);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;37m白莲[1;33m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m白莲[1;33m护腕[2;37;0m[33m。[2;37;0m\n");
