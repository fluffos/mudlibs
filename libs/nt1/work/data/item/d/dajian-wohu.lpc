// SN:U[^4kWF8W:E;>U2^
// ITEM Made by player(步小嘉:dajian) /data/item/d/dajian-wohu.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Sep  8 17:18:19 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m圣火护腕[2;37;0m", ({ "wohu" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：步小嘉(dajian)
");
	set("value", 2100000);
	set("point", 55);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;31m圣火护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m圣火护腕[2;37;0m[33m。[2;37;0m\n");
