// SN:LK_g8=;GkcbkWP?@
// ITEM Made by player(藏马:donb) /data/item/d/donb-dddf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Feb  8 16:13:41 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m苍狼之心[2;37;0m", ({ "dddf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m苍狼之心[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m苍狼之心[2;37;0m[33m。[2;37;0m\n");
