// SN:QSHYW0]l_Vb=8Bac
// ITEM Made by player(风二中:dajianb) /data/item/d/dajianb-sfhw.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Sep 25 11:01:30 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m神风护腕[2;37;0m", ({ "sfhw" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：风二中(dajianb)
");
	set("value", 2100000);
	set("point", 56);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;37m神风护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m神风护腕[2;37;0m[33m。[2;37;0m\n");
