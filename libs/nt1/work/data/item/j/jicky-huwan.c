// SN:P:]`@=bNZ:Od]aJK
// ITEM Made by player(毛毛:jicky) /data/item/j/jicky-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat May 15 12:27:17 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m狂风护腕[2;37;0m", ({ "huwan" }));
	set_weight(2250);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("point", 11);
	set("material", "iron");
	set("wear_msg", "[33m$N[33m装备[1;37m狂风护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m狂风护腕[2;37;0m[33m。[2;37;0m\n");
