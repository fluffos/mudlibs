// SN:L[L@Yek^Cid@c1fd
// ITEM Made by player(九阳神功:jiuyang) /data/item/j/jiuyang-hubi.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Oct 25 22:04:57 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m黄金圣[1;35m腕[2;37;0m", ({ "hubi" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：九阳神功(jiuyang)
");
	set("value", 2100000);
	set("point", 55);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;33m黄金圣[1;35m腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m黄金圣[1;35m腕[2;37;0m[33m。[2;37;0m\n");
