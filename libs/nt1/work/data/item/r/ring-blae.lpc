// SN:Ma8aVdTG8aLK]\n3
// ITEM Made by player(白莲:ring) /data/item/r/ring-blae.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jul 20 20:26:58 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m白莲护腕[2;37;0m", ({ "blae" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m白莲护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m白莲护腕[2;37;0m[33m。[2;37;0m\n");
