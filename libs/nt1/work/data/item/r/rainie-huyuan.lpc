// SN:8OU2LgM4=ijn]?6]
// ITEM Made by player(秦梦遥:rainie) /data/item/r/rainie-huyuan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jul 27 11:23:25 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("铁护腕[2;37;0m", ({ "huyuan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：秦梦遥(rainie)
");
	set("value", 2100000);
	set("point", 210);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备铁护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了铁护腕[2;37;0m[33m。[2;37;0m\n");
