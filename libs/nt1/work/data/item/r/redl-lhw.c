// SN:YI]6K;QXg]E`2mE?
// ITEM Made by player(红莲老祖:redl) /data/item/r/redl-lhw.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jan  6 21:15:42 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m莲花腕[2;37;0m", ({ "lhw" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：红莲老祖(redl)
");
	set("value", 2100000);
	set("point", 70);
	set("material", "magic stone");
	set("wear_msg", "$N掏出一些碧青色的药丸在莲花腕上涂涂抹抹。\n莲花腕准备完毕。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m莲花腕[2;37;0m[33m。[2;37;0m\n");
