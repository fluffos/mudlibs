// SN:FDA0R_e5]@HH>KE;
// ITEM Made by player(日月侠:riyuex) /data/item/r/riyuex-rywan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Aug 31 17:16:22 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("日月护腕[2;37;0m", ({ "rywan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：日月侠(riyuex)
");
	set("value", 2100000);
	set("point", 55);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备日月护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了日月护腕[2;37;0m[33m。[2;37;0m\n");
