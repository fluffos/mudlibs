// SN:eUHQE2P<Z\;94H[W
// ITEM Made by player(胡探索:rtest) /data/item/r/rtest-rtestab.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Aug 21 00:26:21 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m神秘[1;32m护腕[2;37;0m", ({ "rtestab" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：胡探索(rtest)
");
	set("value", 2100000);
	set("point", 122);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;37m神秘[1;32m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m神秘[1;32m护腕[2;37;0m[33m。[2;37;0m\n");
