// SN:=T:fMl^3Wg6h_1BI
// ITEM Made by player(傅君婥:fujunzhuo) /data/item/f/fujunzhuo-shadow.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Mar 12 18:22:26 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m月[1;32m之[1;34m魅影[2;37;0m", ({ "shadow" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
[1;35m一串美丽的腕链，中间由一个月亮形的饰品连接着，上面浮光流动，让人把握不住。[2;37;0m
护腕缘上刻着一行小字：傅君婥(fujunzhuo)
");
	set("value", 2100000);
	set("point", 70);
	set("material", "magic stone");
	set("wear_msg", "[1;35m$N娇笑一声，带上了一根叮当作响的手链，双颊容光焕发，浑似变了一个人。[2;37;0m\n");
	set("remove_msg", "[1;35m$N低叹，取下了手中的腕链，放入怀中，脸色笼上了一层严霜。[2;37;0m\n");
