// SN:ERLEgWi8bHfEILen
// ITEM Made by player(飞机:feiji) /data/item/f/feiji-kui.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug  3 13:09:35 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m黑凤凰只盔[2;37;0m", ({ "kui" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m黑凤凰只盔[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m黑凤凰只盔[2;37;0m[33m。[2;37;0m\n");
