// SN:eQOoj]WM6B;5?La`
// ITEM Made by player(天蛆:ququ) /data/item/q/ququ-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Aug  6 17:44:16 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;32m龙之臂[2;37;0m", ({ "huwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;32m龙之臂[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;32m龙之臂[2;37;0m[33m。[2;37;0m\n");
