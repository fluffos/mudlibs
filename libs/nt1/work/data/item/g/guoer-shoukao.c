// SN:^[WfWZ0i2PM\?_m9
// ITEM Made by player(杨家哥哥:guoer) /data/item/g/guoer-shoukao.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Oct 11 21:30:14 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m手铐[2;37;0m", ({ "shoukao" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：杨家哥哥(guoer)
");
	set("value", 2100000);
	set("point", 44);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m手铐[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m手铐[2;37;0m[33m。[2;37;0m\n");
