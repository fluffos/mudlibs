// SN:bNIS<l5?oHAI4coI
// ITEM Made by player(狗狗狗:google) /data/item/g/google-mywrist.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Jul 19 13:48:48 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m狗狗爪子[2;37;0m", ({ "mywrist" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：狗狗狗(google)
");
	set("value", 2100000);
	set("point", 230);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;36m狗狗爪子[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m狗狗爪子[2;37;0m[33m。[2;37;0m\n");
