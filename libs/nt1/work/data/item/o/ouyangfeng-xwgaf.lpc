// SN:b_R?d3He0Nh`EnNn
// ITEM Made by player(渡欧:ouyangfeng) /data/item/o/ouyangfeng-xwgaf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Mar 16 22:04:38 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[37m玄武[1;33m骨一腕[2;37;0m", ({ "xwgaf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：渡欧(ouyangfeng)
");
	set("value", 2100000);
	set("point", 137);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[2;37;0m[37m玄武[1;33m骨一腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[2;37;0m[37m玄武[1;33m骨一腕[2;37;0m[33m。[2;37;0m\n");
