// SN:3EZd@Z^IGj;F81L8
// ITEM Made by player(渡无:noxiao) /data/item/n/noxiao-lwd.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Jul 22 21:43:28 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m凤舞飘带[2;37;0m", ({ "lwd" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：渡无(noxiao)
");
	set("value", 2100000);
	set("point", 25);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m凤舞飘带[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m凤舞飘带[2;37;0m[33m。[2;37;0m\n");
