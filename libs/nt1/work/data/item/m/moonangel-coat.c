// SN:NkUWae1<C7QlCW^]
// ITEM Made by player(月天使:moonangel) /data/item/m/moonangel-coat.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat May 29 08:14:35 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[31m暗夜之魔幻披风[2;37;0m", ({ "coat" }));
	set_weight(1400);
	set("item_make", 1);
	set("unit", "件");
	set("long", "这是由[1;37m冰蚕丝[2;37;0m炼制而成的一件战衣。
战衣缘上刻着一行小字：月天使(moonangel)
");
	set("value", 2100000);
	set("point", 350);
	set("material", "silk");
