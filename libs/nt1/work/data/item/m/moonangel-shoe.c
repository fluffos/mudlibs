// SN:Z?]b_@WF7fPjh4f^
// ITEM Made by player(月天使:moonangel) /data/item/m/moonangel-shoe.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat May 29 08:18:47 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[31m暗夜之贝绳凉鞋[2;37;0m", ({ "shoe" }));
	set_weight(420);
	set("item_make", 1);
	set("unit", "双");
	set("long", "这是由[1;37m冰蚕丝[2;37;0m炼制而成的一双靴子。
靴子缘上刻着一行小字：月天使(moonangel)
");
	set("value", 2100000);
	set("point", 140);
	set("material", "silk");
