// SN:iC8iW=6;5BC8JA?4
// ITEM Made by player(慕容来:mrr) /data/item/m/mrr-hww.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Aug  7 02:39:54 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m助手[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m助手[2;37;0m[33m。[2;37;0m\n");
