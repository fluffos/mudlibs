// SN:4jOQ2\W_oWW?=^7R
// ITEM Made by player(行香子:michael) /data/item/m/michael-cxnh.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Oct 12 14:41:19 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;32m声声慢[2;37;0m", ({ "cxnh" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
[1;32m声声慢[2;37;0m
护腕缘上刻着一行小字：行香子(michael)
");
	set("value", 2100000);
	set("point", 56);
	set("material", "magic stone");
	set("wear_msg", "[1;32m寻寻觅觅，冷冷清清，凄凄惨惨戚戚。乍暖还寒时候，最难将息。三杯两盏淡酒，怎敌他、晚来风急？雁过也，正伤心，却是旧时相识。[2;37;0m\n");
	set("remove_msg", "[1;32m满地黄花堆积。憔悴损，如今有谁堪摘？守著窗儿，独自怎生得黑？梧桐更兼细雨，到黄昏、点点滴滴。这次第，怎一个、愁字了得！[2;37;0m\n");
