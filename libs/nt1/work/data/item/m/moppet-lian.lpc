// SN:P4Z[MCM7oXT455;E
// ITEM Made by player(琉璃娃娃:moppet) /data/item/m/moppet-lian.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Jan  5 13:56:26 2004
#include <ansi.h>
#include <armor.h>
...
[1;37m天然的水晶制品，晶莹剔透[2;37;0m
护腕缘上刻着一行小字：琉璃娃娃(moppet)
");
	set("value", 2100000);
	set("point", 25);
	set("material", "magic stone");
	set("wear_msg", "[1;32m$N轻叹一声，戴上水晶手链[2;37;0m\n");
	set("remove_msg", "[1;32m$N噘噘嘴巴，叭的一声把手链仍在一边[2;37;0m\n");
