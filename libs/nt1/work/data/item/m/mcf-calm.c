// SN:bF@`80bOi2KZNK`7
// ITEM Made by player(梅超风:mcf) /data/item/m/mcf-calm.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Sep 20 15:15:47 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m静心戒[2;37;0m", ({ "calm" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;35m静心戒[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m静心戒[2;37;0m[33m。[2;37;0m\n");
