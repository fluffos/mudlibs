// SN:NMYa[i\12F`>OU5l
// ITEM Made by player(月天使:moonangel) /data/item/m/moonangel-circlet.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat May 29 08:13:18 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[31m暗夜之夜眼灵环[2;37;0m", ({ "circlet" }));
	set_weight(4500);
	set("item_make", 1);
	set("unit", "顶");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一顶头盔。
头盔缘上刻着一行小字：月天使(moonangel)
");
	set("value", 2100000);
	set("point", 175);
