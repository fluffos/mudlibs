// SN:]n89j]RUZ[P?m[O`
// ITEM Made by player(傲问天:pxhb) /data/item/p/pxhb-huwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jul  6 04:45:09 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m护腕[2;37;0m", ({ "huwan" }));
	set_weight(2500);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("point", 80);
	set("material", "steel");
	set("wear_msg", "[33m$N[33m装备[1;37m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m护腕[2;37;0m[33m。[2;37;0m\n");
