// SN:S9oCRSePR=O9F6^e
// ITEM Made by player(南宫无仁:playerf) /data/item/p/playerf-evild.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Fri Oct  8 16:00:19 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[2;37;0m[34m恶魔之臂[2;37;0m", ({ "evild" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
[30m这是使用九幽恶魔的[34m前肢鳞甲[30m炼制，经过恶魔之血浸泡的带有诅咒的[34m恶魔之臂。[2;37;0m
护腕缘上刻着一行小字：南宫无仁(playerf)
");
	set("value", 2100000);
	set("point", 56);
	set("material", "magic stone");
	set("wear_msg", "$N[1;31m从九幽深潭中抓出一对[34m恶魔之臂。[2;37;0m\n");
	set("remove_msg", "$N[1;31m将[34m恶魔之臂[1;31m浸入九幽深潭之中。[2;37;0m\n");
