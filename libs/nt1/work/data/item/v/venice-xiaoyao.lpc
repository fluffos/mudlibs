// SN:fChmK6LaDdcja1fY
// ITEM Made by player(慕容闻琳:venice) /data/item/v/venice-xiaoyao.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jun 15 17:43:47 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;32m逍遥仙女环[2;37;0m", ({ "xiaoyao" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;32m逍遥仙女环[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;32m逍遥仙女环[2;37;0m[33m。[2;37;0m\n");
