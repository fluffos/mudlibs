// SN:UkC`iV_oh2S_L0ol
// ITEM Made by player(慕容闻琳:venice) /data/item/v/venice-huan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jun 22 03:05:14 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m紫霞环[2;37;0m", ({ "huan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
[1;35m紫霞宫掌门信物。[2;37;0m
护腕缘上刻着一行小字：慕容闻琳(venice)
");
	set("value", 2100000);
	set("point", 263);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m紫霞环[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m紫霞环[2;37;0m[33m。[2;37;0m\n");
