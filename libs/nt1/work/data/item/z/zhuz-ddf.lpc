// SN:O8<Xc=Z_=BJkcRX[
// ITEM Made by player(真天蓬:zhuz) /data/item/z/zhuz-ddf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug 10 16:54:07 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("point", 15);
	set("material", "iron");
	set("wear_msg", "[33m$N[33m装备他们啊[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了他们啊[2;37;0m[33m。[2;37;0m\n");
