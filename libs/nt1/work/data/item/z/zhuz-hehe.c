// SN:^7[DYK8o71dY96bY
// ITEM Made by player(真天蓬:zhuz) /data/item/z/zhuz-hehe.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug 10 16:55:22 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("point", 15);
	set("material", "iron");
	set("wear_msg", "[33m$N[33m装备文张[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了文张[2;37;0m[33m。[2;37;0m\n");
