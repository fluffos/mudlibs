// SN:9JEZmOEFU5]f;gbJ
// ITEM Made by player(真天蓬:zhuz) /data/item/z/zhuz-www.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug 10 17:09:34 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("point", 15);
	set("material", "iron");
	set("wear_msg", "[33m$N[33m装备太太[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了太太[2;37;0m[33m。[2;37;0m\n");
