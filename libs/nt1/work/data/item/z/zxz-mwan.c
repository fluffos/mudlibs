// SN:=XBLeTnkSP;T1RLR
// ITEM Made by player(无盐:zxz) /data/item/z/zxz-mwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Thu Jul 22 09:06:50 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m护腕[2;37;0m[33m。[2;37;0m\n");
