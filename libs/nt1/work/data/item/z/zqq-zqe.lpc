// SN:W4;8POUZY8dN>\im
// ITEM Made by player(朱七七:zqq) /data/item/z/zqq-zqe.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Mon Jul 19 08:20:11 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m走马兰台类转蓬[2;37;0m", ({ "zqe" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;33m走马兰台类转蓬[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m走马兰台类转蓬[2;37;0m[33m。[2;37;0m\n");
