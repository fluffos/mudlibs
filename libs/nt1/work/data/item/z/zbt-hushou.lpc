// SN:fdZ<E3<lLYENVP;Z
// ITEM Made by player(渡咒:zbt) /data/item/z/zbt-hushou.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue May 25 22:12:17 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m法螺[2;37;0m", ({ "hushou" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;33m法螺[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m法螺[2;37;0m[33m。[2;37;0m\n");
