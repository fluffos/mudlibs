// SN:9K?WPDR07[63QhU>
// ITEM Made by player(真天蓬:zhuz) /data/item/z/zhuz-zhouzi.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Aug 10 16:49:58 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("point", 15);
	set("material", "iron");
	set("wear_msg", "[33m$N[33m装备肘子[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了肘子[2;37;0m[33m。[2;37;0m\n");
