// SN:V5XZ9jU?UjFB2l<A
// ITEM Made by player(慕容新月:xinyue) /data/item/x/xinyue-shoulian.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Mar 28 23:28:54 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m相思带[2;37;0m", ({ "shoulian" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
[1;35m一根普普通通的粉红色的绳子，上面点缀着一粒粒细小的红豆。[2;37;0m
护腕缘上刻着一行小字：慕容新月(xinyue)
");
	set("value", 2100000);
	set("point", 78);
	set("material", "magic stone");
	set("wear_msg", "[1;35m$N细心的系上一根粉红色的丝带在手腕上，双目之中泪花闪动，分明是想起了遥远的记忆。[2;37;0m\n");
	set("remove_msg", "[1;35m$N细心的解下了手中的丝带，双目中盈动的泪光也不见了，有着一种幽怨的怒气在其中荡漾。[2;37;0m\n");
