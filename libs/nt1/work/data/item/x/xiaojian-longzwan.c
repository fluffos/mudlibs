// SN:e7=Ua8?CC1;GE>6Z
// ITEM Made by player(小剑:xiaojian) /data/item/x/xiaojian-longzwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jan 27 20:02:54 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;34m龙[1;37m之[1;34m腕[2;37;0m", ({ "longzwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：小剑(xiaojian)
");
	set("value", 2100000);
	set("point", 56);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;34m龙[1;37m之[1;34m腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;34m龙[1;37m之[1;34m腕[2;37;0m[33m。[2;37;0m\n");
