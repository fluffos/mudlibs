// SN:V4_loZ9mCo:SIcF=
// ITEM Made by player(小剑:xiaojian) /data/item/x/xiaojian-longwan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jan 27 16:11:10 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;34m龙[1;37m之[1;34m腕[2;37;0m", ({ "longwan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
