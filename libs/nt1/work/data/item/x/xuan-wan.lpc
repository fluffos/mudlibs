// SN:CI6l4@?kmdZoAG=[
// ITEM Made by player(渡邪:xuan) /data/item/x/xuan-wan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Sep 14 17:13:00 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m金铁护腕[2;37;0m", ({ "wan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;37m金铁护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m金铁护腕[2;37;0m[33m。[2;37;0m\n");
