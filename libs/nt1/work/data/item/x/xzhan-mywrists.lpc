// SN:_jMn2PMZ@Mc?>^^b
// ITEM Made by player(血战:xzhan) /data/item/x/xzhan-mywrists.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Feb 17 22:42:40 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m血龙手镯[2;37;0m", ({ "mywrists" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m血龙手镯[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m血龙手镯[2;37;0m[33m。[2;37;0m\n");
