// SN:Fc5^=g?H^YlcjELY
// ITEM Made by player(小剑:xiaojian) /data/item/x/xiaojian-longzsue.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jan 27 20:01:08 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;34m龙[1;37m之[1;34m靴[2;37;0m", ({ "longzsue" }));
	set_weight(420);
	set("item_make", 1);
	set("unit", "双");
