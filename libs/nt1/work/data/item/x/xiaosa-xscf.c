// SN:c9;6>O8Z=H1K;MQP
// ITEM Made by player(小撒:xiaosa) /data/item/x/xiaosa-xscf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Sep 23 00:17:06 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;37m雪域[2;37;0m护腕[2;37;0m", ({ "xscf" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：小撒(xiaosa)
");
	set("value", 2100000);
	set("point", 100);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;37m雪域[2;37;0m护腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;37m雪域[2;37;0m护腕[2;37;0m[33m。[2;37;0m\n");
