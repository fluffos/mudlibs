// SN:0X;LARLd3XakO7Vi
// ITEM Made by player(夏天的冰:xiabing) /data/item/x/xiabing-wan.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat Jan 10 16:52:24 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;33m夏天的[1;37m风[2;37;0m", ({ "wan" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：夏天的冰(xiabing)
");
	set("value", 2100000);
	set("point", 99);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;33m夏天的[1;37m风[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m夏天的[1;37m风[2;37;0m[33m。[2;37;0m\n");
