// SN:W:>[SEX][kXOKm?[
// ITEM Made by player(永远寂寞:xiaolang) /data/item/x/xiaolang-shou.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Tue Jul 13 23:06:48 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m龙王护手[2;37;0m", ({ "shou" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：永远寂寞(xiaolang)
");
	set("value", 2100000);
	set("point", 69);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;31m龙王护手[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m龙王护手[2;37;0m[33m。[2;37;0m\n");
