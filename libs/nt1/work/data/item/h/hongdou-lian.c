// SN:DdXL0R^f6mT>U^:D
// ITEM Made by player(红豆:hongdou) /data/item/h/hongdou-lian.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Jul 30 17:46:57 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m水晶手链[2;37;0m", ({ "lian" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：红豆(hongdou)
");
	set("value", 2100000);
	set("point", 67);
