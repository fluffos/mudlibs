// SN:kCgHFickf]XkH3?C
// ITEM Made by player(猎人:hunterx) /data/item/h/hunterx-qsg.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Jun 30 16:28:21 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;35m千年史册耻无名[2;37;0m", ({ "qsg" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：猎人(hunterx)
");
	set("value", 2100000);
	set("point", 173);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;35m千年史册耻无名[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;35m千年史册耻无名[2;37;0m[33m。[2;37;0m\n");
