// SN:YBM7J`3I^nU8XK9E
// ITEM Made by player(红痕:hongdou) /data/item/h/hongdou-lianb.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Oct 26 20:46:42 2003
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m水晶手链[2;37;0m", ({ "lianb" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
	set("long", "这是由[1;35m神铁[2;37;0m炼制而成的一对护腕。
护腕缘上刻着一行小字：红痕(hongdou)
");
	set("value", 2100000);
	set("point", 102);
	set("material", "magic stone");
	set("wear_msg", "[33m$N[33m装备[1;36m水晶手链[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m水晶手链[2;37;0m[33m。[2;37;0m\n");
