// SN:PBd7<_TNFk_7N[WV
// ITEM Made by player(猎人:hunterx) /data/item/h/hunterx-djg.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sat May  8 14:43:19 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;31m唯我独尊[2;37;0m", ({ "djg" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;31m唯我独尊[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;31m唯我独尊[2;37;0m[33m。[2;37;0m\n");
