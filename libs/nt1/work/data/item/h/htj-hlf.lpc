// SN::6E^8;cSLkW7^>7K
// ITEM Made by player(皇太极:htj) /data/item/h/htj-hlf.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Sun Mar  7 18:41:18 2004
#include <ansi.h>
#include <armor.h>
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;33m皇龙腕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;33m皇龙腕[2;37;0m[33m。[2;37;0m\n");
