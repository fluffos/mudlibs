// SN:emaQJK0G\3Q5fU5^
// ITEM Made by player(闯越:ime) /data/item/i/ime-xtr.c
// Written by GAN JIANG(Doing Lu 1998/11/2)	Wed Jun  9 16:42:58 2004
#include <ansi.h>
#include <armor.h>
...
void create()
{
	set_name("[1;36m玄天[1;37m绕[2;37;0m", ({ "xtr" }));
	set_weight(3000);
	set("item_make", 1);
	set("unit", "对");
...
");
	...
	set("wear_msg", "[33m$N[33m装备[1;36m玄天[1;37m绕[2;37;0m[33m。[2;37;0m\n");
	set("remove_msg", "[33m$N[33m脱下了[1;36m玄天[1;37m绕[2;37;0m[33m。[2;37;0m\n");
