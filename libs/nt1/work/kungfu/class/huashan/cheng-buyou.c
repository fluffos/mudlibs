...
int accept_ask(object me, string topic)
{
        ...
        {                       
        case "天外飞龙" :
                if (me->query("max_neili") > 10000 || me->query_skill("force") > 405)
                {
                      command("shake");
                ...
                return MASTER_D->teach_pfm(me, this_object(),
                        ([ "perform" : "can_perform/huashan-jianfa/long",
                           "name"    : "天外飞龙",
                           "sk1"     : "huashan-jianfa",
                           "gongxian": 700,
                           "lv1"     : 150,
        ...
        case "风扫落叶" :
                if (me->query("max_neili") > 20000 || me->query_skill("force") > 405)
                {
                      command("shake");
                      command("say 我剑宗以剑术为主，气为次！你的内功修为已入了气宗歧途，再不能修炼剑宗剑术。");
                      return 1;
