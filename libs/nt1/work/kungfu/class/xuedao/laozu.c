...
mixed ask_skill1()
{
        ...
        if (me->query("can_perform/xuedao-daofa/resurrect"))
                return "自己下去练，罗嗦什么！";
        ...
        me->set("can_perform/xuedao-daofa/resurrect", 1);
        me->add("contribution", -500);
...
mixed ask_skill6()
{
        ...
        if (me->query("can_perform/xuedao-daofa/ying"))
                return "自己下去练，罗嗦什么！";
        ...
        if (me->can_improve_skill("xuedao-daofa"))
                me->improve_skill("xuedao-daofa", 1500000);
        me->improve_skill("martial-cognize", 1500000);
        me->set("can_perform/xuedao-daofa/ying", 1);
        me->add("contribution", -300);
...
mixed ask_skill7()
{
        ...
        if (me->query("can_perform/xuedao-daofa/chi"))
                return "自己下去练，罗嗦什么！";
        ...
        if (me->can_improve_skill("xuedao-daofa"))
                me->improve_skill("xuedao-daofa", 1500000);
        me->improve_skill("martial-cognize", 1500000);
        me->set("can_perform/xuedao-daofa/chi", 1);
        me->add("contribution", -800);
...
mixed ask_skill8()
{
        ...
        if (me->query("can_perform/xuedao-daofa/xue"))
                return "自己下去练，罗嗦什么！";
        ...
        if (me->can_improve_skill("xuedao-daofa"))
                me->improve_skill("xuedao-daofa", 1500000);
        me->improve_skill("martial-cognize", 1500000);
        me->set("can_perform/xuedao-daofa/xue", 1);
        me->add("contribution", -1000);
...
mixed ask_skill9()
{
        ...
        if (me->query("can_perform/xuedao-daofa/shi"))
                return "自己下去练，罗嗦什么！";
        ...
        if (me->can_improve_skill("xuedao-daofa"))
                me->improve_skill("xuedao-daofa", 1500000);
        me->improve_skill("martial-cognize", 1500000);
        me->set("can_perform/xuedao-daofa/shi", 1);
        me->add("contribution", -2000);
