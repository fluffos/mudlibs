...
LONG );
	...
	set_skill("taiji-shengong", 4000);
	set_skill("taiji-jian", 4000);
	set_skill("taiji-quan", 4000);
	set_skill("tiyunzong", 4000);
        set_skill("martial-cognize", 10000);
        set_skill("yinyang-shiertian", 4000);
...
void catch_ob(object ob)
{
        ...
        CHANNEL_D->do_channel(this_object(), "rumor", "听说" +
                            ...
                            "火手判官张召重缉拿归案，押入大牢。");
        ob->get_into_prison(0, "/d/changan/prison", 120);
