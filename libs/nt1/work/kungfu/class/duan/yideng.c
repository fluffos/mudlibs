...
LONG );
        ...
        set_skill("force", 440);
        set_skill("xiantian-gong", 440);
        set_skill("kurong-changong", 420);
        set_skill("dodge", 420);
        set_skill("tiannan-bufa", 420);
        set_skill("cuff", 400);
        ...
        set_skill("qiantian-zhi", 440);
        set_skill("yiyang-zhi", 440);
        set_skill("parry", 400);
        // set_skill("jingluo-xue", 300);
        set_skill("buddhism", 440);
        set_skill("literate", 400);
        set_skill("sanscrit", 400);
        set_skill("martial-cognize", 360);
        ...
        set("no_teach", ([                 "xiantian-gong"  : "这个我可不能传你。",         ]));
        setup();
...
int recognize_apprentice(object me, string skill)
{
        ...
        if (skill != "sanscrit" && skill != "buddhism" && skill != "yiyang-zhi")
        {
                command("say 这些还是向你的师父学吧，老衲只能传授些知识给你。");
                return -1;
        }

        if (skill == "buddhism" && me->query_skill("buddhism", 1) > 399)
        {
                command("haha");
        ...
        if (!me->query_temp("can_learn/yideng/yiyang-zhi") && skill == "yiyang-zhi")
        {
