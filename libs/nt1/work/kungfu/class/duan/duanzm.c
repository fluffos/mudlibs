...
#define MAIJING "/clone/book/jingluoxue1"
#define MAIJING2 "/clone/book/jingluoxue2"
...
void create()
{
        ...
        set_skill("force", 480);
        set_skill("kurong-changong", 480);
        set_skill("dodge", 440);
        set_skill("tiannan-bufa", 440);
        set_skill("cuff", 440);
        set_skill("jinyu-quan", 440);
        set_skill("strike", 440);
        set_skill("wuluo-zhang", 440);
        set_skill("sword", 440);
        set_skill("staff", 440);
        set_skill("duanjia-jian", 440);
        set_skill("finger", 480);
        set_skill("qiantian-zhi", 460);
        set_skill("yiyang-zhi", 480);
        set_skill("parry", 440);
        // set_skill("jingluo-xue", 280);
        set_skill("buddhism", 460);
...
void attempt_apprentice(object ob)
{
        ...
        if (ob->query_skill("kurong-changong", 1) < 100)
        {
