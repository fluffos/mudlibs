...
LONG );
        ...
        set_skill("force", 400);
        set_skill("yunv-xinfa", 400);
        set_skill("nuhai-kuangtao", 400);
        set_skill("sword", 400);
        ...
        set_skill("sad-strike", 400);
        set_skill("fireice-strike", 400);
...
int recognize_apprentice(object ob, string skill)
{
        ...
        if (skill == "unarmed" &&
            ...
            this_player()->query_skill(skill, 1) < 400)
                return 1;
        ...
        */
        case "黯然销魂" :
                return MASTER_D->teach_pfm(me, this_object(),
                        ([ "perform" : "can_perform/sad-strike/sad",
                           "name"    : "黯然销魂",
                           "sk1"     : "sad-strike",
                           "lv1"     : 100,
                           "sk2"     : "force",
