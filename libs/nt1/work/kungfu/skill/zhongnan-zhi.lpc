...
string *action_msg = ({
        "$N一招「剑指南山」，右手拇指直刺$n的$l",
        "$N使一招「天荒地老」，左手轻轻一挥，右手刺向$n的檀中大穴",
        "$N双掌翻飞，一招「海枯石烂」，暗藏玄机，中指戳向$n的$l",
        "$N一声大喝，一式「大江东去」，双指齐出，攻向$n的胸口和$l",
        "$N连上数步，一招「乌雀南飞」，左掌劈向$n，右手却暗袭$n的$l",
        "$N双手不住晃动，缓缓逼近$n，一招「冰冻千里」，笼罩了$n的$l",
        "$N一招「寿比南山」，手指不住晃动，不离$n的$l方寸之间",
});
