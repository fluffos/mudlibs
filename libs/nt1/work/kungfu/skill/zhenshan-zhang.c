...
string *action_msg = ({
        "$N使出一招「力拔山河」，左掌虚晃一下，右手带起阵阵掌风拍向$n的$l",
        "$N纵身跃起，一式「开碑断石」，双掌自上而下拍向$n的$l",
        "$N双掌呼地拍出，一招「风雨欲来」，带起阵阵飞沙走石，直击向$n的$l",
        "$N双掌齐出，幻做掌影重重，一招「地老天荒」拍向$n$l",
});
...
int practice_skill(object me)
{
        ...
        if (me->query_skill("zhenshan-zhang", 1) < 60)
