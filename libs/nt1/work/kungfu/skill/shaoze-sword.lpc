// six-finger.c 六脉神剑之少泽剑

inherit SKILL; 

mapping *action = ({ 
([      "action": "$N左手小指一伸，一条气流从少泽穴中激射而出，“少泽剑”出手入风，指向$n的$l",
        "force" : 350,
        "dodge" : 90,    
        "attack": 90,
        "parry" : 90,                        
...
{ 
       ...
       if ((int)me->query_skill("finger", 1) < (int)me->query_skill("shaoze-jian", 1)) 
...
{ 
       return __DIR__"shaoze-jian/" + action; 
} 
