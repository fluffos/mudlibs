// six-finger.c 六脉神剑之少冲剑
inherit SKILL; 

mapping *action = ({ 
([      "action": "$N右手反指，小指伸出，真气自少冲穴激荡而出，“少冲剑”横生奇变，从$n意想不到的方向刺向$n的$l",
        "force" : 350,
        "attack": 90,
        "dodge" : 90,
        "parry" : 90,
...
{ 
       ...
       if ((int)me->query_skill("finger", 1) < (int)me->query_skill("shaochong-jian", 1)) 
...
{ 
       return __DIR__"shaochong-jian/" + action; 
} 
