...
string *action_msg = ({
        "$N一式「大江东去」，双掌大开大合，直向$n的$l击去",
        "$N身形一变，一式「黄河九曲」，双掌似曲似直，拍向$n的$l",
        "$N使一式「湖光山色」，左掌如微风拂面，右掌似细雨缠身，直取$n的$l",
        "$N两掌一分，一式「曾经沧海」，隐隐发出潮声，向$n横击过去",
        "$N身形一转，使出一式「水光潋滟」，只见漫天掌影罩住了$n的全身",
        "$N突然身形一缓，使出一式「小雨初晴」，左掌凝重，右掌轻盈，击往$n的$l",
        "$N使一式「风雪江山」，双掌挟狂风暴雪之势，猛地劈向$n的$l",
        "$N一招「霜华满地」，双掌带着萧瑟的秋气，拍向$n的$l",
        "$N身法陡然一变，使出一式「仙乡冰舸」，掌影千变万幻，令$n无法躲闪",
        "$N清啸一声，一式「冰霜雪雨」，双掌挥舞，如同雪花随风而转，击向$n的$l",
        "$N往後飘出数丈，双掌在空中一划，带起一阵寒风，向$n的$l拍去",
