...
int perform(object me, object target)
{
        ...
        if( userp(me) && !me->query("can_perform/yinsuo-jinling/san"))
        ...
        if( me->query_skill("yunv-xinfa", 1) < 60 )
                return notify_fail("你的玉女心法火候未到，无法施展「三无三不手」！\n");

        if( me->query_skill("yinsuo-jinling", 1) < 100 )
                return notify_fail("银锁金铃不够娴熟，无法施展「三无三不手」！\n");
        ...
        message_combatd( HIR"\n$N一声冷笑，迅捷凌利的连攻三招，正是银锁金铃的绝技「三无三不手」！\n"NOR, me);
