...
void set_from_me(object me)
{
        ...
        if (mycombat_exp > 200000 && random(100) < 5)
        {
                // 经验 > 200K，5%几率出现多个敌人
...
void do_continue_help(object ob)
{
        ...
        while (n--)
        {
                NPC_D->set_from_me(obsn, ob, 100)
                obsn->delete_temp(multi-enemy)
                obsn->set_temp(help_who, this_object())
                obsn->set_temp(is_helper, 1)
        }
