...
int ask_quest(object me, object who)
{
        ...
        {
                message_vision("$N瞪大眼睛看着$n，道：“你的门派有更重要的事要你去做！\n",
                               me, who);
                return 1;
        }  
        ...
        message("vision", me->name() + "在你耳边悄声说道：“你务必要在" +
...
int accept_object(object me, object who, object ob)
{
	...
	mixed special = 0;      // 是否有特殊奖励
        ...
        } else
        {
                ...
                if (quest_count == 50)
                {
                        msg += "$N哈哈大笑两声道：“真有你的，连着五十"
                               "次任务都完成的漂漂亮亮，很好，很好。”\n";
                        special = 1;
                } else
                if (quest_count == 100)
                {
                        msg += "$N大喜道：“不错不错，真实不错，一百"
                               "次任务干得很好。”\n";
                        special = "/clone/gift/puti-zi";
                } else
                if (quest_count == 200)
                {
                        msg += "$N叹道：“真是长江后浪推前浪，想不到你接连两百"
                               "次任务都无一疏漏，不易，不易！”\n";
