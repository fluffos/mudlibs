...
#include <msgtypes.h>
#include "classes.h"
/* lpscript.h was never shipped in this archive (nor in the upstream Lima
   base it installs over) -- LPSCRIPT_D is only ever called via call_other
   (master.lpc's compile_object(), for a never-present *.scr file type),
   so no symbols from this header are actually needed to compile. Removed
   rather than invented -- see NOTES.md. */
...
#define AMMO_WEAPON             "/std/ammo_weapon"
...
#define BLADE_DOUBLE_BASE       "/std/blade_double_base"
#define BLADE_CUSTOM            "/std/blade_custom"
#define BLASTER_BASE            "/std/blaster_base"
#define BLASTER_CUSTOM          "/std/blaster_custom"
#define BOARD_OB                "/contrib/board"
...
#define LIGHTSABER_SHOTO_BASE   "/std/lightsaber_shoto_base"
...
#define RANGED_BASE             "/std/ranged_base"
#define ROBE_CUSTOM             "/std/robe_custom"
#define SIGN                    "/std/sign"
#define SITH_SWORD_BASE         "/std/sith_sword_base"
#define SITH_SWORD_DOUBLE_BASE  "/std/sith_sword_double_base"
#define SITH_SWORD_CUSTOM       "/std/sith_sword_custom"
#define SPELL                   "/std/spell"
#define STOCK_MASTER            "/std/stock_master"
#define VERB_OB                 "/std/verb_ob"
#define VIBRO_BLADE_BASE        "/std/vibro_blade_base"
#define VIBRO_BLADE_DOUBLE_BASE "/std/vibro_blade_double_base"
...
#define M_BLASTER_COMPONENT     "/std/modules/m_blaster_component"
...
#define M_LOCKPICK              "/std/modules/m_lockpick"
...
#define M_TEACHER               "/std/modules/m_teacher"
...
#define M_POWER                 "/std/modules/m_power"
...
#define M_SPECIAL_WEAPON        "/std/modules/m_special_weapon"
...
#define CREATE_MENU             "/obj/mudlib/createmenu"
...
#define NICKNAMEMENU            "/obj/mudlib/nicknamemenu"
...
#define CMD_OB_TASKTOOL         "/cmds/wiz/tasktool"
#define CMD_OB_EMOJI            "/cmds/player/emoji"
#define CMD_OB_FRAMES           "/cmds/player/frames"
#define CMD_OB_METRIC           "/cmds/player/metric"
#define CMD_OB_MODE             "/cmds/player/mode"
#define CMD_OB_SIMPLIFY         "/cmds/player/simplify"
#define CMD_OB_WIDTH            "/cmds/player/width"
...
#define M_NICKNAME              "/obj/secure/shell/nickname"
...
#define MAKER                   "/contrib/roommaker/buildmenu"
