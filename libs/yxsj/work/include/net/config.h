...
// The Battlefield of Pili
#define MUDLIST_DNS  ({ "140.113.167.47", 9000 })
// The Eastern Stories
//#define MUDLIST_BAK  ({ "140.113.204.42", 8008 })
// The Never Been Place
#define MUDLIST_BAK  ({ "140.128.9.13", 9000 })

#define LISTNODES ([ \
		"eastern stories"	: "140.113.204.42 8008",\
        "astaria"       : "198.69.82.2 5563", \
