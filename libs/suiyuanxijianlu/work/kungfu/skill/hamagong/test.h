...
//手太阴肺经
string *hand_taiyin_name = ({ "少商穴","鱼际穴","太渊穴","经渠穴","尺泽穴",}); 

//手阳明太肠经
string *hand_yangming_name = ({ "商阳穴","二间穴","三间穴","合谷穴","阳溪穴","曲池穴",}); 

//足太阴脾经
string *foot_taiyin_name = ({ "隐白穴","大都穴","太白穴","商丘穴","阳陵泉穴",}); 

//足阳明胃经
string *foot_yangming_name = ({ "厉兑穴","内庭穴","陷谷穴","冲阳穴","解溪穴","三里穴",}); 

//手少阴心经
string *hand_shaoyin_name = ({ "少冲穴","少府穴","神门穴","灵道穴","少海穴",}); 

//手少阳小肠经
string *hand_shaoyang_name = ({ "少泽穴","前谷穴","後溪穴","腕骨穴","阳谷穴","小海穴",}); 
//足太阳膀胱string *foot_taiyang_name = ({ "至阴穴","通谷穴","束骨穴","京骨穴","昆仑穴","委中穴",});
//足少阴肾string *foot_shaoyin_name = ({ "涌泉穴","然谷穴","太溪穴","复溜穴","阴谷穴",});
//手厥阴心包string *hand_queyin_name = ({ "中冲穴","劳宫穴","大陵穴","间使穴","曲泽穴",});
//手少阳三焦string *hand_shaoyang_name2 = ({ "关冲穴","液门穴","中渚穴","阳池穴","支沟穴","天井穴",});
//足少阳胆string *foot_shaoyang_name = ({ "窍阴穴","侠溪穴","临泣穴","丘墟穴","阳辅穴","阳陵泉穴",});
//足厥阴肝string *foot_queyin_name = ({ "大敦穴","行间穴","太冲穴","中封穴","曲泉穴",});
