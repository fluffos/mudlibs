...
further palace avenue (`/d/silvere/rooms/center/outside4`
continuing south toward the palace entrance is still
the LDMud SILBASEROOM original), statue touch/helmet,
further council road / mail / bank deposit / Caves of
Parch, shop buy, and healer/elder interiors are not
loaded. The council hall, library, and adventurers
guild interiors are archive stubs (no details).
...
(`/d/silvere/rooms/center/outside4`) if expanding.
