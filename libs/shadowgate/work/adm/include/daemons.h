...
#define ALT_WORLD_D          (DIR_DAEMONS+"/alternative_world_d.lpc")
...
#define EQ_D                (DIR_DAEMONS+"/equipment_d.lpc")
...
#define FILTERS_D      (DIR_DAEMONS+"/filters_d.lpc")
...
#define USER_D              (DIR_DAEMONS+"/user_d.lpc")
