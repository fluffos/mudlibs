...
#define        award_data        ([ "gxd": ([ "score?":300,"me?":1,"dt-n?":"gongxian", "c-name":"贡献度","all->0?":"yes" ]),"exp": ([ "score?":1,  "me?":3,"dt-n?":"huanjing2003/exp","c-name":"幻境经验","all->0?":"yes" ]),"pot": ([ "score?":1,  "me?":1,"dt-n?":"huanjing2003/pot","c-name":"幻境潜能","all->0?":"yes" ]), ])
