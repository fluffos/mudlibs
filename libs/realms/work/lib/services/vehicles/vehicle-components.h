...
([
    ...
    "basic wagon frame": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/basic-wagon-frame.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "reinforced wagon frame": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/reinforced-wagon-frame.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "armored wagon body": ([
        "class": "frame",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/armored-wagon-body.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "war wagon chassis": ([
        "class": "frame",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/war-wagon-chassis.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "luxury wagon body": ([
        "class": "frame",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/luxury-wagon-body.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "arcane wagon frame": ([
        "class": "frame",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/arcane-wagon-frame.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon platform": ([
        "class": "frame",
    ...
    "wagon arcane cannon": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/arcane-cannon.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon harpoon launcher": ([
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 3 ]),
            "/lib/instances/research/vehicles/components/harpoon-launcher.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon flame thrower": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/arcane-flame-thrower.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon magic missile launcher": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/magic-missile-launcher.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon siege ram": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 4 ]),
            "/lib/instances/research/vehicles/components/siege-ram.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon murder holes": ([
        "class": "weapon",
    ...
    "caltrop dispenser": ([
        ...
        "prerequisites": ([
            "metal crafting": ([ "type": "skill", "value": 3 ]),
            "/lib/instances/research/vehicles/components/caltrop-dispenser.lpc" : (["type": "research"]),
        ]),
    ]),
    "net launcher": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 3 ]),
            "engineering": ([ "type": "skill", "value": 2 ]),
            "/lib/instances/research/vehicles/components/net-launcher.lpc" : (["type": "research"]),
        ]),
    ]),
    "wagon oil dispenser": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/oil-dispenser.lpc" : (["type": "research"]),
        ]),
    ]),
    ...
    "wagon levitation matrix": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/levitation-matrix.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon illusion shroud": ([
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 10 ]),
            "/lib/instances/research/vehicles/components/illusion-shroud.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon teleportation rune": ([
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 12 ]),
            "/lib/instances/research/vehicles/components/teleportation-rune.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "wagon elemental binding": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/elemental-binding.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "basic wooden hull": ([
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 2 ]),
            "/lib/instances/research/vehicles/components/basic-hull-construction.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "reinforced hull": ([
        "class": "hull",
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 5 ]),
            "engineering": ([ "type": "skill", "value": 2 ]),
            "/lib/instances/research/vehicles/components/reinforced-hull-construction.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "ironclad hull": ([
        "class": "hull",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/ironclad-hull-construction.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "arcane hull": ([
        "class": "hull",
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 5 ]),
            "spellcraft": ([ "type": "skill", "value": 8 ]),
            "/lib/instances/research/vehicles/components/arcane-hull-construction.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "arcane cargo hold": ([
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 10 ]),
            "/lib/instances/research/vehicles/components/arcane-cargo.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "arcane warding": ([
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 8 ]),
            "/lib/instances/research/vehicles/components/arcane-warding.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "spiked armor": ([
        "class": "defense",
    ...
    "arcane sanctum": ([
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 8 ]),
            "/lib/instances/research/vehicles/components/arcane-sanctum.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "greek fire projector": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/greek-fire-projector.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "corvus boarding bridge": ([
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 4 ]),
            "engineering": ([ "type": "skill", "value": 3 ]),
            "/lib/instances/research/vehicles/components/corvus-boarding-bridge.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "springald mount": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/springald-mount.lpc" : (["type": "research"]),
        ]),
    ]),
    "onager mount": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 5 ]),
            "engineering": ([ "type": "skill", "value": 4 ]),
            "/lib/instances/research/vehicles/components/onager-mount.lpc" : (["type": "research"]),
        ]),
    ]),
    "lightning cannon": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 14 ]),
            "/lib/instances/research/vehicles/components/lightning-cannon.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "frost projector": ([
        "class": "weapon", 
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 10 ]),
            "/lib/instances/research/vehicles/components/frost-projector.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "acid sprayer": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/acid-sprayer.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "soul reaper": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/soul-reaper.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "sonic disruptor": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/sonic-disruptor.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "confusion projector": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 12 ]),
            "/lib/instances/research/vehicles/components/confusion-projector.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "mind spike launcher": ([
        "class": "weapon",
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 14 ]),
            "/lib/instances/research/vehicles/components/mind-spike-launcher.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "arcane propulsion": ([
        ...
        "prerequisites": ([
            "spellcraft": ([ "type": "skill", "value": 10 ]),
            "/lib/instances/research/vehicles/components/arcane-propulsion.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "simple sail": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/basic-sailmaking.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "lateen sail": ([
        "class": "propulsion",
        ...
        "prerequisites": ([
            ...
            "carpentry": ([ "type": "skill", "value": 1 ]),
            "/lib/instances/research/vehicles/components/lateen-sailmaking.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "square sail": ([
        "class": "propulsion",
        ...
        "prerequisites": ([
            ...
            "carpentry": ([ "type": "skill", "value": 2 ]),
            "/lib/instances/research/vehicles/components/square-sailmaking.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "arcane sail": ([
        "class": "propulsion",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/arcane-sailmaking.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "planar rudder": ([
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/planar-rudder.lpc": ([ "type": "research" ]),
        ]),
    ]),
    "elemental engine": ([
        "class": "arcane",
        ...
        "prerequisites": ([
            ...
            "/lib/instances/research/vehicles/components/elemental-engine.lpc": ([ "type": "research" ]),
        ]),
    ]),
    ...
    "shallow draft hull": ([
        ...
        "prerequisites": ([
            "carpentry": ([ "type": "skill", "value": 2 ]),
            "/lib/instances/research/vehicles/components/shallow-draft-hull.lpc": ([ "type": "research" ])
        ])
    ]),
    "arcane hull": ([
        "class": "hull",
    ...
    "paddlewheel": ([
        ...
        "prerequisites": ([
            "engineering": ([ "type": "skill", "value": 4 ]),
            "/lib/instances/research/vehicles/components/paddlewheel.lpc": ([ "type": "research" ])
        ])
    ]),
    "arcane propulsion": ([
        "class": "propulsion",
    ...
    "waterwheel mill": ([
        ...
        "prerequisites": ([
            "engineering": ([ "type": "skill", "value": 6 ]),
            "/lib/instances/research/vehicles/components/waterwheel-mill.lpc": ([ "type": "research" ])
        ])
    ]),
