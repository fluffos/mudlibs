...
protected mapping RegionTypes = ([
    "forest": ([
        "terrain": "/lib/environment/terrain/forest.lpc",
        "path type": "/lib/environment/features/paths/path.lpc",
    ...
    "keeper's temple":([
        "terrain": "/lib/environment/terrain/keepers-temple.lpc",
        "potential features": ([ ]),
    ...
    "tol-dhurath":([
        "interior": "/lib/environment/interiors/ruin.lpc",
        "potential features": ([ ]),
        "potential items": ([ ]),
        "potential objects": ({ }),
        "potential encounters": ([
    ...
    "hilly forest":([
        "terrain": "/lib/environment/terrain/forest-hill.lpc",
        "potential features": Trees + Terrain,
        "path type": "/lib/environment/features/paths/path.lpc",
        "potential items": ([ "objects": ([
            "woodpile": 10,
    ...
    "mountainous forest":([
        "terrain": "/lib/environment/terrain/forest-mountain.lpc",
        "potential features": Trees + Terrain,
        "path type": "/lib/environment/features/paths/path.lpc",
        "potential items": ([ "objects": ([
            "woodpile": 8,
    ...
    "city": ([
        "terrain": "/lib/environment/terrain/city.lpc",
        "potential features" : ([]),
        "path type" : "/lib/environment/features/paths/road.lpc",
        "potential items" : ([ "objects": ([
            "lamp-post": 15,
            "signPost": 10,
            "well": 5,
    ...
    "rural": ([
        "terrain": "/lib/environment/terrain/farmland.lpc",
        "potential features" : ([]),
        "path type" : "/lib/environment/features/paths/road.lpc",
        "potential items" : ([ "objects": ([
            "hay-bale": 15,
    ...
    "forest village": ([
        "terrain": "/lib/environment/terrain/village.lpc",
    ...
    "rocky lakeside": ([
        "terrain": "/lib/environment/terrain/plains.lpc",
    ...
    "desert": ([
        "terrain": "/lib/environment/terrain/desert.lpc",
        "potential features": Terrain,
        "path type": "/lib/environment/features/paths/path.lpc",
        "potential items": ([ "objects": ([
            "stone-pile": 10,
    ...
    "swamp": ([
        "terrain": "/lib/environment/terrain/swamp.lpc",
        "potential features": Trees + ([ "water": ([ 
    ...
    "mountains":([
        "terrain": "/lib/environment/terrain/rocky-mountain.lpc",
        "potential features": Terrain,
        "path type": "/lib/environment/features/paths/path.lpc",
        "potential items": ([ "objects": ([
            "stone-pile": 15
    ...
    "rocky shoreline":([
        "terrain": "/lib/environment/terrain/rocky-shoreline.lpc",
        "potential features": Terrain + ([ "water": ([ 
    ...
    "tundra":([
        "terrain": "/lib/environment/terrain/tundra.lpc",
        "potential features": Terrain,
        "path type": "/lib/environment/features/paths/path.lpc",
        "potential items": ([ "objects": ([
            "stone-pile": 8
    ...
    "crypt":([
        "interior": "/lib/environment/interiors/crypt.lpc",
        "potential features": ([ ]),
    ...
    "dry cavern":([
        "interior": "/lib/environment/interiors/cave.lpc",
        "potential features": ([ ]),
        "potential items": ([ "lighting": ([
            "lit-torch": 5
        ]) ]),
    ...
    "limestone building":([
        "interior": "/lib/environment/interiors/limestone-interior-shop.lpc",
        "potential features": ([ ]),
    ...
    "granite building":([
        "interior": "/lib/environment/interiors/granite-interior-shop.lpc",
        "potential features": ([ ]),
        "potential items": ([ "lighting": ([ "window": 10 ]),
            "furniture": ([ "counter": 8, "small-shelf": 5,
            "stool": 5 ]) ]),
    ...
    "brick building":([
        "interior": "/lib/environment/interiors/brick-interior-shop.lpc",
        "potential features": ([ ]),
        "potential items": ([ "lighting": ([ "window": 10 ]),
            "furniture": ([ "counter": 8, "small-shelf": 5,
            "stool": 5 ]) ]),
    ...
    "wooden building":([
        "interior": "/lib/environment/interiors/wooden-interior-shop.lpc",
        "potential features": ([ ]),
        "potential items": ([ "lighting": ([ "window": 10 ]),
            "furniture": ([ "counter": 8, "small-shelf": 5,
            "stool": 5, "bench": 5 ]) ]),
    ...
    "opulent building":([
        "interior": "/lib/environment/interiors/opulent-shop.lpc",
        "potential features": ([ ]),
        "potential items": ([ "lighting": ([ "window": 10,
            "chandelier": 3 ]),
    ...
    "stone keep":([
        "interior": "/lib/environment/interiors/stone-keep.lpc",
        "potential features": ([ ]),
    ...
    "wooden keep":([
        "interior": "/lib/environment/interiors/wooden-hall.lpc",
        "potential features": ([ ]),
    ...
    "palace":([
        "interior": "/lib/environment/interiors/opulent-entry.lpc",
        "potential features": ([ ]),
    ...
    "stone castle":([
        "interior": "/lib/environment/interiors/stone-fortress-hall.lpc",
        "potential features": ([ ]),
    ...
    "dwarven mines":([
        "interior": "/lib/environment/interiors/mine.lpc",
        "potential features": ([ ]),
    ...
    "wasteland": ([
        "terrain": "/lib/environment/terrain/rocky-desert.lpc",
        "potential features": Terrain,
        "path type": "/lib/environment/features/paths/path.lpc",
        "potential items": ([ "objects": ([
            "stone-pile": 10
    ...
    "temple": ([
        "interior": "/lib/environment/interiors/stone-temple.lpc",
        "potential features": ([ ]),
        "potential items": ([ "furniture": ([
            "pew": 15,
            "altar-table": 5,
    ...
    "dungeon": ([
        "interior": "/lib/environment/interiors/dungeon.lpc",
        "potential features": ([ ]),
        "potential items": ([ "lighting": ([
            "lit-torch": 10,
            "brazier": 5
