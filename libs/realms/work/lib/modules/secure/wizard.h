...
private nosave string GroupObj = "/lib/services/groups/%s.lpc";
...
/////////////////////////////////////////////////////////////////////////////
protected nomask void loadWizard(mapping data, object persistence)
{
...
/////////////////////////////////////////////////////////////////////////////
protected nomask mapping sendWizard()
{
    return ([
