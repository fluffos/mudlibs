...
/////////////////////////////////////////////////////////////////////////////
protected nomask void loadMaterialAttributes(mapping data, object persistence)
{
...
/////////////////////////////////////////////////////////////////////////////
protected nomask mapping sendMaterialAttributes()
{
    mapping ret = ([]);
    ...
    ret["location"] = (environment() && environment()->environmentName() && 
        (member(({ "/lib/environment/environment.lpc",
            "/lib/environment/generatedEnvironment.lpc" }), 
