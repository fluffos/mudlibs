...
#define DIETIES (([\
   ...
   "khyron":({"Storms/Destruction",({3, 5, 6, 8, 9}),({6, 8, 9})}), \
   ...
   "nilith":({"Undead/War",({3, 5, 6, 8, 9}),({6, 8, 9})}),\
   "nimnavanon":({"Forests/Weather",({1, 2, 3, 4, 5, 6, 7, 8, 9}),({2, 4, 5, 6, 8})}), \
   "seija":({"Magic/Knowledge",({1, 2, 3, 4, 5, 6, 8}),({1, 2, 3, 5})}),\
   "the faceless one":({"Murder/Deception",({2, 3, 5, 6, 8, 9}),({3, 5, 6, 9})}),\
   "ebolek":({"Plague/Pestilence", ({ 3, 5, 6, 8, 9}), ({ 6, 8, 9 }) }), \
