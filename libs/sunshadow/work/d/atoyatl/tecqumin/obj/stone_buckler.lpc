...
void create() {
   ...
   set_id(({ "shield","buckler","stone shield","stone buckler", "shaped buckler","shaped stone buckler"}));
   ...
   set_long("This small round shield is shaped from stone. It looks like"
     ...
     +" light enough to wield as a buckler. Straps of leather enable it to be held in one"
