...
void create(){
	...
	symbol1 = "a single flawless %^BOLD%^%^CYAN%^jewel%^RESET%^";
	weapon1 = "a slender, curving %^BOLD%^rapier%^RESET%^";
	background = "a sturdy %^BOLD%^castle %^RESET%^looming against the %^CYAN%^sky%^RESET%^";
