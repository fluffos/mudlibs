...
void create(){
	...
	symbol1 = "a howling %^BOLD%^%^BLACK%^wolf%^RESET%^";
	weapon1 = "an ornate %^BOLD%^%^BLACK%^dagger%^RESET%^";
...
int query_seal(){ return "a finely detailed image of "+weapon1+".  In the foreground, drawing your attention, is the raised carving of "+symbol1+"."; }
