...
void create(){
	...
	symbol1 = "a shrewd %^BOLD%^dragon %^RESET%^atop its %^YELLOW%^horde%^RESET%^";
	background = "a solitary %^BOLD%^monolith %^RESET%^in a flat %^GREEN%^field%^RESET%^";
...
int query_seal(){ return "a backdrop of "+background+".  On top of the background is the finely detailed image of "+symbol1+"."; }
