...
void create() {
   ...
   set_short("Nicoli, the Graez Thieves Guild's shopkeeper");
   set("aggressive", 0);
   set_level(19);
   set_long("His dark heritage is apparent through the dusky gray skin of his face, the only exposed part of "
