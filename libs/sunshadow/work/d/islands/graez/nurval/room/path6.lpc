...
void create(){
    ...
    set_exits(([
                "northeast": "/d/islands/graez/nurval/room/path7",
                "southwest": "/d/islands/graez/nurval/room/path5",
                   ]));
