...
void create(){
    ...
    set_smell("default","%^C065%^You smell fetid water and rot from the nearby swamp.%^CRST%^");
    set_listen("default","%^C060%^You hear the faint sounds of the nearby swamp.%^CRST%^");

    set_exits(([
                  
                   "west":"/d/islands/graez/rooms/swamp/18",
                   "east":"d/islands/graez/nurval/room/path2",
