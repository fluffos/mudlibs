...
void create(){
    ...
    set_items(([
        ...
        "walls": "%^RESET%^%^C244%^These towering walls are %^RESET%^%^C240%^coal-black stone%^RESET%^%^C244%^, a pair of imposing %^RESET%^%^C242%^gates %^RESET%^%^C244%^lie just to the south.%^CRST%^",
