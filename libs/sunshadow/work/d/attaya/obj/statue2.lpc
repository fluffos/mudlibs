...
int read(string str){
    ...
    write("%^CYAN%^Serenity is far away.  It is but a memory now, long have I tried to remember it, then I longed to forget it as it is something I shall never again possess.  Were it only possible to live one's life only in the yesterdays, I would lose myself in my happiness.\n");
    return 1;
}
