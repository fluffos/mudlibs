...
void create() {
    ...
    set_short("Inside the walls of the Tower of the Black Dawn.");
     set_long("
    This is the southwest guard tower.  Benches are built into all four walls, and firing slits have been cut in the floor and the walls.  An empty weapon rack is built into the north wall.
");
