...
void create(){
    ...
    set_long("%^RESET%^%^ORANGE%^You are in the drying grassland\n%^RESET%^A heavily overgrown Senzokuan styled elven gate stands to the east and its growth reaches over and down into the grass with delicate flowers and the further it goes from the wall, the more the grassland is desperate in trying to survive.");
    set_exits(([
        "east":"/d/magic/temples/edea/temple_w",
        "west":"/d/shadow/virtual/desert/25,7.desert",
        "north":"/d/shadow/virtual/desert/24,8.desert",
        "south":"/d/shadow/virtual/desert/26,8.desert"
        ]));
