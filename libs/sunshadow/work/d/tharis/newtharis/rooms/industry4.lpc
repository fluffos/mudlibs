...
void create(){
   ...
   set_exits(([
      "east" : ROOMS "tharis_weapon",
      "south" : ROOMS "industry3",
   ]));
}
...
int read_em(string str){
    if(!str) return 0;
    if(str == "sign") {
        tell_object(TP, "%^RESET%^%^C250%^This %^RESET%^%^C249%^s%^C248%^i%^C247%^g%^C249%^n%^RESET%^%^C250%^ reads:%^CRST%^\n\n%^RESET%^%^C244%^%^RESET%^%^C093%^B%^C099%^e%^C105%^r%^C111%^g%^C153%^r%^C147%^o%^C147%^m%^C141%^'%^RESET%^%^C135%^s %^RESET%^%^C129%^W%^C093%^e%^C099%^a%^C105%^p%^C111%^o%^RESET%^%^C105%^n%^C105%^s%^C099%^m%^C093%^i%^C099%^t%^C105%^h%^RESET%^%^C111%^y%^CRST%^%^CRST%^");
