...
void create() 
{
    ...
    "that composes the rest of the mausoleum. They provide the one means of "+
    "exiting this place.%^RESET%^");
    
    set_items(([
       ({"structure", "mausoleum", "cracks", "chunks"}) : "%^BOLD%^%^WHITE%^This ancient "+
       ...
       "stairway that seems foreboding. Perhaps it is the darkness into which it leads, "+
