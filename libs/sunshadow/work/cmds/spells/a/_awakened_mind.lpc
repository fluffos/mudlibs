...
void create() {
    ...
    set_description("Your brush with the infinite has awoken something compelling in your mind, enabling you to reach out and touch the mind of a known person, allowing conversations without speech and potentially over vast distances.
