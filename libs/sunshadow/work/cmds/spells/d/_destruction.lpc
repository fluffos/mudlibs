...
void create()
{
    ...
    set_description("This spell instantly delivers divine damage to the target. If the target's health points fall below zero it instantly dies. Successful save halves the damage.");
    set_verbal_comp();
    set_save("fort");
    set_somatic_comp();
