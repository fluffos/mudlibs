...
void recruit_apprentice(object ob)
{
        ...
        ob->set("title",HIR "少林" NOR + CYN "罗汉堂" NOR + RED "弟子" NOR);
        return;
...
{
        student->set("title",HIR "少林" NOR + CYN "罗汉堂" NOR + RED "弟子" NOR);
	return;
}
...
int quest_punish(object who) {
        message_vision( (this_object())->query("name")+"向$N双手合十，说道： 善 哉善哉，你好好学学功夫再要任务吧！\n" ,who);
    who->set("quest",0);
    return(0);
}
