...
#define LOGIN_PROMPT            "请输入您的英文名字（新玩家请用 new 来登记）："
...
#undef NO_PLAYERS                       /* disallow player login */
#define LOGIN_NAME_WAIT         180 /* seconds to wait for a name */
#define LOGIN_PASSWORD_WAIT     600 /* seconds for the password */
...
#define FEEDBACK_NEWSGROUP "general"
...
/* The administrator(s)' email address(es).  ADMIN的邮箱
...
#define WELCOME_LOGO            "/data/config/WELCOME_LOGO"
#define WELCOME_TEXT            "/data/config/WELCOME_TEXT"
