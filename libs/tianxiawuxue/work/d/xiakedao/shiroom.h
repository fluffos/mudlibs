int do_study(string arg)
{
	...
	for (i = 1; i<=times; i++)
	{
		...
		if (me->query_skill(skill_name[item],1)<80)
		{
		 ...
		 if (me->query_skill(skill_name[item],1)>=10000)
		{
		...
		if (learn_pot > 0)
		{
			if(item == 22)
			{
			me->improve_skill(skill_name[item], random((int)me->query("kar"))+(10 + random((int)me->query_int() - 9))/200);
		...
		if(item == 4)
			{
			me->improve_skill(skill_name[item], random((int)me->query("kar"))+(10 + random((int)me->query_int() - 9))/20);
			me->add("qi",-random(me->query("int")));
			success=1;
		}
		else if(me->query("combat_exp") < 300000000)
		{
	   	  ...
	   	  me->improve_skill(skill_name[item], 100+random((int)me->query("kar"))+(10 + 5*random((int)me->query_int() - 9))/10);
			me->add("qi",-random(me->query("int")));
			success=1;
		}
		else if(me->query("combat_exp") < 450000000)
		{
       
        me->improve_skill(skill_name[item], 200+random((int)me->query("kar"))+7*(10 + random((int)me->query_int() - 9))/18);
			me->add("qi",-random(me->query("int")));
			success=1;
		}
        ...
        me->improve_skill(skill_name[item], 200+random((int)me->query("kar"))+10*(10 + random((int)me->query_int() - 9))/15);
			me->add("qi",-random(me->query("int")));
			success=1;
		}
