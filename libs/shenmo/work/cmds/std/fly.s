...
"只见$N纵身一跳，越上云宵，飞驰而去......\n\n"NOR, me);
  ...
  if( (string)me->query("class") == "sfighter") {
                message_vision(HIG"$N两眼紧闭，默运精神力量。\n"+
"突然强光一闪，$N不见了。\n\n"NOR, me);
              }
if( (string)me->query("class") == "wudang") {
                message_vision(HIY"$N默运太极神功，身体腾空而起。\n"NOR, me);
              }
 if( (string)me->query("family/family_name") == "魔界") {
                message_vision(HIC"$N两指轻弹，千里传音召唤黑莲。\n"+
"只见$N冉冉升起，突然黑光闪动，$N消失了。\n\n"NOR, me);
              }
if( (string)me->query("family/family_name") == "明教") {
                message_vision(HIR"$N默默念起一段梵文，ぬねののはひなさ。\n"+
"只见$N施展乾坤大挪移心法，$N腾空而起。\n\n"NOR, me);
              }
if( (string)me->query("family/family_name") == "三界散仙") {
                message_vision(HIB"$N双目紧闭，两指轻弹。\n"+
"只见$N幽冥鬼舞般升起，$N消失在一片茫茫人海了。\n\n"NOR, me);
              }
...
"只见天上降下一朵七色云彩，$N纵身跃上，飞驰而去......\n\n"NOR, me);
 ...
 if( (string)me->query("family/family_name") == "天空界") {
                message_vision(HIW"$N扔出一片羽毛,纵身一跃，顷刻间你已踏上羽毛，腾空而去。\n"NOR, me);
              }
...
//      else if(arg=="pkdao") loc="/d/pkdao/pkdao";
     //   else if(arg=="sanjie") loc="/d/sanjie/sanjiedao";
        ...
        else if(arg=="lingjie") loc="/d/lingjie/rukoujob";
  ...
  //       else if(arg=="pkdao") loc="/d/pkdao/pkdao";
   ...
   //     else if(arg=="wudang") loc="/d/xkx/wudang/guangchang";
