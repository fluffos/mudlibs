...
{
string msg;
if ( ob && !userp(ob) && stringp(msg=ob->query_hit_msg(effective)) )
        msg = msg;
else    {
        msg = NOR"( $N"NOR;
        if( effective ) 
...
if ( ob && !userp(ob) && stringp(msg=ob->query_hit_sen_msg(effective)) )
        msg = msg+NOR;
else    {
        msg = NOR"( $N"NOR;      
