...
#define SHOUTAO               "/std/weapon/shoutao"  // 手套 
#define UMBRELLA		   "/std/weapon/umbrella"  //伞
...
#define F_SHOUTAO               "/std/weapon/_shoutao"  // 手套 
#define F_UMBRELLA		   "/std/weapon/_umbrella"  //伞
