...
int do_back(object me)
{
	...
	room = load_object("/d/mingjiao/qiandian");
        ...
        room->set("exits/southdown", "/d/mingjiao/square" );
        room->set("exits/north", "/d/mingjiao/dadian");
        room->set("exits/east",  "/d/mingjiao/eastdian");
        room->set("exits/west",  "/d/mingjiao/westdian"   );
