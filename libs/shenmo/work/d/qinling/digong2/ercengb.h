...
LONG);
set("exits", ([ /* sizeof() == 5 */ 
"east" : __DIR__"erceng"+sprintf("%d",37+random(12)), 
"south" : __DIR__"erceng"+sprintf("%d",25+random(24)), 
"west" : __DIR__"erceng"+sprintf("%d",13+random(36)), 
"north" : __DIR__"erceng"+sprintf("%d",1+random(48)), 
])); 
...
"/d/eastway/qinling/npc/stealer" : random(4), 
*/
]));
setup();
}
