...
LONG);
set("exits", ([ /* sizeof() == 5 */ 
"east" : __DIR__"erceng"+sprintf("%d",39+random(11)), 
"south" : __DIR__"erceng"+sprintf("%d",29+random(20)), 
"west" : __DIR__"erceng"+sprintf("%d",19+random(30)), 
"north" : __DIR__"erceng"+sprintf("%d",9+random(40)), 
])); 
