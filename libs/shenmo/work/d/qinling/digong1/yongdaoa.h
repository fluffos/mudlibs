...
LONG);
set("exits", ([ /* sizeof() == 5 */
"east" : __DIR__"yiceng"+sprintf("%d",43+random(6)),
"south" : __DIR__"yiceng"+sprintf("%d",33+random(16)),
"west" : __DIR__"yiceng"+sprintf("%d",23+random(26)),
"north" : __DIR__"yiceng"+sprintf("%d",13+random(36)),
]));
