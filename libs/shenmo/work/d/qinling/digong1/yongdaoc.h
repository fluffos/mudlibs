...
LONG); 
set("exits", ([ /* sizeof() == 5 */ 
"east" : __DIR__"yiceng"+sprintf("%d",random(28)), 
"south" : __DIR__"yiceng"+sprintf("%d",random(28)), 
"west" : __DIR__"yiceng"+sprintf("%d",random(28)), 
"north" : __DIR__"yiceng"+sprintf("%d",random(28)), 
])); 
