...
LONG); 
set("exits", ([ /* sizeof() == 5 */ 
"southeast" : __DIR__"yiceng"+sprintf("%d",random(28)), 
"southwest" : __DIR__"yiceng"+sprintf("%d",random(49)), 
"northwest" : __DIR__"yiceng"+sprintf("%d",random(49)), 
"northeast" : __DIR__"yiceng"+sprintf("%d",random(28)), 
])); 
