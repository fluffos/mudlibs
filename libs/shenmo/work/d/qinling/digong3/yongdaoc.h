...
LONG);
set("exits", ([ /* sizeof() == 5 */ 
"east" : __DIR__"sanceng"+sprintf("%d",9+random(40)), 
"south" : __DIR__"sanceng"+sprintf("%d",19+random(30)), 
"west" : __DIR__"sanceng"+sprintf("%d",29+random(20)), 
"north" : __DIR__"sanceng"+sprintf("%d",random(49)),  
])); 
