...
{
  if (!userp(me)&&me->query("id")=="zi long") {
	...
	me->move("/d/sds/saichang");
          message("chat",HIY+"【银河战役】沙织(Sha zhi):"+me->name()+ "败在了天龙座：紫龙的手下!\n"NOR,users());  
