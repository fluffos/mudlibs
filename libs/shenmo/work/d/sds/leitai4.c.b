...
void alternative_die(object me)
{
  ...
  if (!userp(me)&&me->query("id")=="xing shi") {
	...
	me->move("/d/sds/saichang");
          message("chat",HIY+"【银河战役】沙织(Sha zhi):"+me->name()+ "败在了天马座：星矢的手下!\n"NOR,users());  
