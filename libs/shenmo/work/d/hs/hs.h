...
mapping pangolin = ([ "name"  :  "穿山甲"  ,  "id"  :  "pangolin" ,
		"kee"   :    7      ,  "atk"  :    3        ,  "def"  :    15    ,     "spd"  :   2	,
		"fkee"  :    2      ,  "fatk" :    1        ,  "fdef" :    3     ,     "fspd" :   1	,
		"rkee"  :    12     ,  "ratk" :    8        ,  "rdef" :    20    ,     "rspd" :   5	,   
		"keef"  :    2      ,  "atkf" :    1        ,  "deff" :    5     ,     "spdf" :   1	,
              "unarmed_skill" : "hs-unarmed1" ,
              "parry_skill" : "hs-parry1" ,
              "dodge_skill" : "hs-dodge1" ,
              "force_skill" : "hs-force" ,
                    ]);
 
mapping tortoise = ([ "name"  :  "龟"     ,  "id"   :  "tortoise" ,
...
mapping elephant = ([ "name"  :  "象"     ,  "id"   :  "elephant" ,
...
mapping hippo    = ([ "name"  :  "河马"   ,  "id"   :  "hippo"    ,
...
mapping crocodile= ([ "name"  :  "鳄鱼"   ,  "id"   :  "crocodile"    ,
...
mapping shark    = ([ "name"  :  "鲨鱼"   ,  "id"   :  "shark"    ,
		"kee"   :    8      ,  "atk"  :    18       ,  "def"  :    8     ,     "spd"  :   8	,
		"fkee"  :    2      ,  "fatk" :    4        ,  "fdef" :    2     ,     "fspd" :   2      ,  
		"rkee"  :    10     ,  "ratk" :    15       ,  "rdef" :    10    ,     "rspd" :   8   	,
		"keef"  :    2      ,  "atkf" :    3        ,  "deff" :    1     ,     "spdf" :   2      ,
              "unarmed_skill" : "hs-unarmed3" ,
              "parry_skill" : "hs-parry3" ,
              "dodge_skill" : "hs-dodge3" ,
              "force_skill" : "hs-force" ,

                    ]);

mapping bat      = ([ "name"  :  "蝙蝠"   ,  "id"   :  "bat"      ,
		"kee"   :    5      ,  "atk"  :    12       ,  "def"  :    8     ,     "spd"  :   13	,
		"fkee"  :    1      ,  "fatk" :    2        ,  "fdef" :    2     ,     "fspd" :   4      ,  
		"rkee"  :    8      ,  "ratk" :    9        ,  "rdef" :    9     ,     "rspd" :   14   	,
		"keef"  :    1      ,  "atkf" :    1        ,  "deff" :    1     ,     "spdf" :   4      ,
              "unarmed_skill" : "hs-unarmed2" ,
              "parry_skill" : "hs-parry2" ,
              "dodge_skill" : "hs-dodge2" ,
              "force_skill" : "hs-force" ,

                    ]);

mapping cat      = ([ "name"  :  "猫"     ,  "id"   :  "cat"      ,
...
mapping monkey   = ([ "name"  :  "猴"     ,  "id"   :  "monkey"   ,
...
mapping peacock  = ([ "name"  :  "孔雀"   ,  "id"   :  "peacock"  ,
...
mapping chicken   = ([ "name"  :  "鸡"     ,  "id"   :  "chicken"  ,
...
mapping leopard  = ([ "name"  :  "豹"     ,  "id"   :  "leopard"  ,
...
{ 
    ...
    ob->set("str",att["atk"]);
    ob->set("unit",att["unit"]);

    ob->set_skill("dodge",att["spd"]*2);
    ob->set_skill("unarmed",att["atk"]*2);
    ob->set_skill("parry",att["def"]*2);
    ob->set_skill("force",att["kee"]*2);
    ob->set_skill(att["dodge_skill"],att["spd"]*2);
    ob->set_skill(att["unarmed_skill"],att["atk"]*2);
    ob->set_skill(att["parry_skill"],att["def"]*2);
    ob->set_skill(att["force_skill"],att["kee"]*2);

    ob->map_skill("dodge", att["dodge_skill"]);
    ob->map_skill("unarmed", att["unarmed_skill"]);
    ob->map_skill("parry", att["parry_skill"]);
    ob->map_skill("force", att["force_skill"]);
    ob->reset_action();

    ob->set("maximum_force",att["kee"]*3);
    ob->set("max_force",att["kee"]*3);

    att["能量"]=att["atk"]+att["kee"]+att["def"]+att["spd"];
    ob->set("att",att);
}
