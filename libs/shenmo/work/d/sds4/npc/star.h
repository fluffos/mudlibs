...
random(2)?
message("chat",HIY"【"NOR+HIG"海皇神殿"NOR+HIY"】"+me->query("name")+HIY"("+me->query("id")+HIY"): 燃烧吧，小宇宙！\n"NOR,users()):
message("chat",HIY"【"NOR+HIG"海皇神殿"NOR+HIY"】"+me->query("name")+HIY"("+me->query("id")+HIY"): 小宇宙！爆发吧！\n"NOR,users());
