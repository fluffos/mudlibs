...
void create()
{
        set_name(WHT"天使翼"NOR, ({"tianshi yi", "wing"}));
        set_weight(3000);
        if( clonep() )
                ...
                if(random(10)==1){
                	set("armor_prop/attack",random(40));     
                	set("armor_prop/defense",random(20));     
                }    	
                else if(random(10)==8){
                	set("armor_prop/attack",random(20));
                	set("armor_prop/defense",random(40));
                }              	
                else{
                	set("armor_prop/attack",random(20));
                	set("armor_prop/defense",random(20));    
