...
LONG);
set("exits", ([ /* sizeof() == 5 */ 
"east" : __DIR__"sanceng"+sprintf("%d",24+random(25)), 
"south" : __DIR__"sanceng"+sprintf("%d",24+random(25)), 
"west" : __DIR__"sanceng"+sprintf("%d",49+random(25)), 
"north" : __DIR__"sanceng"+sprintf("%d",49+random(25)), 
])); 
...
"/d/eastway/qinling/npc/wujiang" : random(3), 
]));
setup();
}
/*
