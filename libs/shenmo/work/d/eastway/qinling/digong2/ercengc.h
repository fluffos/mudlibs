...
LONG);
set("exits", ([ /* sizeof() == 5 */ 
"east" : __DIR__"erceng"+sprintf("%d",44+random(5)), 
"south" : __DIR__"erceng"+sprintf("%d",44+random(5)), 
"west" : __DIR__"erceng"+sprintf("%d",39+random(10)), 
"north" : __DIR__"erceng"+sprintf("%d",39+random(10)), 
])); 
