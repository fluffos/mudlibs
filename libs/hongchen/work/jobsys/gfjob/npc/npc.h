...
mapping *dizhia=({
      ...
      (["cdizhi":                "苗疆",
       "weizhi2" :              "/u/dubei/miaojiang/jiedao4",]),  
      (["cdizhi":                "扬州",
       "weizhi2" :              "/d/city/xjs",]),  
      (["cdizhi":                "杭州",
      ...
      (["cdizhi":                "雪山",
       "weizhi2" :              "/d/xueshan/xuelu04",]),
      (["cdizhi":                "华山",
       "weizhi2" :              "/d/huashan/yunu",]),
      (["cdizhi":                "慕容山庄",
       "weizhi2" :              "/u/beyond/mr/xiaojing1-2",]),
      (["cdizhi":                "慕容山庄",
       "weizhi2" :              "/u/beyond/mr/liulin",]),
      (["cdizhi":                "苏州城",
       "weizhi2" :              "/u/beyond/suzhou/baodaiqiao",]),
      (["cdizhi":                "苏州城",
       "weizhi2" :              "/u/beyond/suzhou/shihu",]),
      (["cdizhi":                "苏州城",
       "weizhi2" :              "/u/beyond/suzhou/xuanmiaoguan",]),
      (["cdizhi":                "苏州城",
       "weizhi2" :              "/u/beyond/suzhou/zijinan",]),
      (["cdizhi":                "少林寺",
...
int do_yes()
{
        ...
        message_vision("$N嘿嘿奸笑两声，悄悄塞给了$n一棵人参。\n",me,ob);
           r_shen=new("/u/dubei/job/renshen");;
        r_shen->move(ob);
        command("give "+ob->query("id")+" gold");
        message_vision("$N嘿嘿一笑，转身离开，一眨眼就消失不见了。\n",me);
        destruct(me);
