...
| 110-1 | `xkx100utf8` | 侠客行一百 | `git clone https://github.com/fluffos/xkx100 (HEAD 51396a26, 2026-09-12; mudlib root is the repo root; .lpc + §9 formatted on the fluffos-org repo). MudRen/xkx100 is the same tree with a MudCore wrap and was not converted separately` | 40275 | WASM playable |
...
| 162 | `sanguozhi` | 三国志 | `git clone https://github.com/fluffos/sanguozhi (HEAD 80cb871, 2026-09-12; mudlib root is the repo root; .lpc + §9 formatted on the fluffos-org repo)` | 40210 | WASM playable |
| 163 | `nt7` | 王者归来 | `git clone https://github.com/fluffos/nt7 (HEAD 04a1a75e, 2026-09-12; mudlib root is the repo root; .lpc + §9 formatted on the fluffos-org repo)` | 40211 | WASM playable |
...
| 174-1 | `foundation1` | Foundation I | `mudbytes.net File Repository, file #1043, recovered via Wayback Machine snapshot 20190802021701 (original download endpoint down)` | 40248 | WASM playable |
...
| 941-1 | `lpmud245` | LPmud 2.4.5 | `ftp.lysator.liu.se/pub/lpmud/mudlibs/other/2.4.5.tar.gz (still live, recovered directly 2026-08-31)` | 40262 | WASM playable |
...
| 981 | `dtxyzjb` | 大唐西游指间版 | `大唐西游指间版.rar` | 40267 | WASM playable |
...
| 986 | `ptjnbxq` | 普通技能编写器 | `普通技能编写器.rar` | — | not-mudlib |
| 987 | `xlwebmud` | 西陆WEBMUD 仗剑江湖 | `西陆WEBMUD仗剑江湖.rar` | — | not-mudlib |
| 988 | `njhhdxfhzxth` | es2/xkx（南京河海大学，含纵横天下） | `南京河海大学的es2和xkx《包含纵横天下》.gz` | — | not-convertible |
| 989 | `zjmudouter` | zjmud (outer container) | `zjmud.7z` | — | not-mudlib |
<!-- END NUMBERING TABLE -->
